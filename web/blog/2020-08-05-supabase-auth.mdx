...
Back in May we were an early alpha-stage startup, when one of our users unexpectedly [launched us on Hacker News](https://news.ycombinator.com/item?id=23319901). Although we had completed only 3 months of development the developer support was both incredible and humbling.
...
<source src="/videos/auth-zoom.mp4" type="video/mp4" />
</video>
...
<video width="99%" autoplay="autoplay" loop muted playsinline controls="true">
<source src="/videos/rls-zoom.mp4" type="video/mp4" />
</video>
...
<video width="99%" autoplay="autoplay" loop muted playsinline controls="true">
<source src="/videos/policies-zoom.mp4" type="video/mp4" />
</video>
...
<iframe width="730" height="440" src="https://www.youtube.com/embed/2oqIZW5S-lQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>