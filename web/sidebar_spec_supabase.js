module.exports = {
  docs: [
    ...
    },
    {
      type: 'category',
      label: 'Auth',
      items: ['reference/javascript/auth-signup', 'reference/javascript/auth-signin', 'reference/javascript/auth-signout', 'reference/javascript/auth-session', 'reference/javascript/auth-user', 'reference/javascript/auth-update', 'reference/javascript/auth-setauth', 'reference/javascript/auth-onauthstatechange', 'reference/javascript/auth-api-getuser'],
      collapsed: true,
    },
    {
      type: 'category',
      label: 'Auth (Server Only)',
      items: ['reference/javascript/auth-api-createuser', 'reference/javascript/auth-api-deleteuser', 'reference/javascript/auth-api-generatelink', 'reference/javascript/auth-api-inviteuserbyemail', 'reference/javascript/auth-api-sendmobileotp', 'reference/javascript/auth-api-resetpasswordforemail', 'reference/javascript/auth-api-updateuserbyid'],
      collapsed: true,
    },
    {
      type: 'category',
