module.exports = {
  docs: [
    ...
    },
    {
      type: 'category',
      label: 'Storage',
      items: ['reference/javascript/storage-createbucket', 'reference/javascript/storage-getbucket', 'reference/javascript/storage-listbuckets', 'reference/javascript/storage-deletebucket', 'reference/javascript/storage-emptybucket', 'reference/javascript/storage-from-upload', 'reference/javascript/storage-from-download', 'reference/javascript/storage-from-list', 'reference/javascript/storage-from-update', 'reference/javascript/storage-from-move', 'reference/javascript/storage-from-delete', 'reference/javascript/storage-from-createsignedurl', 'reference/javascript/storage-from-deletefiles'],
      collapsed: true,
    },
    {
      type: 'category',
