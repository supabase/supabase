...
That's just a fancy way of saying that you can put some logic into your database, and then call it from anywhere. 
This is especially useful for things like password resets, where the logic rarely changes.
