...
import { signUp, signIn, userData, signOut, signInOauth, onAuthStateChange, update } from './examples/users'
...
Once these steps are completed, you can use the `signIn()` menthod with the enabled provider:
