...
Note, if you want to receive the "previous" data for updates and deletes,
...
Note, if you want to receive the "previous" data for updates,
you will need to set `REPLICA IDENTITY` to `FULL`, like this:
`ALTER TABLE your_table REPLICA IDENTITY FULL;`
...
You will not be able to delete data from your database unless you set your set your table to use FILL `REPLICA IDENTITY`, like this:
`ALTER TABLE your_table REPLICA IDENTITY FULL;`
