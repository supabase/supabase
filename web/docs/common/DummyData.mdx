...
| name           | country_id | miscellaneous        |
| -------------- | :--------: | -------------------- |
| Rio de Janeiro |     76     | { isCapital: false } |
| Beijing        |    156     | { isCapital: true }  |
| Paris          |    250     | { isCapital: true }  |
| Auckland       |    554     | { isCapital: false } |
| Lagos          |    556     | { isCapital: false } |
| San Francisco  |    840     | { isCapital: false } |
