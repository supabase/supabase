...
```jsx
// see full api reference here: https://supabase.com/docs/reference/javascript/auth-signup
...
If supabase-js is loaded on your site (in this case http://localhost:3000) then it will automatically pluck the access_token out of the URL and initiate a session. You can check the [session()](https://supabase.com/docs/reference/javascript/auth-session) method to see if there is a valid session:
