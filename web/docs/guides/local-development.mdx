...
You will also need to install [NPM](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm). In the future we will make our CLI available on `brew` and `apt`.
