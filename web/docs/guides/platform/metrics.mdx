...
The endpoint discussed in this article is an Enterprise feature and is not available on self-hosted. It is available for all projects until 1st Sept 2022, and then will be disabled for Free-tier and Pro-tier projects.
