...
This prevents locke-in and, more importantly, it is our way of supporting open source development.

We support the tools that we use in a number of ways - donating directly, building client libraries, 
and even employing contributors to work full-time on the tools (in the case of PostgREST).
