...
Let's also create a constant file to to make our lives easier. 
...
This splash screen inherits `AuthState` to redirect users to the appropreate pages depending on their authentication state. 
