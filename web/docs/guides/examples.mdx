...
By [@gdangel0](https://twitter.com/gdangel0) and powered by [@AlterClassIO](https://twitter.com/AlterClassIO).
...
Enroll here → [Build a FullStack App with Next.js, Supabase & Prisma](https://themodern.dev/courses/build-a-fullstack-app-with-nextjs-supabase-and-prisma-322389284337222224)
