...
And one optional step is to update the CSS file to make the app look nice. 
You can find the full contents of this file [here](https://github.com/supabase/supabase/blob/master/examples/react-user-management/src/index.js).
