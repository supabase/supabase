...
- Login to the CLI. [Docs](/docs/reference/cli/supabase-login)
  - Command: `supabase login`
- Initialize Supabase inside your project.  [Docs](/docs/guides/local-development#getting-started)
  - Command: `supabase login`
- Link to your Remote Project. [Docs](/docs/reference/cli/supabase-link)
...
You can execute any Edge Function using curl. You can copy the curl command from the Dashboard. It should look like this:

```bash
curl --request POST 'https://hganqyntpokmkeyqbvux.functions.supabase.co/hello-world' \
  --header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJvbGUiOiJhbm9uIiwiaWF0IjoxNjQyMTkzMTk0LCJleHAiOjE5NTc3NjkxOTR9.QNsSlnt6BA4EF1jCwMaCdn0B8AiCr9jhqeMwJvcd3ho' \
