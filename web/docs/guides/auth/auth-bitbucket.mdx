...
- Add your Bitbucket OAuth Consumer keys to your [Supabase Project](https://supabase.com)
...
The JavaScript client code is documented here: [Supabase OAuth Client Code](https://supabase.com/docs/reference/javascript/auth-signin#sign-in-using-third-party-providers)
