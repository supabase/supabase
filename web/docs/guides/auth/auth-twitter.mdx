...
### Log into the [Twitter Developer Dashboard](https://developer.twitter.com/en/portal/dashboard) 

Once logged into the *"Twitter Developer Dashboard"*:
...
- Under "App Sttings", click on the gear icon next to your app name to go to "App Settings"
...
- Enter your "Callback URL" 
    - Your "Callback URL" or "OAuth Redirect URI" looks like this:
...
### Enter your Twitter API Key and API Secret Key into your Supabase Project
