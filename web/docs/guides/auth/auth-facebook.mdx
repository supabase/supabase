...
First, you'll need a Developer Account at [developers.facebook.com](https://developers.facebook.com).
...
In the next step you require a callback URI, which looks like this: 
