...
The JavaScript client code is documented here: [Supabase OAuth Client Code](/docs/reference/javascript/auth-signin#sign-in-with-magic-link)
The Dart client code is documented here: [Supabase OAuth Client Code](/docs/reference/dart/auth-signin#sign-in-with-magic-link)
