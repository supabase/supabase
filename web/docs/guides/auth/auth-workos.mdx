...
- Connect a WorkOS Connected Identity Provider
...
Set up the identity provider by
...
- Enter the `Client ID`, `Secret`, and `WorkOS URL` saved in the previous steps. The WorkOS URL should be set to https://api.workos.com/
- Click `Save`
