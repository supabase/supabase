...
- You can find this endpoint from the realm settings under the "General Tab" or visit http://localhost:8080/auth/realms/my_realm_name/.well-known/openid-configuration .
