...
1. Edit the `secret_gen.rb` file:
    ...
    - `client_id` = "The Service ID of the service you created". This is the `Services ID` you created in the above step `Obtain a Services ID`.
    ...
    - `key_id` = "The Key ID of the private key". This can be found in the name of your downloaded secret file (For a file named `AuthKey_XXXXXXXXXX.p8` your key_id is `XXXXXXXXXX`).
        - If you've lost this ID, you can find it in the Apple Developer Site:
            - Go to `Certificates, Identifiers & Profiles`.
...
- Go to your [Supasebase Dashboard](https://supabase.io).
