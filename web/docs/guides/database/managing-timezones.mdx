...
This is becuase it makes it much easier to calculate diffeneces between timezones if you adopt the mental model that "everything in my database is in UTC time".
