...
Postgres is extensible, allowing Supabase to provide some amazing functionality immediately . Enable Postgres extensions with the click of a button.
...
When you create a new project in Supabase we ask for a password. You can use this password to connect direcly to your Postgres database.
...
Read more in [Database Configuration](/reference/postgres/database-passwords).
...
Read more in [Database Configuration](/reference/postgres/changing-timezones).
