...
You might want to migrate older projects to a new project, e.g. to use a newer Postgres version. We don't have a well-tested migration path, but here's something you can try:
