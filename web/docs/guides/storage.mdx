...
Files can be any sort of media file. This includes images, gifs, and videos. Because of the size of these files, it's best-practice to store them outside of your database.
