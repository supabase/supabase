...
Currently, we do not generate the `client_secret` the Apple requires, but here's a [useful guide](https://medium.com/identity-beyond-borders/how-to-configure-sign-in-with-apple-77c61e336003) on how you can generate it on your end!
