...
import LWXBannerBg from './LWXBannerBg'
...
export function LWXCountdownBanner() {
  ...
  return (
    <div className="relative w-full h-14 p-2 flex items-center group justify-center text-white bg-[#020405] hover:bg-[#05080a] transition-colors overflow-hidden">
