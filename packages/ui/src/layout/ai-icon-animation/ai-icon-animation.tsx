...
export const AiIconAnimation = memo(
  ({ size = 24, loading = false, className, allowHoverEffect = false }: AiIconAnimationProps) => {
  ...
  (prevProps, nextProps) => {
    return (
      ...
      prevProps.allowHoverEffect === nextProps.allowHoverEffect
    )
  }
)

AiIconAnimation.displayName = 'AiIconAnimation'
