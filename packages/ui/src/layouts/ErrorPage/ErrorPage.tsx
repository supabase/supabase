  ...
  return (
    <div className="relative mx-auto flex h-screen w-full flex-col items-center justify-center">
      ...
      <div className="absolute">
        <h1
          className={`text-scale-1200 select-none text-[14rem] opacity-[5%] filter transition duration-200 ease-in sm:text-[18rem] lg:text-[28rem] ${
      ...
      <div
        className={`flex flex-col items-center justify-center space-y-6 transition duration-200 ease-in ${
