...
describe('#Select', () => {
  ...
  it('should have "form-select--error" class', () => {
    ...
    expect(screen.queryByTestId('form-select')).toHaveClass(
      'block box-border w-full rounded-md shadow-sm transition-all text-foreground border focus-visible:shadow-md outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:border-foreground-muted placeholder-foreground-muted appearance-none bg-none bg-destructive-200 border border-destructive-500 placeholder:text-destructive-400 text-sm px-4 py-2'
    )
  })
})
