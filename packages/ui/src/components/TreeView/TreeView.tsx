...
export const TreeViewItemVariant = cva(
  ...
  'group relative transition-colors h-[28px] flex items-center gap-3 text-sm cursor-pointer select-none text-foreground-light hover:bg-control aria-expanded:bg-transparent data-open:bg-transparent', // data-open:bg-control bg state for context menu open
  {
    variants: {
      isSelected: {
