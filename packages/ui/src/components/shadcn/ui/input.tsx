...
export const InputVariants = cva(
  cn(
    ...
    'aria-[] aria-invalid:bg-destructive-200 aria-invalid:border-destructive-400 aria-invalid:focus:border-destructive aria-invalid:focus-visible:border-destructive'
  ),
  {
    variants: {
      size: {
