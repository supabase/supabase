...
export const InputVariants = cva(
  cn(
    'flex h-10 w-full rounded-md border border-control read-only:border-secondary bg-foreground/[.026] px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-foreground-muted read-only:placeholder:text-foreground-muted',
