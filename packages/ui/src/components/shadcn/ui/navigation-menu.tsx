...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger ref={ref} className={cn('group', className)} {...props}>
    {children}{' '}
    <ChevronDown
      className="relative top-px ml-1 h-3 w-3 transition duration-200 group-data-open:rotate-180"
      aria-hidden="true"
    />
...
>(({ className, containerProps, ...props }, ref) => (
  ...
  >
    <NavigationMenuPrimitive.Viewport
      className={cn(
        'origin-top-center relative mt-1.5 h-radix-navigation-menu-viewport w-full overflow-hidden rounded-md border bg text-popover-foreground shadow-lg data-open:animate-in data-open:fade-in data-open:slide-in-from-right-10 data-open:duration-100 data-open:ease-out data-closed:animate-out data-closed:fade-out data-closed:duration-75 md:w-radix-navigation-menu-viewport',
        className
      )}
      ref={ref}
      {...props}
