...
const badgeVariants = cva(
  'inline-flex items-center justify-center rounded-full font-normal whitespace-nowrap tracking-[0.07em] uppercase font-medium text-[9.5px] leading-[1.1] px-[5.5px] py-[3px]',
  {
    variants: {
      variant: {
