...
const badgeVariants = cva(
  'inline-flex items-center text-center uppercase tracking-widest px-[6px] py-[4px] rounded-full text-[10px] font-medium bg-opacity-10 leading-none indent-[0.04em]',
  {
    variants: {
      variant: {
