    ...
    variants: {
      type: {
        primary: `
          ...
          data-open:bg-brand-400/80 dark:data-open:bg-brand-500/80
          data-open:outline-brand-600
          `,
        default: `
          text-foreground
        ...
        secondary: `
          ...
          data-open:border-foreground-lighter
          data-open:outline-border-strong
        `,
        ...
        alternative: `
          ...
          focus-visible:outline-brand-600
          data-open:bg-brand-500
          data-open:border-brand-500
          data-open:outline-brand-600
        `,
        outline: `
          text-foreground
        ...
        danger: `
          ...
          data-open:bg-destructive-400 dark:data-[state=open]:bg-destructive-/50
          data-open:outline-destructive
        `,
        warning: `
          text-foreground
          ...
          hover:text-hi-contrast
          focus-visible:outline-amber-700
          data-open:border-warning
          data-open:bg-warning-400 dark:data-[state=open]:bg-warning-/50
          data-open:outline-warning
        `,
      },
      block: {
