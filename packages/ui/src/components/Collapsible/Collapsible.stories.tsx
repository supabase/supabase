    ...
    <>
      <Collapsible className="-space-y-px">
        <Collapsible.Trigger asChild>
          <button
            type="button"
            className="group text-foreground flex justify-between items-center w-full bg-scale-300 rounded border border-scale-500 p-3"
          >
        ...
        <Collapsible.Content>
          <div className="group text-foreground flex justify-between items-center w-full bg-scale-300 rounded border border-scale-500 p-3">
