  ...
  return (
    <span
      className={cn(
        ...
        variant === 'pill'
          ? 'items-center text-[10px] leading-none -tracking-[0.025em] text-foreground-light bg-surface-200/50 dark:bg-surface-100/50 rounded px-[5px] py-[3px] border border-border-muted'
          : 'items-baseline text-[10px] leading-[inherit] text-foreground/40',
        className
      )}
    >
      {shortcutLabel}
