...
export const MCP_CLIENT_INSTRUCTIONS: Record<string, McpClientInstructions> = {
  ...
  windsurf: {
    primary: () => (
      <blockquote data={{ callout: 'warning' }}>
        <paragraph>
          Ensure you are running Devin Desktop version <inlineCode value="0.1.37" /> or higher.
        </paragraph>
      </blockquote>
    ),
    alternate: () => (
      <paragraph>
        Devin Desktop does not currently support remote MCP servers over HTTP transport. You need to use
