...
const contextBadgeVariants = cva(
...
export interface ContextBadgeProps
  extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof contextBadgeVariants> {}

export const ContextBadge = React.forwardRef<HTMLDivElement, ContextBadgeProps>(
  ({ className, variant = 'default', children, ...props }, ref) => {
    return (
      <div ref={ref} className={cn(contextBadgeVariants({ variant }), className)} {...props}>
        {children}
      </div>
    )
  }
