...
export const projectComposerTemplates: ProjectComposerTemplate[] = [
  ...
  },
  {
    ...
    category: 'Core',
    tags: ['functions', 'edge', 'serverless', 'deno'],
    files: [
      {
        path: 'supabase/config.toml',
  ...
  },
  {
    ...
    category: 'Storage',
    tags: ['storage', 'avatars', 'images'],
    dependencies: {
      required: ['storage', 'auth'],
      optional: ['auth-email'],
    },
    files: [
      {
  ...
  },
  {
    ...
    category: 'Realtime',
    tags: ['realtime', 'comments', 'collaboration'],
    dependencies: {
      required: ['database'],
    },
    files: [
  ...
  },
  {
    ...
    category: 'Ecommerce',
    tags: ['stripe', 'webhook', 'functions'],
    dependencies: {
      required: ['functions', 'database'],
    },
    files: [
      {
