...
import { mergeTemplates, resolveTemplateDependencies } from './composition'
import { buildCompositionGraph } from './graph'
...
describe('start composition graph adapter', () => {
  it('converts templates, dependencies, and output resources into graph primitives', () => {
    ...
    const graph = buildCompositionGraph({ templates, selectedIds, resolution, mergeResult })
