  ...
  return (
    ...
    >
      <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4">
        <div className="mb-5">
          <h2 className="m-0 mb-1.5 text-[15px] font-semibold tracking-tight text-foreground">
            Compose your project
          </h2>
          <p className="m-0 text-[13px] leading-relaxed text-foreground-light">
            Pick your back-end pieces and connect them to your front-end.
          </p>
        </div>
