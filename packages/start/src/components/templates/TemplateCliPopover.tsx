    ...
    <Popover>
      ...
      >
        ...
        <div className="flex items-center gap-2 border-t bg-background/25 px-3 py-2 font-mono text-xs text-foreground-light">
          <span className="shrink-0 text-foreground-light">$</span>
...
export const templateSearchCliDescription =
  'Agents can use this command to list or search the Supabase templates registry before composing a project.'
