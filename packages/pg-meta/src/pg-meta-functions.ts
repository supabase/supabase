      ...
      ? _generateCreateFunctionSql(
          {
            ...
            // Procedures have no RETURNS clause (return_type is null in the
            // row schema); coalesce to undefined so the branded create input
            // stays valid while _generateCreateFunctionSql ignores it for
            // procedures anyway.
