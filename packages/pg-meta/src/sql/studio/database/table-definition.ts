 ...
 * Derived from https://github.com/MichaelDBA/pg_get_tabledef; the
 * `-- Supabase perf fix:` comments mark where it diverges from the
 * vendored upstream to avoid O(catalog) information_schema scans.
 */
export const CREATE_PG_GET_TABLEDEF_SQL: SafeSqlFragment = safeSql`
