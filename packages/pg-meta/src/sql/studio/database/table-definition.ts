...
/** pg_temp.pg_get_tabledef: OID-scoped catalog lookups (no information_schema scans). */
const PG_GET_TABLEDEF_SQL: SafeSqlFragment = safeSql`
...
export const createPgGetTabledefSql = (): SafeSqlFragment => PG_GET_TABLEDEF_SQL
