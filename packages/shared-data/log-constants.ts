...
const schemas: LogSchema[] = [
  {
    ...
    fields: [
      ...
      { path: 'metadata.request.headers.traceparent', type: 'string' },
      { path: 'metadata.request_id', type: 'string' },
      { path: 'metadata.response.origin_time', type: 'number' },
      { path: 'metadata.response.status_code', type: 'number' },
      { path: 'metadata.span_id', type: 'string' },
      { path: 'metadata.trace_id', type: 'string' },
    ],
  },
  {
    name: 'Auth',
