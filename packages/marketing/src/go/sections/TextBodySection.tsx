...
export default function TextBodySection({ section }: { section: GoTextBodySection }) {
  return (
    <article className="prose prose-headings:text-foreground prose-p:text-foreground-light prose-strong:text-foreground prose-li:text-foreground-light prose-a:text-primary prose-a:decoration-primary max-w-none">
