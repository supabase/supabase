...
export {
  ...
  type GitHubTemplateSourceOptions,
...
// Node-only operations (filesystem, etc.) live in 'template-composer/node'. They are
// NOT re-exported here so this barrel stays safe for browser bundles. CLI
// consumers: `import { installTemplate } from 'template-composer/node'`.
...
export { normalizeRegistrySlug } from './src/registry/schema'
