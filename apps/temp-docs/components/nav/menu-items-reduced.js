export const menuItems = {
  Docs: [
    ...
    },
    {
      ...
      label: 'CLI',
      collapsed: true,
      items: ['guides/cli', 'guides/cli/local-development', 'guides/cli/managing-environments'],
    },
    {
      type: 'category',
      label: 'Auth',
    ...
    },
    {
      ...
      label: 'Realtime',
      collapsed: true,
      items: ['guides/realtime', 'guides/realtime/quickstart', 'guides/realtime/postgres-cdc'],
    },
    {
      type: 'category',
      label: 'Storage',
