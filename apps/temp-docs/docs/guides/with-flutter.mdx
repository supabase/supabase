...
We can use [`flutter create`](https://flutter.dev/get-started/test-drive) to initialize
...
Every Supabase project is configured with [Storage](/guides/storage) for managing large files like
photos and videos.
