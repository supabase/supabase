...
- Ensure that you have suitable indices to cater to your common query patterns
    ...
    - pg_stat_monitor can help you [find query insights and improve performance](https://www.percona.com/blog/improve-postgresql-query-performance-insights-with-pg_stat_monitor/)
