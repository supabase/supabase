...
summary = "Google sign-in fails for selected users when the OAuth consent screen, requested scopes, or Google Workspace policies do not permit their accounts."
