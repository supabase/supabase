...
**Why This Occurs:**
This happens due to a fundamental change made to fix various issues. Please see more details on why this change was made and solutions to fix it: https://github.com/orgs/supabase/discussions/37869
