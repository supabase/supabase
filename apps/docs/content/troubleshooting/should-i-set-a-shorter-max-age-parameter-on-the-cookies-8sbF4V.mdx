...
summary = "Shortening a cookie's Max-Age does not shorten the server-side Auth session because session validity is controlled by refresh-token and sign-out state."
