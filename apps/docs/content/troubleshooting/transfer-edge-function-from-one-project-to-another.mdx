...
summary = "Edge Functions are project-scoped, so moving them requires copying function source, redeploying it, and recreating project-specific secrets and configuration."
diagnostic_sources = [ "edge-function-logs" ]
topics = [ "cli", "database", "functions" ]
keywords = [ "functions", "typescript", "deno" ]
database_id = "83446166-2539-44ce-bde5-9252ce59d2e3"
---
