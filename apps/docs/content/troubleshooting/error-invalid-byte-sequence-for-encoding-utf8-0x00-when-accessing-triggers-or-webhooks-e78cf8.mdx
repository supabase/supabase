...
summary = "Trigger or webhook inspection can fail with an invalid UTF-8 byte error when standard_conforming_strings is disabled and stored definitions contain incompatible escapes."
