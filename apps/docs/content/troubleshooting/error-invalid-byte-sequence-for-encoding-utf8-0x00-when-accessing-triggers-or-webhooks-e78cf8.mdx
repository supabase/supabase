...
This setting, when `off`, can cause issues with how certain character sequences are interpreted by PostgreSQL, leading to errors in dashboard queries that expect UTF8-compliant strings.
