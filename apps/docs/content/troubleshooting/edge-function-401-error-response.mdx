...
If you would like to continue using the JWT check, make sure that your [Supabase Client](/docs/guides/api/rest/client-libs) only uses your [legacy keys](https://supabase.com/dashboard/project/_/settings/api-keys/legacy).
