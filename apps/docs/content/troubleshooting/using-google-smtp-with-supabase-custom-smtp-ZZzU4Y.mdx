...
2. The SMTP password used has to be an app password. Google workspace doesn't make it to figure out how to create this. You need to **enable 2FA** on your workspace account first (not inside the admin console but in https://myaccount.google.com/)
