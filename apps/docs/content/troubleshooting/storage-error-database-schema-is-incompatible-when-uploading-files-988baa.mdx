...
summary = "A Row Level Security policy recursively queries its own table or a policy chain that returns to the original table."
diagnostic_sources = [ "postgres-logs", "security-advisor", "database-inspection" ]
