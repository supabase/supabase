...
summary = "CLI TransportError means the Management API request failed before an HTTP response, commonly because a proxy, firewall, antivirus, or TLS interceptor blocked the connection."
