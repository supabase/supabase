...
- Create the project directly from the [Supabase Dashboard](https://supabase.com/dashboard) instead of through Lovable.
...
>
  ...
  <div className="border-b mt-3 pb-3">
    ...
    Create the project directly from the [Supabase Dashboard](https://supabase.com/dashboard) or manually connect Lovable to an existing Supabase project before enabling Lovable Cloud.
