...
summary = "A Lovable Cloud backend does not appear in your Supabase Dashboard because Lovable, not your Supabase account, owns and manages the underlying project."
