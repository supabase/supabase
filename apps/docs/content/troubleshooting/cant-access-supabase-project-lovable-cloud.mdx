...
These projects are not owned by your Supabase account, so they will **not appear on your Supabase Dashboard** or be accessible using your Supabase credentials.
...
However, you can manually clone your project backend and migrate your data following Lovable’s official guide:

[Self-Hosting Guide (Lovable Docs)](https://docs.lovable.dev/tips-tricks/self-hosting)
...
- Create the project directly from the [Supabase Dashboard](/dashboard) instead of through Lovable.
- Avoid enabling Lovable Cloud if you plan to manage your Supabase project independently.
- **Manually connect your Lovable project to your Supabase project**, or **start your Lovable project already connected** to your own Supabase project from the beginning.

## Additional resources

For more information, check the Lovable Cloud FAQ: [Lovable Cloud FAQ](https://docs.lovable.dev/features/cloud#faq)
...
>
  <div className="border-b mt-3 pb-3">
    <AccordionItem
      header="Can I get direct SQL editor access at supabase.com?"
  ...
  <div className="border-b mt-3 pb-3">
    ...
    Since Lovable fully manages the database infrastructure, direct database URLs and connection credentials are not exposed.
  ...
  <div className="border-b mt-3 pb-3">
    <AccordionItem
      header="How can I prevent this in the future?"
      id="prevent-future"
    >

    Create the project directly from the [Supabase Dashboard](/dashboard) or manually connect Lovable to an existing Supabase project before enabling Lovable Cloud.
