...
You can check your CPU usage directly on the Supabase Platform. For this go to database health in the reports section or [click here](/dashboard/project/_/observability/database) and select your project.
