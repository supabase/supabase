...
summary = "Power BI scheduled refresh rejects a direct database connection when its hosted service does not trust the certificate authority presented by the connection."
diagnostic_sources = [ "client-tracing", "postgres-logs" ]
