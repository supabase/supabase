...
summary = "An inactive replication slot can retain old transaction state and prevent autovacuum from reclaiming dead rows."
diagnostic_sources = [ "database-inspection", "metrics" ]
topics = [ "database" ]
keywords = []
