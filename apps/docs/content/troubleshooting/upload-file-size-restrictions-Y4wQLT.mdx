...
You can view the maximum file upload size the [docs](https://supabase.com/docs/guides/storage/uploads/file-limits). It differs based on your plan and on any bucket or global limits you might have already set.
...
2. Tap the overflow (three vertical dots) button, and then tap _Edit bucket_.
