...
summary = "Server-side OAuth sign-in does not navigate automatically because the framework must redirect to the authorization URL returned by signInWithOAuth."
