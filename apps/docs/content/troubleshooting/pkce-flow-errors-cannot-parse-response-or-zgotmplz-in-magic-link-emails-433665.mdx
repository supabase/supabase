...
summary = "PKCE magic links fail when Go template URL values are embedded unsafely or the email-to-app redirect skips the browser that holds the code verifier."
