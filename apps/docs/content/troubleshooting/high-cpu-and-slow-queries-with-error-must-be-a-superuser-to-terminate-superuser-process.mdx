...
summary = "High CPU with a superuser termination error can indicate a wraparound-prevention autovacuum that must finish and cannot be canceled by project roles."
diagnostic_sources = [ "metrics", "postgres-logs", "performance-advisor", "database-inspection" ]
