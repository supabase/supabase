...
Back up your PG database by restarting in the [General Settings](/dashboard/project/_/settings/general) (in case). When you restore your database, you will have a backup saved. Alternatively, you can also download your properties table instead as a backup.
