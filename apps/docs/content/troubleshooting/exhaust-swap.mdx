...
Swap is a portion of your instance's disk that is reserved for the operating system to use when the available RAM has been used. As it uses the disk, Swap is slower to access and is generally used as a last resort.
