...
summary = "The operating system moves less-active memory pages to swap; this becomes a problem when memory pressure and disk activity affect database performance."
diagnostic_sources = [ "metrics", "reports", "database-inspection" ]
...
High Swap is concerning if your instance is consistently using more than 75% of the available RAM.
