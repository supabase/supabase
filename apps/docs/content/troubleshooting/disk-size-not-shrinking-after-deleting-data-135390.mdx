...
summary = "Deleting rows frees space for Postgres to reuse but does not shrink the project's underlying storage volume."
diagnostic_sources = [ "reports", "database-inspection", "metrics" ]
