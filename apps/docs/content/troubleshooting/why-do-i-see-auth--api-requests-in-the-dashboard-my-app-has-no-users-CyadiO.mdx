...
summary = "Projects with no end users still show Auth and API traffic because the Dashboard periodically calls service health endpoints."
diagnostic_sources = [ "auth-logs", "api-logs", "reports" ]
