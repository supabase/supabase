...
summary = "A frozen serverless runtime can resume with a stale pooled TCP socket, causing connection attempts or queries to hang."
diagnostic_sources = [ "client-tracing", "supavisor-logs", "postgres-logs", "metrics" ]
