...
summary = "A self-hosted Grafana dashboard shows no metrics when its endpoint, container configuration, environment variables, or startup script is incorrect."
diagnostic_sources = [ "metrics", "client-tracing" ]
