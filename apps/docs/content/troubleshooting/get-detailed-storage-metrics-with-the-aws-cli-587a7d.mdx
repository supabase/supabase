...
summary = "Studio shows current Storage objects, while detailed bucket-size analysis requires listing and aggregating objects through the S3-compatible API."
diagnostic_sources = [ "reports", "storage-logs" ]
