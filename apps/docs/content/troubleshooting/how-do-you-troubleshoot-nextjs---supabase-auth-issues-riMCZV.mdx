...
summary = "Next.js Auth failures commonly come from incorrect cookie exchange, client construction, redirect handling, or cached server-rendered responses."
diagnostic_sources = [ "auth-logs", "client-tracing", "api-logs" ]
