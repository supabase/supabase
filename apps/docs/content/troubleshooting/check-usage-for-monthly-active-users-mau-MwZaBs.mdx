...
summary = "Monthly active user counts reflect distinct Auth users active during the organization's current billing cycle, not the number of requests."
diagnostic_sources = [ "reports", "auth-logs" ]
