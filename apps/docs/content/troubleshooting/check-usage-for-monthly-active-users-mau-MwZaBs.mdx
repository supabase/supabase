...
You can view Monthly Active Users usage on the [organization's usage page](/dashboard/org/_/usage). To view usage for a specific project, select it from the project dropdown.
