...
summary = "Direct database connections fail when the client network cannot route IPv6 and no IPv4-compatible pooler or add-on is used."
diagnostic_sources = [ "client-tracing", "postgres-logs", "database-inspection" ]
