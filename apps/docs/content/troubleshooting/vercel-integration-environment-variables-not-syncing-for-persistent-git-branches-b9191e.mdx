...
summary = "Vercel variables appear missing when branch and environment scoping does not match the Preview, Production, or custom environment used by the deployment."
