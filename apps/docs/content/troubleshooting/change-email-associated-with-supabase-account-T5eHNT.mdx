...
- Go to [*Account Settings > Preferences*](https://supabase.com/dashboard/account/me)
- Find your email under "*Account Identities*" and click the edit icon
- After saving the new address, an email will be sent to **both the old and new email addresses**
- Your account email be updated after clicking the link **in both emails** 
