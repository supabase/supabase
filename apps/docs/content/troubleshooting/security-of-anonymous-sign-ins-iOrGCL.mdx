...
summary = "Anonymous sign-ins remain isolated by unique user identities, but safe use still depends on RLS policies, abuse controls, and an intentional upgrade path to permanent accounts."
diagnostic_sources = [ "auth-logs", "security-advisor" ]
