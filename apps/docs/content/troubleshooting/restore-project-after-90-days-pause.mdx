...
summary = "A project paused beyond the Dashboard restoration window must be recovered from its downloadable database and Storage backups into a new project."
diagnostic_sources = [ "reports", "database-inspection", "storage-logs" ]
topics = [ "platform" ]
