...
For step-by-step instructions using the Supabase CLI, check out this [Backup database using the CLI](/docs/guides/platform/migrating-within-supabase/backup-restore#backup-database-using-the-cli) guide.
