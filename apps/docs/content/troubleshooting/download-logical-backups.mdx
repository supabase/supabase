...
If you're unable to download backups due to physical backups being enabled, you can use the Postgres utility `pg_dumpall` as an alternative. This tool offers more flexibility and control for creating backups.
...
Additionally, refer to our documentation on [Database Backups](https://supabase.com/docs/guides/platform/backups).
