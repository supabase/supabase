...
summary = "User-management operations return unexpected_failure when custom constraints, triggers, or functions make the underlying Auth database transaction fail."
