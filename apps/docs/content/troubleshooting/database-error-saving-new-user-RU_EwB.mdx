...
Start in the [Auth logs explorer](/dashboard/project/_/logs/auth-logs) in your project dashboard. The logs will surface the specific error message and give you the most direct signal about what went wrong.
