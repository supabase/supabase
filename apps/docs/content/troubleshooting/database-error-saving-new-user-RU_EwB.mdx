...
- You can use the [Auth logs explorer](https://supabase.com/dashboard/project/_/logs/auth-logs) to find the issue with more information
- You can use the [Postgres logs explorer](https://supabase.com/dashboard/project/_/logs/postgres-logs)
