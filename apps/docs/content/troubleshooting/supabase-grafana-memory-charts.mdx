...
5. [Remove bloat](Choose /docs/reference/cli/supabase-inspect-db OR https://supabase.com/blog/postgres-bloat): Bloat can fragment data across pages, causing redundant data to be pulled from disk.
