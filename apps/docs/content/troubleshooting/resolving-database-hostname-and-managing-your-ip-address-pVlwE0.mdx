...
summary = "Direct database connectivity depends on resolving the project hostname to an IP version that the client network supports."
diagnostic_sources = [ "client-tracing", "database-inspection", "postgres-logs" ]
