...
keys, refer to our [documentation here](/docs/guides/api/api-keys).
...
1. Go to Project [Project Settings → JWT Keys](/dashboard/project/_/settings/jwt)s in the Supabase Dashboard
