...
<Admonition type="info">
  This troubleshooting guide is about rotating **Legacy anon, service_role API keys**. The Legacy
  API keys are being deprecated, and we recommend migrating to New API keys. To learn more about API
  keys, please refer to our [documentation here](https://supabase.com/docs/guides/api/api-keys).
</Admonition>
...
1. Go to [Project Settings → JWT Keys](https://supabase.com/dashboard/project/_/settings/jwt) in the Supabase Dashboard
...
1. Go to Project [Project Settings → JWT Keys](https://supabase.com/dashboard/project/_/settings/jwt)s in the Supabase Dashboard
...
- [I am using JWT-based anon key in a mobile, desktop, or CLI application and need to rotate my service_role JWT secret?](/docs/guides/api/api-keys#i-am-using-jwt-based-anon-key-in-a-mobile-desktop-or-cli-application-and-need-to-rotate-my-servicerole-jwt-secret)
