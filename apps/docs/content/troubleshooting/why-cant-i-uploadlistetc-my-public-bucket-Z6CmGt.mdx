...
summary = "A public bucket makes downloads public, but uploads, listing, updates, and deletes still require RLS policies."
diagnostic_sources = [ "storage-logs", "database-inspection", "client-tracing" ]
---
