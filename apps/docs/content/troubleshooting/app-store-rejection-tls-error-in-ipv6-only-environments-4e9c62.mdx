...
summary = "An IPv6-only App Store TLS rejection usually comes from application URL handling, certificate validation, or network code rather than a missing AAAA record on the Supabase domain."
