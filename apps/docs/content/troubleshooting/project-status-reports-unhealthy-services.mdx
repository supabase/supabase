...
summary = "Dependent services report unhealthy when the database is still recovering or cannot respond because of sustained resource pressure."
diagnostic_sources = [ "reports", "metrics", "postgres-logs", "database-inspection" ]
