...
summary = "Supabase accounts provisioned through Vercel Marketplace use Vercel-managed sign-in, so direct email/password login and password reset are unavailable."
