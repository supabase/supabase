...
summary = "A 404 occurs when the requested function name is unknown, its deployment bundle is unavailable, or the function code returns 404."
...
The function dashboard does not show platform 404 errors. Run this query in [Logs Explorer](/dashboard/project/_/logs/explorer) to distinguish requests rejected before execution from 404 responses returned by your code:
