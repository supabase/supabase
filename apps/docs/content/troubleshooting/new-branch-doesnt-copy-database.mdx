...
summary = "A preview branch is empty when the main branch lacks a complete migration history, because branching replays migration files instead of cloning the current schema."
