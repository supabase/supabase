---
title = "Supavisor FAQ"
summary = "Supavisor queues client connections and reuses a bounded pool of database connections, with different state guarantees in transaction and session mode."
diagnostic_sources = [ "metrics", "supavisor-logs", "database-inspection", "postgres-logs" ]
