...
summary = "GitHub connection controls differ across account, organization, and project scopes, while the underlying OAuth grant is owned at the account level."
diagnostic_sources = [ "reports" ]
