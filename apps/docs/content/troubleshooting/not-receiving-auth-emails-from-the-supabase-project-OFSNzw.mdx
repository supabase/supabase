...
summary = "Auth email delivery fails either before provider handoff because of SMTP configuration or rate limits, or afterward because of provider suppression, filtering, or recipient-server policy."
