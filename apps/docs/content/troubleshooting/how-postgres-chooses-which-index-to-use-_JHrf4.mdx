...
summary = "The Postgres planner chooses an index only when its estimated plan cost is lower than alternatives for the query and current statistics."
diagnostic_sources = [ "database-inspection", "performance-advisor" ]
