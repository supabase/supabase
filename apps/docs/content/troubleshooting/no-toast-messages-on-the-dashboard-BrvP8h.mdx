...
topics = ["platform", "studio"]
keywords = ["notifications", "dashboard", "browser", "ad-blocking"]
---
...
![Screenshot 2024-07-01 at 2 05 36 PM](/img/troubleshooting/8ba54441-2057-4dc0-8add-a8eaab9f2d93.png)

Here is an example of a toast success message:

![Screenshot 2024-07-01 at 2 06 35 PM](/img/troubleshooting/c6e228b8-fa64-47a9-bdf6-f1f6405b9cf9.png)
