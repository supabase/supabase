...
summary = "Realtime access is suspended when connections, channels, or messages substantially exceed project quotas or indicate abusive traffic."
diagnostic_sources = [ "reports", "realtime-logs" ]
---
...
When Realtime is disabled for your project, you will see the error code `RealtimeDisabledForTenant` in your [Realtime logs](/dashboard/project/_/logs/realtime-logs). On the client side, connections will fail to establish and existing subscriptions will stop receiving events.
...
2. **Review your usage**: While waiting for a response, check the [Realtime observability report](/dashboard/project/_/observability/realtime) to understand what drove the elevated usage.
...
- Monitor your usage regularly through the [Realtime observability report](/dashboard/project/_/observability/realtime)
