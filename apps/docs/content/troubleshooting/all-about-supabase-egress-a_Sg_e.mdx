...
- Picking the "Top Paths" from the [log explorer](https://supabase.com/dashboard/project/_/logs/explorer/templates) will help you identify heavily queried paths
- By finding the most requested queries from Query performance report: https://supabase.com/dashboard/project/_/advisors/query-performance
