...
You can read about Unified egress, included quota, and how to understand usage in the [egress](https://supabase.com/docs/guides/platform/manage-your-usage/egress). 

You can review the [Billing Dashboard](https://supabase.com/dashboard/org/_/usage#egress) for egress usage. Alternatively, the [project reports](/dashboard/project/_/observability) have a few egress related stats. You can create a custom report to look into daily egress. 

- Example: [Custom Reports](https://supabase.com/dashboard/project/_/observability/api-overview?newReport=true) -> Add/Remove charts -> Database API -> API Egress.
...
- Review your egress usage at the project and org level in the [Billing Dashboard](https://supabase.com/dashboard/org/_/usage#egress)
