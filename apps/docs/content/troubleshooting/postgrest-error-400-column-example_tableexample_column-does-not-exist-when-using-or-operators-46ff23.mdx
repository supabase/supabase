...
summary = "Mutation requests with or filters can report existing columns as missing because PostgREST versions before the fixed release resolved those columns incorrectly."
diagnostic_sources = [ "api-logs", "database-inspection" ]
