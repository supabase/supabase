...
summary = "Grafana CPU series separate query work, kernel work, I/O wait, and idle time so sustained saturation can be traced to compute, connection, disk, or memory pressure."
diagnostic_sources = [ "metrics", "reports", "performance-advisor" ]
