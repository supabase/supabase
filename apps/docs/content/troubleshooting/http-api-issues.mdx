...
summary = "HTTP timeouts, 5xx responses, and slow APIs commonly result from exhausted compute, disk, memory, or connection capacity, though network and service incidents can produce similar symptoms."
diagnostic_sources = [ "api-logs", "reports", "metrics", "performance-advisor", "database-inspection" ]
topics = [ "platform" ]
