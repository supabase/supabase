...
If you are observing the error `relation "supabase_migrations.schema_migrations" does not exist` in your PostgreSQL logs, it is typically caused by the Supabase dashboard polling for migration history.
