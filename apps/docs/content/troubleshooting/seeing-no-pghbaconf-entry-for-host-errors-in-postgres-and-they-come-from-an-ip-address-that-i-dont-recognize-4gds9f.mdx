...
summary = "Unknown internet hosts can generate rejected database-login attempts that appear as `pg_hba.conf` errors without establishing a connection."
diagnostic_sources = [ "postgres-logs", "client-tracing" ]
