...
summary = "A Vercel Marketplace project can remain linked when deletion is completed on only one platform instead of cleaning up both Supabase and Vercel ownership records."
