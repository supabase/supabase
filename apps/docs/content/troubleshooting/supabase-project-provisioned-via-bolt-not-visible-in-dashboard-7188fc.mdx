...
summary = "A project created through Bolt can belong to Bolt's organization instead of the person's Supabase organization, so it is absent from their Dashboard."
