...
The [Partner Catalog](/partners/catalog) is Supabase's public directory of third-party integrations and partners, listing tools that extend your Supabase project with external Auth, Caching, Hosting, and Low-code tools. It's distinct from [Dashboard Integrations](/guides/integrations#supabase-dashboard-integrations), which are installed directly from within a project in the Supabase Dashboard.
