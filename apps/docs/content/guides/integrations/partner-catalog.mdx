...
The Partner Catalog is different from [Dashboard Integrations](/guides/integrations#supabase-dashboard-integrations). You install Dashboard Integrations directly from a project in the Supabase Dashboard.
