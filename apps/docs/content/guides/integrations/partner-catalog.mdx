...
- **Business viability**
  While we welcome everyone to build an integration, we only list companies that are deemed to be long-term viable. This includes an official business registration and bank account, meaningful revenue, or Venture Capital backing. We require these criteria to ensure the health of the catalog.
- **Compliance**
...
- **Maintainability**
  All integrations are required to be maintained and functional with Supabase, and the company may be assessed on its ability to remain functional over a long time horizon.
