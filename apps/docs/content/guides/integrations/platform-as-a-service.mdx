...
This document will guide you on best practices when using Supabase as a PaaS and assumes that Supabase projects are in a Supabase organization that you own. If you are interacting with projects through OAuth integration, navigate to [Supabase OAuth Integration](/docs/guides/integrations/build-a-supabase-oauth-integration) for more details.
...
If you want access to Pico instances please contact us.
...
- Realtime: [`PATCH /v0/projects/{ref}/config/realtime`](https://api.supabase.com/api/v0#tag/projects-config/patch/v0projectsrefconfigrealtime) (moving to v1 soon)
...
We've enabled transferring the project from your org to your user's org while you continue to retain access to interact with the project.
...
<Admonition type="warning" title="Remove custom configuration before transferring project">
