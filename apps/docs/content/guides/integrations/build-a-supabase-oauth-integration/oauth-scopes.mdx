...
| `Edge Functions` | `Write`  | Retrieve information about a project's edge functions                                                                                                                                                                                                                                  |
...
| `Projects`       | `Write`  | Retrieve a project's metadata<br/>Check if a project's database is eligible for upgrade<br/>Retrieve a project's network restrictions<br/>Retrieve a project's network bans                                                                                                            |
...
| `Storage`        | `Write`  | Retrieve a project's storage buckets.                                                                                                                                                                                                                                                  |
|                  |
