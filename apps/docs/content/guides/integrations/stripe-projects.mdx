...
- If the Stripe account is already linked to a Supabase organization, you just confirm the request.
...
{/* Inferred from the Supabase-side authorization screen's confirmation states, not confirmed against the account-request API schema; worth double-checking with the Stripe Projects team before publishing. */}
