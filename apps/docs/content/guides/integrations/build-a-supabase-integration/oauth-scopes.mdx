...
| `Storage`        | `Read`  | Retrieve a project's storage buckets<br>Retrieve storage bucket configuration and settings<br>Retrieve files and objects metadata within storage buckets                                                                                                                               |
| `Storage`        | `Write` | Create, update, or delete storage buckets<br>Manage files and objects in storage buckets<br>Update storage bucket configuration and settings<br>Manage storage bucket permissions and policies                                                                                         |