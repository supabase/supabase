...
Private Connectivity provides enterprise-grade private network connectivity between your cloud VPC and your Supabase database. For AWS, this uses AWS PrivateLink via AWS VPC Lattice. This eliminates exposure to the public internet by creating a secure, private connection that keeps your database traffic within the cloud provider's network backbone.

For configuration information, see [Private Connectivity](/docs/guides/platform/private-connectivity)
