...
- [Superuser accesss and unsupported operations](docs/guides/database/postgres/roles-superuser)

## Storage

- [Object ownership](/docs/guides/storage/security/ownership)
- [Access control](/docs/guides/storage/security/access-control)
  - The Storage API docs contain hints about require [RLS policy permissions](/docs/reference/javascript/storage-createbucket)
