...
description: 'Consumer-side guide to defending your install of @supabase/* npm packages against supply-chain attacks.'
---
...
A proxy in front of `registry.npmjs.org` is the strongest layer of defence your org can add. It lets you enforce quarantine, audit, block, and roll back independently of what npmjs.org does.
