...
<div className="grid lg:grid-cols-12 gap-6 not-prose">
  {[
    ...
    {
      title: 'Rust',
      href: '/guides/getting-started/quickstarts/rust',
      description: 'Learn how to create a Supabase project, register users, and store files.',
      icon: '/docs/img/icons/rust-icon-white',
    },
    {
      title: 'Flutter',
