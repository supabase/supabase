...
<div className="grid lg:grid-cols-12 gap-6 not-prose">
  {[
    ...
    {
      title: 'XMLUI',
      href: '/guides/getting-started/quickstarts/xmlui',
      description:
        'Learn how to create a Supabase project, add some sample data to your database, and query the data from an XMLUI app.',
      icon: '/docs/img/icons/xmlui-icon',
      enabled: isFeatureEnabled('docs:framework_quickstarts'),
    },
  ]
