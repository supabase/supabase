...
The publishable keys work the same way through `SUPABASE_PUBLISHABLE_KEYS`. Read [Environment variables](/docs/guides/functions/secrets) for more on environment variables in Edge Functions.
