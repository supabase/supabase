...
MCP compatible tools can connect to Supabase using the [Supabase MCP server](https://github.com/supabase-community/supabase-mcp). Below are instructions on to connect to this server using popular AI tools:
...
For a full list of tools available, see the [GitHub readme](https://github.com/supabase-community/supabase-mcp#tools). If you experience any issues, please [submit an bug report](https://github.com/supabase-community/supabase-mcp/issues/new?template=1.Bug_report.md).
