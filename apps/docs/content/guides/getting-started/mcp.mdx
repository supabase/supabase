...
<Admonition type="note" title="Authenticating the server" className="mt-3">

You'll need to login with Supabase and grant certain permissions the first time you connect.

In the future, we'll offer more control over these permissions.
