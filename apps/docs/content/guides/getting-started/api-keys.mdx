...
<Admonition type="warning" title="Changes to API keys">
...
## What publishable keys secure

Publishable keys secure the public components of your application. Public components run in environments where it is impossible to secure any secrets. These include:
