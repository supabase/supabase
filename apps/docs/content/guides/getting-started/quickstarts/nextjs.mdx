...
### Explore pre-built components and helpers

- [Pre-built Auth UI for React](/docs/guides/auth/auth-helpers/auth-ui)
- [Auth Helpers for Next.js](/docs/guides/auth/auth-helpers/nextjs)

### Additional next steps

- [Setup auth using `@supabase/ssr`](/docs/guides/auth/server-side/creating-a-client)
- [Set up Server-Side Auth for Next.js](/docs/guides/auth/server-side/nextjs)
