...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Create a `/src/lib` directory in your SvelteKit app, create a file called `supabaseClient.ts` and add the following code to initialize the Supabase client with your project URL and public API (anon) key:
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Create `+page.server.ts` file in the `routes` directory with the following code.

    </StepHikeCompact.Details>
    <StepHikeCompact.Code>


      ```js src/routes/+page.server.ts
