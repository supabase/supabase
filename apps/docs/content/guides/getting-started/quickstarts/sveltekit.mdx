...
- [Supabase Auth with SvelteKit](/docs/guides/auth/auth-helpers/sveltekit#sign-in--sign-up--sign-out)

### Additional next steps

- [Setup auth using `@supabase/ssr`](/docs/guides/auth/server-side/creating-a-client?framework=sveltekit)
- [Build a User Management App with Svelte](/docs/guides/getting-started/tutorials/with-svelte)