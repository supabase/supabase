...
- #### Implement Authentication:
  - [Email and Password](/docs/guides/auth/server-side/email-based-auth-with-pkce-flow-for-ssr)
  - [OAuth](/docs/guides/auth/server-side/oauth-with-pkce-flow-for-ssr)
- [Learn more about SSR](/docs/guides/auth/server-side-rendering)

### Explore pre-built components

- [Pre-built Auth UI for React](/docs/guides/auth/auth-helpers/auth-ui)

### Additional next steps

- [Build a User Management App with React](docs/guides/getting-started/tutorials/with-react)