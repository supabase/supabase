...
Create a new directory for your Reflex app, initialize a project with `uv`, add Reflex as a dependency, and scaffold the app. When prompted for a template, press Enter to accept the default blank app.
