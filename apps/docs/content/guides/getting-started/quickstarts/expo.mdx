...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Create a helper file to initialize the Supabase client using the environment variables.

    The code below uses AsyncStorage to persist the user session in your app.
