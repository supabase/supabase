...
{/* TODO: Need more here */}
    Open the project [**Connect** panel](https://supabase.com/dashboard/project/_?showConnect=true). In this quickstart, connect via the `Shared Pooler` value. If your network supports IPv6, you can connect to the database directly without using the connection pooler.
