...
subtitle: 'Learn how to query the Supabase data from a Vue app'
...
Explore drop-in [Supabase UI components](https://supabase.com/ui/docs/vue/client) built on shadcn/ui that connect to Supabase via a single command.
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    Create a file `/src/lib/supabaseClient.js` in your project and add the following code to initialize the Supabase client:
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Start the app and go to http://localhost:5173 and you should see the list of instruments.
