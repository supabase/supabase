...
During this guide we'll walkthrough manual Next.js setup, but is recommended to use the [NextJs quickstart template](/docs/guides/getting-started/quickstarts/nextjs).
