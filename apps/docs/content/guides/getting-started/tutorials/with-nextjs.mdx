...
During this guide we'll walktrough manual nextjs setup, but is recommended to use the [NextJs quickstart template](/docs/guides/getting-started/quickstarts/nextjs).
