...
Create an `AuthForm` client side component with the `Auth` component rendered within it. This component will allow your apaplication to authenticate the user via magic link.
