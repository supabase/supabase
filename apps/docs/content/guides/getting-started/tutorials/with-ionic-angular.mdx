...
Create a `LoginPage` with the `ionic g page sign-in` Ionic CLI command.

<$CodeSample
path="/user-management/ionic-angular-user-management/src/app/sign-in/sign-in.page.ts"
lines={[[1, -1]]}
meta="name=src/app/sign-in/sign-in.page.ts"
/>

<$CodeSample
path="/user-management/ionic-angular-user-management/src/app/sign-in/sign-in.page.html"
lines={[[1, -1]]}
meta="name=src/app/sign-in/sign-in.page.html"
/>
