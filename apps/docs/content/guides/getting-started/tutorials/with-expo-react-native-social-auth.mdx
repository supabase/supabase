...
To enable Apple sign-up on Android and Web, you'll also need to register the tunnelled URL (e.g., `https://arnrer1-anonymous-8081.exp.direct`) obtained by running:
...
>
  <TabPanel id="invertase-react-native-apple-authentication" label="Invertase">
    ...
    We should now be able to test the authentication by running it on a physical device or simulator:
...
>
  <TabPanel id="web" label="Web">
    ...
    To allow the Google Sign In to work, as we did before for Apple, you'll need to register the tunnelled URL (e.g., `https://arnrer1-anonymous-8081.exp.direct`) obtained to the Authorized JavaScript origins list of your [Google Cloud Console's OAuth 2.0 Client IDs](https://console.cloud.google.com/auth/clients/) configuration.
