...
This tutorial demonstrates how to build a product management app with social authentication. The app showcases user authentication, data management, and photo uploads using:
...
![Supabase Social Auth example](/docs/img/supabase-expo-social-auth.png)
...
Now integrate social authentication with Supabase Auth.

### Apple authentication

First, add the button that you'll create inside the login screen you created previously:
...
For Apple authentication, you can choose between two options:

- [Expo's AppleAuthentication library](https://docs.expo.dev/versions/latest/sdk/apple-authentication/) - iOS only
- [Invertase's React Native Apple Authentication library](https://github.com/invertase/react-native-apple-authentication) - supports iOS, Android, and Web (using the [react-apple-signin-auth](https://react-apple-signin-auth.ahmedtokyo.com/) web library)
...
>
  <TabPanel id="invertase-react-native-apple-authentication" label="Invertase">
    ...
    ```tsx name=components/social-auth-buttons/AppleSignInButton.ios.tsx
    import { supabase } from '@/lib/supabase';
    ...
    ```tsx name=components/social-auth-buttons/AppleSignInButton.android.tsx
    import { supabase } from '@/lib/supabase';
    ...
    ```tsx name=components/social-auth-buttons/AppleSignInButton.web.tsx
    import { supabase } from '@/lib/supabase';
    import type { SignInWithIdTokenCredentials } from '@supabase/supabase-js';
  ...
  <TabPanel id="expo-apple-authentication" label="Expo">
    ...
    ```tsx name=components/social-auth-buttons/AppleSignInButton.tsx
    import { supabase } from '@/lib/supabase';
    import { AppleButton, appleAuth } from '@invertase/react-native-apple-authentication';
    import type { SignInWithIdTokenCredentials } from '@supabase/supabase-js';
    import { router } from 'expo-router';
