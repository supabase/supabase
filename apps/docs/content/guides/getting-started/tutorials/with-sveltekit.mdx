...
If there is an error with confirming the token, redirect the user to ana error page.
...
Now that you have all the pages in place, run this command in a terminal:
