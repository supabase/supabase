---
title: 'Build a User Management App with Expo React Native and Expo Router'
description: 'Learn how to use Supabase in your Expo Router-based React Native App.'
...
## Building the app with Expo Router

Letwith-expo-react-native( Expo Router ).mdx's start building the Expo Router-based React Native app from scratch.

### Initialize a React Native app with Expo Router

We will initialize an app called `expo-user-management` using Expo's template and Expo Router:

```bash
npx create-expo-app -t expo-template-blank-typescript expo-user-management
cd expo-user-management
npx expo install @supabase/supabase-js @react-native-async-storage/async-storage @rneui/themed expo-router
```
