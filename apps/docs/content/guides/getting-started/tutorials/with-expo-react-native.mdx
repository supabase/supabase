...
Now follow the [docs](https://supabase.com/docs/guides/storage/quickstart#add-security-rules) to create a new bucket called `avatars` and add policies to allow authenticated users to write and read to the bucket. With that, you should have a fully functional application!
