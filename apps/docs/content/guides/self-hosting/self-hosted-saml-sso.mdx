...
- `API_EXTERNAL_URL` set to the publicly-accessible URL of your Supabase Auth service (e.g., `https://<your-domain>/auth/v1`). This URL is used as the SAML Service Provider entity ID and for constructing the ACS endpoint URL
