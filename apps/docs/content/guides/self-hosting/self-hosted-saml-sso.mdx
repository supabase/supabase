...
| Method       | Use case                                                                                                                                  |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `domain`     | Extract the domain from the user's email and let Auth find the right IdP. Best for sign-in forms where the user enters their email first. |
| `providerId` | Use when you know the exact provider - for example, a dedicated "Sign in with Okta" button.                                               |

## Test the sign-in flow

1. Open your application and trigger SSO sign-in (or use the curl command above)
2. You should be redirected to your IdP's sign-in page
