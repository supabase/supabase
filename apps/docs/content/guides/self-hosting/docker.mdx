...
### Configuring social sign-in (OAuth) providers

See the [Configure social sign-in (OAuth) Providers](/docs/guides/self-hosting/self-hosted-oauth) guide for setup instructions.
