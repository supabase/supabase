...
You will also likely want to connect to your postgres database via an ORM or another direct method other than `psql`

For this you will use the following URL which uses connection pooling by default.
