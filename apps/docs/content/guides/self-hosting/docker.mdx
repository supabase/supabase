...
See the [Configure Phone Login & MFA](/docs/guides/self-hosting/docker-phone-mfa) guide for SMS provider setup, OTP settings, and multi-factor authentication configuration.
