...
description: 'Learn how to migrate database objects created in Supabase Studio from the supabase_admin role to the postgres role in self-hosted Supabase.'
