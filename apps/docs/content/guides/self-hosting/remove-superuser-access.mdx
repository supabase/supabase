...
description: 'Learn how to remove superuser access from studio and shift database objects ownership from supabase_admin role to postgres role in self-hosted Supabase.'
subtitle: 'Learn how to remove superuser access from studio and shift database objects ownership from supabase_admin role to postgres role in self-hosted Supabase.'
---
