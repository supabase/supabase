...
2. Remove #'s from the entire section starting with `- name: cors`, including `deny: []`
...
3. Confirm the Docker bridge gateway IP is correctly added in `./volumes/api/kong.yml`
