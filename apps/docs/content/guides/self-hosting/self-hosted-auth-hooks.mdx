...
The Auth service (GoTrue) can call a **hook** at specific lifecycle events during auth flow. Each hook can be configured with the following environment variables:
