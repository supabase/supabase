...
First we'll create a `documents` table to store the documents that we will search over. This is an example - adjust this to match the structure of your application.
