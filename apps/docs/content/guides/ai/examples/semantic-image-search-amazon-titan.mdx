...
You can find your database connection string on your project dashboard, click on [Connect](https://supabase.com/dashboard/project/_?showConnect=true). Use the Session pooler connection string which looks like this:
