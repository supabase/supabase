...
Replace the `DB_CONNECTION` with your own connection string. You can find the connection string on your project dashboard, click on [Connect](https://supabase.com/dashboard/project/_?showConnect=true).
