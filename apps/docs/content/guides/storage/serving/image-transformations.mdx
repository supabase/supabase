...
You can enable or disable Image Transformations for your project from [Storage Settings](/dashboard/project/_/storage/files/settings) dashboard. Navigate to **Storage** > **Settings** in your project dashboard and toggle the **Enable Image Transformations** option.

<Admonition type="note">

Disabling Image Transformations will prevent any image transformation requests from being processed. This can be useful to prevent unexpected usage or cost if you do not use this feature.
