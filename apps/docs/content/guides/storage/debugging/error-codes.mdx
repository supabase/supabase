...
| `FST_ERR_VALIDATION`                 | The request body contains invalid content.                      | 400          | Verify the request payload is valid.                                                                                                                                                        |
| `FST_ERR_CTP_EMPTY_JSON_BODY`        | The request body is empty.                                      | 400          | Ensure you are sending a request body.                                                                                                                                                      |
| `FST_ERR_CTP_INVALID_JSON_BODY`      | The request body is not valid json.                             | 400          | Ensure the request body is valid json.                                                                                                                                                      |
| `FST_ERR_CTP_INVALID_CONTENT_LENGTH` | The request body does not match the content-length headers.     | 415          | Ensure the content-length header matches the json payload.                                                                                                                                  |
| `FST_ERR_CTP_INVALID_MEDIA_TYPE`     | Incorrect or missing content-type header.                       | 400          | Ensure the content-type header is set to application/json                                                                                                                                   |
| `DatabaseConnectionLimit`            | There are no available database connections.                    | 503          | Ensure your project has enough capacity for the current traffic.                                                                                                                            |
| `DatabaseReadOnly`                   | The database is in readonly mode.                               | 503          | Verify the request payload is valid.                                                                                                                                                        |
| `DatabaseInvalidObjectDefinition`    | The storage schema has drifted from the expected state.         | 503          | The storage database schema is incorrect, [Contact Support](/dashboard/support/new)                                                                                                         |
| `DatabaseSchemaMismatch`             | The storage schema has drifted from the expected state.         | 503          | The storage database schema is incorrect, [Contact Support](/dashboard/support/new)                                                                                                         |
