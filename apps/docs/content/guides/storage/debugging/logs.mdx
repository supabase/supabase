...
The [Storage Logs](/dashboard/project/_/logs/storage-logs) provide a convenient and simple way to examine all incoming request logs to your Storage service. You can do basic filtering by time and keyword searches.
