...
Please refer to the followings guides for more information on how to upload objects with metadata.:
...
To retrieve the metadata of an object, using the `info()` method.
