...
When using the `service_key` to create a bucket or object, the owner will not be set and the bucket or object will be owned by anyone. This is also the case when you are creating Storage resources via the Dashboard.
