...
It uses the traditional `multipart/form-data` format and is to implement using the supabase-js SDK. Here's an example of how to upload a file using the standard upload method:
