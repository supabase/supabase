...
- [Set up real-time replication](/docs/guides/storage/analytics/etl) from your PostgreSQL database
- [Query data with PostgreSQL](/docs/guides/storage/analytics/query-with-postgres) using the Iceberg Foreign Data Wrapper
