...
Managed replication into Analytics Buckets through Supabase Pipelines is no longer supported. This guide assumes your Analytics Bucket is being populated by your own ingestion pipeline. If you need managed replication today, use [Supabase Pipelines](/docs/guides/database/replication/supabase-pipelines) with **BigQuery**.
