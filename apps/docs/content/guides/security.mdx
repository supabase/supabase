...
Additional [security and compliance controls](/docs/guides/deployment/shared-responsibility-model#managing-healthcare-data) for projects that deal with Personal Health Information (ePHI) and require HIPAA compliance are available through the HIPAA add-on.
