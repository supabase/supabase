...
or in case of a self-hosted instance (see [Accessing Postgres](/docs/guides/self-hosting/connection-pooling#connect-through-supavisor) for more information):
