...
Use both together: grants control _whether_ a role can touch an object; RLS controls _what_ rows they see.

## Grant access explicitly

A table isn't reachable through the Data API unless a role has been granted privileges on it. Grant the minimum privileges each role needs. For example:
