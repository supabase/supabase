...
```sh
npx shadcn@latest add https://supabase.com/ui/r/platform-kit-nextjs.json
```
...
```sh
pnpm dlx shadcn@latest add https://supabase.com/ui/r/platform-kit-nextjs.json
```
...
```sh
yarn dlx shadcn@latest add https://supabase.com/ui/r/platform-kit-nextjs.json
```
...
```sh
bunx --bun shadcn@latest add https://supabase.com/ui/r/platform-kit-nextjs.json
```
