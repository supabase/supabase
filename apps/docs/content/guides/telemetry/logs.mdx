...
If you are debugging a specific error or unexpected behavior, start with the [Debugging guide](/docs/guides/telemetry/debugging) — it routes you to the right log source based on your error code or symptom before you open the Logs Explorer.
...
For regular expression filtering, structured-field queries, and field discovery techniques, see [Advanced log filtering](/docs/guides/telemetry/advanced-log-filtering).
