...
3. From the stack home, copy the Prometheus remote-write endpoint as well as the instance ID and API token.

## 2. Configure the Supabase integration

1. Navigate to **Integrations & connections → Supabase** inside Grafana Cloud.
2. Provide:
