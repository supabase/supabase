...
#### Auth API Gateway
{/* TODO: Fill in */}
The Auth API Gateway reports focus on …

| Chart                    | Description                                   | Key Insights                                    |
| ------------------------ | --------------------------------------------- | ----------------------------------------------- |
| Total Requests             | Count of unique users performing auth actions | User engagement and retention patterns          |
| Response Errors            | Breakdown of authentication methods used      | Password vs OAuth vs magic link preferences     |
| Response speed                 | Total new user registrations                  | Growth trends and onboarding funnel performance |
| Network Traffic              | Error rates grouped by status code            | Authentication friction and security issues     |
...
| Response Errors        | HTTP requests to Realtime endpoints                           | API usage alongside WebSocket activity            |
