...
Instructions are included in the [README](https://github.com/supabase/supabase-grafana?tab=readme-ov-file#supabase-grafana) for deploying the repository using docker.
