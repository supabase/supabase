...
- <a href="https://github.com/supabase/supabase-grafana" target="_blank" rel="noreferrer">Supabase Grafana repository (opens in a new tab)</a> for dashboard JSON and alert examples.
...
- <a href="https://grafana.com/docs/grafana-cloud/monitor-infrastructure/integrations/integration-reference/integration-supabase/" target="_blank" rel="noreferrer">Grafana Cloud’s Supabase integration doc</a> (community-maintained, built on this Metrics API).
- <a href="https://docs.datadoghq.com/integrations/supabase/" target="_blank" rel="noreferrer">Datadog’s Supabase integration doc</a> (community-maintained, built on this Metrics API).
