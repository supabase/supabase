...
Name the datasource "prometheus" (if you use a different name, you need to modify the `dashboard.json` file when adding the dashboard).
...
- The **Grafana Data Source settings** section contains the necessary connection details
