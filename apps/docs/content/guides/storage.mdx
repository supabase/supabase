  ...
  - id: get-started
    ...
    items:
      - title: Files buckets
        ...
        description: Store and serve images, videos, documents, and general-purpose files with global CDN delivery and image transforms. Direct URL access and row-level security for user-generated content and media libraries.
      - title: Analytics buckets
        href: /guides/storage/analytics/introduction
        description: Store analytical data in Apache Iceberg format for data lakes, logs, and ETL pipelines. Query via Postgres foreign tables with partitioned organization for large-scale workloads.
      - title: Vector buckets
        href: /guides/storage/vector/introduction
        description: Store embeddings and run similarity search for AI, RAG, and semantic matching. HNSW indexing, multiple distance metrics, and metadata filtering.
---
