  ...
  - id: examples
    ...
    items:
      - title: Storage templates and examples
        ...
        description: Browse templates and sample apps in the Supabase GitHub repository.
      - title: Resumable Uploads with Uppy
        ...
        description: Use Uppy to upload files to Supabase Storage using the TUS protocol (resumable uploads).
  - id: resources
    heading: Resources
