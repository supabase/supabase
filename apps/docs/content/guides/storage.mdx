  ...
  - id: get-started
    ...
    items:
      - title: Files buckets
        ...
        description: Store and serve images, videos, documents, and other files with CDN delivery and image transforms.
      - title: Analytics buckets
        href: /guides/storage/analytics/introduction
        description: Store data lake tables in Apache Iceberg format and query them from Postgres.
      - title: Vector buckets
        href: /guides/storage/vector/introduction
        description: Store embeddings and run similarity search for AI and semantic search apps.
---
