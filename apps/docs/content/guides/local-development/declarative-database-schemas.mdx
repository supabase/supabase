...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    <StepHikeCompact.Details title="Apply the migration locally">
      Start the local database and apply the new migration file. You can then validate your schema using the local Dashboard.
    </StepHikeCompact.Details>
