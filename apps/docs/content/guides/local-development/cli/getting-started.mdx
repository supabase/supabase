...
The Supabase CLI lets you run the entire Supabase stack locally, on your machine or in a CI environment. With two commands, you can set up and start a new local project:
