...
**Default subject**: "Confirm your new email"
...
**Default subject**: "A new MFA factor was added"
...
**Default subject**: "An MFA factor was removed"
...
**Default subject**: "A new identity was linked"
...
**Default subject**: "An identity was unlinked"
...
```html
<p>A new {{ .Provider }} identity was linked to your account.</p>
```
...
```html
<p>A new {{ .FactorType }} MFA factor was added to your account.</p>
```
