...
**Default subject**: "A new sign-in method was linked to your account"
**When sent**: When a new sign-in method is linked to the account
**Purpose**: Notify users when a new sign-in method has been linked to their account
**Content**: Confirms that a new sign-in method was linked
...
```html
<p>Your {{ .Provider }} account was linked as a new sign-in method.</p>
```
