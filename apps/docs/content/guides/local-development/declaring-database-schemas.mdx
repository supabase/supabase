...
Some entities like views and enums depend columns to be declared in a specific order. To avoid messy diffs, always add new columns by appending to the end of the table.
