...
Testing through your application code provides end-to-end verification. Here's an example using TypeScript and Vitest that mirrors our pgTAP tests above:
