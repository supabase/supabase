...
description: 'Learn how develop and test database schema, tables, functions, and Row Level Security (RLS) policies.'
---
...
#### Testing RLS policies in practice
...
Testing through application code provides end-to-end verification. Here's an example using TypeScript that mirrors the pgTAP tests above:
...
describe('Todos RLS', () => {
  ...
  // Test users from the pgTAP example
