...
Cloning your base project copies its schema and configuration, but not its data or storage objects. This is meant to protect your sensitive production data. Your branch starts with the tables of your base project and no rows in them.
