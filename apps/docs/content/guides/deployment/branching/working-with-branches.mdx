...
We recommend registering a single webhooks processor that dispatches events to downstream services based on payload type.

For example, you can deploy the following Edge Function to process run completed events by notifying a Slack channel.
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
      <StepHikeCompact.Details title="Update branch notification URL" fullWidth>
        ...
        Update the notification URL of your branch to point to your Edge Function.
