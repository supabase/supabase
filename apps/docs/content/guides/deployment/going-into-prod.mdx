...
- The table below shows the rate limit quotas on the following authentication endpoints. You can configure the auth rate limits for your project in the [**Auth > Rate Limits**](/dashboard/project/_/auth/rate-limits) section of the dashboard.
