...
For more information on the shared responsibilities and rules under HIPAA, please review the [HIPAA compliance responsibilities document](/docs/guides/security/hipaa-compliance).
