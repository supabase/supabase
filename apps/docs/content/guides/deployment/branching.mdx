...
If your organization's plan doesn't include branching, the CLI will display an error with a direct link to your organization's billing page when you run `supabase branches create` or `supabase branches update`.
</Admonition>
