...
When you merge your Git branch into the production branch, all new migrations will be applied to your Production environment. Seed files and other configurations will be ignored by default.
