...
We execute independent steps in parallel and skip children nodes when the parent fails. For e.g., if your database migrations failed at step 5, we will skip step 6 and not seed your branch.
