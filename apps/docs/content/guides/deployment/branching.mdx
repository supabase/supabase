...
- **Cloned from your base project**: Each new branch is created as a clone of your base project, the main project that your production branch runs on. A branch starts with that project's schema, migration history, and configuration rather than with an empty database.
