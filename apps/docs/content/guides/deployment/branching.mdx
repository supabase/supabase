    ...
    <StepHikeCompact.Step step={1}>
        <StepHikeCompact.Details title="Install the GitHub Integration" fullWidth>
            ...
            <figure className="max-w-[520px]">
                <Image src="/docs/img/guides/platform/branching/enable-supabase-branching-opt-in-install-github.png?v=1" />
            </figure>

            If you don't have the GitHub integration installed, click `Add new project connection`.
...
2. We clone your branch and configure the new project based on the [`config.toml`](/docs/guides/local-development/cli/config) committed into this project branch.
