...
If a parent node fails, all dependent children nodes will be skipped. For e.g., if your database migrations failed at step 5, we will not seed your branch because step 6 is skipped.
