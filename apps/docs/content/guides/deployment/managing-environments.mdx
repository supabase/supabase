...
- `SUPABASE_ACCESS_TOKEN` is your personal access token. Use a [scoped token](/docs/guides/platform/personal-access-tokens) limited to the projects this workflow deploys to.
