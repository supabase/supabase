...
To understand how database migrations work, it is useful to think of database schemas as interfaces in TypeScript. They define the structure of your tables, functions, and other database entities. When you change an interface in TypeScript, you need to update any code that accesses the changed fields. Similarly when you modify a database schema, you have to update all other entities that reference it.
