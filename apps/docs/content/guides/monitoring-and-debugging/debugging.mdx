...
<<<<<<< HEAD:apps/docs/content/guides/monitoring-and-debugging/debugging.mdx
=======
<Admonition type="tip">
...
>>>>>>> caacbeb071 (update headers and add links for agents):apps/docs/content/guides/telemetry/debugging.mdx
