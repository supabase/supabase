...
To pick up a signal from these checks, see [Detecting](/docs/guides/monitoring-and-debugging/debugging). For the other sources, see [Observe the data](/docs/guides/monitoring-and-debugging/access-data).
