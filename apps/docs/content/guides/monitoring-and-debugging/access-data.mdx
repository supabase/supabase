...
Live Postgres statistics such as bloat, cache hit rate, blocking sessions, index usage, and slow queries. See [Inspect the database](/docs/guides/database/inspect) (`supabase inspect db`) for the command and SQL catalog.
...
- [`supabase inspect db`](/docs/guides/database/inspect) for the database diagnostic catalog
