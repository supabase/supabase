...
{/* TODO(DOCS-1262): the platform gateway is Envoy, not Kong (see PLAT-1285) — confirm the current response header names with Kang Ming Tay before replacing x-kong-proxy-latency/x-kong-upstream-latency below */}
