...
- Install and configure [Docker Desktop](https://docs.docker.com/desktop)
...
![Docker Settings (macOS)](/docs/img/guides/cli/docker-mac.png)

</TabPanel>
<TabPanel id="windows" label="Windows">

![Docker Settings (Windows)](/docs/img/guides/cli/docker-win.png)
