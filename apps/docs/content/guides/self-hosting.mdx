...
Self-hosting runs Supabase on your own infrastructure instead of the managed platform. It's a good fit if you need full control over your data, have compliance requirements that prevent you from using managed services, or want to run Supabase in an isolated environment.
