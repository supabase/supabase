...
## Community supported {/* supa-mdx-lint-disable-next-line Rule004ExcludeWords */}
There are several community-driven projects to help you deploy Supabase. These projects may be outdated and are seeking active maintainers. If you're interested in maintaining one of these projects, please [reach out](/open-source/contributing/supasquad).
