...
**Health Advisor** runs on-demand checks against live service error rates — 5xx responses across Data API, Auth, Storage, and Edge Functions. See [Health Advisor](/docs/guides/observability/health-advisor) for the full list of checks and remediation steps.
