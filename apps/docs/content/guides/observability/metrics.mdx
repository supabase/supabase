...
Chart a subset of the same window in Studio [Reports](/docs/guides/observability/reports). Use this page when you want the Prometheus-compatible scrape endpoint.
...
- [Log Drains ](/docs/guides/observability/log-drains) for exporting event-based telemetry alongside metrics.
