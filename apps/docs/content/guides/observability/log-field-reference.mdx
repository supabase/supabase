                ...
                return (
                  <div key={field.path} className="px-4 py-3">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {field.containsPii && (
                        <span className="text-[10px] font-medium uppercase tracking-wide text-warning border border-warning-500 rounded px-1.5 py-0.5 shrink-0">
                          PII
                        </span>
                      )}
                    </div>
                    {field.description && (
                      <p className="mt-1 text-sm text-foreground-light">{field.description}</p>
                    )}
                    {!isTopLevel && (
