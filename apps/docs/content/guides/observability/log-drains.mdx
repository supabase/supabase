...
- Combine Supabase logs with application-level traces — see [Tracing with the JS SDK](/docs/guides/observability/client-side-tracing) to extend your traces into Supabase.
...
- [Metrics API](/docs/guides/observability/metrics) — export Postgres performance metrics alongside your logs.
- [Tracing with the JS SDK](/docs/guides/observability/client-side-tracing) — instrument your application and combine traces with Supabase logs.
