...
## Pricing
Usage beyond the free quota is charged at $0.09 per GB.

| Plan       | Unified Egress Quota | Over-Usage   |
|------------|----------------------|--------------|
| Free       | 5 GB                 | -            |
...
- For Storage, [Smart CDN](/docs/guides/storage/cdn/smart-cdn) can help manage Egress usage. You can also use [Supabase Image Transformations](/docs/guides/storage/serving/image-transformations) to optimize images and reduce Egress.