...
<StepHikeCompact>
  <StepHikeCompact.Step step={1}>
    ...
    <StepHikeCompact.Code>
      <Image
        alt="Third-Party MAU sign-in screen"
        src={{
          light: '/docs/img/guides/platform/third-party-mau-auth0-sign-in-screen.png',
          dark: '/docs/img/guides/platform/third-party-mau-auth0-sign-in-screen.png',
        }}
        width={1098}
        height={1970}
      />
