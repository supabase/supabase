...
## Debug Storage size usage
Since we designed Storage to work as an integrated part of your Postgres database on Supabase, you can query information about your storage objects like any other table.
