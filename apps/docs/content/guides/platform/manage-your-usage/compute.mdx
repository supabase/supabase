...
| --------- | ------------ | ------------ | ----------- |
January 1, 00:00 AM - January 10, 4:00 PM | Micro | 232 hours |
January 10, 04:00 PM - January 10, 4:30 PM | Micro | 1 hour | full hour is billed |
January 10, 04:30 PM - January 10, 5:00 PM | Small | 0 hours | time window is allocated to Micro Compute size |
January 10, 05:00 PM - January 31, 23:59 PM | Small | 511 hours |

### Compute usage on your invoice
Compute usage and costs can be found under the "Compute Hours" line item on your invoice.
...
<Admonition type="note" label="Nano Compute size in Pro organizations">
  In Pro organizations, Nano Compute is billed at the same price as Micro Compute. It is recommended to upgrade your project from Nano Compute to Micro Compute when it's convenient for you. Compute sizes are not auto-upgraded because of the downtime incurred.
</Admonition>
...
| Line Item                 | Compute Size | Hours Active | Costs |
| ------------------------- | ------------ | ------------ | ----- |
| Pro Plan                  | -            | -            | $25   |
| Compute Project 1         | Micro        | 744          | $10   |
| **Subtotal**              |              |              | **$35** |
| Compute Credits           |              |              | -$10  |
| **Total**                 |              |              | **$25** |
...
| Pro Plan                  | -            | -            | $25   |
| Compute Project 1         | Micro        | 744          | $10   |
| Compute Project 2         | Micro        | 744          | $10   |
| Compute Project 3         | Micro        | 744          | $10   |
| **Subtotal**              |              |              | **$55** |
| Compute Credits           |              |              | -$10  |
| **Total**                 |              |              | **$45** |
...
| ------------------------- | ------------ | ------------ | ----- |
| Pro Plan                  | -            | -            | $25   |
| Compute Project 1         | Micro        | 233          | $3    |
| Compute Project 1         | Small        | 511          | $11   |
| **Subtotal**              |              |              | **$39** |
| Compute Credits           |              |              | -$10  |
| **Total**                 |              |              | **$29** |
...
- start out on a smaller Compute size, [create a report](https://supabase.com/dashboard/project/_/reports) in the Dashboard to monitor your CPU and memory utilization, and upgrade the Compute size as needed
