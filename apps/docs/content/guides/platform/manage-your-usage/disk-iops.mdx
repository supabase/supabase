...
<Price>$0.00003288</Price> per IOPS-Hr (<Price>$0.024</Price> per IOPS per month). gp3 disks come
with a default IOPS of 3,000. You are only charged for provisioned IOPS exceeding these 3,000 IOPS.
