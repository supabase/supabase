...
<Price>$0.000171</Price> per GB-Hr (<Price>$0.125</Price> per GB per month). The primary
...
<Price>$0.000267</Price> per GB-Hr (<Price>$0.195</Price> per GB per month). Unlike general
