...
The allowance and degraded-state consequences described on this page are not enforced yet. Exceeding your allowance doesn't rate limit queries, shorten retention, or cut off access — this page describes how enforcement will work once the grace period ends on Dec 23, 2026.
