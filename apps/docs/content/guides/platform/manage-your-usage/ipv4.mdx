...
You can assign a dedicated IPv4 address to a database by enabling the [IPv4 add-on](/docs/guides/platform/ipv4-address). You are charged for all IPv4 addresses configured across your databases.
