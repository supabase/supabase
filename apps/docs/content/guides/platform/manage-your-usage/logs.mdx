...
| ----------- | -------------------- | ------------------------------ |
| Logs Ingest | 5 GB                 | <Price price="0.50" /> per GB  |
| Logs Query  | 1,000 GB             | <Price price="0.002" /> per GB |
