...
You can configure a custom domain for a project by enabling the [Custom Domain add-on](/docs/guides/platform/custom-domains). You are charged for all custom domains configured across your projects.
...
- Use the default, randomly assigned Supabase URL `abcdefghijklmnopqrst.supabase.co` for staging environments
