...
Project add-ons are billed in-arrears based on how many hours you used it.
If you remove the custom domain add-on, you are no longer billed from the time of removal onwards.
