...
To ensure customers have ample time to do preparation for the new changes, we will introduce a grace period that runs through the start of 2027 before billing begins.
