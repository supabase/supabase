...
The Dashboard estimates initial sync volume and cost from source table metadata without scanning all rows. You can create a pipeline or reset tables even if an estimate is unavailable.
