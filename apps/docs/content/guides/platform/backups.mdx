...
Please be advised that deleting a project will result in the permanent removal of all associated data, including any backups stored in S3. This action is irreversible and should be carefully considered before proceeding.
...
| Plan       | Database Size (0-40GB) | [Database Size (>40GB)](#backup-process-for-large-databases) | [PITR](#point-in-time-recovery) | [Read Replicas](./read-replicas#prerequisites) |
| ---------- | ---------------------- | ------------------------------------------------------------ | ------------------------------- | ---------------------------------------------- |
...
This feature is available to all Enterprise plan projects. Pro and Team plan projects can enable PITR as an add-on.
