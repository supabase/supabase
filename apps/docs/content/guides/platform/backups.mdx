...
As a general rule of thumb, projects either have logical or physical backups based on plan, database size, and add-ons:
...
<Admonition type="caution" label="Physical backups are not enabled by default">
