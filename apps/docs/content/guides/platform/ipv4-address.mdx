...
1. **Supavisor Connection String (in session mode / on port 5432?)**: Use this string (found in Supabase Dashboard) as a replacement for the direct connection string
