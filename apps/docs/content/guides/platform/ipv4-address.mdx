...
For regular use-cases like a restart or compute size changes, we will keep the same IPv4 address.
However, in case your project gets paused and unpaused for any reason, you will get a new IPv4 address assigned.
