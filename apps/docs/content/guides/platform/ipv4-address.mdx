...
However, there are cases where maintaining the same IPv4 address cannot be ensured:

- If the project is paused and unpaused
- If the addon is removed and added again
