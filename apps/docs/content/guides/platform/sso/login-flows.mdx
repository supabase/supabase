...
See our [Choosing the Right Sign-in Flow guide](/docs/guides/platform/sso/choosing-sign-in-flow) for use case examples.
...
1. Navigate to [the **SSO** settings](/dashboard/org/_/sso) section of the dashboard
2. Enable "Single Sign-On"
3. Toggle **Enable SP-initiated sign-in** to "ON"
...
1. Navigate to [the **SSO** settings](/dashboard/org/_/sso) section of the dashboard
2. Toggle **Enable SP-initiated sign-in** to "OFF"
3. Save changes
...
1. Navigate to [the **SSO** settings](/dashboard/org/_/sso) section of the dashboard
2. Toggle **Enable SP-initiated sign-in** to "ON"
...
- **Choose your sign-in flow:** See [Choosing the Right Sign-in Flow](/docs/guides/platform/sso/choosing-sign-in-flow)
