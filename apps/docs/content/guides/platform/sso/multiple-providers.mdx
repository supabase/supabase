...
For technical details, see [the Understanding SSO Sign-in Flows guide](/docs/guides/platform/sso/sign-in-flows#multiple-saml-apps-per-domain).
...
3. Leave **Enable SP-initiated sign-in** "OFF", this is critical
...
1. Navigate to [the **SSO** settings](/dashboard/org/_/sso) section of the dashboard
2. Enable **Single Sign-On**
3. Verify **Enable SP-initiated sign-in** is "OFF"
...
- **Understand sign-in flows:** Read [Understanding SSO Sign-in Flows](/docs/guides/platform/sso/sign-in-flows)
- **Choose the right flow:** See [Choosing the Right Sign-in Flow](/docs/guides/platform/sso/choosing-sign-in-flow)
