...
2. In each Supabase organization:
   - Enable SSO
   - Leave "Enable SP-initiated sign-in" **OFF**
...
2. Leave "Enable SP-initiated sign-in" **OFF**
...
1. Enable SSO in your Supabase organization
2. Toggle "Enable SP-initiated sign-in" **ON**
...
2. Enable SSO and toggle "Enable SP-initiated sign-in" **ON**
...
- Non-SSO users use password/social sign-in
...
- Toggle "Enable SP-initiated sign-in" ON
...
- Toggle "Enable SP-initiated sign-in" OFF
...
- **Understand the technical details:** Read [Understanding SSO Sign-in Flows](/docs/guides/platform/sso/sign-in-flows)
