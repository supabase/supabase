...
Toggle this on if you want SSO-authenticated users to be **automatically added to your organization** when they log in via SSO. Auto-join applies on **every login**, not first signup - this makes it safe to test SSO before enabling this feature.
