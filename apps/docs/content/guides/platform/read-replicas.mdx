...
We're in the process of opening up Read Replicas for all projects on the Teams and Enterprise plan that were created on or after 20th March, and progressively enabling it for additional groups afterwards. Please use the [early access form](https://forms.supabase.com/read-replica) if it's not enabled for you yet and you would like early access.
