...
Disk size can also be manually expanded on the [Database settings page](https://supabase.com/dashboard/project/_/settings/database). The maximum default you can expand the Disk size to is 200 GB. If you wish to manually expand it to any more than 200 GB, [contact us](https://supabase.com/dashboard/support/new).
...
The maximum disk size for the Pro/Team Plan is 60 TB. If you need more than this, [contact us](https://forms.supabase.com/enterprise) to learn more about the Enterprise Plan.
