...
To initiate an upgrade of your database and therefore right-sizing of your disk, head over to your [project infrastructure settings](https://supabase.com/dashboard/project/_/settings/infrastructure).
