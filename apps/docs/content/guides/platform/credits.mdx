...
As an example, if you start a Pro Plan subscription on January 1 and downgrade to the Free Plan on January 15, your organization will receive approximately $12.50 in credits for the unused time between January 15 and January 31.

**Credit top-ups:** For more information, see [Credit top-ups](/docs/guides/platform/credits#how-to-top-up-your-credits)
...
Yes, you can transfer credits to another organization. Please submit a [support ticket](https://supabase.help).
