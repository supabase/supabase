...
```sh
nix run 'github:supabase/postgres?ref=15.6.1.121#start-server' 15
```
...
Once your project has been restored locally, connect to it with your preferred Postgres tooling using `host=localhost`, `user=postgres`, `port=5432`, and an empty password. This will allow you to inspect your saved data and export whatever is necessary.
