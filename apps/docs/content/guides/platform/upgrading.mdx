...
1. After your project is paused, click **Restore project**. When a project is unpaused, it is restored from the [physical backup](/guides/platform/backups) that was taken at the time the project was paused. The restoration can take several minutes depending on how much data your database has. You will receive an email once the restoration is complete.
