...
Pausing and restoring project will take some time depending on how much data your database has. If the restore process fails, contact Supabase support to bring your project back online.
