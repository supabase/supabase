...
To cancel your subscription, go to your [organization's billing settings](/dashboard/org/_/billing), click "Change subscription plan" and select the Free Plan. The cancellation is immediate, please refer to [downgrade docs](#downgrade) for full details.
