...
Our goal is to be as accommodating as possible without placing an excessive strain on our infrastructure. Service restrictions may be applied to your organization to enforce Fair Use in the following cases:
...
You will receive a notification before Fair Use Policy are applied. However, in some cases, like suspected abuse of our services, restrictions may be applied without prior notice.

#### How is Fair Use Policy applied?

Fair Use Policy are applied through service restrictions. This could mean:
...
Fair Use Policy is generally applied to all projects of the organization.

#### How do I remove restrictions applied from Fair Use Policy?
