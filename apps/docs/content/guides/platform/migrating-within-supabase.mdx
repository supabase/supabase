...
>
    <div className="border-b mt-3 pb-3">
        ...
        >
        <StepHikeCompact>
        The database backup can be downloaded from the [Database backups](dashboard/project/_/database/backups/scheduled) page or from the [paused project](dashboard/project/_) page if paused for greater than 90 days.
