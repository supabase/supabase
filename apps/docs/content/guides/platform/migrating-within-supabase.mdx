...
You can migrate your database to a different Supabase project. One possible reason you may need to do this is if your project has been paused for longer than 90 days and is no longer restorable.

### Restore a backup downloaded from the dashboard to a new Supabase project

Follow the [Restore dashboard backup guide](/docs/guides/platform/migrating-within-supabase/dashboard_restore)

### Backup a project or restore a CLI backup to a new Supabase project
