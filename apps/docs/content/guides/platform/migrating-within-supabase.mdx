...
if you are on a Paid plan and Physical backups, use the [Restore a new
project feature](https://supabase.com/dashboard/project/_/database/backups/restore-to-new-project)

Learn more about this feature [here](/docs/guides/platform/clone-project).
