...
The simplest option is to use our Google Colab notebook where you provide the necessray details to perform Backup and Restore operations remotely:
...
This should be used if there are issues using the Colab notebook or you prefer running the operations locally.
