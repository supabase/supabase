...
- With network restrictions applied, Edge funcitons lose direct access to the database. Use [supabase-js](/docs/reference/javascript) to connect to the database from Edge Functions instead.
