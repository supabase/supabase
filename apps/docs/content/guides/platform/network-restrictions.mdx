...
Applying or updating network restrictions triggers a brief database reboot. On small projects this usually completes in a few seconds, but larger databases may see a longer interruption.
