...
If you're already monitoring HTTP errors in Sentry, for example with the Http, Fetch, or nativeNodeFetch integrations, you will get duplicate spans for Supabase calls. You can deduplicate the spans by skipping them in your other integration:
