...
Owner, Administrator, and Developer roles are available on all projects but roles, such as Read-Only, are only available on the [Team and Enterprise plans](https://supabase.com/pricing).
