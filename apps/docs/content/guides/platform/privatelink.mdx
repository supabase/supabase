...
PrivateLink is currently in beta and available only to Teams and Enterprise customers.
...
2. Navigate to [**Settings** > **Integrations**](https://supabase.com/dashboard/project/_/settings/integrations)
3. Find the **AWS PrivateLink** section
4. Click **Add Account**
5. Enter your AWS Account ID
6. Provide a description for the account (optional but recommended)
7. Click **Add Account** to submit

After submission, Supabase will create a VPC Lattice Resource Configuration for your project and send an AWS Resource Share to the specified AWS Account ID. This process may take a few moments. Once complete, the account will show a "Ready" status, indicating that the resource share has been sent to your AWS account and is ready to be accepted.
...
4. Locate the resource share from Supabase.
   - The resource share will have the format `sspl-[project_ref]-[random alphanumeric string]`
