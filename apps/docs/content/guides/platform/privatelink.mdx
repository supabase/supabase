...
- Your may configure a custom DNS record to point to your PrivateLink endpoint interface or the endpoints on.aws DNS record within your VPC
...
Monitor your PrivateLink connection health through:

- AWS CloudWatch metrics for VPC Lattice connectivity
- Your standard database monitoring and alerting tools
- Supabase dashboard insights and performance metrics
...
The PrivateLink endpoint behaves like a standard PostgreSQL endpoint, allowing you to connect using:

- Direct PostgreSQL connections using standard tools
