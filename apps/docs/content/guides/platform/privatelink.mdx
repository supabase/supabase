...
Supabase PrivateLink is currently for direct database and PgBouncer connections only. It does not support other Supabase services like API, Storage, Auth, or Realtime. These services will continue to operate over public internet connections.
...
4. Add an inbound rule for:
   ...
   - Destination that is appropriate for your network. that is, the subnet of your VPC or security group of your application instances
