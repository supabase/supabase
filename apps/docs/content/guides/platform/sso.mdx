...
Supabase currently provides SAML SSO for [Team and Enterprise plan customers](https://supabase.com/pricing). If you would like to upgrade your existing Pro plan to Team or Enterprise and enable SSO, please [Contact Sales](https://forms.supabase.com/team). For existing Team and Enterprise plan customers, please follow the steps below.
