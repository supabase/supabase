---
title: 'CLI backup restore guide'
...
Here are the steps necessary to restore your CLI backup into a new project. Expand the steps to see detailed instructions on how to do each step.
