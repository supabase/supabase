      ...
      <StepHikeCompact.Step step={1}>
        ...
        <StepHikeCompact.Step step={2}>
          <StepHikeCompact.Details title="Configure your new project" fullWidth>
                ...
                - If you were using Replication for Realtime, enable [Publication](https://supabase.com/dashboard/project/_/database/publications) where needed.
          </StepHikeCompact.Details>
        </StepHikeCompact.Step>
      </StepHikeCompact>
    </AccordionItem>
...
<Admonition type="info">
  This method requires uploading to Google colab and then to the S3 buckets. This could add
  significant upload time if there are large storage objects.
</Admonition>
...
"**constraint CONSTRAINT for relation RELATION already exists**"
...
You are possibly using psql and postgres version 15 or lower. Completely remove the Postgresql installation and install the latest version as per the instructions above to resolve this issue.
...
If you reset your password for your project, it may take a few minutes for it to reflect. Try again after a few minutes if you did a password reset.
