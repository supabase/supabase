...
The easiest option would be to use this [Google colab script](https://colab.research.google.com/drive/1uNh0fyWg27HuVmqMOj6piZOFZrTcG_KJ?usp=sharing) to migrate your downloaded storage objects to the new s3 buckets. Follow the instructions when running the scripts.
...
Here are some scripts to run this process locally to avoid the additional upload step:
