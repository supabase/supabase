...
<StepHikeCompact.Step step={2}>
  ...
  <StepHikeCompact.Step step={3}>
    <StepHikeCompact.Details title="Restore your backup" fullWidth>
      Go to your [project page](https://supabase.com/dashboard/project/_/) and click the connect button at the top of the page to get your project's connection string:

      You will want to use the Direct connection string if you are able to (you have a IPv6 compatible network or have purchased the IPv4 addon). Otherwise, you will need to use the Session pooler connection string.

      Run this command after replacing the connection string below with your connection string from your project:
