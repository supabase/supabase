...
This guide covers restoring a `.backup` file between two Supabase projects. If you're looking for migration guidance, choose the guide that matches your use case:
