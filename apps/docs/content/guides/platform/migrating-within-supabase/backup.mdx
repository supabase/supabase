...
>
  ...
  <div className="border-b mt-3 pb-3">
    <AccordionItem
      header="Create and configure a new Supabase project (Only for Backup Restore)"
      id="item-2"
    >
      <StepHikeCompact>
...
<div className="border-b mt-3 pb-3">
  <AccordionItem header="Install the Supabase CLI" id="item-3">
...
<StepHikeCompact>
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Get Project URL" fullWidth>
          You will need the project URL for the project you want to backup. Get the URL below:
    ...
    <StepHikeCompact.Step step={2}>
      <StepHikeCompact.Details title="Backup your Project with the CLI" fullWidth>
       Run the following in your terminal after replacing $OLD_DB_URL with the Project URL from the previous step:
...
<StepHikeCompact>
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Get your new Project URL" fullWidth>
          You will need the project URL for your new project for restoring the backup. Get the URL below:
    ...
    <StepHikeCompact.Step step={2}>
      <StepHikeCompact.Details title="Restore your Project with the CLI" fullWidth>
        ...
        >
          ...
          Run the following command from your terminal with the URL obtained in the previous step:
