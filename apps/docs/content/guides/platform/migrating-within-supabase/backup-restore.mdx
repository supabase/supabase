...
This guide covers SQL backup/restore between two Supabase projects using the CLI. If you're looking for migration guidance, choose the guide that matches your use case:
