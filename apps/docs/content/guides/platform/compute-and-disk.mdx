...
The maximum number of replication slots and WAL senders depends on your compute instance size, as follows:

| Compute instance | Max Replication Slots | Max WAL Senders |
| -------------- | --------------------- | --------------- |
| Nano (free)    | 5                     | 5               |
| Micro          | 5                     | 5               |
| Small          | 5                     | 5               |
...
| Compute Instance | Baseline Disk Throughput | Baseline IOPS |
| ---------------- | --------------- | ------------ |
...
Smaller compute instances like Nano, Micro, and Small have baseline performance levels. Larger compute-instances (4XL and above) are designed for sustained, high performance with specific IOPS and throughput limits. If you hit your IOPS or throughput limit, throttling will occur.
...
| Feature | gp3 (General Purpose SSD) | io2 (High Performance SSD) |
|---------|---------------------------|---------------------------|
