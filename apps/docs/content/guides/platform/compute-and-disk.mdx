...
|  | gp3 (General Purpose SSD) | io2 (High Performance SSD) |
|---------|---------------------------|---------------------------|
...
- gp3 disks come with a baseline of 3,000 IOPS and 125 MiB/s. You can provision additional 500 IOPS for every GB of disk size and additional 0.25 MiB/s throughput per provisioned IOPS.
