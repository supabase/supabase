...
The compute size of your project sets the upper limit for disk throughput and IOPS. The table below shows the limits for each instance size. For instance, an 8XL compute instance has a maximum throughput of 9,500 MB/s and a maximum IOPS of 40,000.

| Compute Instance | Disk Throughput | IOPS        |
| ---------------- | --------------- | ----------- |
| Nano (free)      | 43 MB/s         | 250 IOPS    |
| Micro            | 87 MB/s         | 500 IOPS    |
| Small            | 174 MB/s        | 1,000 IOPS  |
| Medium           | 347 MB/s        | 2,000 IOPS  |
| Large            | 630 MB/s        | 3,600 IOPS  |
| XL               | 1,188 MB/s      | 6,000 IOPS  |
| 2XL              | 2,375 MB/s      | 12,000 IOPS |
| 4XL              | 4,750 MB/s      | 20,000 IOPS |
| 8XL              | 9,500 MB/s      | 40,000 IOPS |
| 12XL             | 14,250 MB/s     | 50,000 IOPS |
| 16XL             | 19,000 MB/s     | 80,000 IOPS |
