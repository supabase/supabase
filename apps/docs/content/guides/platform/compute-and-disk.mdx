...
You can adjust storage type, IOPS, throughput and disk size parameters yourself in the Dashboard [Database Settings](/dashboard/project/_/settings/database).
