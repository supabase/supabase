...
<Admonition type="note" label="Nanos in pro orgs">

In Pro organizations, Nano's are billed as Micros, so we recommend upgrading them when it's convenient for you. See [Supabase Pricing](https://supabase.com/pricing) for more information.
