...
By default, the number of connections allowed to Postgres and Supavisor is configured based on the resources available to the database. You can navigate to [Compute Add-ons](/docs/guides/platform/compute-add-ons) to check your database's direct and pooler connections.
