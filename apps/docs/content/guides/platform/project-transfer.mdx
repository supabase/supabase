...
- You could lose access to certain project features depending on the plan of the target organization, that is, moving a project from a Pro Plan to a Free Plan.
...
- You could have less rights on the project depending on your role in the target organization, that is, you were an Owner in the previous organization and only have a Read-Only role in the target organization.
