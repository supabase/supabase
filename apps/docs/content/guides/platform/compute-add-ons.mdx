...
| Compute size | Max Disk Throughput | Baseline Disk Throughput | Max IOPS    | Baseline IOPS |
| ------------ | ------------------- | ------------------------ | ----------- | ------------- |
...
| Large        | 4,750 Mbps          | 630 Mbps                 | 20,000 IOPS | 3,000 IOPS    |
| XL           | 4,750 Mbps          | 1,048 Mbps               | 20,000 IOPS | 3,000 IOPS    |
| 2XL          | 4,750 Mbps          | 1,048 Mbps               | 20,000 IOPS | 3,000 IOPS    |
| 4XL          | 4,750 Mbps          | 1,048 Mbps               | 20,000 IOPS | 3,000 IOPS    |
| 8XL          | 9,500 Mbps          | 1,048 Mbps               | 40,000 IOPS | 3,000 IOPS    |
| 12XL         | 14,250 Mbps         | 1,048 Mbps               | 50,000 IOPS | 3,000 IOPS    |
| 16XL         | 19,000 Mbps         | 1,048 Mbps               | 80,000 IOPS | 3,000 IOPS    |
...
The maximum number of replication slots and WAL senders depends on your compute size, as follows:

| Compute size | Max Replication Slots | Max WAL Senders |
| ------------ | --------------------- | --------------- |
| Nano (free)  | 5                     | 5               |
| Micro        | 5                     | 5               |
| Small        | 5                     | 5               |
