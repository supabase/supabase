...
| Responisibility        | Supabase | Customer | Shared |
| ----------- | ---------- | ---------- | ---------- |
| Information and data     |                         | <IconCheck size={14} /> |                         |
| Accounts and Identities  |                         | <IconCheck size={14} /> |                         |
| Backups                  | <IconCheck size={14} /> |                         |                         |
| Database Schema          |                         | <IconCheck size={14} /> |                         |
| Database Controls        |                         |                         | <IconCheck size={14} /> |
| Network Controls         |                         |                         | <IconCheck size={14} /> |
| Application Architecture |                         | <IconCheck size={14} /> |                         |
| Operating System         | <IconCheck size={14} /> |                         |                         |
| Virtual hosts            | <IconCheck size={14} /> |                         |                         |
| Virtual network          | <IconCheck size={14} /> |                         |                         |
| Cloud compute            | <IconCheck size={14} /> |                         |                         |

To summarise, you are always responsible for:
