...
Many Change Data Capture (CDC) tools are available for MSSQL, allowing you to add Microsoft SQL Server as a data source and Supabase as a destination.

For more information, read the [Manual Replication documentation](/docs/guides/database/replication/manual-replication-setup).
