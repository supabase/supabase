...
1. Get your project's Session pooler connection string from your project dashboard by clicking on [Connect](https://supabase.com/dashboard/project/_?showConnect=true).
1. Replace [YOUR-PASSWORD] in the connection string with your database password. You can reset your database password if you do not have it in your [Database settings](https://supabase.com/dashboard/project/_/settings/database).
