...
If you are on the Pro, Team or Enterprise Plan, you can get daily backups from [your Supabase dashboard](https://supabase.com/dashboard/project/_/database/backups/scheduled)

You can also backup your database by following the [backup and restore guide](/docs/guides/platform/migrating-within-supabase/backup-restore) provided.
