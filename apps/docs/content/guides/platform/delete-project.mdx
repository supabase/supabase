...
Deleted projects cannot be recovered. All data, backups, and configurations are permanently removed. Ensure you have exported all critical data or saved backups before proceeding to delete your project.

</Admonition>

## What Gets Deleted

When you delete a project, the following are permanently removed and **cannot be recovered**:

- **Database and all data**: Your entire PostgreSQL database, including all tables, schemas, and records
...
- **Backups**: All automated backups and point-in-time recovery snapshots are deleted
...
1. Navigate to your project's **Settings** > **Danger Zone**
...
For more information, see the [Supabase CLI documentation](https://supabase.com/docs/reference/cli/supabase-projects-delete).
...
See the [Management API documentation](https://supabase.com/docs/reference/api/v1-delete-a-project) for details.
...
- **Database backups**: Use `pg_dump` to export your PostgreSQL database:
...
See [Access Controls](http://localhost:3001/docs/guides/platform/access-control)
...
To pause a project, navigate to **Settings** > **General** and click **Pause Project**.
...
- Contact [Supabase support](https://supabase.com/support) for guidance
