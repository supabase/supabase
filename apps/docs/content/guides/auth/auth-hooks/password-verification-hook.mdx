...
as $$
  ...
  begin
    ...
    -- record failed attempt if outside throttle window
    insert into public.password_failed_verification_attempts
      ...
      on conflict (user_id) do update
        ...
        where public.password_failed_verification_attempts.last_failed_at < now() - interval '10 seconds'
      returning last_failed_at into _last_failed_at;
