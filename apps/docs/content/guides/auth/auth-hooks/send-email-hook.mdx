...
| Email Provider Enabled | Auth Hook Enabled | Result                                                               |
| ---------------------- | ----------------- | -------------------------------------------------------------------- |
| True                   | True              | Auth Hook handles email sending (SMTP not used)                      |
| True                   | False             | SMTP handles email sending (custom if configured, default otherwise) |
| False                  | True              | Email Signups Disabled                                               |
| False                  | False             | Email Signups Disabled                                               |
