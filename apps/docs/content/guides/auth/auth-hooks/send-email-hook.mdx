...
| `email_data` | `object`                                          | Metadata specific to the email sending process |

The `email_data` object contains these fields:

| Field                                               | Description                                                                                                                                                                                                                                                                                                         |
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `email_action_type`                                 | The kind of email to send, such as `signup`, `magiclink`, or `recovery`                                                                                                                                                                                                                                             |
| `token`                                             | The one-time code to show in the email                                                                                                                                                                                                                                                                              |
| `token_hash`                                        | The hashed token to put in a verification link                                                                                                                                                                                                                                                                      |
| `site_url`                                          | Your project's Auth API URL, such as `https://<project-ref>.supabase.co/auth/v1`. Despite the name, this isn't the [Site URL](/docs/guides/auth/redirect-urls) from your Auth settings. Build verification links from it: `<site_url>/verify?token=<token_hash>&type=<email_action_type>&redirect_to=<redirect_to>` |
| `redirect_to`                                       | Where to send the user after they verify. It's the redirect URL the client asked for if it's in your allow list, and your Site URL otherwise                                                                                                                                                                        |
| `token_new`, `token_hash_new`                       | The second code and hash for email changes. See [Email change behavior](#email-change-behavior-and-token-hash-mapping)                                                                                                                                                                                              |
| `old_email`, `old_phone`, `provider`, `factor_type` | Details for security notification emails, such as the previous email address. Empty for other email types                                                                                                                                                                                                           |
...
function generateConfirmationURL(email_data) {
  const baseUrl = `${email_data.site_url}/verify`
...
function generateConfirmationURL(email_data) {
   ...
   return `${email_data.site_url}/verify?${params.toString()}`
}
