...
| [MFA Verification Attempt](/docs/guides/auth/auth-hooks/mfa-verification-attempt-hook)           | Teams and Enterprise |
| [Password Verification Attempt](/docs/guides/auth/auth-hooks/password-verification-attempt-hook) | Teams and Enterprise |
