...
| -------------------------------------------------------------------------------------- | -------------------- |
| [Custom Access Token](/docs/guides/auth/auth-hooks/custom-access-token)                     | Free, Pro            |
| [Send SMS](/docs/guides/auth/auth-hooks/send-sms)                                           | Free, Pro            |
| [Send Email](/docs/guides/auth/auth-hooks/send-email)                                       | Free, Pro            |
| [MFA Verification Attempt](/docs/guides/auth/auth-hooks/mfa-verification-attempt)           | Teams and Enterprise |
| [Password Verification Attempt](/docs/guides/auth/auth-hooks/password-verification-attempt) | Teams and Enterprise |
