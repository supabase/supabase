...
<Tabs
  ...
  queryGroup="language"
>
<TabPanel id="sql-send-message-via-job-queue" label="Send messages via a job queue">
...
Your company would like to use an alternate message provider. Some examples of alternate message providers include [Msg91](https://msg91.com/) for India and [Africa's Talking](https://africastalking.com/). For demonstration, we use Twilio as it is widely available and does not require a regional number.
