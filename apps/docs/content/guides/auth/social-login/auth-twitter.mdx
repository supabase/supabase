...
- Add your X OAuth 2.0 Client ID and Client Secret to your Supabase Project.
...
- Click `+ Create Project`.
  ...
  - Copy and save your OAuth 2.0 Client ID.
  - Copy and save your OAuth 2.0 Client Secret.
These credentials are available under the OAuth 2.0 client configuration in the X Developer Portal.
...
curl -X PATCH "https://api.supabase.com/v1/projects/$PROJECT_REF/config/auth" \
  ...
  -d '{
    ...
    "external_x_client_id": "your-x-oauth-client-id",
    "external_x_secret": "your-x-oauth-client-secret"
  }'
```
