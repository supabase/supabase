...
Setting up Discord sign-in for your application consists of 3 parts:
...
- Once signed in, go to [discord.com/developers](https://discord.com/developers).
...
When your user signs in, call [`SignIn()`](/docs/reference/csharp/sign-in-with-oauth) with `Provider.Discord` as the provider:
