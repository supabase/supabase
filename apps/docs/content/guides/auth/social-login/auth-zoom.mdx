...
Setting up Zoom sign-in for your application consists of 3 parts:
...
When your user signs in, call [`SignIn()`](/docs/reference/csharp/sign-in-with-oauth) with `Provider.Zoom` as the provider:
