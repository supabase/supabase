...
If that is not preferable, you can change in the settings for your Google app. Go to Google App Platform, then click on Branding and then set your application home page, privacy policy and terms of use. You can also add your logo.
Afterwards go to Audience and click publish. The app will need to be verified by Google, which usually takes around 24 hours.
