---
title: 'SSO and social sign-in with WorkOS'
---

## Use social sign-in with WorkOS

### Step 1. Create a WorkOS organization

Sign in to the WorkOS dashboard and visit the Organizations tab to create an organization.
...
## Step 5. Add sign-in code to your client app
