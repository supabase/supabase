...
<Admonition type="caution">
  If you are using AWS SES as your SMTP provider, some extra configuration may be needed. Please
  check the [AWS SES Documentation](https://docs.aws.amazon.com/ses/latest/dg/Welcome.html)
</Admonition>
