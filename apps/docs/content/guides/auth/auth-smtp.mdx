...
- Email-based account invitations from the Supabase dashboard or from the Auth admin APIs
...
- [Configure CAPTCHA protection](https://supabase.com/docs/guides/auth/auth-captcha) for your project, which is the most effective way to control bots in this scenario. You can use CAPTCHA services which provide inisible challenges where real users won't be asked to solve puzzles most of the time.
