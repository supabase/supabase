...
Supabase supports a suite of social providers across various platforms including web, mobile apps, and Capacitor. Follow these guides to configure a social provider for your platform.

<Admonition type="info">

**Capacitor Support**: For Capacitor apps, you can use the [@capgo/capacitor-social-login](https://github.com/Cap-go/capacitor-social-login) plugin for native social authentication. See our [comprehensive Capacitor social login guide](/docs/blog/setup-supabase-with-capacitor-social-login) for step-by-step instructions.
