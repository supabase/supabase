...
The code adds a [matcher](https://nextjs.org/docs/app/building-your-application/routing/middleware#matching-paths) so the Proxy doesn't run on routes that don't access Supabase.
...
<div className="mt-12">
  <$CodeTabs>
    ...
    <$CodeSample
      ...
      meta="name=lib/supabase/middleware.ts"
      language="typescript"
    />
  </$CodeTabs>
</div>
