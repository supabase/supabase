...
<TabPanel id="type-definition" label="Locals">

<Admonition type="note">

Add supabase and getSession to the type definition (Typescript only)
...
<TabPanel id="page-component" label="Page Component usage">
...
<TabPanel id="api-route" label="API route usage">
...
<TabPanel id="form-actions" label="Form actions usage">
