...
The `.signInWithOAuth` method uses the `window` object for the automatic redirect. For automatic redirect to work, it should be called from a Client component. If the method is used server-side, you need to handle the redirect yourself.
