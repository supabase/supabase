...
For **access tokens**, you must use a namespaced claim because [Auth0 strips non-namespaced custom claims](https://auth0.com/docs/troubleshoot/product-lifecycle/past-migrations/custom-claims-migration):
