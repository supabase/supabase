...
If you are self-hosting, make sure you closely follow these instructions. If you are using the Firebase provider in the hosted platform, requests from other Firebase projects are rejected with a 401 status code. 
