...
>
  <TabPanel id="async-storage" label="AsyncStorage">
    <$CodeSample
      path="/auth/quickstarts/expo-react-native-social-auth/lib/supabase.web.ts"
      lines={[[1, -1]]}
...
/>
  ...
  <TabPanel id="secure-store" label="SecureStore">
    ...
    <$CodeSample
      path="/auth/quickstarts/expo-react-native-social-auth/lib/supabase.ts"
      lines={[[1, -1]]}
...
<$CodeSample
  path="/auth/quickstarts/expo-react-native-social-auth/.env"
  lines={[[1, -1]]}
  meta="name=.env"
/>
...
<$CodeSample
  path="/auth/quickstarts/expo-react-native-social-auth/hooks/use-auth-context.tsx"
  lines={[[1, -1]]}
...
<$CodeSample
  path="/auth/quickstarts/expo-react-native-social-auth/providers/auth-provider.tsx"
  lines={[[1, -1]]}
...
<$CodeSample
path="/auth/quickstarts/expo-react-native-social-auth/components/splash-screen-controller.tsx"
lines={[[1, -1]]}
...
<$CodeSample
path="/auth/quickstarts/expo-react-native-social-auth/components/social-auth-buttons/sign-out-button.tsx"
lines={[[1, -1]]}
...
<$CodeSample
path="/auth/quickstarts/expo-react-native-social-auth/app/(tabs)/index.tsx"
lines={[[1, -1]]}
...
<$CodeSample
path="/auth/quickstarts/expo-react-native-social-auth/app/login.tsx"
lines={[[1, -1]]}
...
<$CodeSample
path="/auth/quickstarts/expo-react-native-social-auth/app/_layout.tsx"
lines={[[1, -1]]}
...
>
  <TabPanel id="invertase-react-native-apple-authentication" label="Invertase">
    ...
    <$CodeSample path="/auth/quickstarts/expo-react-native-social-auth/components/social-auth-buttons/apple/apple-sign-in-button.ios.tsx" lines={[[1, -1]]} meta="name=components/social-auth-buttons/apple/apple-sign-in-button.ios.tsx"
/>
    ...
    <$CodeSample path="/auth/quickstarts/expo-react-native-social-auth/components/social-auth-buttons/apple/apple-sign-in-button.android.tsx" lines={[[1, -1]]} meta="name=components/social-auth-buttons/apple/apple-sign-in-button.android.tsx"
/>
  ...
  <TabPanel id="react-apple-signin-auth" label="Web">
    ...
    <$CodeSample path="/auth/quickstarts/expo-react-native-social-auth/components/social-auth-buttons/apple/apple-sign-in-button.web.tsx" lines={[[1, -1]]} meta="name=components/social-auth-buttons/apple/apple-sign-in-button.web.tsx"
/>
  ...
  <TabPanel id="expo-apple-authentication" label="Expo">
    ...
    <$CodeSample path="/auth/quickstarts/expo-react-native-social-auth/components/social-auth-buttons/apple/apple-sign-in-button.tsx" lines={[[1, -1]]} meta="name=components/social-auth-buttons/apple/apple-sign-in-button.tsx"
/>
...
>
 <TabPanel id="mobile" label="Mobile">
    ...
    <$CodeSample path="/auth/quickstarts/expo-react-native-social-auth/components/social-auth-buttons/google/google-sign-in-button.tsx" lines={[[1, -1]]} meta="name=components/social-auth-buttons/google/google-sign-in-button.tsx"
/>
  ...
  <TabPanel id="web" label="Web">
    ...
    <$CodeSample path="/auth/quickstarts/expo-react-native-social-auth/components/social-auth-buttons/google/google-sign-in-button.web.tsx" lines={[[1, -1]]} meta="name=components/social-auth-buttons/google/google-sign-in-button.web.tsx"
/>
