...
<StepHikeCompact>
                  ...
                  <div className="row flex flex-center">
                      <div className="col-6 form-widget">
                          ...
                          <div className="error-message">
                              ...
                              <p className="description">{authError}</p>
                              <button
                  ...
                  <div className="row flex flex-center">
                      <div className="col-6 form-widget">
                          ...
                          <div className="success-message">
                              ...
                              <p className="description">Loading your account...</p>
                          </div>
                      </div>
                  </div>
              );
              ...
              return (
                  <div className="row flex flex-center">
                      <div className="col-6 form-widget">
                          ...
                          <p className="description">You are logged in as: {session.user.email}</p>
  ...
  <StepHikeCompact.Step step={6}>
    <StepHikeCompact.Details title="Start the app">
      ...
      Start the app, go to http://localhost:5173 in a browser, and open the browser console and you should be able to log in.
