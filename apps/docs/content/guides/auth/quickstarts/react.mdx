...
<StepHikeCompact>
  ...
  <StepHikeCompact.Details title="Create a React app">
    ...
    Select React from the [list of UI Library quickstarts](https://supabase.com/ui/docs/getting-started/quickstart) and follow the instructions to create a new project.
