...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Create a React Native component to manage logins and sign ups. This component uses the [`getClaims`](/docs/reference/javascript/auth-getclaims) method to check local JWT validation, and if valid, login the user.
