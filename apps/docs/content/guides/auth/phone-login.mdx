...
Rate limits continue to apply when phone confirmations are disabled. When phone confirmations are disabled, an SMS message is sent and the associated phone number is confirmed.
