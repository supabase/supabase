...
Users can also sign in with their phones using native mobile sign-in with the built-in identity provider. For native mobile sign-in with Android and iOS, see the [social login guides](/docs/guides/auth/social-login).
