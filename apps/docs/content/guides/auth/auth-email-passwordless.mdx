...
Rate limits continue to apply when email confirmations are disabled. When email confirmations are disabled, an email is sent and the associated email is marked as confirmed.
