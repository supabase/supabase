...
Supabase Auth provides several passwordless sign-in methods. Passwordless logins allow users to sign in without a password, by clicking a confirmation link or entering a verification code.
