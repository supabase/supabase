...
To sign up the user, call [`SignUp()`](/docs/reference/csharp/sign-up) with their email address and password. You can optionally specify a URL to redirect to after the user clicks the confirmation link.
...
To sign up the user, call [`SignUp()`](/docs/reference/csharp/sign-up) with their email address and password:
...
When your user signs in, call [`SignIn()`](/docs/reference/csharp/sign-in-with-password) with their email address and password:
