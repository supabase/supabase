...
Finally, you can use your newly minted JWT as the Bearer Token Authentication header in all PostgREST requests.
...
Remember to provide your project's publishable key as the `apikey` header to bypass validation by our API gateway.
