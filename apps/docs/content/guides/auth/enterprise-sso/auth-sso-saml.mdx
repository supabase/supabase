...
To initiate a sign-in request from your application's user interface (that is, the SP Initiated Flow), you can use:
...
Many cloud-based identity providers offer a marketplace where you can register your application for on-boarding with customers. When you use Supabase Auth's SAML 2.0 support you can register your project in any one of these marketplaces.
