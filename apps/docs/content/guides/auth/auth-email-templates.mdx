...
| `{{ .Email }}`           | Contains the original email address of the user. Empty when when trying to [link an email address](/docs/guides/auth/auth-anonymous#link-an-email--phone-identity) to an anonymous account.                                                                                           |
| `{{ .NewEmail }}`        | Contains the new email address of the user when This variable is only supported in the "Change Email Address" template.                                                                                                                                                               |
