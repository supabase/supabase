...
| `{{ .Provider }}`        | Contains the provider of the linked or removed sign-in method. This variable is only supported in the "New sign-in method linked" and "Sign-in method removed" notification templates.                                                                                                |
