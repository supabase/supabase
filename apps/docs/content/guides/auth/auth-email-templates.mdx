...
You can customize the email messages used for the authentication flows and security notifications. You can edit the following authentication-related email templates:
...
And the following security-related email notification templates:
...
| <span className="!whitespace-nowrap">`{{ .OldEmail }}`</span>        | Contains the old email address of the user. This variable is only supported in the "Email changed notification" template.                                                                                                                                                             |
| <span className="!whitespace-nowrap">`{{ .Phone }}`</span>           | Contains the new phone number of the user. This variable is only supported in the "Phone changed notification" template.                                                                                                                                                              |
| <span className="!whitespace-nowrap">`{{ .OldPhone }}`</span>        | Contains the old phone address of the user. This variable is only supported in the "Phone changed notification" template.                                                                                                                                                             |
...
| <span className="!whitespace-nowrap">`{{ .FactorType }}`</span>      | Contains the type of the newly enrolled/unenrolled MFA factor. This variable is only supported in the "MFA factor enrolled notification" and "MFA factor unenrolled notification" templates.                                                                                          |
