...
curl -X PATCH "https://api.supabase.com/v1/projects/$PROJECT_REF/config/auth" \
  ...
  -d '{
      ...
      "mailer_templates_confirmation_content": "<h2>Confirm your sign up</h2><p>Follow this link to confirm your user:</p><p><a href=\"{{ .ConfirmationURL }}\">Confirm your email</a></p>",
...
```html
<a href="{{ .SiteURL }}/confirm-signup">Confirm your sign up</a>
```
