...
curl -X PATCH "https://api.supabase.com/v1/projects/$PROJECT_REF/config/auth" \
  ...
  -d '{
      "mailer_subjects_confirmation": "Confirm your sign up",
      "mailer_templates_confirmation_content": "<h2>Confirm your sign up</h2><p>Follow this link to confirm your sign up:</p><p><a href=\"{{ .ConfirmationURL }}\">Confirm your sign up</a></p>",
      ...
      "mailer_templates_recovery_content": "<h2>Reset password</h2><p>Follow this link to reset your password:</p><p><a href=\"{{ .ConfirmationURL }}\">Reset password</a></p>",
      "mailer_subjects_invite": "You have been invited",
      "mailer_templates_invite_content": "<h2>You have been invited</h2><p>You have been invited to create an account on {{ .SiteURL }}. Follow this link to accept the invite:</p><p><a href=\"{{ .ConfirmationURL }}\">Accept the invite</a></p>",
      "mailer_subjects_email_change": "Confirm your email address change",
      "mailer_templates_email_change_content": "<h2>Confirm email change</h2><p>Follow this link to confirm that you would like to change your email address:</p><p><a href=\"{{ .ConfirmationURL }}\">Change email address</a></p>",
  }'
```
...
```html
<a href="{{ .SiteURL }}/confirm-sign-up">Confirm your sign up</a>
```
...
```html
<a href="{{ .SiteURL }}/confirm-sign-up?confirmation_url={{ .ConfirmationURL }}"
  >Confirm your sign up</a
>
```
