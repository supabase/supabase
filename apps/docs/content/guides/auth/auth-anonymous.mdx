...
The Supabase team has received reports of user metadata being cached across unique anonymous users as a result of Next.js Static page rendering. For the best user experience, utilize Static rendering. 
