...
<Image
  alt="Healthy pipeline status page showing replication metrics and a live table"
  caption="A healthy pipeline is connected, caught up, and receiving ongoing table changes from the WAL."
