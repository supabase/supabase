...
Check the [plan and access requirements](/docs/guides/database/replication/pipelines-faq#which-plans-support-pipelines) and [compare destination data models](/docs/guides/database/replication#supported-destinations).
