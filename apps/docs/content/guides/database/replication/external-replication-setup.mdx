...
If you already have a Postgres publication set up, you can skip to [Step 2: Enable external replication (ETL)](#step-2-enable-external-replication-etl).
...
### Step 2: Enable external replication (ETL)
...
### Disabling external replication (ETL)
...
For cleanup details, see [What happens when you disable external replication (ETL)?](/docs/guides/database/replication/external-replication-faq#what-happens-when-you-disable-external-replication-etl).
