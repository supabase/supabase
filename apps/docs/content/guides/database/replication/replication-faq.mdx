...
For a complete list of limitations including destination-specific ones, see the [Setup guide](/docs/guides/database/replication/replication-setup#limitations).
