...
To remove Pipelines from a project, delete all replication pipelines first. After all pipelines are deleted, the disable action becomes available. For the Dashboard steps, see [Disabling Supabase Pipelines](/docs/guides/database/replication/supabase-pipelines#disabling-supabase-pipelines).
