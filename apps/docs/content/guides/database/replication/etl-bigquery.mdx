...
id: 'etl-bigquery'
title: 'BigQuery'
description: 'Replicate your database to Google BigQuery.'
...
BigQuery is Google's fully managed data warehouse. Automatic destinations allow you to sync your database tables to BigQuery for analytics and reporting.

<Admonition type="tip">

This page covers BigQuery-specific configuration. For complete setup instructions including publications, general settings, and pipeline management, see the [Automatic Destinations Setup guide](/docs/guides/database/replication/etl-replication-setup).

</Admonition>

### Setup

Setting up BigQuery replication requires preparing your GCP resources, then configuring BigQuery as a replication destination.
...
#### Step 2: Add BigQuery as a replication destination

After preparing your GCP resources, configure BigQuery as a replication destination:

1. Navigate to [Database](/dashboard/project/_/database/etl) → **Replication** in your Supabase Dashboard
...
4. Complete the remaining configuration following the [Automatic Destinations Setup guide](/docs/guides/database/replication/etl-replication-setup)
...
For general replication limitations that apply to all automatic destinations, see the [Automatic Destinations Setup guide](/docs/guides/database/replication/etl-replication-setup#limitations).
