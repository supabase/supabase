...
BigQuery is Google's fully managed data warehouse. Managed destinations allow you to sync your database tables to BigQuery for analytics and reporting.

<Admonition type="tip">

This page covers BigQuery-specific configuration. For complete setup instructions including publications, general settings, and pipeline management, see the [Managed Destinations Setup guide](/docs/guides/database/replication/etl-replication-setup).
...
4. Complete the remaining configuration following the [Managed Destinations Setup guide](/docs/guides/database/replication/etl-replication-setup)
