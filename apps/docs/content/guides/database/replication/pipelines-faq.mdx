...
Data type changes aren't applied to BigQuery and require a table resynchronization. See [BigQuery schema change support](/docs/guides/database/replication/bigquery#schema-change-support) for the full behavior and limitations.
