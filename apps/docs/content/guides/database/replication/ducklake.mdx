...
4. Click **Create and start pipeline**.
...
Replica-identity changes affect only new WAL. If retained updates or deletes still fail after restart, [reset the affected table](/docs/guides/database/replication/pipelines-monitoring#table-errors).
