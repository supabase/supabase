...
ETL Replication currently supports BigQuery and Iceberg (Analytics Buckets). See the [ETL Destinations guide](/docs/guides/database/replication/etl-destinations) for details on choosing between them.
...
Check the [Database](/dashboard/project/_/database/replication) → **ETL Replication** page:
...
See the [Monitoring guide](/docs/guides/database/replication/etl-replication-monitoring) for comprehensive monitoring instructions.
...
You can stop or start your pipeline from the destinations list in the [ETL Replication dashboard](/dashboard/project/_/database/replication).
...
1. Check the [setup guide](/docs/guides/database/replication/etl-replication-setup) and [monitoring guide](/docs/guides/database/replication/etl-replication-monitoring)
