...
Replication currently supports Iceberg (Analytics Buckets). See the [ETL Destinations guide](/docs/guides/database/replication/etl-destinations) for details.
...
1. Check the [Replication Setup guide](/docs/guides/database/replication/etl-replication-setup) and [Replication Monitoring guide](/docs/guides/database/replication/etl-replication-monitoring)
