...
Supabase currently provides managed replication to Iceberg (Analytics Buckets) with BigQuery coming soon. See the [Managed Destinations guide](/docs/guides/database/replication/etl-destinations) for details.
