...
Both destinations are supported, but availability varies based on our planned rollout strategy. The destinations you can access depend on your project and access level.
