...
title: 'Automatic Destinations FAQ'
description: 'Frequently asked questions about replication to automatic destinations.'
subtitle: 'Common questions and answers about replication to automatic destinations.'
sidebar_label: 'FAQ'
---
...
## What automatic destinations are supported?

Supabase currently provides managed replication to Iceberg (Analytics Buckets) with BigQuery coming soon. See the [Automatic Destinations guide](/docs/guides/database/replication/etl-destinations) for details.
...
Check the [Database](/dashboard/project/_/database/etl) → **Replication** page:
...
1. Check the [Automatic Destinations Setup guide](/docs/guides/database/replication/etl-replication-setup) and [Replication Monitoring guide](/docs/guides/database/replication/etl-replication-monitoring)
