...
Apache Iceberg is an open table format for analytic datasets. Replication, powered by Supabase ETL, to Iceberg uses Supabase [Analytics Buckets](/docs/guides/storage/analytics) to store your replicated data.
