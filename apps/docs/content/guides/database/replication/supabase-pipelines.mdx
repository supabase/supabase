...
3. Select a Supabase Pipelines destination, such as **BigQuery**
...
Supabase Pipelines automatically optimizes how changes are delivered to the destination. It currently performs data extraction and loading only, without transformation - your data is replicated as-is to the destination.
