...
#### Available managed destinations

For a complete list of available managed destinations and how to choose the right one for your needs, see [Managed Destinations](/docs/guides/database/replication/etl-destinations).
...
2. Configure the destination settings:
   ...
   **Destination-specific settings:**
   Each destination type requires different configuration. See the [Managed Destinations guide](/docs/guides/database/replication/etl-destinations) for configuration details specific to your chosen destination.
