...
Both Analytics Buckets and BigQuery destinations are supported. However, availability varies based on our planned roll-out strategy. The destinations you can access depend on your project and access level.
