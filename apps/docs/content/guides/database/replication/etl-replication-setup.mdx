...
Replication requires two main components: a **publication** (source) and a **destination**. Follow these steps to set up your replication pipeline.

<Admonition type="tip">

If you already have a publication set up, you can skip to [Step 2: Enable Replication](#step-2-enable-etl-replication).
