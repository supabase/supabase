...
After setting up replication to managed destinations, you can monitor the status and health of your replication pipelines directly from the Supabase Dashboard. The pipeline, powered by [Supabase ETL](https://github.com/supabase/etl), is the active Postgres replication process that continuously streams changes from your database to your destination.
...
<Image alt="Replication Logs" src="/docs/img/database/replication/etl-logs.png" zoomable />
