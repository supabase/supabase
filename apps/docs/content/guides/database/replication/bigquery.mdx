...
{/* SCREENSHOT SLOT: pipelines-bigquery-configuration.png — Add a sanitized 2x capture of the BigQuery destination drawer after the region helper copy is deployed. */}
