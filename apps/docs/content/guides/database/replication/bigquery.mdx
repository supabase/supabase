...
<Image
  ...
  caption="Configure the BigQuery destination details and credentials. This staging capture shows its environment-specific pipeline region; production Pipelines run in AWS eu-central-1 (Frankfurt)."
