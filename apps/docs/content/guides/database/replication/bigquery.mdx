...
Column-list changes for tracked tables follow the [schema rules](#schema-change-support). For table membership, row filters, or partition behavior, follow [publication changes](/docs/guides/database/replication/pipelines#adding-or-removing-tables).
