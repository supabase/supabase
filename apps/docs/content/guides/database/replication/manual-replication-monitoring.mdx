...
title: 'Monitoring Manual Destinations'
description: 'Monitor replication lag and status for manual destination setups.'
subtitle: 'Track replication health and performance for manual destinations.'
...
2. **Database** - Query system tables:
...
## Monitoring on the primary database
...
## Monitoring on the subscriber database
