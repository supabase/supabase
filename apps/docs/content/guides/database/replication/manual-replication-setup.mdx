...
This guide covers setting up **manual logical replication** using your own tools. If you prefer a managed solution powered by Supabase ETL, read the [external replication (ETL) setup guide](/docs/guides/database/replication/external-replication-setup) instead.
