...
This guide covers setting up **manual logical replication** using external tools. If you prefer a managed solution, read [the external replication setup docs](/docs/guides/database/replication/external-replication-setup) instead.
