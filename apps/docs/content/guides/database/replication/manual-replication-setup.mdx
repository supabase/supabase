...
This guide covers setting up **manual destinations** using external tools. If you prefer a simpler, managed solution, see [Automatic destinations](/docs/guides/database/replication/etl-replication-setup) instead.
