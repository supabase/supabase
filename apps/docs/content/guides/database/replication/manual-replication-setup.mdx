...
This guide covers setting up **manual logical replication** using your own tools. If you prefer a managed solution, read [Set up Supabase Pipelines](/docs/guides/database/replication/supabase-pipelines) instead.
