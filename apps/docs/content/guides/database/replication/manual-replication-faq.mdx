...
title: 'Manual Destinations FAQ'
description: 'Frequently asked questions about replication to manual destinations.'
subtitle: 'Common questions and answers about replication to manual destinations.'
sidebar_label: 'FAQ'
---
...
Using the Supabase CLI, you can [configure database settings](/docs/guides/database/custom-postgres-config#cli-configurable-settings) to optimize them for your replication needs. These values can vary depending on the activity of your database size and activity.
