...
title: 'Monitoring Managed Destinations'
description: 'Monitor the status and health of your replication pipelines to managed destinations.'
...
Managed destinations are powered by [Supabase ETL](https://github.com/supabase/etl), an open source tool built specifically for Postgres logical replication. The Dashboard provides a managed interface to configure and monitor your replication pipelines.
