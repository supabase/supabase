...
Validation confirms only that the database and schema are visible. It does not verify that the role can create or own tables, create pipes, or write through Snowpipe Streaming.
