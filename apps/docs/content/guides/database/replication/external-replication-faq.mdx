...
## What does ETL install in the database?
...
Disabling external replication removes the database objects that Supabase ETL installed in your source database, including the ETL state tables and DDL event trigger.
