...
| `pg_net.ttl`                          | Sets how long the [pg_net extension](https://supabase.com/docs/guides/database/extensions/pg_net?queryGroups=database-method&database-method=sql#configuration) saves responses|
| `pg_net.batch_size`                          | Sets how many requests the [pg_net extension](https://supabase.com/docs/guides/database/extensions/pg_net?queryGroups=database-method&database-method=sql#configuration) can make per second|
