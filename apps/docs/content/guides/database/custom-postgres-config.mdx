...
1. If you use the --no-restart flag, particularly where read replicas exist, and later one of the database is restarted, this might lead to a conflict of mismatching parameters and prevent one of the database coming up correctly.
