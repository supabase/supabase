...
1. [max_worker_processes](https://postgresqlco.nf/doc/en/param/max_worker_processes)(https://postgresqlco.nf/doc/en/param/max_worker_processes/) (CLI only)
1. [session_replication_role](https://postgresqlco.nf/doc/en/param/session_replication_role)(https://postgresqlco.nf/doc/en/param/session_replication_role/)
1. [shared_buffers](https://postgresqlco.nf/doc/en/param/shared_buffers)(https://postgresqlco.nf/doc/en/param/shared_buffers/) (CLI only)
