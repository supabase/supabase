...
If your organization isn't eligible or hasn't been rolled out yet, **High availability** won't appear. For eligible organizations, an administrator can turn it on when creating a new project.
