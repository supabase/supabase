...
Create a basic Database Function which returns a string "hello world".
...
5. `select 'hello world';`: A function body. The final `select` statement inside a function body will be returned if there are no statements following it.
