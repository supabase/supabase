...
<Image
  alt="Line chart of TPC-C throughput at 500 warehouses, in transactions per minute (tpmC), from 0 to 320 connections. OrioleDB rises to about 350,000 tpmC by 20 connections and holds between about 400,000 and 490,000 from 80 connections onward. Heap stays between about 30,000 and 90,000 across the whole range."
