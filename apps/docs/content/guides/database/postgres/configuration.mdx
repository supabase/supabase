...
**Warning:** if you are self-hosting PostgreSQL, default timezone will be set to your local timezone. We recommend changing to UTC, see the [Change timezone](/docs/guides/database/postgres/configuration#change-timezone) section on how to change this.
