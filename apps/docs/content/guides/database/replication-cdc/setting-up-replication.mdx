...
<TabPanel id="airbyte" value="Airbyte">
...
<TabPanel id="estuary" value="Estuary">
...
<TabPanel id="fivetran" value="Fivetran">
...
<TabPanel id="materialize" value="Materialize">
...
<TabPanel id="stitch" value="Stitch">
