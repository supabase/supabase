...
This page is the catalog of live Postgres diagnostics. For project logs, the Metrics API, and Studio Logs or Reports, see [Observe the data](/docs/guides/monitoring-and-debugging/access-data).
...
You can pair the information available from `pg_stat_statements` with the detailed system metrics available [via the Metrics API](/docs/guides/monitoring-and-debugging/metrics) to better understand the behavior of your DB and the queries you're executing against it.
