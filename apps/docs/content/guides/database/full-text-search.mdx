...
```python
data = await supabase.from('books').select().eq('title', 'Harry').execute()
```
...
```python
data = await supabase.from_('books').select().text_search('description', "'big'").execute()
```
...
```python
data = await supabase.from_('books').select().text_search('title_description', "little").execute()
```
...
```python
data = await supabase.from_('books').select().text_search('description', "'little' & 'big'").execute()
```
...
```python
response = await client.from_('books').select().text_search('description', "'little' | 'big'").execute()
```
...
```python
data = await client.rpc('search_books_by_title_prefix', { 'prefix': 'Lit' }).execute()
```
...
```python
data = await client.from_('books').select().text_search('fts', "'little' & 'big'").execute()
```
...
```python
data = await client.from_('books').select().text_search('description', "'big' <-> 'dreams'").execute()
```
...
```python
data = await client.from_('books').select().text_search('description', "'year' <2> 'school'").execute()
```
...
```python
data = await client.from_('books').select().text_search('description', "'big' & !'little'").execute()
```
