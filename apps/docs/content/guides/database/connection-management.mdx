...
Note that, in addition to your own direct database connections, the pool size also needs to serve internal Supabase services and connections made using Supavisor session mode.
