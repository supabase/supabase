...
Supabase supports reconfiguring pg_net starting from v0.10.0+. For the latest release, initiate a postgres upgrade in the [Infrastructure Settings](https://supabase.com/dashboard/project/_/settings/infrastructure).
