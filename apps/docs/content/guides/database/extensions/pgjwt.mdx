...
Note, Supabase creates and handles JWT for you. It is built into the platform so the pgjwt extension is not needed and is safe to disable. For more information on how Supabase handles JWT see our documentation here: [Supabase and JWTs](https://supabase.com/docs/guides/auth/jwts#supabase-and-jwts)
