...
Then you can use [specific syntax for iterative search](https://github.com/pgvector/pgvector/?tab=readme-ov-file#iterative-index-scans) to get exact number of results as in the query.
