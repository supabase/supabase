...
No other Postgres user can assume or sign in via this role. It solely exists to securely define what PGAudit will record.
...
Generates the following sign in the [Dashboard's Postgres Logs](/dashboard/project/_/logs/postgres-logs):
