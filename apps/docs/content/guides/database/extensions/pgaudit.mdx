...
<Admonition type="caution">
  Use global logging sparingly as it can generate a large amount of logs and make it difficult to find specific events of importance. Consider limiting the scope of what is logged and/or defer to user logging where possible.
  first.
</Admonition>
