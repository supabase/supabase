...
Use the [Observability overview](/docs/guides/observability) to see how Query Performance, Advisors, and the Metrics API work together when you plan optimizations.
