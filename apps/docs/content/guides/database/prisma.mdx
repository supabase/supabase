    ...
    <StepHikeCompact.Code>
            <Tabs>
                ...
                <TabPanel id="serverless" label="serverless deployments">
                    ...
                    Add a DATABASE_URL variable to your .env file. This is for your Supavisor Transaction mode string, which is necessary for managing serverless environments. It uses port 6543 and requires two flags appended to the the end of the string: "pgbouncer=true&connection_limit=1"
                    ```text .env
