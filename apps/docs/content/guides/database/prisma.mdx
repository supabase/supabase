...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    ![Session Mode](/docs/img/guides/database/transaction-mode.png)
    ...
    <StepHikeCompact.Code>
            <Tabs>
                <TabPanel id="serverful" label="server-based deployments">
                    ...
                    DIRECT_URL="postgres://[DB-USER].qjqzlvutjxbyodxrrvhb:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.supabase.com:5432/postgres"
                    ```

                    Change your string's `[DB-USER]` to `prisma`
                    ```md
                ...
                <TabPanel id="serverless" label="serverless deployments">
                    ...
                    DATABASE_URL="postgres://[DB-USER].qjqzlvutjxbyodxrrvhb:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.supabase.com:6543/postgres?pgbouncer=true"

                    # Used for Prisma Migrations (use session mode or direct connection)
                    DIRECT_URL="postgres://[DB-USER].qjqzlvutjxbyodxrrvhb:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.supabase.com:5432/postgres"
                    ```

                    Change both your strings' `[DB-USER]` to `prisma`
                    ```md
                    postgres://prisma.qjqzlvutjxbyodxrrvhb...
                    ```
