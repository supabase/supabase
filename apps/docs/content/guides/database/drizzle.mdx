...
If you plan on solely using Drizzle instead of the Supabase Postgres API, you can turn off the latter in the [API Settings](https://supabase.com/dashboard/project/_/settings/api).
