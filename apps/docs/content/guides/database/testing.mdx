...
A good starting point are the tests written for the Supabase client itself. For example, [here](https://github.com/supabase/supabase/tree/master/tests) are the tests for the Supabase JS client written with TypeScript and Jest.
