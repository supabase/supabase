...
id: 'database'
title: 'Database'
description: 'Every Supabase project is a full Postgres database.'
sidebar_label: 'Overview'
---

Every Supabase project has a full [Postgres](https://www.postgresql.org/) database — not a Postgres-flavored abstraction.
