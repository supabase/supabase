...
{/* TODO: Dashboard links */}
You don't have to be a database expert to start using Supabase, [a project table view](/dashboard/project/_/editor/) makes Postgres as easy to use as a spreadsheet.

{/* TODO: Also a video? */}

<Image
  alt="A screenshot of the table view in the Supabase Dashboard"
  src={{
    dark: '/docs/img/table-view.png',
    light: '/docs/img/table-view-light.png',
  }}
  width={1600}
  height={767}
/>

- [Find out more about tables](/docs/guides/database/tables)

### Relationships
{/* TODO: What is next steps? */}
...
Every Supabase project comes with a [SQL Editor](/dashboard/project/_/sql). You can also save your favorite queries to run later!
...
- [How to connect to your Project's Postgres database](/docs/guides/database/connecting-to-postgres).
- [Importing data into a database](/docs/guides/database/import-data)
- [Securing data in a database](/docs/guides/database/secure-data)