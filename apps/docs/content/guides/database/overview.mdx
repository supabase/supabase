...
Every <InfoTooltip tooltipContent="The open source Firebase alternative.">Supabase project comes with a full [Postgres](https://www.postgresql.org/) database, a free and open source database</InfoTooltip> which is considered one of the world's most stable and advanced databases.
