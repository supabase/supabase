...
Supabase is pre-configured with over 50 extensions and additional extensions can be installed through the [database.dev](https://database.dev/) package manager. 

Pure SQL extensions can be installed directly in the database using the SQL editor or any Postgres client.

If you would like to request an extension, please add (or upvote) it in the [Github Discussion](https://github.com/orgs/supabase/discussions/33754).
