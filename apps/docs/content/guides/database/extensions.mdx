...
Supabase is pre-configured with over 50 extensions. If you would like to request an extension, please add (or upvote) it in the [Github Discussion](https://github.com/orgs/supabase/discussions/33754).
