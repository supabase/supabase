...
Supabase provides managed replication to popular data platforms powered by [Supabase ETL](https://github.com/supabase/etl), an open source tool for Postgres logical replication. Configure your destination through the Dashboard, and Supabase ETL handles the replication pipeline automatically.
