...
Use Supabase's built-in ETL product to automatically replicate data to supported systems. This is the easiest way to sync your data to external destinations like BigQuery and Analytics Buckets (Iceberg).
