...
Replication powered by [Supabase ETL](https://github.com/supabase/etl) automatically replicates data to supported systems. Right now, **BigQuery** is the only supported managed destination. We plan to add more destinations in the future.
