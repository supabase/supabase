...
BigQuery is currently available as a managed destination. Snowflake is in Early Access. [Request access](/go/supabase-pipelines-new-destinations) to Snowflake, ClickHouse, or DuckLake.
