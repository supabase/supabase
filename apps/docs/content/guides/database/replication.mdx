...
External replication currently supports BigQuery as the managed destination. New destinations are in the works, and this table will be updated as support expands.
