...
This guide covers **database replication** for syncing data to external systems. This is different from [Read Replicas](/docs/guides/platform/read-replicas), which are used to deploy read-only databases across multiple regions for lower latency and load balancing.
...
### ETL Replication (Recommended)

Use Supabase's built-in ETL product to automatically replicate data to supported systems. This is the easiest way to sync your data to external destinations like BigQuery and Analytics Buckets.

- [Learn more about ETL Replication](/docs/guides/database/replication/etl-replication)
...
- [Setting up manual replication](/docs/guides/database/replication/manual-replication-setup)
- [Monitoring replication](/docs/guides/database/replication/manual-replication-monitoring)
