...
If you're working with small datasets in development, you can experiment using CSV import in the Supabase dashboard. If you're working with a large dataset in production, you should plan your data import to minimize app latency and ensure data integrity.
...
[pgloader](https://pgloader.io/) is a tool for efficiently importing data into a Postgres database that supports a wide range of source database engines, including MySQL and MS SQL.
