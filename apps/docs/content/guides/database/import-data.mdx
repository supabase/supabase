...
2. Click on "Create a table" (for new, empty projects) or "Insert" (for existing tables), then choose "Import Data from CSV" and follow the on-screen instructions to upload your CSV file.
