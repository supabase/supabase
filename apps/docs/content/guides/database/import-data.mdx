...
2. Click on _+ New table_ (for new, empty projects) or _Insert_ (for existing tables), then choose *Import Data from CSV* and follow the on-screen instructions to upload your CSV file.
