...
Supabase's Supavisor pooler in Session mode acts as an IPv4 proxy. It offers a direct connection experience with default IPv4 support for developers in IPv4-only environments or without the IPv4 add-on.
