...
### Should I use Supavisor and PgBouncer together?
...
### How does default pool size work?
...
### Client connections vs Backend connections and how to calculate?
...
### Where can I see my current connection usage?
...
### Why am I seeing active connections when my app is idle?

Even if your application isn’t making queries, some Supabase services keep persistent connections to your database. For example, Storage, PostgREST, and our health checker all maintain long-lived connections. You’ll usually see a small baseline of active connections from these services.

### Why does connection strings have different ports?
...
### Does Supabase connection pooling affect latency?
...
### How do I choose the right connection method?
...
<Image
  ...
  src={{
    dark: '/docs/img/guides/database/connecting-to-postgres/connection-decision-tree.png',
    light: '/docs/img/guides/database/connecting-to-postgres/connection-decision-tree-light.png',
  }}
