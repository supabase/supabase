...
You can track connection usage from the [Reports](/dashboard/project/_/observability/database) section in your project dashboard. There are three key reports:
