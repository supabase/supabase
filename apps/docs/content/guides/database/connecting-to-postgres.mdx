...
If this error started immediately after rotating your database password, it's likely a transient pooler-side caching delay rather than a wrong password — see [this troubleshooting guide](/docs/guides/troubleshooting/supavisor-error-password-authentication-failed-after-password-rotation) for how to confirm and resolve it.
