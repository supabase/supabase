...
We’ve got you covered with answers to common challenges and queries in the FAQs below.
...
### How do I fix the “FATAL: password authentication failed” error?
...
### Why can’t I connect using IPv4?
...
### How do I know which connection method to choose?

- Direct connection: Persistent backend services (IPv6 only)
- Supavisor session mode: Persistent backends needing IPv4
...
### Where can I find my Postgres connection string in Supabase?

Your connection string is located in your Supabase project’s dashboard under “Project Settings” → “Database”. Here you can copy your connection string directly.

### Can I use `psql` with my Supabase database?
