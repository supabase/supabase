...
Supabase offers [client libraries](https://supabase.com/docs/reference) for popular programming languages. These libraries provide a convenient wrapper around the Data APIs, making it easier to interact with your database using your preferred language.
...
unsure, you can check the [networking guide](/docs/guides/platform/ipv4-address#supabase-and-ipv6-compatibility)
...
In Session mode, Supabase's Supavisor pooler acts as an IPv4 proxy, allowing developers in IPv4-only environments to connect directly without the IPv4 add-on.
...
<Admonition type="caution">
  ...
  prepared statements](https://github.com/orgs/supabase/discussions/28239) in your connection
  library.
</Admonition>
