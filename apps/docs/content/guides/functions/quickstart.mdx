...
🎉 Your function is now live! Test it with your project's publishable key that you can find in the [**Settings > API Keys**](https://supabase.com/dashboard/project/casukmhgekgbhumkdkyd/settings/api-keys) section of the Dashboard:
