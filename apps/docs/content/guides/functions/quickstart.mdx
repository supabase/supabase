...
<Admonition type="info" label="First time running Supabase services?">
...
Deploy your function to Supabase's global edge network. Make sure Docker Desktop is installed and running!
...
When the deployment is successful, your function is automatically distributed to 40+ edge locations worldwide.
