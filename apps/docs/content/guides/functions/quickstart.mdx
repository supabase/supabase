...
🎉 Your function is now live! Test it with your project's publishable key that you can find in the [**Settings > API Keys**](/dashboard/project/casukmhgekgbhumkdkyd/settings/api-keys) section of the Dashboard:
