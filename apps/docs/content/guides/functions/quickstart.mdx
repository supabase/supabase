...
If you're using an Intellj Idea editor, you can use the `--with-intellij-settings` flag with `supabase init` to create an auto generated deno cofig for IntelliJ IDEA.
</Admonition>
