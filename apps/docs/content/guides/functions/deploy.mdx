...
You can now invoke your Edge Function using the project's `PUBLISHABLE_KEY`, which can be found in the [API settings](/dashboard/project/_/settings/api) of the Supabase Dashboard. You can invoke it from within your app:
