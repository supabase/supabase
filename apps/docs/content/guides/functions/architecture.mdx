...
description: 'Supabase Edge Functions Architecture'
...
<div class="video-container">
  <iframe
    src="https://www.youtube-nocookie.com/embed/za_loEtS4gs"
    frameBorder="1"
...
This guide explains the architecture and inner workings of Supabase Edge Functions, based on the concepts demonstrated in the video "Supabase Edge Functions Explained" by Lydia Hallie. Edge functions are serverless compute resources that run at the edge of the network, close to users, enabling low-latency execution for tasks like API endpoints, webhooks, and real-time data processing. We'll break it down into key sections: an example use case, deployment process, global distribution, and execution mechanics.
