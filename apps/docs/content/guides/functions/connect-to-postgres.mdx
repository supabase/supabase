...
First, declare the dependencies in a `deno.json` file inside the function directory (see [Managing dependencies](/docs/guides/functions/dependencies) for more details):
