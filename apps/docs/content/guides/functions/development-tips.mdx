...
Using import maps is deprecated; it's recommended to use [deno.json](https://supabase.com/docs/guides/functions/dependencies#importing-dependencies) instead.
