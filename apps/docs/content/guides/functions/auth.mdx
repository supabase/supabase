...
* If you plan to test locally with `supabase functions serve` you _must_ use `Deno.env.get('SUPABASE_URL')`; `http://localhost:54321` will fail because of docker containerization – see [github discussion](https://github.com/orgs/supabase/discussions/32437#discussioncomment-11706231) for more info.
