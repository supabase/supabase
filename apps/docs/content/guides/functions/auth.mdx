...
Create a named secret key for each caller in your project's [API keys settings](/dashboard/project/_/settings/api-keys). Give it a name like `automations`, and share the generated `sb_secret_...` value with the service that calls this function.
