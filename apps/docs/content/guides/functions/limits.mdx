...
- Maxiumum Duration (Wall clock limit): 400s (this is the duration an Edge Function worker will stay active. During this period, a worker can serve multiple requests)
- Maximum CPU Time: 2s
