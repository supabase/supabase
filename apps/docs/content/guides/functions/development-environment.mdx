...
Set up your editor environment to for proper TypeScript support, autocompletion, and error detection.
...
If you want to serve an Edge Function without the default JWT verification. This is important for for webhooks from Stripe, GitHub, etc. These services don't have your JWT tokens, so you need to skip auth verification.
