...
<Admonition type="info" label="New to Supabase?">
...
<Admonition type="info" label="Pre-built templates">
...
🚀 Your function is now automatically distributed to 40+ edge locations worldwide, running at `https://YOUR_PROJECT_ID.supabase.co/functions/v1/hello-world`
...
<Admonition type="warning" label="No version control">
...
<Admonition type="info" label="CLI not installed?">
