...
If you're invoking your Edge Function from a browser, you'll need to handle CORS (Cross-Origin Resource Sharing). See the [CORS guide](/docs/guides/functions/cors) for instructions on configuring CORS headers in your function.
