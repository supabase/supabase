...
We use [Supabase Auth](https://supabase.com/docs/guides/functions/auth#fetching-the-user) to authenticate the user who is sending the messages.
...
<TabPanel id="query" label="Using custom protocol">
```ts
  import { createClient } from "jsr:@supabase/supabase-js@2";
