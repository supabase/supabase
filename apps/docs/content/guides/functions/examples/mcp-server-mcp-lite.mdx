...
Navigate to your project directory and start your development environment:
...
- [Original tutorial by Fiberplane](https://blog.fiberplane.com/blog/mcp-lite-supabase-edge-functions/)
