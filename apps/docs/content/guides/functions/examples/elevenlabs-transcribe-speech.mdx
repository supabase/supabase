...
- The [Deno runtime](https://docs.deno.com/runtime/getting_started/installation/) installed on your machine and optionally [setup in your favorite IDE](https://docs.deno.com/runtime/getting_started/setup_your_environment).
