...
Create a new folder [`_templates`](/docs/guides/functions/development-environment#recommended-project-structure) and create a new file `magic-link.tsx` with the following code:
