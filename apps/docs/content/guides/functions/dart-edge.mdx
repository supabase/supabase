...
Create a `edge.yaml` file if you do not have one yet in the root of your project. Then, add the following configuration to specify the path to your Supabase project.
...
Also, currently Dart Edge does not work with the latest versions of Flutter. If you do have the latest version of Flutter on your machine, you can use [FVM](https://fvm.app/) to use an older version of Flutter for your Dart Edge project.
