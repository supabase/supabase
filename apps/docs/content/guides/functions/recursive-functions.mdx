...
```typescript
import { createClient, RateLimitError } from 'jsr:@supabase/supabase-js@2'
...
If you need a higher rate limit for your project, please [contact support](https://supabase.com/dashboard/support/new) with details about your use case.
