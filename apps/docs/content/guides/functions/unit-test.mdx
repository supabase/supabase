...
In this reference implementation the pricing logic lives inside the function folder `process-ticket/pricing.ts`.
You can also move it to `_shared/` if you want to reuse it across multiple functions.
</Admonition>
