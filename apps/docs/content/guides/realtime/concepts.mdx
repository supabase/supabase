...
We recommend using Broadcast by default and using Broadcast from Database specifically as it will allow you to scale your application easily compared to Postgres Changes.
