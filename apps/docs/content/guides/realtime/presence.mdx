...
Go to your Supabase project's [API Settings](https://supabase.com/dashboard/project/_/settings/api) and grab the `URL` and <LegacyApiKeys keyword='publishable' type='anon'/> key.
