...
Regardless of whether it's public or private, the Realtime service connects to your database as the authenticated Supabase Admin role.
...
select
  realtime.send(
    ...
    'event',                              -- Event name
    'topic',                              -- Topic
    private => true                       -- Private / Public flag (defaults to true)
  );
```
