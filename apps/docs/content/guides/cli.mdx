...
---
First you need to install the Supabase CLI. Please go to [Supabase CLI](https://supabase.com/docs/guides/cli/getting-started#installing-the-supabase-cli) for further details.
