{/* prettier-ignore */}
<Price price="0.053" /> per hour (~<Price price="39" /> per month) for each pipeline. <Price price="0.60" /> per Gigabyte of initial sync data. <Price price="3.00" /> per Gigabyte of ongoing replication data.

| Plan       | Pipeline                   | Initial Sync Data             | Ongoing Replication Data      |
| ---------- | -------------------------- | ----------------------------- | ----------------------------- |
| Free       | -                          | -                             | -                             |
