...
This quickstart optimizes for getting you to a working app, not for production. Before you deploy:
...
- Consider a [custom domain](/docs/guides/platform/custom-domains) for your Supabase project once you're ready to go live.
