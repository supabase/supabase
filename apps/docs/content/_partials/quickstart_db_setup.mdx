...
You can use [the Management API](/docs/reference/api/v1-create-a-project) and ask [the MCP server](/docs/guides/ai-tools/mcp#account-management) to create a new Supabase project.
...
Do this within your project's dashboard by copying and running the snippet in your project's [SQL Editor](/dashboard/project/_/sql/new).
...
You can use [the Management API](/docs/reference/api/v1-run-a-query) and ask [the MCP server](/docs/guides/ai-tools/mcp#database) to execute SQL queries.
