...
<Admonition type="tip" label="Want to use an API?">

You can also use [the Management API](/docs/reference/api/v1-create-a-project) to create a new Supabase project.
