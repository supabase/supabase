...
- Create an account access token once at [**Account Settings > Access Tokens (opens in a new tab)**](https://supabase.com/dashboard/account/tokens) and reuse it wherever you configure observability tooling.
