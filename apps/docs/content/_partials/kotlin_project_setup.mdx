...
Before we start building we're going to set up our Database and API. This is as starting a new Project in Supabase and then creating a "schema" inside the database.
