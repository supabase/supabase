...
In your [Supabase Auth settings](https://supabase.com/dashboard/project/_/auth/providers) enable Google as a provider and set the required credentials as outlined in the [auth docs](/docs/guides/auth/social-login/auth-google).
