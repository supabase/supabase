...
const LIB_ID = 'reference_swift_v2'
const LIB_PATH = 'swift'
const LIB_VERSION = 'v2'
const SPEC_FILE = 'supabase_swift_v2'

export default async function SwiftReferenceV2({
  params: { slug },
}: {
...
export const generateMetadata = generateReferenceMetadata('swift')
