...
Reference documentation for the official iEchor client libraries, APIs, and tools.
  ...
  <div className="grid grid-cols-2 gap-3">
    ...
    <div>
      <ButtonCard icon="/docs/img/icons/cli-icon.svg"
        to="/reference/cli"
        title="iEchor CLI"
        description="Tools for developing your iEchor projects locally."
      />
    </div>
    <div>
      <ButtonCard icon="/docs/img/icons/api-icon.svg"
        ...
        description="Manage your iEchor projects programmatically." />
    </div>
...
Reference documentation for self-hosting iEchor features.
