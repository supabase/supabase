...
```
create or replace function auth.useragent() returns text as $$
...
Read more about the http-context here: [https://postgrest.org/en/v10.0/api.html#http-context](https://postgrest.org/en/v10.0/api.html#http-context)
