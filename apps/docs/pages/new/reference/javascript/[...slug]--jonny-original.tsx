...
export default function Ref(props) {
  ...
  //const menuItems = jsSpec.functions.map((item) => console.log(item))
  // useEffect(() => {
  //   window.scrollTo(0, 0)
  //   setOffsetY(0)
  // }, [])
          ...
          >
            {jsSpec.functions.map((item, itemIndex) => {
              ...
              return (
                <>
                  <header
                    className="sticky top-14 backdrop-blur backdrop-filter bg-white-1200
                  dark:bg-blackA-300bg-gray-600 z-10 p-4"
                  >
