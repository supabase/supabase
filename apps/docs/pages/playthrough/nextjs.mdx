...
<Step title="Initialize the Next.js app" show={<Playground />}>
...
<Chapter title="The Login component">

Lets start building the Next.js app from scratch.

<Step title="Install auth helpers" show={<Playground />}>
...
<Step title="Add SessionContextProvider" show={<Playground />}>

Go to <GoToFile path="pages/_app.js" /> and add the context provider:

```js title=pages/_app.js solve=file
...
function MyApp({ Component, pageProps }) {
  const [supabaseClient] = useState(() =>
    createBrowserSupabaseClient({ cookieOptions: { sameSite: 'none' } })
  )
...
<Step title="Install Supabase Auth UI" show={<Playground />}>
...
<Step title="Add the Auth component" show={<Playground />}>

Go to <GoToFile path="pages/index.js" /> and add:

```js title=pages/index.js solve=file
...
<Step title="Run the app" show={<Playground />} intro={[saveFileCommand("components/Account.js")]}>
...
<Chapter title="The Account component">

<Step title="Create the Account component" show={<Playground />}>

Add a <GoToFile path="components/Account.js" /> file and put this:

```js title=components/Account.js solve=file
...
<Step title="Update index.js" show={<Playground />}>

Now in <GoToFile path="components/index.js" /> add:

```js title=components/index.js solve=file
import { Auth, ThemeSupa } from '@supabase/auth-ui-react'
import { useSession, useSupabaseClient } from '@supabase/auth-helpers-react'
...
<Step title="Add styles" show={<Playground />}>

Now in <GoToFile path="styles/globals.css" /> add:

```css title=styles/globals.css solve=file
html,
body {
  --custom-font-family: -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell,
...
<Step title="Test" show={<Playground />} />
