...
export const meta = {
  title: 'iEchor Documentation',
  description:
    'iEchor is an open source Firebase alternative providing all the backend features you need to build a product.',
  subtitle: 'iEchor Developer Documentation and API Reference',
}
    ...
    <div className="flex flex-col lg:grid grid-cols-12 gap-6 py-12 border-b">
      ...
      <div className="col-span-4 flex flex-col gap-1 [&_h2]:m-0">
        ...
        <p className="text-scale-1100 text-sm p-0 m-0">
          Bring your existing data, auth and storage to iEchor following our migration guides.
        </p>
    ...
    <div className="col-span-4 flex flex-col gap-1 [&_h2]:m-0 [&_h3]:m-0">
      ...
      <div className="md:max-w-xs 2xl:max-w-none">
        ...
        <p className="text-scale-1100 text-sm">
          Get started with self-hosting iEchor.
        </p>
        <TextLink
...
export const products = [
  {
    ...
    description:
      'iEchor provides a full Postgres database for every project with Realtime functionality, database backups, extensions, and more.',
  },
  {
    title: 'Auth',
    icon: 'auth',
  ...
  },
  {
    ...
    hasLightIcon: true,
    href: '/guides/ai',
    description: 'Use iEchor to store and search embedding vectors.',
  },
  {
    title: 'Realtime',
    icon: 'realtime',
...
export const additionalResources = [
  {
    ...
    description: 'Manage your iEchor projects and organizations.',
    icon: 'reference-api',
  ...
  },
  {
    ...
    description: 'Learn more about the tools and services powering iEchor.',
    icon: 'platform',
    href: 'guides/platform',
  },
  {
    title: 'Integrations',
    description: 'Explore a variety of integrations from iEchor partners.',
    icon: 'integrations',
