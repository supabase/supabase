...
export const meta = {
  id: 'flutterflow',
  title: 'FlutterFlow',
  description: 'FlutterFlow is a low-code tool that allows you to build Flutter apps incredibly fast.',
...
![Connect FlutterFlow to Supabase](/docs/img/guides/integrations/flutterflow/connect-flutterflow-to-supabase.gif)
...
![Insert a row](/docs/img/guides/integrations/flutterflow/insert.gif)
...
![Select and display data from Supabase](/docs/img/guides/integrations/flutterflow/select.gif)
...
![Delete data from Supabase](/docs/img/guides/integrations/flutterflow/delete.gif)
...
- [Writing data to Supabase DB from FlutterFlow](https://docs.flutterflow.io/data-and-backend/supabase/supabase-database/adding-data)
