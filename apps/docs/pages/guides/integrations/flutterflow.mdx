...
<video width="99%" muted playsInline controls={true}>
  <source src="/docs/videos/guides/integrations/flutterflow/connect-flutterflow-to-supabase.mp4" type="video/mp4" muted playsInline />
</video>
...
<video width="99%" muted playsInline controls={true}>
  <source src="/docs/videos/guides/integrations/flutterflow/insert.gif" type="video/mp4" muted playsInline />
</video>
...
<video width="99%" muted playsInline controls={true}>
  <source src="/docs/videos/guides/integrations/flutterflow/select.gif" type="video/mp4" muted playsInline />
</video>
...
<video width="99%" muted playsInline controls={true}>
  <source src="/docs/videos/guides/integrations/flutterflow/delete.gif" type="video/mp4" muted playsInline />
</video>
