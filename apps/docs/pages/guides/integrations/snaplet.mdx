...
If you experience any issues with getting Supabase working with Snaplet, or with this guide, feel free to come chat with us on [Discord](https://app.snaplet.dev/chat).
...
![Supabase connection string](https://docs.snaplet.dev/screenshots/supabase_connection_string.webp)
...
> **Highly Recommended:** Create a read-only role for your connection string. For more info on how to create a read-only role across all schemas, you can check out [our docs](https://docs.snaplet.dev/guides/postgresql#create-a-read-only-role).
...
![Onboarding start](https://docs.snaplet.dev/screenshots/onboarding_start.webp)
...
![Validating credentials](https://docs.snaplet.dev/screenshots/checking_creds.png)
...
![New project](https://docs.snaplet.dev/assets/images/new_project-74c5ef5f64da9f0bad9c50c23bc04acb.png)
...
1. Open your terminal and run `npm install snaplet`
...
![Supabase schema exclude](https://docs.snaplet.dev/assets/images/snaplet-supabase-schema-exclude-5f123e687bfd94895b5c136a2a5beb87.png)
