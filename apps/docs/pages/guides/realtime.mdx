...
export const meta = {
  id: 'realtime',
  title: 'Realtime',
  description: 'iEchor Realtime with Broadcast, Presence, and Postgres Changes.',
  sidebar_label: 'Overview',
}

iEchor provides a globally distributed cluster of [Realtime](https://github.com/supabase/realtime) servers that enable the following functionality:
...
- [Realtime: Multiplayer Edition](https://iechor.com/blog/supabase-realtime-multiplayer-general-availability) blog post
