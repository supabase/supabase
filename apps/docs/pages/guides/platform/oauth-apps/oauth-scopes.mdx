...
export const meta = {
  ...
  description: 'Scopes let you specify the access your integration needs',
  subtitle: 'Scopes let you specify the access your integration needs',
}
...
Scopes restrict access to the [Supabase Management API](/docs/reference/api/introduction) for OAuth tokens. All scopes can be specified as read and/or write.
...
| `Domains`        | `Read`  | Retrieve the custom domains for a project<br/>Retrieve the vanity sudomain configuration for a project                                                                                                                                                                                    |
| `Domains`        | `Write` | Activate, intialise, reverify and delete the custom domain for a project<br/>Activate, delete or check the availability of a vanity subdomain for a project                                                                                                                               |
| `Edge Functions` | `Read`  | Retrieve information about a project's edge functions                                                                                                                                                                                                                                     |
| `Edge Functions` | `Write` | Create, update, delete an edge function                                                                                                                                                                                                                                                   |
