...
5XX status codes can be the result of the project being not powerful enough to process a complex request being made by a client, or to keep up with the volume of requests being made against the project.
...
Free-tier projects may be paused due to inactivity, or on request by the owner, or in rare instances, due to abuse.
