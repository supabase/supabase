...
<Admonition type="note">
  You can transfer projects to a free organization, in case you haven't used up your 2 free project
  limit, if you don't want additional projects on the Pro plan. See [Project
  Transfers](/docs/guides/platform/project-transfer).
</Admonition>
