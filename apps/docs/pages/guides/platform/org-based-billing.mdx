...
<details>
<summary>
  <i>Where do I change my project addons such as PITR, Compute and Custom Domain?</i>
</summary>

Head over to your [projects add ons page](https://supabase.com/dashboard/project/_/settings/addons) to change your compute size, Point-In-Time-Recovery or custom domain.
