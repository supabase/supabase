...
Note that project migration is for transferring your projects to different regions. If you need to move your project to a different organization without touching the infrastrusture, see [project transfers](https://supabase.com/docs/guides/platform/project-transfer).
