...
{/* screenshot of Daily Backups dashboard */}
...
{/* screenshot of the Dashboard with the confirmation modal */}
...
{/* screenshot of the Dashboard of the project in restoration mode */}
...
{/* screenshot of Point-in-Time Recovery on the Dashboard */}
...
{/* screenshot of PITR calendar view on the Dashboard */}
