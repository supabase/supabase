...
export const meta = {
  id: 'sso-with-azure',
  title: 'Setup SSO with Azure AD',
  description: 'Configuration instructions for single sign-on with Azure AD (Entra)',
}
...
<a href="https://alt.supabase.io/auth/v1/sso/saml/metadata?download=true"><Button size="large" icon={<IconArrowDown />}>Download Supabase SAML Metadata File</Button></a>
...
Supabase as laid out in [Step 8](#step-8-wait-for-confirmation).*
