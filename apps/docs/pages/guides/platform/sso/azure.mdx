...
In the modal titled _Create your own application_ enter the name you wish Supabase to be available to your Azure AD users. `Supabase` works in most cases.
