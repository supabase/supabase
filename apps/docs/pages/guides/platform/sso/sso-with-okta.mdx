...
export const meta = {
  ...
  description: 'Configuration instructions for single sign-on with Okta',
}
...
metadata URL from [Step 6](#step-6-obtain-idp-metadata-url) and information
regarding the attribute statements from [Step
5](#step-5-fill-out-attribute-statements) (if any changes are applicable) to
