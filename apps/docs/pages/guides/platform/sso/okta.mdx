...
iEchor supports single sign-on (SSO) using Okta.
...
iEchor supports the SAML 2.0 SSO protocol. Choose it from the _Create a new
...
menu. You can choose any values you like. `iEchor` as a name works well for
most use cases.
...
These settings let iEchor use SAML 2.0 properly with your Okta application.
Make sure you enter this information exactly as shown on in this table and
screenshot.

| Setting                                        | Value                                                      |
| ---------------------------------------------- | ---------------------------------------------------------- |
| Single sign-on URL                             | `https://iechor.com/dashboard/auth/v1/sso/saml/acs`      |
| Use this for Recipient URL and Destination URL | ✔️                                                         |
| Audience URI (SP Entity ID)                    | `https://iechor.com/dashboard/auth/v1/sso/saml/metadata` |
| Default RelayState                             | `https://iechor.com/dashboard`                           |
...
Attribute Statements allow iEchor to get information about your Okta users on each login.
...
Please share any changes, if any, from this screen with your iEchor support
contact.
...
iEchor needs to finalize enabling single sign-on with your Okta
application.
...
your support contact at iEchor.

Wait for confirmation that this information has successfully been added to
iEchor. It usually takes us 1 business day to configure this information
for you.
