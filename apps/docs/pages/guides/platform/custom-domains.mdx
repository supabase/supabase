...
You will require [Owner or Admin permissions](/docs/guides/platform#manage-team-members) for the project you'd like to set up a custom domain for.

## Configure a Custom Domain using the Supabase Dashboard

The [General Settings](https://app.supabase.com/project/_/settings/general) page of the Supabase Dashboard has a "Custom Domains" section, that will guide you through setting up a Custom Domain for your project.

If your project does not yet have a Custom Domains add-on enabled, or if it is not on a paid plan, it will first redirect you to the [Billing update](https://app.supabase.com/project/_/settings/billing/update) page.
...
### Purchase a Custom Domains add-on using the Supabase Dashboard

Use the [Billing update](https://app.supabase.com/project/_/settings/billing/update) page of the dashboard to upgrade to paid tier, and subscribe to the Custom Domains add-on for your project.
