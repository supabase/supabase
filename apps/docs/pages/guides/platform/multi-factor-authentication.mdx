...
Supabase does not return recovery codes. Instead, we recommend that you register a backup TOTP factor to use in an event that you lose access to your primary TOTP factor.

</Admonition>

<Admonition type="caution">

If you lose access to your 2FA device, please reach out to [our support team](/dashboard/support/new). Do note that an MFA reset may take upwards of 3 days to process for security reasons.
...
You can disable MFA for your user account under your [Supabase account settings](/dashboard/account/security). On subsequent login attempts, you will not be prompted to enter a 2FA code.
