...
- Supabase provides `captcha` protection on the signup, sign-in and password reset endpoints. Please refer to [our guide](/docs/guides/auth/auth-captcha) on how to set up `captcha` for your project.
