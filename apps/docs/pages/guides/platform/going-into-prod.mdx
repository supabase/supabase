...
As your team grows, you might want to consider the different levels of access that your team is given.

- Free and Pro: Supabase provides access controls within the Dashboard for Developers and Administrators.
- Teams and Enterprise: these tiers include more advance access controls, including Read-only Roles for the Dahsboard.

You might also consider running your workload across several organizations. It is a common pattern to have a Production organization which is restricted only to those team members who are qualified to have direct access to production databases.
