...
As your team grows, consider the different [access levels](/docs/guides/platform/access-control) that your team is requires.
...
You can turn on the [PGAudit](/docs/guides/database/extensions/pgaudit) extension to keep track of all changes to your database.
