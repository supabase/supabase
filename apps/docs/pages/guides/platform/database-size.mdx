...
This SQL query will show the size of your Postgres database:
...
New Supabase projects have a database size of ~40-60mb. This space includes pre-installed extensions, schemas, and default Postgres data.

Additional database size is used when installing additional extensions, even if those extensions are inactive.
