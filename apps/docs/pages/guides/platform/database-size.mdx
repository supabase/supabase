...
[Free Tier](#free-tier-project) projects enter ['read only'](#free-tier-project-read-only-mode) mode when you exceed the 500mb limit. Once in read-only mode, you have several options:
