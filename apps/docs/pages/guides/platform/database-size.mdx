...
- [Upgrade to the Pro plan](https://supabase.com/dashboard/project/_/settings/billing/subscription) to increase the limit to 8GB. [Disable the Spend Cap](https://app.supabase.com/project/_/settings/billing/subscription?panel=costControl) if you want your Pro instance to auto-scale and expand beyond the 8GB database size limit.
