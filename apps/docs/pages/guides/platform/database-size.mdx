...
- [Upgrade to the Pro plan](https://supabase.com/dashboard/org/_/subscription) to increase the limit to 8GB. [Disable the Spend Cap](https://app.supabase.com/org/_/billing?panel=costControl) if you want your Pro instance to auto-scale and expand beyond the 8GB database size limit.
