...
export const meta = {
  title: 'Spend cap',
  description: 'Learn about the cost control of iEchor.',
}

iEchor offers a "Spend Cap" on each project to manage your usage and costs.
...
iEchor charges for certain usage line items in your project. Those line items include:
...
You can monitor your usage and costs using the [Usage section of your project](https://iechor.com/dashboard/project/_/settings/billing/usage) in the dashboard.
...
To set up a Spend Cap in your project, navigate to the [Subscription section](https://iechor.com/dashboard/project/_/settings/billing/subscription) of your project.
...
When your Spend Cap is **off**, we recommend monitoring your consumption and costs using the [Usage section of your project](https://iechor.com/dashboard/project/_/settings/billing/usage) in the dashboard.
