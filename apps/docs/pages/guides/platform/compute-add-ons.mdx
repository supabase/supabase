...
| Plan            | Pricing | CPU                     | Memory | Max Disk Throughput | Baseline Disk Throughput | Connections: Direct (recommended) | Connections: Pooler (recommended) |
| --------------- | ------- | ----------------------- | ------ | ------------------------- | -------------------------- | --------------------------------- | --------------------------------- |
| Free (Included) | $0      | 2-core ARM (shared)     | 1 GB   | 2,085 Mbps                | 87 Mbps                    | 60                                | 200                               |
| Small           | $5      | 2-core ARM (shared)     | 2 GB   | 2,085 Mbps                | 174 Mbps                   | 90                                | 200                               |
| Medium          | $50     | 2-core ARM (shared)     | 4 GB   | 2,085 Mbps                | 347 Mbps                   | 120                               | 200                               |
