...
3. Reset database password for the branch. To do this navigate to `https://supabase.com/dashboard/project/[branch-ref]/settings/database` and click `Reset database password` button. Save the new password and use it in the next step.
