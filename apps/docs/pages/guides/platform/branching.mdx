...
We do not recommended Branching in a production environment while it is in Early Access.
...
<StepHikeCompact>
    ...
    <StepHikeCompact.Step step={2}>
        <StepHikeCompact.Details title="Pull your database changes to local" fullWidth>
...
<Admonition type="note" label="Changes must be locally pulled and committed to keep your Git repository state in sync with your remote Preview Branch.">

Remote Supabase Dashboard changes aren't automatically reflected in your Git repository. If you'd like to see migration file automation in a future release, [join the discussion](https://github.com/orgs/supabase/discussions/18937).
