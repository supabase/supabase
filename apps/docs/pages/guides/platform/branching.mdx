...
There is a known issue with the reliability of Preview Branches being deployed correctly for projects based in Sout East Asia (Singapore) and Central EU (Frankfurt) regions.
