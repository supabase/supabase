...
Supabase currently provides SAML SSO for [Teams tier and Enterprise tier customers](https://supabase.com/pricing). Please contact [Enterprise Sales](https://supabase.com/contact/enterprise) to have this enabled for your organization.
</Admonition>
