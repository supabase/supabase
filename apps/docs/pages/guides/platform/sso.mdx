...
Supabase currently provides SAML SSO for [Team and Enterprise plan customers](https://supabase.com/pricing). Please contact [Enterprise Sales](https://forms.supabase.com/team) to have this enabled for your organization.
