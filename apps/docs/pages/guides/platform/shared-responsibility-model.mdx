...
If you sign a BAA with Supabase, you can use Supabase to store and process Protected Health Information (PHI). You are responsible for ensuring that your project is configured with these required best practices
...
- Your project is not making use of the [Supabase AI editor](https://supabase.com/dashboard/project/_/sql) in our dashboard.
