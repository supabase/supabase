...
<ThemedImage
  ...
  sources={{
    light: '/docs/img/guides/platform/logs/unnesting-none.png',
    dark: '/docs/img/guides/platform/logs/unnesting-none-dark.png',
  }}
  style={{ maxHeight: 200 }}
/>
...
<ThemedImage
  ...
  sources={{
    light: '/docs/img/guides/platform/logs/unnesting-2.png',
    dark: '/docs/img/guides/platform/logs/unnesting-2-dark.png',
  }}
  style={{ maxHeight: 200 }}
/>
