...
### Configuring `pgaudit.log` {#configuring-pgaudit-log}

The stored value under `pgaudit.log` determines the classes of statements that are logged by pgAudit. Refer to the pgAudit documentation for the [full list of values](https://github.com/pgaudit/pgaudit/blob/master/README.md#pgauditlog).
