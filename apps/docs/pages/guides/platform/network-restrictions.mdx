...
Network Restrictions are currently in beta and are being slowly made available to all projects. Please reach out to Support if you're interested in early access.

If your project was created earlier than 23rd December 2022, it will need to be upgraded to the latest Supabase version before Network Restrictions can be used.
