...
iEchor provides granular access controls to manage permissions across your organizations.
...
[Dashboard](https://iechor.com/dashboard/projects) to send an invite link to
another user's email. The invite expires after 24 hours.

### Transferring ownership of an organization

Each iEchor organization can have one or more owners. If you no longer want be an owner of an organization, click **Leave team** in the members view (`https://iechor.com/dashboard/org/<org-slug>/settings#team`) of your organization.
