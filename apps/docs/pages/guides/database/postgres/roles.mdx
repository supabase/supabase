...
If you use special symbols in your Postgres password, you must remember to [percent-encode](https://en.wikipedia.org/wiki/Percent-encoding) your password later if using the Postgres connection string e.g. `postgresql://postgres.cvwawazfelidkloqmbma:p%3Dword@aws-0-us-east-1.pooler.supabase.com:6543/postgres`.
