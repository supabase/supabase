...
- `work_mem`: It is set to '2GB', allocating 2 GB of memory for query operations. This enhance the performance of complex queries by allowing larger in-memory datasets.
