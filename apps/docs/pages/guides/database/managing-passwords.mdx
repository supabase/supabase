...
Your PostgreSQL database is the core of your iEchor project, so it's important that it has a strong, secure password at all times.
...
You can update this from the Dashboard under the [database settings](https://iechor.com/dashboard/project/_/settings/database) page.
