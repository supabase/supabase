...
Logging history of webhook calls is available under the `net` schema of your database. For further informations see the [GitHub Repo](https://github.com/supabase/pg_net).
