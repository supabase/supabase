...
### Invoke iEchor Edge Function every minute

Make a POST request to a iEchor Edge Function every minute. Note: this requires the [`pg_net` extension](/docs/guides/database/extensions/pgnet) to be enabled.
