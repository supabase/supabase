...
## Full Text Search
The `&@~` operator performs full text search. It returns any maching results. Unlike `LIKE` operator, pgroonga can search any text that contains the keyword case insensitive.
