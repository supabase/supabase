...
export const meta = {
  id: 'pg_graphql',
  title: 'pg_graphql: Native GraphQL for PostgreSQL',
  description: 'A GraphQL API for PostgreSQL',
}
...
Note that pg_graphql fully supports schema introspection so you can connect any IDE or schema inspection tool to see the full set of fields and arguments available in the API.
