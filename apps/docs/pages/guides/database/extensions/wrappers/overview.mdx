...
![FDW](/docs/img/database/fdw-qetl.png)
...
Foreign Data Wrappers do not provide Row Level Security and we do not advise exposing them via your API. Wrappers should _always_ be stored in a private schema. For example, if you are connecting to your Stripe account, then you should create a `stripe` schema to store all of your Foreign Tables inside. This schema should _not_ be added to the “Additional Schemas” setting in the API section.
