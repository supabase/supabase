...
Alternatively, you may also set up foreign data wrappers through the dashboard by going to the [Wrappers](https://supabase.com/dashboard/project/_/database/wrappers) page.
