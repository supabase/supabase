...
<video width="99%" muted playsInline controls="true">
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/api/api-url-and-key.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" muted playsInline controls="true">
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/postgres-connection.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" muted playsInline controls="true">
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/connection-pool-config.mp4"
    type="video/mp4"
    muted
    playsInline
  />
