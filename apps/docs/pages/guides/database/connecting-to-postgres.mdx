...
You can find the connection pooler in the [Database settings page](/dashboard/project/_/settings/database) under "Database string".
Make sure "Use connection pooling" is checked and copy the connection string.
...
You can find the direct connection string in the [Database settings page](/dashboard/project/_/settings/database) under "Database string".
Make sure "Use connection pooling" is unchecked and copy the connection string.
