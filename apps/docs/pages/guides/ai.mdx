...
- Integrations with all popular AI providers, such as [OpenAI](/docs/guides/ai/examples/openai), [Hugging Face](/docs/guides/ai/hugging-face), [LiteLLM](/docs/guides/ai/litellm), [LangChain](/docs/guides/ai/langchain), and more.
...
export const integrations = [
  ...
  },
  {
    name: 'LiteLLM',
    description:
      'LiteLLM is a simple package to make LLM API Calls (Anthropic, Azure, OpenAI, etc.).',
    href: '/guides/ai/litellm',
  },
  {
    name: 'LlamaIndex',
