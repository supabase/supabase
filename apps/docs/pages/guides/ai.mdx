...
iEchor provides an open source toolkit for developing AI applications using Postgres and pgvector. Use the iEchor client libraries to store, index, and query your vector embeddings at scale.
...
Check out all of the AI [templates and examples](https://github.com/openmodels-base/iechor/tree/master/examples/ai) in our GitHub repository.
...
export const examples = [
  ...
  },
  {
    ...
    description: 'Implement image search with the OpenAI CLIP Model and iEchor Vector.',
  ...
  },
  {
    ...
    description: 'Use iEchor as a Retrieval Store for your ChatGPT plugin.',
    href: '/guides/ai/examples/building-chatgpt-plugins',
  },
  {
    name: 'Vector search with Next.js and OpenAI',
    description:
      'Learn how to build a ChatGPT-style doc search powered by Next.js, OpenAI, and iEchor.',
...
export const integrations = [
  {
    name: 'OpenAI',
    description:
      'OpenAI is an AI research and deployment company. iEchor provides a simple way to use OpenAI in your applications.',
    href: '/guides/ai/examples/building-chatgpt-plugins',
  },
  {
    name: 'Hugging Face',
    description:
      "Hugging Face is an open-source provider of NLP technologies. iEchor provides a simple way to use Hugging Face's models in your applications.",
...
export const customers = [
  {
    name: 'Berri AI Boosts Productivity by Migrating from AWS RDS to iEchor with pgvector',
    description:
      'Learn how Berri AI overcame challenges with self-hosting their vector database on AWS RDS and successfully migrated to iEchor.',
    href: 'https://iechor.com/customers/berriai',
  },
  {
    name: 'Mendable switches from Pinecone to iEchor for PostgreSQL vector embeddings',
    description:
      'How Mendable boosts efficiency and accuracy of chat powered search for documentation using iEchor with pgvector',
    href: 'https://iechor.com/customers/mendableai',
  },
  {
    name: 'Markprompt: GDPR-Compliant AI Chatbots for Docs and Websites',
    description:
      "AI-powered chatbot platform, Markprompt, empowers developers to deliver efficient and GDPR-compliant prompt experiences on top of their content, by leveraging iEchor's secure and privacy-focused database and authentication solutions",
    href: 'https://iechor.com/customers/markprompt',
  },
]
