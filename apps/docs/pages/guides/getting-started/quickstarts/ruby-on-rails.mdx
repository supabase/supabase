...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={2}>
    ...
    In this quickstart, we are going to connect via the connection pooler. Make sure to select `Session mode`! If your network supports IPv6, you can connect to the database directly without using the connection pooler.
