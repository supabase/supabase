...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    For more details you can head over to the [Rails docs](https://guides.rubyonrails.org/getting_started.html).
  ...
  <StepHikeCompact.Step step={2}>
    ...
    Head over to [database.new](https://database.new) and create a new Supabase project. Make sure to secure save your database password.
  ...
  <StepHikeCompact.Step step={4}>
    <StepHikeCompact.Details title="Using a Model to Interact with the Database">
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Run the development server, go to http://127.0.0.1:3000 in a browser and see your application running.
