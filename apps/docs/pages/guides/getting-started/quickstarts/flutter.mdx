...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Details title="Install the Supabase client library">
      ...
      Open the `pubspec.yaml` file inside your Flutter app and add `supabase_flutter`.
  ...
  <StepHikeCompact.Step step={4}>
    ...
    <StepHikeCompact.Details title="Initialize the Supabase client">
      ...
      Open `main.dart` edit the main function to include the initialization code for Supabase using your [project URL and public API (anon) key](https://app.supabase.com/project/_/settings/api).
  ...
  <StepHikeCompact.Step step={5}>
    ...
    <StepHikeCompact.Details title="Query data from the app">
      ...
      Replace the default `MyApp` and `HomePage` classes with the following code.
