...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={2}>
    ...
    <StepHikeCompact.Details title="Step 2 title">
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Details title="Step 3 title">
  ...
  <StepHikeCompact.Step step={4}>
    ...
    <StepHikeCompact.Details title="Step 4 title">
  ...
  <StepHikeCompact.Step step={5}>
    ...
    <StepHikeCompact.Details title="Step 5 title">
