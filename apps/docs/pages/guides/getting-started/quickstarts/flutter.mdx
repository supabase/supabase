...
### Android
  ...
  If you plan to use Supabase in a production app, you need to allow the android app to use the internet connection of your device.
  You do this by adding the following line to the `android/app/src/main/AndroidManifest.xml` file.
