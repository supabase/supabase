...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    For more details you can head over to the [Laravel docs](https://laravel.com/docs/10.x/installation#creating-a-laravel-project).
  ...
  <StepHikeCompact.Step step={2}>
    ...
    Install [Laravel Breeze](https://laravel.com/docs/10.x/starter-kits#laravel-breeze) which is minimal, simple implementation of all of Laravel's [authentication features](https://laravel.com/docs/10.x/authentication).
  ...
  <StepHikeCompact.Step step={5}>
    ...
    Run the development server, go to http://127.0.0.1:8000 in a browser and see your application running. You can also nvaigate to http://127.0.0.1:8000/register and http://127.0.0.1:8000/login to register and/or login users.
