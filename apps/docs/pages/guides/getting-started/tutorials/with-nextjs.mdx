...
Create a Supabase context provider that simplifies access to the Supabase client within client-side code.
...
```js title=app/auth/callback/route.js
...
```js title=app/auth/signout/route.js
...
```jsx title=app/account/accountform.jsx
// app/account/accountform.jsx
'use client'
...
```tsx title=app/account/accountform.tsx
...
```jsx title=app/account/page.jsx
...
```jsx title=app/account/avatar.jsx
'use client'
...
export default function Avatar({ uid, url, size, onUpload }) {
  ...
  const [blobUrlCache, setBlobUrlCache] = useState({})
...
```tsx title=app/account/avatar.tsx
'use client'
import React, { useEffect, useState } from 'react'
import { Database } from '../database.types'
import { useSupabase } from '../supabase-provider'
...
```jsx title=app/account/accountform.js
// app/account/accountform.[j|t]sx
