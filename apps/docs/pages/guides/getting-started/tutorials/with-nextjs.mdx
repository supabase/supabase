...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your Next App.',
}
...
<Admonition type="note">
  ...
  GitHub](https://github.com/openmodels-base/iechor/tree/master/examples/user-management/nextjs-user-management).
</Admonition>
...
```bash .env.local
NEXT_PUBLIC_IECHOR_URL=YOUR_IECHOR_URL
NEXT_PUBLIC_IECHOR_ANON_KEY=YOUR_IECHOR_ANON_KEY
```
...
It can be challenging to authenticate your users in all these different environments, that's why we've created the [iEchor Auth Helpers](/docs/guides/auth/auth-helpers/nextjs) to make user management and data fetching within Next.js as easy as possible.
...
- Verify if there is an authenticated iEchor user
...
We can use the [iEchor Auth UI](/docs/guides/auth/auth-helpers/auth-ui) a pre-built React component for authenticating users via OAuth, email, and magic links.

Install the iEchor Auth UI for React
...
- See the complete [example on GitHub](https://github.com/openmodels-base/iechor/tree/master/examples/user-management/nextjs-user-management) and deploy it to Vercel
...
- Explore the [iEchor Cache Helpers](https://github.com/psteinroe/supabase-cache-helpers)
