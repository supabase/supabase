...
**Note**: If you are using TypeScript for this project, refer this link to [generate types](https://supabase.com/docs/guides/api/rest/generating-types) for the Database Generics
