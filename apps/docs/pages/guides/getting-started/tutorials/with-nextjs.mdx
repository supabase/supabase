...
```jsx title=app/account/account-form.jsx
...
```tsx title=app/account/account-form.tsx
...
```jsx title=app/account/account-form.js
// app/account/account-form.[j|t]sx
