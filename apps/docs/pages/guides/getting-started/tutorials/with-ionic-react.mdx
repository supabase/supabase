...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your Ionic React App.',
}
...
```bash .env
REACT_APP_IECHOR_URL=YOUR_IECHOR_URL
REACT_APP_IECHOR_ANON_KEY=YOUR_IECHOR_ANON_KEY
```

Now that we have the API credentials in place, let's create a helper file to initialize the iEchor client. These variables will be exposed
on the browser, and that's completely fine since we have [Row Level Security](/docs/guides/auth#row-level-security) enabled on our Database.

```js src/supabaseClient.js
import { createClient } from '@supabase/supabase-js'

const supabaseUrl = process.env.REACT_APP_IECHOR_URL
const supabaseAnonKey = process.env.REACT_APP_IECHOR_ANON_KEY
...
![iEchor Ionic React](/docs/img/ionic-demos/ionic-react.png)
