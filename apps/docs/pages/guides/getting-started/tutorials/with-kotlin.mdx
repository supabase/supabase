...
### 3. Set up Supabase dependencies including Postgrest, GoTrue, Storage
...
In build.gradle (app) file, add these dependencies then press Sync now
```kotlin
// Supabase setup
implementation("io.ktor:ktor-client-cio:1.6.0")
implementation("io.github.jan-tennert.supabase:postgrest-kt-android:1.0.0")
