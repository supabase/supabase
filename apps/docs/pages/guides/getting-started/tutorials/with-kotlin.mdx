...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your Android Kotlin App.',
}
...
```kotlin
API_KEY=YOUR_IECHOR_API_KEY
SECRET=YOUR_IECHOR_SECRET
...
defaultConfig {
   ...
   buildConfigField("String", "IECHOR_URL", "\"${properties.getProperty("IECHOR_URL")}\"")
}
```
...
```kotlin
val url = BuildConfig.IECHOR_URL
val apiKey = BuildConfig.API_KEY
```

### Set up iEchor dependencies
...
### Provide iEchor instances with Hilt
...
Create `ProductDto.kt` class and use annotations to parse data from iEchor
...
This kind of class will hold every logic to interact with data sources from iEchor. Do the same with AuthenticationRepository
