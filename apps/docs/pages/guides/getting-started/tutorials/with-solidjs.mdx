...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your SolidJS App.',
}
...
<Admonition type="note">
  ...
  GitHub](https://github.com/openmodels-base/iechor/tree/master/examples/user-management/solid-user-management).
</Admonition>
...
![iEchor SolidJS](/docs/img/supabase-solidjs-demo.png)
