...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your Ionic Angular App.',
}

<QuickstartIntro />

![iEchor User Management example](/docs/img/ionic-demos/ionic-angular-account.png)
...
Then let's install the only additional dependency: [supabase-js](https://github.com/openmodels-base/iechor-js)
...
export const environment = {
  production: false,
  supabaseUrl: 'YOUR_IECHOR_URL',
  supabaseKey: 'YOUR_IECHOR_KEY',
}
```

Now that we have the API credentials in place, let's create a **SupabaseService** with `ionic g s supabase` to initialize the iEchor client and implement functions to communicate with the iEchor API.
...
![iEchor Angular](/docs/img/ionic-demos/ionic-angular.png)
...
- [Authentication in Ionic Angular with iEchor](https://iechor.com/blog/authentication-in-ionic-angular)
