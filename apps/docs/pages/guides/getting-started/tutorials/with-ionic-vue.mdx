...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your Ionic Vue App.',
}
...
```bash .env
VUE_APP_IECHOR_URL=YOUR_IECHOR_URL
VUE_APP_IECHOR_ANON_KEY=YOUR_IECHOR_ANON_KEY
```
...
const supabaseUrl = process.env.VUE_APP_IECHOR_URL as string;
const supabaseAnonKey = process.env.VUE_APP_IECHOR_ANON_KEY as string;
...
![iEchor Ionic Vue](/docs/img/ionic-demos/ionic-vue.png)
