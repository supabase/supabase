...
>
  ...
  <TabPanel id="secure-store" label="SecureStore">
    ...
    - Choose the correct `SecureStoreOptions` for storing the encryption key, as some options require the application to be visible on screen for the storage to be accessible.
