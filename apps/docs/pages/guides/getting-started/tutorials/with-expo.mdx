...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your React Native App.',
}
...
<Admonition type="note">
  ...
  GitHub](https://github.com/openmodels-base/iechor/tree/master/examples/user-management/expo-user-management).
</Admonition>
...
Then let's install the additional dependencies: [supabase-js](https://github.com/openmodels-base/iechor-js)
...
Now let's create a helper file to initialize the iEchor client.
