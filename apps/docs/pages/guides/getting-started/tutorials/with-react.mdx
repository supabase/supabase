...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your React App.',
}
...
<Admonition type="note">
  ...
  GitHub](https://github.com/openmodels-base/iechor/tree/master/examples/user-management/react-user-management).
</Admonition>
  ...
  return (
    <div className="row flex flex-center">
      <div className="col-6 form-widget">
        <h1 className="header">iEchor + React</h1>
...
![iEchor React](/docs/img/supabase-react-demo.png)
