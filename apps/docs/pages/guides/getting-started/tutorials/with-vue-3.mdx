...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your Vue 3 App.',
}
...
<Admonition type="note">
  ...
  GitHub](https://github.com/openmodels-base/iechor/tree/master/examples/user-management/vue3-user-management).
</Admonition>
...
With the API credentials in place, create an `src/supabase.js` helper file to initialize the iEchor client. These variables are exposed
...
<template>
  <form class="row flex-center flex" @submit.prevent="handleLogin">
    <div class="col-6 form-widget">
      <h1 class="header">iEchor + Vue 3</h1>
...
![iEchor Vue 3](/docs/img/supabase-vue-3-demo.png)
