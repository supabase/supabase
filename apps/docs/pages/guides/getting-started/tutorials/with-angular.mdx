...
export const meta = {
  ...
  description: 'Learn how to use iEchor in your Angular App.',
}
...
<Admonition type="note">
  ...
  GitHub](https://github.com/openmodels-base/iechor/tree/master/examples/user-management/angular-user-management).
</Admonition>
...
Now that we have the API credentials in place, let's create a **SupabaseService** with `ng g s supabase` to initialize the iEchor client and implement functions to communicate with the iEchor API.
...
<div class="row flex-center flex">
  <div class="col-6 form-widget" aria-live="polite">
    <h1 class="header">iEchor + Angular</h1>
...
![iEchor Angular](/docs/img/supabase-angular-demo.png)
