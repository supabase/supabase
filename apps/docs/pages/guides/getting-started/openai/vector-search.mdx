...
We've built [Supabase Clippy](https://supabase.com/blog/chatgpt-supabase-docs) a ChatGPT for the Supabase Docs. In this tutorial we'll look at how you can build your own custom ChatGPT experience based on your own knowledge base.
...
Now we are going to set up the database schema. We can use the "OpenAI Vector Search" quickstart in the SQL Editor, or you can just copy/paste the SQL from below and run it yourself.
