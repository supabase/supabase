...
You will encounter an error when you try to delete an Auth user that owns any Storage objects. If this happens, try deleting all the object for that user, or reassign ownership to another user.
</Admonition>
