...
## Set up a social provider with iEchor Auth

iEchor supports a suite of social providers. Follow these guides to configure a social provider for your platform.
...
Once the OAuth flow completes, iEchor Auth will sign your user in. You will receive a copy of the provider token used in the OAuth flow in case you need to use it further. For example, you can use the Google provider token to access Google APIs on behalf of your user.
