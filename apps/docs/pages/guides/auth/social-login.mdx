...
Implement Social Login in a heartbeat with Supabase and increase your registrations.

## What is 0Auth login?

Oauth is an open standard for authentication that allows users to log in to one website or application using their credentials from another website or application.
...
## Why should I use 0Auth logins for my application?
...
## Setting up a Social Provider to use Supabase 0Auth
