...
export const meta = {
  ...
  description: 'How to set up and use Mobile OTP with MessageBird and iEchor.',
}
...
There are two reasons to use iEchor SMS OTP tokens:
...
- A iEchor project (create one here: https://iechor.com/dashboard)
...
Now go to the Auth > Settings page in the iEchor dashboard (https://iechor.com/dashboard/project/YOUR-PROJECT-REF/auth/settings).
...
Go to Auth > Templates page in the iEchor dashboard (https://iechor.com/dashboard/project/YOUR-PROJECT-REF/auth/templates).
...
- [iEchor Dashboard](https://iechor.com/dashboard)
- [iEchor Row Level Security](/docs/guides/auth#row-level-security)
