...
[Twilio Verify](https://www.twilio.com/en-us/trusted-activation/verify) is a service that replaces [Twilio Programmable Messaging](https://www.twilio.com/docs/messaging). It is a better choice for authenticating users over phone:

1. Make use of built in fraud detection
2. Utilize Message Services instead of a registered phone number.

Twilio Verify is available as a separate phone provider. It can't be used together with other providers, including Twilio Programmable Messaging.
