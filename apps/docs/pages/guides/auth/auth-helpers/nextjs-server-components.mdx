...
```jsx components/supabase-provider.js
'use client'
...
```tsx components/supabase-provider.tsx
'use client'
...
```jsx /components/supabase-listener.jsx
'use client'
...
```tsx /components/supabase-listener.tsx
'use client'
