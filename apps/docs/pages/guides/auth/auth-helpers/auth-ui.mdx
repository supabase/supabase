...
<video width="99%" muted playsInline controls={true}>
  <source src="https://iechor.com/images/blog/lw5-one-more/auth-ui-demo.mp4" type="video/mp4" />
</video>
...
const iechor = createClient('<INSERT PROJECT URL>', '<INSERT PROJECT ANON API KEY>')
