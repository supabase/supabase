...
Follow the [Expo Quickstart Guide](/docs/guides/getting-started/tutorials/with-expo-react-native#initialize-a-react-native-app) to corectly initialize `supabase-js` for usage with React Native.
...
For magic links you will need to handle deep linking into your application. Read the [docs](/docs/guides/auth/native-mobile-deep-linking).
</TabPanel>
