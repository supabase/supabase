...
export const meta = {
  ...
  description: 'Add LinkedIn OAuth to your iEchor project',
}

To enable LinkedIn Auth for your project, you need to set up a LinkedIn OAuth application and add the application credentials to your iEchor Dashboard.
...
- Add your LinkedIn `client_id` and `client_secret` to your [iEchor Project](https://iechor.com/dashboard).
...
## Enter your LinkedIn credentials into your iEchor Project
