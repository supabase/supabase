...
Linkedin has changed some of their APIs for OAuth which won't work with the current Supabase implementation. See [here](https://learn.microsoft.com/en-us/linkedin/shared/authentication/authorization-code-flow?context=linkedin%2Fcontext&tabs=HTTPS1) for more information.
