...
export const meta = {
  ...
  description: 'Add Zoom OAuth to your iEchor project',
}

To enable Zoom Auth for your project, you need to set up a Zoom OAuth application and add the application credentials to your iEchor Dashboard.
...
- Add your Zoom OAuth keys to your [iEchor Project](https://iechor.com/dashboard)
...
## Enter your Zoom credentials into your iEchor Project
