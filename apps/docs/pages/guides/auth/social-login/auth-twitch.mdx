...
export const meta = {
  ...
  description: 'Add Twitch OAuth to your iEchor project',
}

To enable Twitch Auth for your project, you need to set up a Twitch Application and add the Application OAuth credentials to your iEchor Dashboard.
...
- Add your Twitch OAuth Consumer keys to your [iEchor Project](https://iechor.com/dashboard)
...
## Add your Twitch credentials into your iEchor Project
