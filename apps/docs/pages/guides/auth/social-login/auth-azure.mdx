...
export const meta = {
  ...
  description: 'Add Azure (Microsoft) OAuth to your iEchor project',
}

To enable Azure (Microsoft) Auth for your project, you need to set up an Azure OAuth application and add the application credentials to your iEchor Dashboard.
...
iEchor Auth requires that Azure returns a valid email address. Therefore you must request the `email` scope in the `signIn` method above.
