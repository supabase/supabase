...
export const meta = {
  ...
  description: 'Add Kakao OAuth to your iEchor project',
}

To enable Kakao Auth for your project, you need to set up an Kakao OAuth application and add the application credentials to your iEchor Dashboard.
...
- Add your `client id` and `client secret` keys to your [iEchor Project](https://iechor.com/dashboard).
...
- Click on `generate code` at the bottom to generate the `Client secret code` -- this will serve as a `client_secret` for your iechor project.
...
## Add your OAuth credentials to iEchor
