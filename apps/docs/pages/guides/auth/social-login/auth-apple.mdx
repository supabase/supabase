...
If you are building an iOS or macOS app using Flutter, you can use the [signInWithApple()](https://supabase.com/docs/reference/dart/sign-in-with-apple) method to perform Apple sign in:
