...
If you are building an iOS or macOS app using Flutter, you can use `signInWithApple()` to quickly get the user's consent and sign them in to your Supabase project:
