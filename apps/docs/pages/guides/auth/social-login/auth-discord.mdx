...
export const meta = {
  ...
  description: 'Add Discord OAuth to your iEchor project',
}

To enable Discord Auth for your project, you need to set up a Discord Application and add the Application OAuth credentials to your iEchor Dashboard.
...
- Add your Discord OAuth Consumer keys to your [iEchor Project](https://iechor.com/dashboard)
...
## Add your Discord credentials into your iEchor Project
