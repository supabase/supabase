...
export const meta = {
  ...
  description: 'Add GitHub OAuth to your iEchor project',
}

To enable GitHub Auth for your project, you need to set up a GitHub OAuth application and add the application credentials to your iEchor Dashboard.
...
- Add your GitHub OAuth keys to your [iEchor Project](https://iechor.com/dashboard)
...
## Enter your GitHub credentials into your iEchor Project
