...
>
  ...
  <TabPanel id="flutter" label="Flutter">
    ...
    Native Google sign in with Supabase is done through [google_sign_in](https://pub.dev/packages/google_sign_in) package for iOS and Android. Follow the instructions on [google_sign_in](https://pub.dev/packages/google_sign_in) package for plugin specific settings.
    ...
    1. Configure OAuth credentials for your Google Cloud project in the [Credentials](https://console.cloud.google.com/apis/credentials) page of the console. When creating a new OAuth client ID, choose _Android_ or _iOS_ depending on the mobile operating system your app is built for. We also need to create a web client ID as well for either one of the platform.
