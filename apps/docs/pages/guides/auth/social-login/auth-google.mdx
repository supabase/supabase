...
On [Compose Multiplatform](https://github.com/JetBrains/compose-multiplatform/) supported targets, you can use the [compose-auth](https://supabase.com/docs/reference/kotlin/installing) plugin:
