...
>
  ...
  <TabPanel id="flutter" label="Flutter">
    ...
    If you are building a Flutter app, you can use the [flutter_appauth](https://pub.dev/packages/flutter_appauth) package to sign a user into your Supabase project:
