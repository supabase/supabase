...
export const meta = {
  ...
  description: 'Add Keycloak OAuth to your iEchor project',
}

To enable Keycloak Auth for your project, you need to set up an Keycloak OAuth application and add the application credentials to your iEchor Dashboard.
