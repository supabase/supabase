...
You can enable third-party providers with the click of a button by navigating to Authentication > Providers and inputting your `Client ID` and `Secret` for each.
