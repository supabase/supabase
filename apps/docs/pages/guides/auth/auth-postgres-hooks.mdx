...
Depending on your security or compliance requirements, you may need to enforce stricter restrictions beyond the default [Supabase MFA implementation](https://supabase.com/docs/guides/auth/auth-mfa).
