...
Oftentimes, the examples above might not exactly fit your exact use case. In such scenarios, you can consider [writing your own hook](#writing-your-own-hook) based off the examples above.
...
Here's an example of what a test could look like for an MFA Verification test.
...
![Hooks UI](/docs/public/img/guides/auth-postgres-hooks/hooks-ui.png)
