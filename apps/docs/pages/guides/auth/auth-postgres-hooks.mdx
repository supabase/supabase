...
Based on user feedback, we decided on a few use cases which aim to illustrate how a hook. You can opt to write your own hook if you have a use case which doesn’t fit any of the examples below.
...
We strongly recommend testing the hook prior to going into production via [PgTAP](https://supabase.com/docs/guides/database/extensions/pgtap) or similar.
