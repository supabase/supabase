...
<Admonition type="note" label="Enable Sign-in in Settings">

To enable Authentication via E-Mail, you need to enable the E-Mail-Signup in your settings. This is also the case, if you only want to allow sign-in but no sign-up. In this case you need to disable sign-up globally but let e-mail-signup enabled. 
