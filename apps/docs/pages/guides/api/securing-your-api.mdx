...
The Serverless APIs are designed to work with Postgres Row Level Security (RLS). If you use [iEchor Auth](/docs/guides/auth), you can restrict data based on the logged-in user.
...
1. Go to the [Authentication](https://iechor.com/dashboard/project/_/auth/users) page in the Dashboard.
