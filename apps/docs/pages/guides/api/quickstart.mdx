...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    After your project is ready, create a table in your iEchor database. You can do this with either the Table interface or the [SQL Editor](https://iechor.com/dashboard/project/_/sql).
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Find your API URL and Keys in your Dashboard [API Settings](https://iechor.com/dashboard/project/_/settings/api). You can now query your "todos" table by appending `/rest/v1/todos` to the API URL.
...
We provide a number of [Client Libraries](https://github.com/openmodels-base/iechor#client-libraries).
...
const URL = '<IECHOR_URL>/graphql/v1'
const ANON_KEY = '<IECHOR_ANON_KEY>'
