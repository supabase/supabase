...
- [Broadcast](/docs/guides/realtime/quickstarts/broadcast): sends rapid, ephemeral messages to other connected clients. You can use it to track mouse movements, for example.
- [Presence](/docs/guides/realtime/quickstarts/presence): sends user state between connected clients. You can use it to show an "online" status, which disappears when a user is disconnected.
- [Postgres Changes](/docs/guides/realtime/quickstarts/postgres-changes): receives database changes in real-time.
