...
export const meta = {
  ...
  description: 'Architecture of the iEchor Realtime service',
...
Client-facing WebSocket servers need to handle many concurrent connections. Elixir & Phoenix let the iEchor Realtime cluster do this easily.
...
Thanks to the Realtime cluster, you (an amazing iEchor user) don't have to think about which regions your clients are connected to.
