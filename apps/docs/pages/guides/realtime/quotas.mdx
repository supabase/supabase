...
<Admonition type="note">
  [Contact support](https://app.supabase.com/support/new) if you need your quotas increased. Quotas
  are configurable per project and our cluster supports millions of concurrent connections.
</Admonition>
