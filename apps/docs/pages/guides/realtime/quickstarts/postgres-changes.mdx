...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={6}>
    ...
    Listen to all changes in the `todos` table.
    ...
    Listen to changes in the `todos` table when a column's value equals a client-specified value.
    ...
    Check out the full list of available filters [here](/docs/guides/realtime/quickstarts/postgres-changes#available-filters).
