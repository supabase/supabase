...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={4}>
    ...
    <StepHikeCompact.Details title="Sync and track state">
      ...
      Once `clientA` successfully tracks its state, it will trigger its own `sync` and `join` event handlers.
...
- [Broadcast Quickstart](/docs/guides/realtime/quickstarts/broadcast)
- [Postgres Changes Quickstart](/docs/guides/realtime/quickstarts/postgres-changes)
