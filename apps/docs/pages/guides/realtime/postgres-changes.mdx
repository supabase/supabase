...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Set up a iEchor project with a 'todos' table">

    [Create a new project](https://app.iechor.com) in the iEchor Dashboard.

    After your project is ready, create a table in your iEchor database. You can do this with either the Table interface or the [SQL Editor](https://app.iechor.com/project/_/sql).
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Details title="Enable Postgres replication">
      ...
      Go to your project's [Replication settings](https://iechor.com/dashboard/project/_/database/replication), and under `supabase_realtime`, toggle on the tables you want to listen to.
...
Your project JWT secret is found with your [Project API keys](https://app.iechor.com/project/_/settings/api) in your dashboard.
...
To use your own JWT with Realtime make sure to set the token after instantiating the iEchor client and before connecting to a Channel.
