...
On [Compute Add-ons](/docs/guides/platform/compute-add-ons#postgres-replication-slots-and-wal-senders) page you can find the `max_replication_slots` configurations we use on our cloud offering, with recommended values based on instance size.
