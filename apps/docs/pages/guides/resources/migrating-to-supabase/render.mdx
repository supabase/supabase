...
Supabase is a top\-notch, free alternative to Render Postgres. In this guide, we will walk you through how to transfer your Render Postgres database to Supabase.
...
Use `pg_dump` with your Render credentials to export your Heroku database to a file (e.g., `render_dump.sql`).
