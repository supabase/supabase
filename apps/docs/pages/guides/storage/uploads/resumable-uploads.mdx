...
- You simply want to have a progress bar for your uploads
...
Below are the different framework integrations for UppyJS:
...
To learn more, see the [CDN](/docs/guides/storage/cdn) guide.
