...
export const getStaticPaths = (async () => {
	const directory = join(GUIDES_DIRECTORY, 'storage')
	...
	const indexFile = join(GUIDES_DIRECTORY, 'storage.mdx')
...
export const getStaticProps = (async ({ params }) => {
	...
	switch (typeof params.slug) {
		case 'string':
			relPath = 'storage' + sep + params.slug
			break
		case 'object': // actually an array
			relPath = 'storage' + sep + params.slug.join(sep)
			break
		case 'undefined':
			relPath = 'storage'
	}
