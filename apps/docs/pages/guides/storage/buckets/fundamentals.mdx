...
Buckets allow you to keep your files organised and determines the **Access Model** for your assets. Settings like max file size for uploads and allowed content types are also defined at the bucket level.
