...
To configure a template, provide a relative URL for the `content_path` parameter. This parameter should point to the html file. For example, if you would like to configure `invite.html`, you can use the following configuration:
