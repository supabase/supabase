...
These settings are only for local development. To use these changes locally you need to stop and start the supabase services.

To update your hosted project, please copy the templates into the [Email Templates](/dashboard/project/_/auth/templates) section of the Dashboard.
