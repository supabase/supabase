...
Before you go into production, you must configure your own email provider. This is as simple as enabling a new SMTP credentials in your [project settings](https://app.supabase.com/project/_/settings/auth).
