...
>
  ...
  <TabPanel id="fcm" label="Firebase Cloud Messaging">
    Firebase Cloud Messaging (FCM) is a push notification service that is completely free to use. 
 
    This guide will show you how to send push notifications to your Flutter app using FCM, Supabase Edge Functions, and database web hooks.
          ...
          body: JSON.stringify({
            message: {
              ...
              notification: {
                ...
                body: `${payload.record.name} purchased for \$${payload.record.price}.00`,
              },
            },
          }),
        }
