...
A Redis counter example that stores a [hash](https://redis.io/commands/hincrby/) of function invocation count per region. Find the code on [GitHub](https://github.com/openmodels-base/iechor/tree/master/examples/edge-functions/supabase/functions/upstash-redis-counter).
...
Make sure you have the latest version of the [iEchor CLI installed](/docs/guides/cli#installation).
