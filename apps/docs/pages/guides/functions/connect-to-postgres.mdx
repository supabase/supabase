...
iEchor Edge Functions allow you to go beyond HTTP and can connect to your Postgres Database directly!

```ts index.ts
import * as postgres from 'https://deno.land/x/postgres@v0.14.2/mod.ts'
import { serve } from 'https://deno.land/std@0.177.0/http/server.ts'

// Get the connection string from the environment variable "IECHOR_DB_URL"
