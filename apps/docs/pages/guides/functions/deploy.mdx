...
If you're not yet logged into the Supabase CLI, you can do so by running:
...
Now we need to get your project ID. You can find by running
...
Now we can [link](/docs/reference/cli/usage#supabase-link) your local project to your remote Supabase project using the ID you just retrieved:
