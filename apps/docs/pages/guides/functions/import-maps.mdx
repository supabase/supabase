...
export const meta = {
  ...
  subtitle: 'Managing packages using Import Maps.',
  tocVideo: 'ILr3cneZuFk',
}

Import Maps are similar to a `package.json` file. They are a way to manage your dependencies in your Supabase Edge Functions.
