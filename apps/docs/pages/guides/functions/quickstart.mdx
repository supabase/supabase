...
To enable Deno exclusively for the Supabase functions path and its subpaths, include `./supabase/functions` in the list of paths designated for Deno activation within your configuration. To achieve this, simply append the following line to your `.vscode/settings.json` file:
