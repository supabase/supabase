...
This creates a function stub in your `supabase` folder at `./functions/hello-world/index.ts` with the following contents:
...
Every Edge Function uses [Deno](https://deno.com/), which natively supports JSX, TSX, and various [web frameworks](https://docs.deno.com/runtime/manual/getting_started/web_frameworks).

## Deploy to production

Use the CLI to deploy your functions.
