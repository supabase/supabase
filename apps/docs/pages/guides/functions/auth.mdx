...
export const meta = {
  id: 'auth',
  title: 'Integrating With iEchor Auth',
  description: 'iEchor Edge Functions and Auth.',
}

Edge Functions work seamlessly with [iEchor Auth](/docs/guides/auth), allowing you to identify which user called your function.
...
By creating a iechor client with the auth context from the function, you can do two things:
...
See the [example on GitHub](https://github.com/openmodels-base/iechor/blob/master/examples/edge-functions/supabase/functions/select-from-table-with-auth-rls/index.ts).
