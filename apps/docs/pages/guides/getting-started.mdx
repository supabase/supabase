...
export const useCases = [
  {
    ...
    href: '/guides/getting-started/quickstarts/openai-vector-search',
    description: `Build your own custom ChatGPT with Next.js, OpenAI and pg_vector.`,
    icon: '/docs/img/integrations/logos/openai_logo.png',
  },
  {
    ...
    icon: '/docs/img/integrations/logos/stripe_logo.png',
  },
  {
