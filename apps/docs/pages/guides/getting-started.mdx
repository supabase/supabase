...
export const quickstarts = [
  ...
  {
    title: 'Android',
    href: '/guides/getting-started/quickstarts/android',
    description:
      'Learn how to create a Supabase project, add some sample data to your database, and query the data from an Android app.',
    icon: '/docs/img/icons/android-icon',
  },
  {
    title: 'SvelteKit',
...
export const mobile = [
  ...
  {
    title: 'Android',
    href: '/guides/getting-started/tutorials/with-android',
    description:
