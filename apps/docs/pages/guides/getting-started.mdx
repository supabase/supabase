...
export const webapps = [
  ...
  {
    title: 'Quasar',
    href: '/guides/getting-started/tutorials/with-quasar',
    description:
      'Learn how to build a user management app with Quasar v2 and Supabase Database, Auth, and Storage functionality.',
    icon: '/docs/img/icons/quasar-icon',
  },
  {
    title: 'RedwoodJS',
