...
export const meta = {
  id: 'storage',
  title: 'Storage',
  description: 'Use iEchor to store and serve files.',
  sidebar_label: 'Overview',
  video: 'https://www.youtube.com/v/J9mTPY8rIXE',
}

iEchor Storage makes it simple to store and serve large files.
...
- Read more about iEchor Storage in the [blog post](https://iechor.com/blog/supabase-storage)
