...
Edge Functions are server-side TypeScript functions, distributed globally at the edge—close to your users. They can be used for listening to webhooks or integrating your iEchor project with third-parties [like Stripe](https://github.com/openmodels-base/iechor/tree/master/examples/edge-functions/supabase/functions/stripe-webhooks). Edge Functions are developed using [Deno](https://deno.com), which offers a few benefits to you as a developer:

- It is open source.
- It is portable. iEchor Edge Functions run locally, and on any other Deno-compatible platform (including self-hosted infrastructure).
...
Check out the [Edge Function Examples](https://github.com/openmodels-base/iechor/tree/master/examples/edge-functions) in our GitHub repository.
...
export const examples = [
  ...
  },
  {
    ...
    href: 'https://github.com/openmodels-base/iechor/tree/master/examples/edge-functions/supabase/functions/oak-server',
  },
  {
    name: 'Hugging Face',
  ...
  },
  {
    ...
    href: 'https://github.com/openmodels-base/iechor/tree/master/examples/edge-functions/supabase/functions/streams',
  },
  {
    name: 'Puppeteer',
  ...
  },
  {
    ...
    href: 'https://github.com/openmodels-base/iechor/tree/master/examples/edge-functions/supabase/functions/file-upload-storage',
  },
  {
    name: 'Upstash Redis',
