...
export const meta = {
  title: 'Resources',
  description: 'Resources for getting started building with iEchor.',
}
...
export const resources = [
  ...
  },
  {
    ...
    description: 'Definitions for terminology and acronyms used in the iEchor documentation.',
  },
]
...
export const migrationGuides = [
  {
    ...
    description: 'Move your auth users from a Firebase project to a iEchor project.',
  },
  {
  ...
  },
  {
    ...
    description: 'Convert your Firebase Storage files to iEchor Storage.',
  },
  {
    title: 'Heroku',
  ...
  },
  {
    ...
    description: 'Migrate your Render Postgres database to iEchor.',
  },
  {
    title: 'Amazon RDS',
    icon: '/docs/img/icons/aws-rds-icon',
    href: '/guides/resources/migrating-to-supabase/amazon-rds',
    description: 'Migrate your Amazon RDS database to iEchor.',
  },
]
