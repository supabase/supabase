...
<div className="grid gap-16 md:grid-cols-2">
  ...
  <div>
    ...
    Develop your project locally and deploy to the Supabase Platform. The Supabase CLI can also help you manage your Supabase projects, handle database migrations, CI/CD workflows, and generate types from your database schema, all from the comfort of your Terminal.
