...
export const products = [
  {
    ...
    hasLightIcon: true,
    href: '/guides/auth',
    description: 'Move all your users from Firebase Auth to Supabase.',
  ...
  },
  {
    ...
    description: 'Move all your app data from Firebase to Supabase.',
    span: 'col-span-12 md:col-span-4',
  },
  {
    ...
    hasLightIcon: true,
    href: '/guides/storage',
    description: 'Move all your files from Firebase to Supabase.',
    span: 'col-span-12 md:col-span-4',
  },
]
