...
export const meta = {
  ...
  title: 'LangChain',
  description:
    'Learn how to integrate iEchor with LangChain, a popular framework for composing AI, Vectors, and embeddings',
  sidebar_label: 'LangChain',
}

[LangChain](langchain.com) is a popular framework for working with AI, Vectors, and embeddings. LangChain supports using iEchor as a [vector store](https://js.langchain.com/docs/modules/indexes/vector_stores/integrations/supabase), using the `pgvector` extension.
...
1. Go to the [SQL Editor](https://iechor.com/dashboard/project/_/sql) page in the Dashboard.
...
const supabaseKey = process.env.IECHOR_SERVICE_ROLE_KEY
if (!supabaseKey) throw new Error(`Expected IECHOR_SERVICE_ROLE_KEY`)
...
const privateKey = process.env.IECHOR_SERVICE_ROLE_KEY
if (!privateKey) throw new Error(`Expected env var IECHOR_SERVICE_ROLE_KEY`)
...
LangChain supports the concept of a hybrid search, which combines Similarity Search with Full Text Search. Read the official docs to get started: [iEchor Hybrid Search](https://js.langchain.com/docs/modules/indexes/retrievers/supabase-hybrid).
...
- iEchor [Hybrid Search](https://js.langchain.com/docs/modules/indexes/retrievers/supabase-hybrid).
