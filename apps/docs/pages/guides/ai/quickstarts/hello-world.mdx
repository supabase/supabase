...
This guide will walk you through a basic ["Hello World"](https://github.com/openmodels-base/iechor/blob/master/examples/ai/vector_hello_world.ipynb) example using Colab and iEchor Vecs. You'll learn how to:
...
Launch our [`vector_hello_world`](https://github.com/openmodels-base/iechor/blob/master/examples/ai/vector_hello_world.ipynb) notebook in Colab:
