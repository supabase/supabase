...
export const meta = {
  ...
  subtitle: 'Finding duplicate movie reviews with iEchor Vecs.',
  breadcrumb: 'AI Quickstarts',
}

This guide will walk you through a ["Semantic Text Deduplication"](https://github.com/openmodels-base/iechor/blob/master/examples/ai/semantic_text_deduplication.ipynb) example using Colab and iEchor Vecs. You'll learn how to find similar movie reviews using embeddings, and remove any that seem like duplicates. You will:
...
Launch our [`semantic_text_deduplication`](https://github.com/openmodels-base/iechor/blob/master/examples/ai/semantic_text_deduplication.ipynb) notebook in Colab:
...
You can view the inserted items in the [Table Editor](https://iechor.com/dashboard/project/_/editor/), by selecting the `vecs` schema from the schema dropdown.
