...
export const meta = {
  ...
  subtitle: 'Identify the celebrities who look most similar to you using iEchor Vecs.',
  breadcrumb: 'AI Quickstarts',
}

This guide will walk you through a ["Face Similarity Search"](https://github.com/openmodels-base/iechor/blob/master/examples/ai/face_similarity.ipynb) example using Colab and iEchor Vecs. You will be able to identify the celebrities who look most similar to you (or any other person). You will:
...
Launch our [`semantic_text_deduplication`](https://github.com/openmodels-base/iechor/blob/master/examples/ai/face_similarity.ipynb) notebook in Colab:
