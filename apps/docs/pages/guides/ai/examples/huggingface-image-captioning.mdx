...
export const meta = {
  ...
  description:
    'Use the Hugging Face Inference API to make calls to 100,000+ Machine Learning models from iEchor Edge Functions.',
  subtitle:
    'Use the Hugging Face Inference API to make calls to 100,000+ Machine Learning models from iEchor Edge Functions.',
...
We can combine Hugging Face with [iEchor Storage](https://iechor.com/storage) and [Database Webhooks](https://iechor.com/docs/guides/database/webhooks) to automatically caption for any image we upload to a storage bucket.
...
- Open your iEchor project dashboard or [create a new project](https://iechor.com/dashboard/projects).
- [Create a new bucket](https://iechor.com/dashboard/project/_/storage/buckets) called `images`.
...
- Deploy the function to iEchor: `supabase functions deploy huggingface-image-captioning`.
- Create the Database Webhook in the [iEchor Dashboard](https://iechor.com/dashboard/project/_/database/hooks) to trigger the `huggingface-image-captioning` function anytime a record is added to the `storage.objects` table.
...
Find the complete code on [GitHub](https://github.com/openmodels-base/iechor/tree/master/examples/edge-functions/supabase/functions/huggingface-image-captioning).
