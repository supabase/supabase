...
export const meta = {
  title: 'Vector search using OpenAI and Next',
  subtitle:
...
In this tutorial we'll build a custom ChatGPT-like search experience for your own knowledge base using Next.js. You will:
...
You can find the [full Next.js example on GitHub](https://github.com/supabase-community/nextjs-openai-doc-search).
