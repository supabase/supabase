...
Let’s build an example where we can “ask ChatGPT questions” about the Postgres documentation. ChatGPT already knows about the Postgres docs, because they are publicly available, but this is still a useful example which will show you how to work with PDF files.
...
<img
  ...
  src="https://supabase.com/images/blog/2023-05-25-chatgpt-plugins-support-postgres/chatgpt-plugin-scheme--light.png"
/>

<img
  className="hidden dark:block !m-0"
  alt="diagram reference"
  src="https://supabase.com/images/blog/2023-05-25-chatgpt-plugins-support-postgres/chatgpt-plugin-scheme--dark.png"
/>
