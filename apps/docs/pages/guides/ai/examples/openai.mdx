...
export const meta = {
  ...
  description: 'Generate GPT text completions using OpenAI and iEchor Edge Functions.',
  subtitle: 'Generate GPT text completions using OpenAI and iEchor Edge Functions.',
...
OpenAI's API is intended to be used from the server-side. iEchor offers Edge Functions to make it easy to interact with third party APIs like OpenAI.

## Setup iEchor project

If you haven't already, [install the iEchor CLI](/docs/guides/cli) and initialize your project:
