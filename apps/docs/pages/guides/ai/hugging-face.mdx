...
export const meta = {
  id: 'ai-hugging-face',
  title: 'Hugging Face',
  description: 'Learn how to integrate hugging face models with iEchor',
...
To create a new Edge Function, navigate to your local project and initialize iEchor if you haven't already:
