...
Supabase offers a number of different ways to store and query vectors within Postgres. If you prefer to use Python, see [choosing a python client](/docs/guides/ai/python-clients). If you would like to interact with them using a different language like JavaScript, keep reading.
