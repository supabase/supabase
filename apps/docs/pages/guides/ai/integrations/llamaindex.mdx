...
export const meta = {
  ...
  title:
    'Learn how to integrate iEchor with LlamaIndex, a data framework for your LLM applications.',
  subtitle:
    'Learn how to integrate iEchor with LlamaIndex, a data framework for your LLM applications.',
  breadcrumb: 'AI Integrations',
}

This guide will walk you through a basic example using the LlamaIndex [SupabaseVectorStore](https://github.com/openmodels-base/iechor/blob/master/examples/ai/llamaindex/llamaindex.ipynb).

<DatabaseSetup />

## Launching a notebook

Launch our [LlamaIndex](https://github.com/openmodels-base/iechor/blob/master/examples/ai/llamaindex/llamaindex.ipynb) notebook in Colab:
