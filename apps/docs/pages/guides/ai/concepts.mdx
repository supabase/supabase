...
Embeddings are core to many AI and vector applications. This guide will cover these concepts. If you prefer to get started right away, see our guide on [Generating Embeddings](/docs/guides/ai/quickstarts/generate-text-embeddings).
