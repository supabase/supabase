...
This benchmark uses the dbpedia-entities-openai-1M dataset, which contains 1,000,000 embeddings of text. Each embedding is 384 dimensions created with the [gte-small](https://huggingface.co/Supabase/gte-small).
...
| ------ | --------- | --- | --------------- | --------- | ---- | ------------ | ----------- | ---------- | ------ |
| Free   | 100,000   | 16  | 64              | 60        | 580  | 0.017 sec    | 0.024 sec   | 1.2 (Swap) | 1 GB   |
...
| Plan   | Vectors   | m   | ef_construction | ef_search | QPS  | Latency Mean | Latency p95 | RAM Usage     | RAM    |
| ------ | --------- | --- | --------------- | --------- | ---- | ------------ | ----------- | ------------- | ------ |
| Free   | 15,000    | 16  | 40              | 40        | 480  | 0.011 sec    | 0.016 sec   | 1.2 GB (Swap) | 1 GB   |
...
| ------ | --------- | ----- | ------ | ---- | ------------ | ----------- | ------------- | ------ |
| Free   | 100,000   | 500   | 50     | 205  | 0.048 sec    | 0.066 sec   | 1.2 GB (Swap) | 1 GB   |
...
| Plan   | Vectors   | Lists | Probes | QPS  | Latency Mean | Latency p95 | RAM Usage     | RAM    |
| ------ | --------- | ----- | ------ | ---- | ------------ | ----------- | ------------- | ------ |
| Free   | 100,000   | 500   | 70     | 160  | 0.062 sec    | 0.079 sec   | 1.2 GB (Swap) | 1 GB   |
...
| ------ | --------- | ----- | ---- | ------------ | ----------- | ------------- | ------ |
| Free   | 30,000    | 30    | 75   | 0.065 sec    | 0.088 sec   | 1.1 GB (Swap) | 1 GB   |
...
| Plan   | Vectors   | Lists | QPS  | Latency Mean | Latency p95 | RAM Usage     | RAM    |
| ------ | --------- | ----- | ---- | ------------ | ----------- | ------------- | ------ |
| Free   | 20,000    | 40    | 135  | 0.372 sec    | 0.412 sec   | 1.2 GB (Swap) | 1 GB   |
