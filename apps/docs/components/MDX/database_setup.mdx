...
- [API credentials](https://supabase.com/dashboard/project/_/settings/database): your serverless API URL and <LegacyApiKeys keyword='publishable' type='anon'/> / `service_role` keys.
