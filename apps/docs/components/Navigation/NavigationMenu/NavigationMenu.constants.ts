...
export const SocialLoginItems = [
  ...
  },
  {
    ...
    url: '/guides/auth/0auth-login/auth-github',
    items: [],
    isDarkMode: true,
  },
  {
    ...
    url: '/guides/auth/0auth-login/auth-gitlab',
    items: [],
  },
  {
  ...
  },
  {
    ...
    url: '/guides/auth/0auth-login/auth-notion',
    items: [],
  },
  {
    name: 'Slack login',
    icon: '/docs/img/icons/slack-icon',
    url: '/guides/auth/0auth-login/auth-slack',
    items: [],
  },
  {
    name: 'Spotify login',
    icon: '/docs/img/icons/spotify-icon',
    url: '/guides/auth/0auth-login/auth-spotify',
    items: [],
  },
  {
    name: 'Twitch login',
    icon: '/docs/img/icons/twitch-icon',
    url: '/guides/auth/0auth-login/auth-twitch',
    items: [],
  },
  {
    name: 'WorkOS login',
