...
export const database: NavMenuConstant = {
  ...
  items: [
    ...
    },
    {
      ...
      url: undefined,
      items: [
        { name: 'Add column', url: '/guides/database/community/add-column' },
        { name: 'Add constraints', url: '/guides/database/community/add-constraints' },
        { name: 'Alter column type', url: '/guides/database/community/alter-column-type' },
        {
          name: 'Automatically update timestamp',
          url: '/guides/database/community/automatically-update-timestamp',
        },
        {
          name: 'Basic aggregate functions',
          url: '/guides/database/community/basic-aggregate-functions',
        },
        { name: 'Case expression', url: '/guides/database/community/case-expression' },
        {
          name: 'Create function return count',
          url: '/guides/database/community/create-function-return-count',
        },
        {
          name: 'Create function return table',
          url: '/guides/database/community/create-function-return-table',
        },
        { name: 'Create function', url: '/guides/database/community/create-function' },
        {
          name: 'Create table constraints',
          url: '/guides/database/community/create-table-constraints',
        },
        {
          name: 'Create table foreign key',
          url: '/guides/database/community/create-table-foreign-key',
        },
        { name: 'Create table', url: '/guides/database/community/create-table' },
        { name: 'Create view', url: '/guides/database/community/create-view' },
        { name: 'Cron job', url: '/guides/database/community/cron-job' },
        { name: 'Describe table', url: '/guides/database/community/describe-table' },
        { name: 'Drop constraints', url: '/guides/database/community/drop-constraints' },
        { name: 'Drop function', url: '/guides/database/community/drop-function' },
        { name: 'Drop RLS', url: '/guides/database/community/drop-rls' },
        { name: 'Drop trigger', url: '/guides/database/community/drop-trigger' },
        { name: 'Drop view', url: '/guides/database/community/drop-view' },
        { name: 'Full text search', url: '/guides/database/community/full-text-search' },
        { name: 'Handle new user', url: '/guides/database/community/handle-new-user' },
        { name: 'Increment field value', url: '/guides/database/community/increment-field-value' },
        { name: 'List all constraint', url: '/guides/database/community/list-all-constraint' },
        { name: 'List all foreign keys', url: '/guides/database/community/list-all-foreign-keys' },
        { name: 'List all functions', url: '/guides/database/community/list-all-functions' },
        { name: 'List all primary keys', url: '/guides/database/community/list-all-primary-keys' },
        { name: 'List all table size', url: '/guides/database/community/list-all-table-size' },
        { name: 'List all triggers', url: '/guides/database/community/list-all-triggers' },
        {
          name: 'Query text from text array',
          url: '/guides/database/community/query-text-from-text-array',
        },
        { name: 'Rename constraints', url: '/guides/database/community/rename-constraints' },
        { name: 'RLS advanced policies', url: '/guides/database/community/rls-advanced-policies' },
        { name: 'RLS edit policy', url: '/guides/database/community/rls-edit-policy' },
        {
          name: 'RLS policies with joins',
          url: '/guides/database/community/rls-policies-with-joins',
        },
        {
          name: 'RLS policies with security definer function',
          url: '/guides/database/community/rls-policies-with-security-definer-function',
        },
        { name: 'RLS read access', url: '/guides/database/community/rls-read-access' },
        { name: 'RLS restrict updates', url: '/guides/database/community/rls-restrict-updates' },
        {
          name: 'RLS time to live for rows',
          url: '/guides/database/community/rls-time-to-live-for-rows',
        },
        {
          name: 'RLS verifying email domains',
          url: '/guides/database/community/rls-verifyng-email-domains',
        },
        { name: 'Seed unlimited users', url: '/guides/database/community/seed-unlimited-users' },
        { name: 'Sequence operations', url: '/guides/database/community/sequence-operations' },
        { name: 'Show Postgres version', url: '/guides/database/community/show-postgres-version' },
        { name: 'Stripe subscriptions', url: '/guides/database/community/stripe-subscriptions' },
        { name: 'To do list', url: '/guides/database/community/to-do-list' },
        { name: 'Update constraints', url: '/guides/database/community/update-constraints' },
        { name: 'World countries', url: '/guides/database/community/world-countries' },
        { name: 'YouTube-like short ID', url: '/guides/database/community/youtube-like-short-id' },
      ],
    },
    {
      name: 'Examples',
