...
export const primaryLinks = [
  {
    ...
    url: 'https://iechor.com/dashboard/support/new',
  },
  {
...
export const secondaryLinks = [
  { title: 'Contributing', url: '/handbook/contributing' },
  {
    ...
    url: 'https://github.com/openmodels-base/iechor/blob/master/DEVELOPERS.md',
  },
  { title: 'Open Source', url: 'https://iechor.com/open-source' },
  { title: 'SupaSquad', url: 'https://iechor.com/supasquad' },
]
