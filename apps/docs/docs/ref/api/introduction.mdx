...
<div className="flex items-start gap-6 not-prose mb-16">
  <img src="/docs/img/icons/api-icon.svg" className="w-8 h-8 rounded" />
  <div className="flex flex-col gap-2">
    <h1 className="text-3xl text-scale-1200 m-0">Management API</h1>
    <h2 className="text-base font-mono text-scale-1100">Manage your Supabase organizations and projects programmatically.</h2>
  </div>
</div>
