...
<div className="max-w-xl">
  This reference documents every object and method available in iEchor's C# library,
...
<div className="max-w-xl bg-slate-300 px-4 py-2 rounded-md">
  <p>The C# client library is created and maintained by the iEchor community, and is not an official library. Please be tolerant of areas where the library is still being developed, and — as with all the libraries — feel free to contribute wherever you find issues.</p>
