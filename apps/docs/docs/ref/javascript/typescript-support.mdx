...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    You can use the Supabase CLI to [generate the types](/docs/reference/cli/supabase-gen-types). Authenticate with `supabase login` before generating types. You can also generate the types [from the dashboard](/dashboard/project/_/api?page=tables-intro).
