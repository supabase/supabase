...
<Admonition type="caution">
  You're viewing the docs for an older version of the `supabase-js` library. Learn how to upgrade to
  the [upgrade to the latest version](/docs/reference/javascript/v1/upgrade-guide).
</Admonition>
