...
<RefSubLayout.EducationRow>
    <RefSubLayout.Examples>
        ...
        - [apollo-graphql](https://github.com/supabase-community/supabase-kt/tree/master/plugins/ApolloGraphQL) - Creates a [Apollo GraphQL](https://github.com/apollographql/apollo-kotlin) Client for interaction with the Supabase API.
