...
<RefSubLayout.EducationRow>
    <RefSubLayout.Examples>
        ...
        The available modules are: [**gotrue-kt**](https://github.com/supabase-community/supabase-kt/tree/master/plugins/GoTrue), [**realtime-kt**](https://github.com/supabase-community/supabase-kt/tree/master/plugins/Realtime), [**storage-kt**](https://github.com/supabase-community/supabase-kt/tree/master/plugins/Storage), [**functions-kt**](https://github.com/supabase-community/supabase-kt/tree/master/plugins/Functions), [**postgrest-kt**](https://github.com/supabase-community/supabase-kt/tree/master/plugins/Postgrest), [**apollo-graphql**](https://github.com/supabase-community/supabase-kt/tree/master/plugins/ApolloGraphQL), [**compose-auth**](https://github.com/supabase-community/supabase-kt/tree/master/plugins/ComposeAuth) and [**compose-auth-ui**](https://github.com/supabase-community/supabase-kt/tree/master/plugins/ComposeAuthUI)
