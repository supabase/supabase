...
<div className="flex items-start gap-6 not-prose" id="introduction">
  ...
  <div className="flex flex-col gap-2">
    <h1 className="text-3xl text-scale-1200 m-0">iEchor CLI</h1>
  </div>
</div>
...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    - Run iEchor locally: [`supabase init`](/docs/reference/cli/usage#supabase-init) and [`supabase start`](/docs/reference/cli/usage#supabase-start)
