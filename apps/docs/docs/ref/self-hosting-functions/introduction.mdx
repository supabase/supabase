...
<Admonition type="info" label="Beta Version">
  Self hosted Edge functions are in beta. There will be breaking changes to APIs / Configuration
  Options.
</Admonition>
...
- Clone the demo repository to your machine - https://github.com/supabase/self-hosted-edge-functions-demo
...
- [Optional] Edit `./functions/main/index.ts`, adding any other request preprocessing logic (for example, you can enable JWT validation, handle CORS requests)
