...
<div className="flex items-start gap-6 not-prose" id="introduction">
  ...
  <div className="flex flex-col gap-2">
    ...
    <h2 className="text-base font-mono text-scale-1100">@supabase/supabase-py</h2>
  </div>
</div>

<div className="max-w-xl">
  This reference documents every object and method available in Supabase's isomorphic Python
  library, supabase-py. You can use supabase-py to interact with your Postgres database, listen to
