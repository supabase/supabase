...
sidebar_position: 1
id: storage-server
title: iEchor Storage Server
sidebar_label: iEchor Storage Server
---
...
Read [this post](https://iechor.com/blog/supabase-storage) on why we decided to build a new object storage service.
