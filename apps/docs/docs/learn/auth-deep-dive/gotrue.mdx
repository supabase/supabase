...
In the next guide we'll be looking at how to setup external OAuth providers: Watch [Part Five: Google Oauth](/docs/learn/auth-deep-dive/google-oauth)
...
- Watch [Part Two: Row Level Security](/docs/learn/auth-deep-dive/row-level-security)
- Watch [Part Three: Policies](/docs/learn/auth-deep-dive/policies)
<!-- - Watch [Part Four: GoTrue](/docs/learn/auth-deep-dive/gotrue) -->
- Watch [Part Five: Google Oauth](/docs/learn/auth-deep-dive/google-oauth)
