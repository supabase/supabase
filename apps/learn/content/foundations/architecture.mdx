...
title: Architecture
description: A high-level view of how Supabase fits together: Postgres at the center,
with services for auth, APIs, storage, realtime, edge functions, and vector search.
