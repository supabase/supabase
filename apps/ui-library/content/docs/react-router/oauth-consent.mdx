...
installation:
  - title: Installation
    registry: oauth-consent-react-router
    showOpenInV0: true
    after: >-
      This block includes the [Supabase
      client](/library/docs/react-router/client). If you already have one
      installed, you can skip overwriting it.
---
