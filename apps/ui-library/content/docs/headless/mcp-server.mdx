...
For local development, Supabase CLI 2.71.1 and later supplies asymmetric signing
keys automatically.
...
and API keys to Edge Functions automatically. OAuth discovery uses the public
project URL forwarded by the Edge Functions gateway.
