...
installation:
  - title: Create the app
    before: >-
      Scaffold the complete template with the [Next.js
      CLI](https://nextjs.org/docs/app/api-reference/cli/create-next-app):
    command: >-
      npx create-next-app@latest my-saas --example
      https://github.com/supabase-community/nextjs-subscription-payments
      --use-pnpm

      cd my-saas
    after: >-
      The scaffold uses the template's dependency versions and includes its
      authentication implementation. Review dependency updates before deploying
      your app.
---
