...
installation:
  - title: Installation
    registry: password-based-auth-react
    showOpenInV0: true
    after: >-
      This block includes the [Supabase client](/library/docs/react/client). If
      you already have one installed, you can skip overwriting it.
---
