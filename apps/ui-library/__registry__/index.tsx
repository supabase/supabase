...
export const Index: Record<string, any> = {
  "default": {
    ...
    "platform-kit-nextjs": {
      ...
      type: "registry:block",
      registryDependencies: ["alert","badge","button","card","chart","command","dialog","drawer","input","form","hover-card","label","popover","select","skeleton","switch","table","toggle-group","toggle","tooltip","use-mobile"],
