...
description: 'Shows how to transfer Edge Functions from one Supabase project to another using either the Supabase CLI or the Dashboard.'
topics: ['Troubleshooting', 'Supabase Platform', 'Edge Functions', 'CLI']
---
...
2. Using the `Download` button, download your desired function as zip:
   ![Download Edge Function](/kb/img/troubleshooting/download-edge-function-via-dashboard.gif)
...
![Upload Edge Function](/kb/img/troubleshooting/upload-edge-function-via-dashboard.gif)
