...
description: 'Explains why dashboard toast notifications can be silently blocked by ad blockers in Brave or Chrome, and how to work around it.'
...
![Error toast reading "Ensure that all your columns are named"](/kb/img/troubleshooting/8ba54441-2057-4dc0-8add-a8eaab9f2d93.png)

Here is an example of a toast success message:

![Example toast success message in the dashboard](/kb/img/troubleshooting/c6e228b8-fa64-47a9-bdf6-f1f6405b9cf9.png)
