...
description: 'How Postgres log levels work, how verbose logging can fill your disk and degrade performance, and how to configure them safely.'
...
[How to Enable the PGAudit Extension](/docs/guides/database/extensions/pgaudit#enable-the-extension)

For detailed configuration instructions and logging options, refer to the complete documentation: [PGAudit Configuration Guide](/docs/guides/database/extensions/pgaudit#configure-the-extension)

**c. Debugging Functions**
For more information on how to debug functions in Supabase, refer to the official guide: [Debugging Functions](/docs/guides/database/functions#debugging-functions).
