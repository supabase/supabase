...
- [Supavisor error: "password authentication failed" after rotating database password](/kb/guides/supavisor-error-password-authentication-failed-after-password-rotation)
