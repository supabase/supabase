...
description: 'Explains why Edge Functions return a 546 error when they exceed CPU or memory limits and how to identify and reduce resource usage to fix it.'
...
![Function Logs tab filtered for "limit", showing Memory limit exceeded errors](/kb/img/troubleshooting/limit_logs.png)
...
![Query results showing 546 errors grouped by hour](/kb/img/troubleshooting/546_errors_by_hour.png)
