...
description: 'Explains why magic link emails show a #ZgotmplZ placeholder or trigger a cannot parse response error, and how to fix it with a web callback redirect flow.'
