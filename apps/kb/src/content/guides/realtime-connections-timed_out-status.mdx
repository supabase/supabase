...
description: 'Fixes Realtime TIMED_OUT connection errors caused by using an older Node.js version with a newer supabase-js client, by upgrading Node or setting the transport explicitly.'
