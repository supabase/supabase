...
description: 'Explains the AWS EBS 24-hour volume modification quota behind disk resize limits, and workarounds like restoring to a new project or pg_upgrade.'
...
More on this in our doc [here](/docs/guides/platform/database-size#disk-size).
