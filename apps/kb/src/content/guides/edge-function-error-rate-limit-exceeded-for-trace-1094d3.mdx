...
description: 'Explains why fan-out Edge Function invocations trigger a per-trace rate limit error and how to pace, batch, or consolidate calls to avoid it.'
