...
description: 'Covers configuring SQLAlchemy connection pooling for auto-scaling and stationary Supabase deployments, including pooler modes and IPv6 support.'
topics: ['Troubleshooting', 'Database', 'Supabase Platform', 'Self-Hosting', 'Supavisor']
