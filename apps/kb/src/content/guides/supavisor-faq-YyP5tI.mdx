---
title: 'Supavisor FAQ'
description: 'Answers common questions about Supavisor connection pooling, including pool size, transaction vs. session mode, connection strings, and monitoring.'
...
![Connect dialog showing the three connection strings](https://github.com/supabase/supabase/assets/91111415/1d653203-84d9-406a-a7c9-1f7d097f5a29)
...
![Pool Size field in Database Settings](https://github.com/supabase/supabase/assets/91111415/ce9e9d28-67c2-4dd2-ac0a-0a0150e63b4f)
