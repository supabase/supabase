...
description: "Explains why new branches don't copy the database schema when migration history is missing, and how to pull, sync, and repair migrations to fix it."
