...
description: 'Walks through recovering a project paused for more than a year by downloading its backups and Storage objects and migrating them to a new project.'
...
![Restore project after pause](/kb/img/restore-after-90-day-dark.png)
