...
description: 'Explains why a non-terminable wraparound-prevention autovacuum causes high CPU and slow queries, and how to mitigate impact and monitor its progress.'
