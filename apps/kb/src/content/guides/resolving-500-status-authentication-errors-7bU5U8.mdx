...
description: 'Walks through using Postgres and Auth logs to diagnose 500 errors caused by database constraints, ownership issues, broken triggers, or SMTP problems.'
...
![Logs query in the SQL Editor with the time range selector highlighted](/kb/img/troubleshooting/152d65ad-f0ed-47cf-8dcb-1e31c6221e71.png)
...
![Expanded log row displayed as readable JSON](https://github.com/user-attachments/assets/6f4c833c-ae15-41e1-9aa8-48ebd58741a1)
