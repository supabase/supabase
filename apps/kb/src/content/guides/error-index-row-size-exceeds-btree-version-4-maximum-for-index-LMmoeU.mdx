...
description: 'Explains the Postgres B-tree row-size limit behind this index error and how to fix it by splitting multi-column indexes or hashing long values.'
