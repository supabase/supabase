...
description: 'Explains why Supavisor connections briefly fail with password authentication errors after a database password rotation and how to resolve it.'
...
>
> Separately, if application instances keep connecting with the old password after changing an existing role's credential, those failed attempts can trip the [auth circuit breaker](/kb/guides/supavisor-error-circuit-breaker-open-after-password-rotation-0fdb72), blocking connections from that client and disrupting the system further.
>
...
- [FATAL: Password authentication failed](/kb/guides/fatal-password-authentication-failed)
- [Supavisor error: "Circuit breaker open" after password rotation](/kb/guides/supavisor-error-circuit-breaker-open-after-password-rotation-0fdb72).
- [Resetting a Supabase database password](/kb/guides/how-do-i-reset-my-supabase-database-password-oTs5sB)
