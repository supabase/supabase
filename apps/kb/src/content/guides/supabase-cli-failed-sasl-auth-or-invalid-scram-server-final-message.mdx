...
description: 'Explains why Supavisor authentication errors like failed SASL auth can occur with the CLI, and three ways to work around them.'
topics: ['Troubleshooting', 'Supabase Platform', 'Database', 'CLI', 'Supavisor']
---
