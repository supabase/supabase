...
description: 'Explains how the Postgres planner chooses between an index and a sequential scan, and covers multi-column, ordered, functional, and covering indexes.'
