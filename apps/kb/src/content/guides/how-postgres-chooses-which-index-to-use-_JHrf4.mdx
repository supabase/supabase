...
description: 'Explains how the Postgres planner decides whether to use an index versus a sequential scan, and covers multi-column, ordered, functional, and covering indexes.'
topics: ['Tip', 'Database']
