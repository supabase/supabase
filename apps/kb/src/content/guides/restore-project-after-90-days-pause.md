---
title: 'How to restore a project paused for more than 90 days'
description: 'Recover data from a project that can no longer be restored in the dashboard by downloading its backups and migrating them to a new project.'
...
![The Project Overview of a paused project, with the Download backups menu open on Database backup and Storage objects](../../assets/guides/restore-project-after-90-days-pause/paused-project-download-backups.png)
...
See the [Restore Dashboard backup guide](/docs/guides/platform/migrating-within-supabase/dashboard-restore) for detailed instructions and troubleshooting.
...
- [Migrating within Supabase](/docs/guides/platform/migrating-within-supabase)
