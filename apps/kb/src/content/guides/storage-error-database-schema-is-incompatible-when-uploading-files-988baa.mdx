...
description: 'Explains why RLS policies that reference each other in a circular way cause infinite recursion errors, and how to break the cycle.'
topics: ['Troubleshooting', 'Database', 'Auth', 'wrong file name']
---
