...
description: 'Explains why Realtime WebSocket connections silently drop when a tab is backgrounded and how to fix it with heartbeatCallback and the Web Worker option.'
