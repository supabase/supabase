...
description: 'Explains why a transaction pooler connection intermittently throws a read-only transaction error due to a contaminated backend connection, and how to fix it.'
