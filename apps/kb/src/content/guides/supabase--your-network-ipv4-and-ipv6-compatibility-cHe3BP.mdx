...
description: 'Explains Supabase IPv6 connection strings and lists options - Supavisor, client libraries, or the IPv4 add-on - for IPv4-only hosts.'
topics: ['Troubleshooting', 'Database', 'Supabase Platform', 'Supavisor', 'wrong file name', 'duplicate']
