...
description: 'Explains what causes unhealthy service indicators in Project Status, including database overload and Edge Functions false positives, and how to resolve them.'
topics: ['Troubleshooting', 'Supabase Platform', 'Dashboard']
---

![Unhealthy services in Project Status](/kb/img/troubleshooting/project-status-unhealthy-services.png)
...
- Review this [troubleshooting doc](/kb/guides/failed-to-run-sql-query-connection-terminated-due-to-connection-timeout) to determine if it could be a resource issue.
