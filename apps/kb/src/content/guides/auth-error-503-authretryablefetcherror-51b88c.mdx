...
description: 'Explains how an invalid Sessions Timebox duration can stop the Auth service from initializing, causing 503 AuthRetryableFetchError, and how to fix it.'
