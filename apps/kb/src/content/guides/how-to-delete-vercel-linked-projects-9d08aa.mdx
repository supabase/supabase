...
description: 'Explains how to fully delete a Supabase project created through the Vercel Marketplace, including cleanup on both platforms.'
...
1. **Delete from Supabase Dashboard**
   ...
   ![Delete project button in Supabase project settings](/kb/img/troubleshooting/54428354-a1f4-4c44-bd03-d87f4b925d94.png)
...
2. **Clean up in Vercel**
   ...
   ![Uninstalled Supabase project in Vercel Storage](/kb/img/troubleshooting/cf450bca-aad3-4783-ae3b-5cc83e0afa54.png)
   - Scroll down and find the **Settings** tab in the sidebar

   ![Vercel project settings navigation](/kb/img/troubleshooting/da70bc33-f123-4567-8901-abcdef123456.png)
   - Click **Delete Database** to completely remove it

   ![Delete Database button in Vercel settings](/kb/img/troubleshooting/c4e7b193-4567-8901-abcd-ef1234567890.png)
...
1. **Transfer the project**
   ...
   ![Transfer project option in Supabase project settings](/kb/img/troubleshooting/627c1a3e-153e-40b5-9a91-a4f7bd7673a4.png)
...
1. **Navigate to organization settings and delete**
   ...
   ![Delete organization in Vercel Marketplace button](/kb/img/troubleshooting/ff01bba8-abcd-ef12-3456-7890abcdef12.png)
...
2. **Uninstall integration**
   ...
   ![Uninstall Integration button in Vercel settings](/kb/img/troubleshooting/f294a4d6-ef12-3456-7890-abcdef123456.png)
