...
description: 'Explains why the organization usage summary on the dashboard includes metrics from projects deleted or inactive earlier in the current billing cycle.'
...
![Organization usage metrics page](/kb/img/troubleshooting/46f59019-6ff1-4bfb-9acd-d5b7bd282f89.png)
