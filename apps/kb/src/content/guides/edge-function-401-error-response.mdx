...
description: 'Walks through triaging a 401 response from an Edge Function, covering custom 401s from function code versus built-in JWT check failures like invalid or missing keys.'
...
![image](/kb/img/troubleshooting/401_edge_functions_toggle_off_JWT_check.png)
