...
description: 'Walks through triaging a 401 from an Edge Function, separating custom 401s in your code from built-in JWT check failures like invalid or missing keys.'
...
![Verify JWT with legacy secret toggle in the function Details tab](/kb/img/troubleshooting/401_edge_functions_toggle_off_JWT_check.png)
