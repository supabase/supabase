...
description: 'Covers Edge Function worker timeout and WebSocket disconnect scenarios (early drop, CPU/wall-clock limits, streaming, cold starts) and their workarounds.'
