...
description: 'Explains why persistent Postgres clients like postgres-js can hang or throw CONNECT_TIMEOUT errors in serverless functions, and how to avoid it.'
topics: ['Troubleshooting', 'Database', 'Edge Functions', 'Supavisor']
---
