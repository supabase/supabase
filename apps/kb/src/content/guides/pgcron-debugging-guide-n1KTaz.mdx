...
description: 'Walks through steps for diagnosing pg_cron issues, including checking the scheduler process, job run details, concurrency limits, and Postgres logs.'
...
![Fast reboot option in project General Settings](https://github.com/user-attachments/assets/d7a2956c-08e0-4ebc-be08-d14a2383f36b)
