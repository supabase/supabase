...
description: 'Explains why disabling the Data API causes a harmless pg_pgrst_no_exposed_schemas schema error in PostgREST logs, and how to stop it.'
topics: ['Troubleshooting', 'Database', 'Supabase Platform', 'Data API']
---
