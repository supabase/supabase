...
description: 'Shows how to raise the direct connection limit with the Supabase CLI and explains the memory and CPU risks of increasing it beyond the defaults.'
topics: ['Troubleshooting', 'Database', 'Supabase Platform', 'Supavisor']
...
Each compute instance has a default direct connection and pooler connection settings. You can find the most recent settings in the [compute docs](/docs/guides/platform/compute-and-disk#disk):
...
You can configure the maximum amount of connections that Postgres will tolerate with the [Supabase CLI.](/docs/guides/database/custom-postgres-config)
...
![Grafana chart showing unhealthy memory usage](/kb/img/troubleshooting/47685206-7914-440e-a010-da62f5c38186.png)
...
> NOTE: You can find your server memory in the [compute add-ons docs](/docs/guides/platform/compute-and-disk)
...
![Grafana CPU chart spiking from rapid connection churn](/kb/img/troubleshooting/0e7f6842-78fd-44f9-b463-425507815fb6.png)
...
![Grafana CPU chart showing low, predictable usage](https://github.com/supabase/supabase/assets/91111415/ee3e4f4c-87a1-4ef8-9ca5-af9094fc1b93)
