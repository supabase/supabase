...
description: 'Explains how NULL values left in auth.users by manual SQL edits cause a 500 database error querying schema, and how to fix the affected column.'
