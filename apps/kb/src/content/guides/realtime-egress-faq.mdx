...
description: 'Explains what counts toward billed Realtime Egress traffic and how to investigate a gap between measured payload and billed usage.'
topics: ['Troubleshooting', 'Realtime', 'Supabase Platform']
---
