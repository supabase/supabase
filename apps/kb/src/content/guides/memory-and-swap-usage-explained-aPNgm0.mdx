...
description: 'Explains how Linux swap and memory usage work on compute instances and how disk IO balance limits relate to high swap usage.'
...
- Monitor CPU IOWait usage and disk IO metrics:
  - [Exported metrics](https://github.com/supabase/grafana-agent-fly-example/blob/main/metrics.md)
