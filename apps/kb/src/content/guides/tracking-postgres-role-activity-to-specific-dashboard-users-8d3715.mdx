...
description: 'Shows how to enable Postgres logging of data-modifying statements and map the logged user IDs from Dashboard SQL Editor queries to specific team members.'
...
- The full statement
- The timestamp
- A `user` field, which is the Supabase user UUID
