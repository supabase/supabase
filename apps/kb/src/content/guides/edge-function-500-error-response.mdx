...
description: 'Explains how to tell whether an Edge Function 500 came from your own code or an unhandled JavaScript error, with fixes and example failure cases.'
