...
description: 'Explains why Edge Functions return a 504 timeout and how to identify slow functions, profile them, and optimize response time.'
...
![Labelled timing output in the function Log tab](/kb/img/troubleshooting/edge-function-504-timestamp-1.png)
