...
description: 'Answers common questions about identifying PgBouncer vs Supavisor connection strings and adjusting pool size and session mode from the dashboard.'
