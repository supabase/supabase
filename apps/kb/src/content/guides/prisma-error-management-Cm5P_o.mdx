...
description: 'A guide covering common Prisma connection and migration errors on Supabase, plus recommendations for roles, pooling, and connection strings.'
...
![Query Performance Advisor listing slow queries](https://github.com/supabase/supabase/assets/91111415/46e2feae-9fca-4436-a957-2c995eb5ca92)
