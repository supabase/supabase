...
description: 'How the Postgres planner picks between a sequential scan and the available indexes, and when composite, ordered, functional, covering, and JSONB indexes help.'
