...
description: 'Explains that this Studio error usually means the database crashed, often from an out-of-memory event, and covers recovery and prevention steps.'
topics: ['Troubleshooting', 'Database', 'Supabase Platform', 'Dashboard']
---
...
If you want to effectively monitor your project's performance minute by minute, you can use the [Metrics API](/docs/guides/observability/metrics).
