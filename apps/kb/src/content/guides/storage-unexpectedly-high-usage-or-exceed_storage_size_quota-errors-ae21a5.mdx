...
description: 'Explains why storage usage can stay high after deleting files: rows removed directly via SQL leave orphaned physical objects behind.'
topics: ['Troubleshooting', 'Dashboard', 'Storage']
---
