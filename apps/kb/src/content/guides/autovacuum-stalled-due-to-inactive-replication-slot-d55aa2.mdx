...
description: 'Explains how an inactive replication slot can stall autovacuum and cause database bloat, with SQL steps to find and drop the offending slot.'
