...
description: 'Describes how to track Edge Function CPU, memory, and execution-time metrics in the dashboard and best practices to reduce resource use.'
topics: ['Troubleshooting', 'Edge Functions', 'Supabase Platform']
---
