...
description: 'Shows how to distinguish a boot error, an app-level 503, or a platform issue behind an Edge Function 503 response, and how to resolve each case.'
...
| `internal_failure` | [platform issue](#platform-issue)                   |
...
![Function logs filtered for the phrase worker boot error](/kb/img/troubleshooting/filter_503.png)
