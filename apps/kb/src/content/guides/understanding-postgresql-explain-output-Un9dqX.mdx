...
description: 'Explains how to read Postgres EXPLAIN and EXPLAIN ANALYZE output, including cost, rows, and timing, to diagnose and optimize slow queries.'
...
![EXPLAIN plan annotated with start-up cost, total cost, rows, and row size](/kb/img/troubleshooting/10950be3-264b-4a41-bc71-3d431c2756b2.png)
...
Since reading a longer execution plan is quite cumbersome, you can use the website [explain.depesz.com](https://explain.depesz.com/) to better visualize the query. If you paste the execution plan in the text area and hit “Submit”, you will get output like this:
![Execution plan visualized on explain.depesz.com](/kb/img/troubleshooting/830b81aa-ae52-44a4-aa49-32c2a6296af7.png)
...
For more insights, you can also read [how Postgres processes queries](https://aws.amazon.com/blogs/database/how-postgresql-processes-queries-and-how-to-analyze-them/).
