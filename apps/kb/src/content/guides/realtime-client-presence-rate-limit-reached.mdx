...
description: 'Explains why a client hits the Presence update rate limit and closes its channel, and how to fix it by using Broadcast or throttling Presence updates.'
