...
description: 'Fixes a PowerBI Service SSL certificate validation error during scheduled refreshes by using an on-premises gateway or an intermediate trusted data source.'
