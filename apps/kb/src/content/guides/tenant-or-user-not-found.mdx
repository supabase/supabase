...
description: 'Explains that a Tenant or user not found error from the shared pooler is usually caused by a mistyped host or username, not an incorrect password.'
