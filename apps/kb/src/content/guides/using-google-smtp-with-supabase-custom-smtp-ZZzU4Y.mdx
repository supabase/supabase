...
description: 'Walks through configuring Google Workspace SMTP with Supabase custom SMTP, including app passwords, required ports, and alternative providers.'
...
2. The SMTP password used has to be an app password. Google workspace doesn't make it easy to figure out how to create this. You need to **enable 2FA** on your workspace account first (not inside the admin console but in [Google Account settings](https://myaccount.google.com/))
...
![Supabase SMTP settings using smtp-relay.gmail.com on port 465](/kb/img/troubleshooting/800448a1-0245-4a26-855f-3be8f44adf03.png)

(The "Require TLS encryption" option didn't seem to affect anything when tested)![Google Workspace SMTP relay settings with authentication and TLS required](/kb/img/troubleshooting/5b55ddbc-abfc-4c66-a012-b8e4d23cd438.png)

## For `smtp.gmail.com`

![Supabase SMTP settings for smtp.gmail.com](/kb/img/troubleshooting/ade24c85-50b5-47ca-a2ce-c3f77a0e128a.png)
