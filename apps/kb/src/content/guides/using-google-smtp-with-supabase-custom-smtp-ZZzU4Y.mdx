...
![image](/kb/img/troubleshooting/800448a1-0245-4a26-855f-3be8f44adf03.png)

(The "Require TLS encryption" option didn't seem to affect anything when tested)![image](/kb/img/troubleshooting/5b55ddbc-abfc-4c66-a012-b8e4d23cd438.png)

## For `smtp.gmail.com`

![image](/kb/img/troubleshooting/ade24c85-50b5-47ca-a2ce-c3f77a0e128a.png)
