...
description: 'Explains common ways a user session token can override the service_role key in the Authorization header, causing unexpected RLS enforcement.'
topics: ['Troubleshooting', 'Auth', 'Database']
github_url: 'https://github.com/orgs/supabase/discussions/30146'
---

> [!CAUTION]
> This troubleshooting guide is about rotating **Legacy anon, service_role API keys**. We are deprecating the Legacy API keys, and recommend migrating to New API keys. To learn more about API keys, refer to [API keys](/docs/guides/getting-started/api-keys).
