...
description: 'Explains how to read the Supabase Grafana memory chart colors and what to do when cache hit rate drops due to memory pressure.'
...
![Grafana chart showing unhealthy memory usage](https://github.com/supabase/supabase/assets/91111415/baebfc74-642d-4988-992c-bb0f473a05ad)
![Second example of unhealthy memory usage](https://github.com/supabase/supabase/assets/91111415/b95c83cf-aa98-4b50-8e07-29f57aaa676c)
...
2. [Increasing the compute size](/docs/guides/platform/compute-and-disk)
