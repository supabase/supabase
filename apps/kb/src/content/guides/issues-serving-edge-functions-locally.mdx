...
description: 'Walks through debugging steps for when supabase functions serve fails or Edge Functions will not run locally, including port and cache checks.'
topics: ['Troubleshooting', 'Edge Functions', 'Supabase Platform', 'CLI']
---
