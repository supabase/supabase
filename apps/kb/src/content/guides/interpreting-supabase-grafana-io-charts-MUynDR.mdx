...
![image](/kb/img/troubleshooting/9c6e0f9c-f842-463b-b214-1a9e31de3b2c.png)

Its Disk IOPS is constantly near peak capacity:

![image](/kb/img/troubleshooting/ec5ed538-985b-411d-a0d7-be718b28d367.png)

Its throughput is also high:

![image](/kb/img/troubleshooting/90cb6a70-fc67-4666-9217-6fa37cfacf82.png)

As a side-effect, its CPU is encumbered by heavy Busy IOWait activity:

![image](/kb/img/troubleshooting/9b88a738-65d6-4be4-8fa0-bc3f13a9a408.png)
