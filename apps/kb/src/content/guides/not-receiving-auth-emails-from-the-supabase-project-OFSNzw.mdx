...
description: 'Explains how to debug undelivered Auth emails using custom SMTP configuration, Auth logs, and the email provider delivery logs.'
...
References:
[Configure a Custom SMTP](/docs/guides/auth/auth-smtp)
