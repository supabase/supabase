...
description: 'Explains how Row Level Security policies can slow down queries, and techniques such as indexing and wrapping functions in select to improve performance.'
...
Postgres has tools to analyze the performance of queries, such as [EXPLAIN](https://www.postgresql.org/docs/current/sql-explain.html).
