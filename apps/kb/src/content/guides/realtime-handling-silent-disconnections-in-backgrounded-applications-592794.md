...
description: 'Why Realtime subscriptions stop receiving events in backgrounded apps, and how to keep the connection alive with heartbeatCallback and Web workers.'
