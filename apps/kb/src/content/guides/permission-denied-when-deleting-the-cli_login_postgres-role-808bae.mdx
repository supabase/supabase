...
description: 'Explains why a standard SQL connection cannot drop the CLI-managed cli_login_postgres role and how to remove it permanently using the Supabase Management API.'
