...
description: "Explains why manually created databases don't appear in the Supabase Dashboard, since integrated services only work with the default postgres database."
