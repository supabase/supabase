...
description: 'Explains why logical backup downloads disappear once PITR or physical backups are enabled, and how to get a logical backup via the CLI or pg_dump instead.'
