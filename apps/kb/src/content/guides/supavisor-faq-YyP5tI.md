---
title: 'Supavisor FAQ'
description: 'How connection pooling works in Supabase: transaction vs. session mode, pool size, client connections, and how to monitor them.'
...
![Supabase Postgres Connection String](../../assets/guides/supavisor-faq-YyP5tI/connect-panel-connection-pooler.png)
...
![Connection pooling size configuration setting](../../assets/guides/supavisor-faq-YyP5tI/connection-pooling-configuration-pool-size.png)
...
You can check our [GitHub repo](https://github.com/supabase/supabase-grafana) for setup instructions for local deployments or free cloud deployments on [Fly.io](http://fly.io/). Refer to Supabase [documentation](/docs/guides/observability/metrics) to learn more about the metrics endpoint.
