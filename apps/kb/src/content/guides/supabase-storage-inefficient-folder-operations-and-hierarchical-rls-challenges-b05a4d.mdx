...
description: 'Explains why Supabase Storage treats folders as key prefixes with no batch operations, and how to model hierarchy and RLS in Postgres or use the S3 API.'
