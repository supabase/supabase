...
description: 'Explains common 500 unexpected_failure errors when creating, updating, or deleting users from the dashboard, and how to fix trigger or constraint issues on auth.users.'
