...
description: 'Explains why projects created through Lovable Cloud do not appear in or connect to your own Supabase Dashboard, and how to migrate to your own project.'
