...
description: 'Explains why bundlers like Vite, Rollup, and Nuxt report a false-positive UNUSED_EXTERNAL_IMPORT warning for supabase-js and how to suppress it.'
