...
description: 'Walk through checks for a self-hosted Supabase Grafana setup that is not showing data, from the metrics endpoint to container env vars and permissions.'
topics: ['Troubleshooting', 'Database']
github_url: 'https://github.com/orgs/supabase/discussions/30579'
---

This guide is for identifying configuration mistakes in [self-hosted Supabase Grafana installations](/docs/guides/observability/metrics/grafana-self-hosted)
...
![Auto-refresh setting in the Grafana dashboard toolbar](/kb/img/troubleshooting/47998bed-0b77-433a-bfed-63222beb2aee.png)
...
![docker ps output showing the supabase-grafana container running](/kb/img/troubleshooting/6c284180-0ffd-432d-b86b-e9fbcfe23868.png)
