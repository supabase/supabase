...
description: 'Explains why raising SQLSTATE 40001 in a PL/pgSQL function triggers PostgREST retry loops and high CPU, and how to fix it and clear hanging backends.'
