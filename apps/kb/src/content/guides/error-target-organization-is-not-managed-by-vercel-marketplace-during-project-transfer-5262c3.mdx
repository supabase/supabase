...
description: 'Explains that transferring a project from a Supabase-managed org to a Vercel Marketplace-managed org is unsupported, and which direction works instead.'
