...
description: 'Defines Supavisor and Postgres connection pooling terms such as client connections, direct connections, pool size, transaction mode, and session mode.'
