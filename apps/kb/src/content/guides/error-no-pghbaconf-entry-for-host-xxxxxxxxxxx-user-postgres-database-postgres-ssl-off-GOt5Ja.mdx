...
description: 'Explains that this connection error happens when SSL enforcement is on and the client connects without SSL, and how to connect with SSL or disable enforcement.'
