...
description: 'Walks through diagnosing and repairing an out-of-sync migration history that causes a preview branch to fail with MIGRATIONS_FAILED.'
...
![Branch creation workflow logs showing the failed migration step for a branch in MIGRATIONS_FAILED status](/kb/img/troubleshooting/migrations-failed-status.png)
...
![Postgres Logs with the failed migration statement marked as an error and its message expanded](/kb/img/troubleshooting/postgres-logs-migration-failed.png)
...
![The rebase branch button in the Dashboard branch details view](/kb/img/troubleshooting/rebase-image.png)
