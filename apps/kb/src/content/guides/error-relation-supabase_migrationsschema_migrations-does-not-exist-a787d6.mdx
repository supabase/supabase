...
description: 'Explains that this Postgres log error comes from dashboard polling for migration history when the CLI-managed migrations table does not yet exist, and when to ignore it.'
