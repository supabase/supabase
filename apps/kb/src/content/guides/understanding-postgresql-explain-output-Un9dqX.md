...
description: 'Read and interpret EXPLAIN and EXPLAIN ANALYZE output to find and fix slow queries.'
...
2. Once debugging is enabled, you can use the [EXPLAIN](/docs/reference/javascript/using-modifiers-explain) function in your application code. Here's how to use it
...
![Annotated EXPLAIN output](../../assets/guides/understanding-postgresql-explain-output-Un9dqX/explain-output-annotated.png)
...
![A query plan visualized](../../assets/guides/understanding-postgresql-explain-output-Un9dqX/explain-depesz-visualization.png)
