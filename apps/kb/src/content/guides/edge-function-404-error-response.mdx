...
description: 'Explains the difference between NOT_FOUND and NOT_FOUND_FUNCTION_BLOB Edge Function 404 errors, and how to check logs, fix typos, or redeploy the function.'
...
>
> ![Setting the time frame on a log query](/kb/img/troubleshooting/edge_function_404_set_timeframe.png)
...
![Test call option in the Function Dashboard](/kb/img/troubleshooting/edge_function_404_test_call.png)
...
![Redeploying a function from its code tab](/kb/img/troubleshooting/edge_function_404_redeploy.png)
