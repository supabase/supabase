...
description: 'Explains how to prepare for and speed up building an HNSW index on a vector column, covering connection, memory, and compute settings.'
...
![Disk size setting in Infrastructure settings](https://github.com/supabase/supabase/assets/91111415/9820e214-8796-4b56-91a3-2e73e4836b2f)
