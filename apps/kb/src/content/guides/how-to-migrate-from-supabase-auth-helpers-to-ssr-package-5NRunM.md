---
title: 'How to migrate from Supabase Auth helpers to the SSR package'
description: 'Move your app from the deprecated auth-helpers packages to the @supabase/ssr package.'
topics: ['Troubleshooting', 'Auth', 'Migration']
...
You can find more clear and concise examples of creating clients [in our SSR documentation](/docs/guides/auth/server-side/creating-a-client#creating-a-client).
