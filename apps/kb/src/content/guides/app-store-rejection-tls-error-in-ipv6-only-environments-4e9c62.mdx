...
description: 'Explains why an App Store TLS error in IPv6-only testing is usually an app networking issue rather than a Supabase configuration problem, with fixes.'
