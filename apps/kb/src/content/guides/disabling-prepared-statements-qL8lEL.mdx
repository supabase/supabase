...
description: 'Explains that Supavisor in transaction mode does not support prepared statements and shows how to disable them for common ORMs and drivers.'
