...
description: 'Explains the three levels where the GitHub OAuth integration is configured and how to remove or reconnect it when settings or permissions are missing.'
