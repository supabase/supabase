...
description: 'Shows how to use the AWS CLI with your project storage credentials to review bucket contents and usage beyond what Studio displays.'
topics: ['Troubleshooting', 'Storage', 'CLI', 'Dashboard']
---
