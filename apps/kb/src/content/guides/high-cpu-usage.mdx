...
description: 'Explains what high CPU usage on a Supabase project can indicate, how to monitor it, common causes, and options for resolving it.'
...
You can check your CPU usage directly on the Supabase Platform. For this go to database health in the [Observability section](/dashboard/project/_/observability/database) and select your project.

![CPU usage reported on Supabase dashboard](/kb/img/guides/platform/exhaust-cpu-report.png)

It is also possible to monitor your resources and set up alerts using Prometheus/Grafana. You can find a guide for this [here](/docs/guides/observability/metrics).
