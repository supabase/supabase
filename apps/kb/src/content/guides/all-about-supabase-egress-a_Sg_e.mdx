...
description: 'Explains what counts as egress across Supabase services and how to review, diagnose, and reduce your egress usage.'
...
![Add chart menu with Database API and API Egress selected](/kb/img/troubleshooting/reports-page-egress.png)
...
- By finding the most requested queries from the [Query performance report](/dashboard/project/_/advisors/query-performance)
...
- Reduce the number of queries/calls by optimising client code or use caches such as [supabase-cache-helpers](https://github.com/psteinroe/supabase-cache-helpers/) to reduce the number of requests/queries being done
