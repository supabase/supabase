...
hosts: 'gregnr'
description: "Learn how to build modern Generative AI applications that let you chat with your PDFs for customer support, summarization, and business intelligence. Supabase AI engineer Greg Richardson demonstrates how Vector and Edge Functions make it easy to build scalable AI apps. Cyrus Khajvandi, CEO of Google-backed Humata, shares how his company scaled to over one million users using Supabase and LLMs."
---
