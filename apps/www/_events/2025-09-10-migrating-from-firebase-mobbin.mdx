...
hosts: 'dventimi'
description: "Supabase engineers and Mobbin CEO discuss technical challenges of scaling applications on Firebase. Learn how transitioning to Postgres addresses Firestore's NoSQL limitations that slow you down, limit queries, and drive up costs, with practical strategies for breaking through Firebase's ceiling."
---
