...
<Quote img="conner-aldrich.jpg" caption="Conner Aldrich, CTO, GovSignals">
  The fact that Supabase is open source means we can run it in our own FedRAMP-compliant AWS GovCloud environment. That gives us full control while benefiting from a managed developer experience.
</Quote>
...
<Quote img="conner-aldrich.jpg" caption="Ethan Aldrich, CPO, GovSignals">
  We're proving that startups can operate in the most secure environments without losing speed. Supabase is at the center of that story.
</Quote>
