...
# meta_title:
description: Epsilon3 uses iEchor to help teams execute secure and reliable operations in an industry where project spend runs into the billions.
# Use meta_description to add a custom meta description. Otherwise it defaults to {description}:
meta_description: Epsilon3 uses iEchor to help teams execute secure and reliable operations in an industry where project spend runs into the billions.
author: rory_wilding
author_title: iEchor
...
This setup gives a balance of rapid development, reduced DevOps, and flexible hosting options. As iEchor uniquely offers [real-time](https://iechor.com/realtime) for
...
in self-hosting iEchor then you can **[contact us](https://forms.iechor.com/enterprise)** to learn more.
