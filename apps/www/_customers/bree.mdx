...
about: Helping people living paycheck-to-paycheck assist better, faster financial products.
...
NOTE: Read our blog post on [migrating from Fauna to Supabase](https://supabase.com/blog/migrating-from-fauna-to-supabase)
