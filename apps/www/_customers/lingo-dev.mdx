...
misc:
  [
    ...
    { label: 'Use case', text: 'Retrieval augmented localization: translation APIs with a memory for glossary, brand voice, and quality' },
...
<Quote img="max-lingo.jpg" caption="Max Prilutskiy, Co-founder and CEO, Lingo.dev">
  ...
  seriously. GDPR, SOC 2 Type II, where data lives, which regions: the architecture was shaped around
  those requirements from day one. As a localization infrastructure company, we treat security
  seriously.
</Quote>
