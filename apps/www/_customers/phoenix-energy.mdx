...
<Quote img="kris-woods-phoenix-energy.jpg" caption="Kris Woods, CTO, Phoenix Energy">
  Supabase Pipelines is going to be really interesting for us. I'd love for everything to live in
  the same place so the team can focus on building impactful tools. It really does feel like
  Supabase is just getting started and I am excited about how we can grow with them from here.
</Quote>
