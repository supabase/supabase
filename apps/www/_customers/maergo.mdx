...
tags:
  - supabase
date: '2024-06-04'
company_url: 'https://maergo.com/'
stats: []
misc:
  [
    { label: 'Use case', text: 'Logistics, SaaS' },
...
**Reduced codebase**\
Maergo’s codebase went from 730k lines of code to 95k lines of code, while preserving all API components of the previous system and even introducing new functionality.
...
Supabase's cost model was more appealing, allowing Maergo to scrap their previous infrastructure of MongoDB and Elastic Beanstalk and their initially planned refactor target architecture, which included RDS Postgres and AWS EKS.
