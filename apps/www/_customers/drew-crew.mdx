---
name: The Drew Crew
title: 'Built for everyone: how Drew Clayborn is coding a lifeline for home care'
# Use meta_title to add a custom meta title. Otherwise it defaults to '{name} | Supabase Customer Stories':
# meta_title:
description: Drew Clayborn is building General Home Health, a HIPAA-compliant home care charting app, by himself. Supabase gives a solo developer the database, auth, realtime, and HIPAA-ready foundation to protect patients, nurses, and agencies.
# Use meta_description to add a custom meta description. Otherwise it defaults to {description}:
meta_description: How Drew Clayborn, a solo developer, uses Supabase Database, Auth, Realtime, Row Level Security, and audit logs to build a HIPAA-compliant home care charting app for nurses and agencies.
author: prashant
...
logo: /images/customers/logos/on-light/drew-crew.png
logo_inverse: /images/customers/logos/on-dark/drew-crew.png
tags:
  - supabase
date: '2026-07-08'
company_url: https://www.thedrewcrew.org
misc:
  - { label: 'Founder', text: 'Drew Clayborn, director, inventor, and developer' }
  - { label: 'App', text: 'General Home Health' }
  - { label: 'Use case', text: 'HIPAA-compliant home care charting app for nurses and agencies' }
  - {
      label: 'Products used',
      text: 'Database, Auth, Realtime, Row Level Security, Audit Logs, Table Editor',
    }
about: The Drew Crew Charitable Organization is a nonprofit in Commerce, Michigan, founded by Drew Clayborn around his recovery from a spinal cord injury. Its app, General Home Health, is a HIPAA-compliant home care charting app for the nurses and agencies that most software companies never see, built to protect the nurse, keep the agency compliant, and let the patient stay home.
...
<Quote
  img="drew-clayborn-drew-crew.jpeg"
  caption="Drew Clayborn, director, inventor, and developer, The Drew Crew"
>
  As a solo developer, it seems daunting at first. You never know how something is going to come
  about. It might happen faster than you want, but just go with it. Don't be afraid to make
  something. And Supabase makes it easy to build quickly and ship.
</Quote>
...
<Quote
  ...
  caption="Drew Clayborn, director, inventor, and developer, The Drew Crew"
>
  A lot of nurses, when they go into a home, they're going into a situation that they've never been
  in. They've never met the family. They don't know how old they are, what issues they have. This
  app is supposed to be an easy solution so that when a nurse walks into a home, they can go
  straight to giving someone the best care they need and deserve.
</Quote>
...
<Quote
  ...
  caption="Drew Clayborn, director, inventor, and developer, The Drew Crew"
>
  I'm not a full-time software engineer with a big team behind me. I'm someone who saw a problem in
  home care every single day and wanted to fix it. Supabase made the backend feel possible. It gave
  me the tools to build something real without getting buried in complexity, and it gave me the
  confidence that I could protect the information this app was built around.
</Quote>
...
<Quote
  ...
  caption="Drew Clayborn, director, inventor, and developer, The Drew Crew"
>
  The fact that Supabase has a HIPAA-compliant aspect makes it so you can be audited. If you're an
  agency using this, you have complete audit logs of everybody logging in, logging out, who's
  charting what. It makes it really easy to monitor the database without seeing things I shouldn't
  necessarily see.
</Quote>
...
<Quote
  ...
  caption="Drew Clayborn, director, inventor, and developer, The Drew Crew"
>
  A supervisor can do their visit virtually. They don't have to drive to the house, they don't have
  to be present. They can monitor everybody's charting and the care the patient is receiving because
  it's all in Supabase, reliably and in real-time.
</Quote>
