...
Supabase is now officially SOC2 Type 2 and HIPAA compliant. While we weren’t [planning](https://news.ycombinator.com/item?id=35526018) to do anything official for this announcement, [the customer is always right](https://news.ycombinator.com/item?id=35555756) and we decided to share some more details.

That’s all you need to know.

The rest of this blog post will give you some background and what to expect if you’re planning to go through the same process.
...
![soc2 to HIPAA](/images/blog/launch-week-8/day-5/soc2-to-hipaa.png)
...
Similarly when you sign a BAA with us, you have some responsibilities you agree to when using Supabase to store PHI. These are documented in our [shared responsibility doc](https://docs-git-ip-hipaa-supabase.vercel.app/docs/guides/platform/shared-responsibility-model#managing-healthcare-data).
...
If you want to start developing healthcare apps on Supabase, reach out to our team [here](https://forms.supabase.com/hipaa). We are excited to see what you build!
