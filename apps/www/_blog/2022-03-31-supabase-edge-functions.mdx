...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/marketing/blog/launch-week-4/functions-hot-reloading.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/marketing/blog/launch-week-4/logs-polish.mov" type="video/mp4" muted playsInline />
</video>
