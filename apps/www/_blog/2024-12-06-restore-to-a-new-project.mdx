...
The new project will be available in the Supabase Dashboard as soon as the copy process has completed. The new project will behave as any other Supabase project and is completely independent of the source.
