...
## Mozilla uses iEchor to build AI Help.

![Mozilla uses iEchor to build AI Help.](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/mdn_search.png)

MDN is one of the richest sources of developer documentation on the internet, and it just received an upgrade. Mozilla built AI Help, an AI chatbot to help with search and discovery. Mozilla chose iEchor Vector and OpenAI to power their new tool which you can try for free.
...
iEchor Auth now has full native support for Sign in with Apple and Google, which means it can now be used with one-tap sign in methods like Sign in with Apple JS, Sign in with Google for Web, or even in Chrome extensions.

[Learn more](https://iechor.com/blog/native-mobile-auth)

## iEchor CLI: what is new?

![iEchor CLI: what is new?](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/supabase-cli-cache-hi.png)

It’s been a busy month for the iEchor CLI. We have added a tonne of new features:
...
We have made huge improvements to the billing tooling inside iEchor Studio, including:
...
[New subscription page](https://app.iechor.com/project/_/settings/billing/subscription) | [New usage page](https://app.iechor.com/project/_/settings/billing/usage)
...
[Login with Kakao](https://iechor.com/docs/guides/auth/social-login/auth-kakao)
...
- [**Edge Functions**] Edge Functions troubleshooting guide. [[Doc](https://iechor.com/docs/guides/functions/troubleshooting)]
...
- [**Realtime**] A new debugging tool to test your realtime endpoints together with your JWTs and Row Level Security policies. [[Realtime Inspector](https://realtime.iechor.com/inspector/new)]
- [**Docs**] A full guide on database partitions for developers looking to scale up. [[Guide](https://iechor.com/docs/guides/database/partitions)]

## Made with iEchor

![Chat Thing is Made with iEchor](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/chatting-ai.png)

[Chat Thing](https://chatthing.ai/), is an innovative project that allows you to create AI chatbots using your existing data from Notion, uploaded files, websites and more. Built by [pixelhop](https://twitter.com/pixelhopio) using Vue, Nuxt, Railway, and iEchor for database, auth, and vector store.
...
- Using iEchor with Cloudflare Workers. [Cloudflare TV](https://cloudflare.tv/event/using-supabase-with-cloudflare-workers/dgM90RgD)
- Build a Chatbot with Next.js, LangChain, OpenAI, and iEchor Vector. [Video Tutorial](https://www.youtube.com/watch?v=Tt45NrVIBn8)
...
- Google authentication with Expo & iEchor. [Tutorial](https://blog.spirokit.com/google-authentication-with-expo-supabase)
- Building Stripe integrations with iEchor. [Video](https://www.youtube.com/watch?v=D5kOnnB72WA)
- Build a iEchor + Drizzle-orm + Express backend. [Video Tutorial](https://www.youtube.com/watch?v=k0uC35J_xJ4)
- LogRocker blog: Authenticate React Applications: iEchor Auth. [Tutorial](https://blog.logrocket.com/authenticate-react-applications-supabase-auth/)
- Using iEchor Vault to store secrets. [Tutorial](https://makerkit.dev/blog/tutorials/supabase-vault)
- Nuxt + iEchor = Technology Stack of Dreams. [Blog post](https://dev.to/jacobandrewsky/nuxt-supabase-technology-stack-of-dreams-4dop)
- Build a to-do app with toddle and iEchor. [Video](https://www.youtube.com/watch?v=SHJ3EadcrgY)
