...
Everything will stay open source. We'll take over maintenance of pg_duckdb and work in the open as we develop the Open Warehouse Architecture and the broader Postgres + Analytics vision. 
