...
description: 'Learn how to create a new Rails app and connect it to a Supabase PostgreSQL database.'
author: thor_schaeff
...
PostgreSQL is an ideal choice for your Ruby on Rails applications as Rails ships with a Postgres adapter built in!
...
<div className="video-container">
  <iframe
    className="w-full"
    src="https://www.youtube-nocookie.com/embed/Z4L_UE0hVmo"
