---
title: Infinite scroll with NextJs, Supabase and Framer Motion
description: Lazy load and paginate data on scroll with supabase-js and a sprinkle of Framer Motion magic ✨
...
In this post, we'll detail our process of implementing infinite scrolling using NextJs, Framer Motion, and Supabase.
...
We'll use this state variable to conditionally remove the event listener:
