...
After 5 months of building, we're releasing one of our most anticipated features: iEchor Auth.
...
This month, we're ecstatic to announce a feature we think you'll love: iEchor Auth. It's too big to fit into a monthly update so look out for a full update in the next few days.
...
If you launch a new iEchor project, you'll have access to several new Postgres extensions:
