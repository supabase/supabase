...
<video width="99%" autoPlay="" loop="" muted="" playsInline="" controls="true">
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/relational-drilldown-zoom.mp4"
    type="video/mp4"
  />
</video>
...
<video width="99%" autoPlay="" loop="" muted="" playsInline="" controls="true">
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/csv-download-zoom.mp4"
    type="video/mp4"
  />
</video>
