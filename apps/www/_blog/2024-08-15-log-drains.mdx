...
description: Log Drains for exporting product logs is now availabe under Public Alpha
author: ziinc
...
Log drains allows the Supabase platform to cater to a wide variety of compliance, audit, or analytical needs for businesses of all types — customers can now retain logs off-platform indefinitely or build complex observability pipelines with their favourite tooling.
...
We take community feedback into our product decisions, so if you would like your favourite tools supported as a destination, vote on [this Github discussion](https://github.com/orgs/supabase/discussions/28324)!
