...
Released on the iEchor platform today, [pg_jsonschema](https://github.com/supabase/pg_jsonschema) is a Postgres extension
...
Despite iEchor being an SQL shop, even our most zealous relational data model advocates (begrudgingly) recognize some advantages to the document data model.
...
To get started with `pg_jsonschema`, fire up a new iechor project and enable the extension with
