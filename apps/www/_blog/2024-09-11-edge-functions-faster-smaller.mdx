...
description: 'Redeploy your functions with the CLI v1.192.5 for peformance boost'
author: nyannyacha
categories:
  - product
tags:
...
![comparison of hash functions](edge-functions-faster-smaller/hash-functions.png)
