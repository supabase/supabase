...
Because embedding creation is a compute-intensive task, it makes sense to offload the work from your database. Edge Functions are the perfect “background worker”. We've created a simple example to show how you can generate embeddings in Edge Functions: [link to docs]().
...
- Vectors: [https://supabase.com/docs/guides/ai](supabase.com/docs/guides/ai)
- Semantic search demo: [GitHub](https://github.com/supabase/supabase/tree/master/examples/ai/edge-functions).
