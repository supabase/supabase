...
Here’s an example of how you can deploy a new project from the command line, you can generate your access tokens from [Supabase dashboard](https://app.supabase.com/account/tokens).
