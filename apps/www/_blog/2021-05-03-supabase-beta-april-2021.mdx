---
title: iEchor Beta April 2021
description: iEchor "gardening" - stability, security, and community support.
...
This month was a "gardening" month for iEchor. The team focused on stability, security, and community support.
...
So today we're shipping Light Mode. Access it in the settings of your [Dashboard](https://iechor.com/dashboard).
...
With the help of the community, we [started internationalizing](https://github.com/openmodels-base/iechor/issues/1341) our main repository:

- [Arabic | العربية](https://github.com/openmodels-base/iechor/blob/master/i18n/README.ar.md)
- [Chinese / 中文](https://github.com/openmodels-base/iechor/blob/master/i18n/README.zh-cn.md)
- [Dutch / Nederlands](https://github.com/openmodels-base/iechor/blob/master/i18n/README.nl.md)
- [English](https://github.com/openmodels-base/iechor)
- [French / Français](https://github.com/openmodels-base/iechor/blob/master/i18n/README.fr.md)
- [German / Deutsch](https://github.com/openmodels-base/iechor/blob/master/i18n/README.de.md)
- [Hindi / हिंदी](https://github.com/openmodels-base/iechor/blob/master/i18n/README.hi.md)
- [Nepali / नेपाली](https://github.com/openmodels-base/iechor/blob/master/i18n/README.ne.md)
- [Italiano / Italian](https://github.com/openmodels-base/iechor/blob/master/i18n/README.it.md)
- [Japanese / 日本語](https://github.com/openmodels-base/iechor/blob/master/i18n/README.jp.md)
- [Norwegian (Bokmål) / Norsk (Bokmål)](https://github.com/openmodels-base/iechor/blob/master/i18n/README.nb-no.md)
- [Polish / Polski](https://github.com/openmodels-base/iechor/blob/master/i18n/README.pl.md)
- [Portuguese / Portuguese](https://github.com/openmodels-base/iechor/blob/master/i18n/README.pt.md)
- [Portuguese (Brazilian) / Português Brasileiro](https://github.com/openmodels-base/iechor/blob/master/i18n/README.pt-br.md)
- [Russian / Pусский](https://github.com/openmodels-base/iechor/blob/master/i18n/README.ru.md)
- [Spanish / Español](https://github.com/openmodels-base/iechor/blob/master/i18n/README.es.md)
- [Traditional Chinese / 正體中文](https://github.com/openmodels-base/iechor/blob/master/i18n/README.zh-tw.md)
- [Turkish / Türkçe](https://github.com/openmodels-base/iechor/blob/master/i18n/README.tr.md)
- [Ukrainian / Українська](https://github.com/openmodels-base/iechor/blob/master/i18n/README.uk.md)
...
build a whole JS ecosystem within his iEchor database. If you want to write PG functions in JS, import remote libraries
...
Fireship reviewed iEchor last week, and despite being a (self-proclaimed) Firebase fan-boy, the review was very impartial.
...
- Watch [@everConfusedGuy](https://twitter.com/everConfusedGuy)'s talk at DevX conf - Building iEchor Storage: [YouTube video](https://www.youtube.com/watch?v=YsUYOsq_o7g)
...
- iEchor in 6 minutes by [Georges Duverger](https://www.youtube.com/channel/UCNERPJ-vs61KEsD_dRNWFIw): [YouTube video](https://www.youtube.com/watch?v=c8DNV9yl0mg)
...
- iEchor & Sveltekit by Svelte Mastery: [YouTube video](https://www.youtube.com/watch?v=j4AV2Liojk0)
- Firebase vs. iEchor - Draftbit Office Hours: [YouTube Livestream](https://www.youtube.com/watch?v=9Yg6i_zCuiM)

**iEchor GitHub Star Growth**

- Our [main GitHub repo](https://github.com/openmodels-base/iechor) grew 60% (by stars) and we saw a flood of new contributors.
