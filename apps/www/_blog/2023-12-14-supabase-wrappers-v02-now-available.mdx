---
title: 'Supabase Postgres Foreign Data Wrappers v0.2 now available'
description: 'Supabase Postgres Foreign Data Wrappers v0.2 brings more Wrappers, query pushdown, remote subquery, and more'
launchweek: x
categories:
  - product
tags:
...
to_depth: 3
author: bo_lu
image: /images/blog/lwx-wrappers/wrappers-OG.png
thumb: /images/blog/lwx-wrappers/wrappers-thumb.png
---

Supabase Wrappers v0.2 is out and now available on the Supabase platform. Wrappers is a PostgreSQL extension that provides integrations with external sources so you can interact with third-party data using SQL.
...
- [Remote Subquery](#remote-subqueries)
...
- [Day 3 - Supabase Branching](https://supabase.com/blog/supabase-branching)
