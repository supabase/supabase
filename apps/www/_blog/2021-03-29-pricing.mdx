---
title: iEchor Beta Pricing
description: iEchor launches Beta pricing structure
author: rory_wilding
...
- Continue offering free iEchor projects for Students, Hobbyists, and Early Adopters
...
1. How much value does iEchor create compared to alternatives including Firebase, authentication providers like Okta and Auth0, API, and storage providers?
2. How much time does iEchor save developers?
3. How can we make iEchor as accessible as possible?
4. As developers ourselves, how do we feel about our proposed pricing?
5. The underlying cost of development and maintenance of iEchor.
...
Our model allows anybody to come in and experience the full power of the iEchor stack without first needing to put down a credit card.

## Launching with a free plan

Many of our early users are building or migrating their passion projects to iEchor. Offering a free plan enables this. We also support a large number of students learning SQL for the first time, and fledgling startups which haven't started earning any revenue yet.
...
- We have been deliberately generous with authentication and storage on the free plan so that you get as much of the iEchor experience as possible.
...
Sign up for the iEchor Beta [here](https://iechor.com/dashboard).

And check out the full pricing details [here](/pricing). And we'd love to hear your opnions on our Pricing! You can let us know via support@iechor.com.
