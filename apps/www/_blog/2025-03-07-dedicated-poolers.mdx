...
Introducing Dedicated Poolers is a step towards a more flexible pricing model, allowing you to choose the right connection type for your use case. If you need dedicated hardware, you can now opt for a Dedicated Pooler. This gives you lower latency, better performance, and higher reliability.
