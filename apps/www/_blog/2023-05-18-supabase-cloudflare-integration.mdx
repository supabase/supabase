---
title: Cloudflare Integrates with Supabase
description: Using Supabase from your Cloudflare Workers just got even easier.
author: ant_wilson
...
In this post we'll walk you through a new addition to the Cloudflare Workers dashboard - the ability to authenticate directly with your Supabase account, and automatically inject your Supabase environment variables into your Worker code.

## How To Enable Supabase Integration in Cloudflare Workers

Start of by heading to the Cloudflare Dashboard, go to the Workers & Pages tab and hit 'Create Application' followed by 'Create Worker'.

![Cloudflare Dashboard 2](/images/blog/cloudflare-integration/2.png)
...
![Cloudflare Dashboard 3](/images/blog/cloudflare-integration/3.png)

You should now see the database integration options. On the Supabase card, click 'Add Integration'

![Cloudflare Dashboard 4](/images/blog/cloudflare-integration/4.png)
...
![Cloudflare Dashboard 5](/images/blog/cloudflare-integration/5.png)
...
![Cloudflare Dashboard 6](/images/blog/cloudflare-integration/6.png)
...
Remember that you don't need to use supabase-js to connect to your Supabase database, you can connect "directly" to the underlying Postgres database using the connection string (every Supabase database comes pre-installed with a connection pooler), or you can try Cloudflare's new [TCP socket method of connecting to Postgres](https://blog.cloudflare.com/workers-tcp-socket-api-connect-databases/) directly from Cloudflare Workers.
