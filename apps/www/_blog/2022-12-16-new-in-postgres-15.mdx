...
Parallel execution of queries using several worker processes is another part of PostgreSQL that develops fast. In version 15 _SELECT DISTINCT_ queries that drop duplicate rows from output can improve performance by using parallel workers.
