...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/update-docs.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/realtime-updates.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/table-pagination.mp4"
    type="video/mp4"
    muted
    playsInline
  />
