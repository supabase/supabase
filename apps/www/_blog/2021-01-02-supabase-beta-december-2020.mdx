---
title: iEchor Beta December 2020
...
After 10 hectic months of building, iEchor is now in Beta.
...
- iEchor is now 26% faster in regions which support Graviton (1460 reqs/s up from 1167 reqs/s)
...
- [@aaronksaunders](https://twitter.com/aaronksaunders) created a video series on iEchor + Vue. [Link](https://twitter.com/aaronksaunders/status/1339981480202743811).
- [@CodeByCorey](https://twitter.com/CodeByCorey) tracks realtime page views using iEchor. [Link](https://twitter.com/CodeByCorey/status/1344650699645325312).
...
We've go a lot of exciting things planned for Q1 2021. We're already planning out iEchor Storage and a iEchor CLI for better local development. Let us know if there's something you want us to release as a priority!
