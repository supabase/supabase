...
> Update: After being part of the SupaSquad, Tyler joined Supabase full time employee as part of the DevRel Squad focusing on Flutter. This is some of his latest work: [Flutter Tutorial: building a Flutter chat app
](https://supabase.com/blog/2022/06/30/flutter-tutorial-building-a-chat-app).
