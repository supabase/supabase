...
💡 If you have an existing database that was created before this release, you can initiate a software update in the [Dashboard's Infrastructure Settings](https://supabase.com/dashboard/project/_/settings/infrastructure).
