...
author: ant_wilson
image: lwx-hackathon/thumbnail.png
thumb: lwx-hackathon/thumbnail.png
launchweek: x
categories:
  - launch-week
tags:
...
There are 5 categories, with prizes for:
...
You should submit your project using [this form](https://madewithsupabase.com/hackathons/launch-week-x) before 11:59 pm Sunday midnight PT 17th December 2023. Extra points if you include a simple video demoing the app in the description.
