...
description: 'PostgREST 12 is out and we take a look at some of our favorite new features like JWT Caching and Aggregate Functions'
launchweek: x
categories:
  - product
tags:
...
PostgREST 12 is out, and we're happy to announce that it's available on [new Supabase projects](https://supabase.com/dashboard/new) starting today. In this post, we'll focus on just a few of our favorite features, for the complete list, check out the [release on GitHub](https://github.com/PostgREST/postgrest/releases/tag/v12.0.0).
...
![Media Type Handlers](/blog/lwx-postgrest-12/postgrest-12-media-type-handlers.png)
