...
Late the in build process an idea was floated to try and integrate a _Wordle_ type easter egg into the site. We build some designs to help the discussion:
