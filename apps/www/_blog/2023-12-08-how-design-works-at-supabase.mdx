...
We bias towards the 80% of developers using Supabase. Following the [Pareto Principle](https://www.investopedia.com/terms/1/80-20-rule), we focus on the smallest changes that have the largest impact on our userbase.
