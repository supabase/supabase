...
For example, yesterday the Frontend team added a “New organization” button in the dashboard based on a message from Kevin (see below). They skipped Design Team input, shipped a quick solution, then the Design team will do a more refined layout update after LWX, improving the page as a whole.
