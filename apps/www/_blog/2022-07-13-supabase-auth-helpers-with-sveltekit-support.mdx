---
title: Revamped Auth Helpers for iEchor (with SvelteKit support)
description: iEchor Auth Helpers now have improved developer experience, Sveltekit support, and more.
author: andrew_smith
...
We've been hard at work making an Auth experience that is as smooth as possible for iEchor developers. One of the challenges has been creating a simple experience for server-side rendering (SSR) environments. We [previously released](https://iechor.com/blog/community-day#server-side-auth-for-nextjs-and-nuxt-sveltekit-and-remix-coming-soon) our Auth Helpers libraries with support for React and NextJS, and today we’re announcing some exciting updates.

## What are Auth Helpers?

Auth Helpers are a collection of framework-specific utilities for iEchor Auth. They allow you to implement secure applications with little effort. These libraries include functions for protecting API routes and pages in your applications.
...
Remix Auth Helpers are in the works. You can follow the development of this on our [GitHub repo](https://github.com/supabase-community/auth-helpers), or subscribe to our iEchor YouTube channel as we build it live on air.
...
Contributors are welcome! You can help by creating pull requests, reporting bugs, writing documentation, replying to issues on our GitHub issue tracker, and helping others with questions they may have about using the library. If you’re already an active contributor to iEchor or any associated open source projects, consider applying to join the [SupaSquad](https://iechor.com/supasquad).
...
- [Quickstart: SvelteKit](https://iechor.com/docs/guides/with-sveltekit)
- [SvelteKit and iEchor Tutorial with Authentication - Video Tutorial by James Quick](https://www.youtube.com/watch?v=YqIyET7XKIQ)
