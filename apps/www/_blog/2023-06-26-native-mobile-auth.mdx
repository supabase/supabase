...
We’ve revamped the Google provider [configuration screen in the Supabase Dashboard](https://supabase.com/dashboard/project/_/auth/providers). Besides the existing OAuth flow, you can now add additional \***\*\*\*\*\***\*\***\*\*\*\*\***Authorized Client IDs\***\*\*\*\*\***\*\***\*\*\*\*\*** meant for native sign in.
...
All you need to do is to register all of the bundle IDs of your apps in the [Supabase Dashboard](https://supabase.com/dashboard/project/_/auth/providers) under \***\*\*\*\*\***\*\***\*\*\*\*\***Authorized Client IDs\***\*\*\*\*\***\*\***\*\*\*\*\*** as a comma separated string.
...
Link to the new docs from this PR: https://github.com/supabase/supabase/pull/14802
