...
```sql
select * from my_airtable_table; # data from Airtable
```
...
- Supaweek: build a production-ready API backed by Supabase, OpenAI, and Zuplo. [Part 1](https://zuplo.com/blog/2023/09/25/using-openai-and-supabase-db-to-create-an-api)
