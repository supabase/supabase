...
image: launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/header.png
thumb: launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/header.png
tags:
  - tutorial
  - launch-week
  - Next-js
...
While Supabase Launch Weeks are online, we love the idea of bringing everyone together as if it was an in-person conference. Our ticketing system is one of the ways that we emulate this.
...
![midjoruney experiments](/images/blog/launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/experiments.jpg)
...
![midjourney variations](/images/blog/launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/midjourney-variations.png)
...
![midjourney failed attempts.jpg](/images/blog/launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/failed-attempts.jpg)
...
![midjourney blending variations](/images/blog/launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/midjourney-blending-variations.png)
...
![Screenshot 2023-04-06 at 09.47.47.png](/images/blog/launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/launch-week-7-ticket-home.png)
...
<figure>
  ![Main background image](/images/blog/launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/ticket-backdrop.png)
  <figcaption>
...
<figure>
  ![Ticket
  outline](/images/blog/launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/ticket-outline.png)
  <figcaption>Ticket outline</figcaption>
</figure>

<figure>
  ![Random AI generated background for the ticket
  outline](/images/blog/launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/ticket-ai-background.png)
...
<figure>
  ...
  ticket!](/images/blog/launch-week-7/designing-with-ai-designing-unique-artwork-for-every-user/ticket-details.png)
...
![Screenshot 2023-04-07 at 5.33.51 PM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/c83cbf92-79fd-486c-8ee9-3a49be351c00/Screenshot_2023-04-07_at_5.33.51_PM.png)

If you’re interested in a more detailed step-by-step guide to reproduce this effect, take a look at the [Infinite scroll with NextJs, Supabase and Framer Motion](https://www.supabase.com/blog/infinite-scroll-with-supabase) blog post.
...
Supabase mechanical keyboard
_In fact, we have 3 of them to give away!_ Guaranteed to annoy your co-workers/cat/partner/ yourself.

Socks
_Perfect for your `<footer>`. Right?!.. anyway._

T-shirts
_Just don’t put them in a tumble dryer_

and; of course a bunch of stickers to ruin your laptop lids with.
