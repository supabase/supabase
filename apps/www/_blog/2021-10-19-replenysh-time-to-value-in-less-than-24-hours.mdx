...
imgSite: replenysh/thumb-replenysh.png
categories:
  - company
tags:
  - auth
...
[Firebase](https://supabase.com/alternatives/supabase-vs-firebase) seemed appealing due to its ability to get started quickly, but the team didn't want to migrate away from a relational database. Specifically, Postgres and RLS fit their requirements.
