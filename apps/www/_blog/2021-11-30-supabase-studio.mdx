...
<details>
  ...
  Sentry do a fantastic job of{' '}
  <a href="https://develop.sentry.dev/sentry-vs-getsentry/">documenting their strategy</a> for
  managing a shared codebase and served as a great model for Supabase.
</details>
