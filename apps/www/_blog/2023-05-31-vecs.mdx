...
Once you're happy with your vecs collection, you can make it acessible to your front-end and supabase-js by exposing the collection as a view

## Future ideas

Currently, `vecs` is unopinionated about where vectors come from or how their produced. While there will always be a need for generic vector
storage and querying, its becoming clear that text and image vectorization make up +95% of usage. That gives us the opportunity to
