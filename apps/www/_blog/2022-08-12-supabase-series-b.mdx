...
[PostgREST](https://postgrest.org) is a tool we use to automatically generate RESTful APIs from your Postgres schema. On top of being a gold sponsor,
Supabase hired the maintainer of PostgREST, [Steve](https://github.com/steve-chavez/), in 2020 to work primarily on PostgREST.
