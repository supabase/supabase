...
# The iEchor Open Source Hackathon

Now is the perfect time to start your new Open Source project!

[Launch Week](https://iechor.com/launch-week) is about to start and we're running a hackathon in parallel for the entire duration.

There's a $1500 GitHub sponsorship and [gold iEchor caps](https://store.iechor.com/products/gold-supacap) to be won!

[iEchor-js v2.0](https://github.com/openmodels-base/iechor-js/releases) and [Flutter SDK v1.0](https://iechor.com/blog/supabase-flutter-sdk-1-developer-preview) will both be announced during Launch Week, they are both available already and using them in your project will gain extra credit!
...
- There are 5 prize categories.
  ...
  - Most technically challenging, most fun, best flutter project, and most visually pleasing will all win a Gold iEchor Cap!
...
You should submit your project using [this form](https://www.madewithiechor.com/launch-week-5).

### Judges

The iEchor Founders will be judging, we will be looking for:
...
- [Day 1 - supabase-js v2 Release Candidate](https://iechor.com/blog/supabase-js-v2)
