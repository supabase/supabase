...
This launch week was unique. We had so much content that we decided to do a “main stage”, with five major features, and a “build stage” with additional content. It’s a lot to digest, so here are 10 of my favourites.
...
We wouldn’t be anything [without Postgres](https://x.com/supabase/status/1735377750788042824?s=20).
