---
title: 'Postgres Best Practices for AI Agents'
...
Today, we are releasing a series of Agent Skills for [Postgres Best Practices](https://github.com/supabase/agent-skills) to teach AI agents how to write better Postgres code. AI coding agents are good at writing code. They struggle with writing _correct_ code for systems they don't understand.
...
- **Security and RLS (Medium-High):** Row Level Security policies and access control patterns
...
The repo is live at [github.com/supabase/agent-skills](http://github.com/supabase/agent-skills).

Install the skill, try it on your next Postgres project, and let us know what rules are missing.
