...
description: 'Sync Stripe webhook data directly to Postgres databases via npm.'
categories:
  - product
  - launch-week
tags:
...
<Img
  src="/images/blog/launch-week-15/day-2-stripe-engine/stripe-sync-engine.png"
  alt="Stripe Sync Engine Diagram"
/>

## Why sync Stripe data to Postgres?

While Supabase offers a convenient foreign data wrapper (FDW) for Stripe, sometimes you want your Stripe data _locally available_ in your Postgres database for:
...
As webhooks come in, the data is automatically persisted in the `stripe` schema. For a full guide, please refer to our [repository docs](https://github.com/supabase/stripe-sync-engine/blob/main/edge-function.md).
