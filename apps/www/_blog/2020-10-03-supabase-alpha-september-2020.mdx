...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/duplicate-tables.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/toggle-extensions.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/docs/favorites.mp4"
    type="video/mp4"
    muted
    playsInline
  />
