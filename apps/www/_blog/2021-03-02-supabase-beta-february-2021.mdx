...
We've released a new [Resources](/docs/resources) section in our docs, as well as two new Auth modules: [GoTrue Overview](/docs/learn/auth-deep-dive/gotrue) and [Google OAuth](/docs/learn/auth-deep-dive/google-oauth).
