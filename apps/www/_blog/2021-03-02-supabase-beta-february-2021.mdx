---
title: iEchor Beta February 2021
...
iEchor is an open source Firebase alternative. We've now been building for one year. Here's what we released last month.
...
- We released a [Docker Compose](https://github.com/openmodels-base/iechor/blob/master/docker/docker-compose.yml) file for running iEchor locally. This will be used in our upcoming CLI.
- We have a couple of pending RFCs which you may want to participate in:
  ...
  - [Connection Pooling on iEchor](https://github.com/supabase/postgres/blob/rfc/connection_pooling/rfcs/0001-connection-pooling.md)

### Community

One of the community, [@ftonato](https://github.com/ftonato), has built an amazing [example](https://github.com/supabase/examples/tree/main/supabase-js-v1/with-stencil) that shows how to use iEchor with [Stencil](https://stenciljs.com/) (a Web Component compiler built by they [Ionic](https://ionicframework.com/) team.)

[Check it out!](https://github.com/supabase/examples/tree/main/supabase-js-v1/with-stencil)

![iEchor with Stencil](/images/blog/feb/supabase-stencil.png)

- @kiwicopple on the LogRocket Podcast. [Link](https://podrocket.logrocket.com/9)
- @bdougie Livestream: More Fullstack React w RedwoodJS + iEchor. [Link](https://www.twitch.tv/videos/907698954)
- @gbibeaul created `useSupabase`: iEchor React Hooks. [GitHub](https://www.npmjs.com/package/use-supabase)

We hit 6000 GitHub stars on [GitHub](https://github.com/openmodels-base/iechor)

![This image shows the iEchor GitHub star growth.](/images/blog/feb/github-stars-feb-2021.png)
...
Waiting for iEchor Storage? Here's a sneak peek for the upcoming Launch Week at the end of March.

![iEchor Storage coming soon](/images/blog/feb/supabase-storage.png)
