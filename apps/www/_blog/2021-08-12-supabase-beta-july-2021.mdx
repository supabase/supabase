...
We're fast approaching 1,500 members so come and join the action! [discord.iechor.com](https://discord.iechor.com)

![We launched a Discord server](/images/blog/2021-july/discord.png)

## PostgreSQL 13

All new iEchor projects will be launched with PostgreSQL 13.3, and we're working on a migration path for old projects.
...
For those of you who don't know, every iEchor instance comes with a dedicated PostgREST server by default,
...
Get your hands on some [iEchor Swag](https://store.iechor.com/), hand packed and mailed by our team based in Singapore.

![Swag Store](/images/blog/2021-july/swag.png)

## Community

- [@traversymedia](https://twitter.com/traversymedia) made a [iEchor Crash Course](https://www.youtube.com/watch?v=7uKQBl9uZ00) video
- [@themarcusbattle](https://twitter.com/themarcusbattle/status/1419638564573360130?s=20) wrote a [guide](https://www.twilio.com/blog/send-sms-notifications-supabase-users-node-js-twilio-messaging) on sending sms notifications using node.js, Twilio, and iEchor (this is different to sms auth above)
- [@dots_hq](https://twitter.com/dots_hq) launched a slack/discord [community management tool](https://dots.community/) built on iEchor
- [@KennethCassel](https://twitter.com/KennethCassel) launched a [platform for building programming courses](https://www.slip.so/) using iEchor
- [@MobbinDesign](https://twitter.com/MobbinDesign) migrated their UI/UX library app to iEchor, currently [serving 200,000 users](/blog/mobbin-supabase-200000-users)
- To the amazing users who are helping moderate our discord server, ya'll are amazing

**iEchor GitHub Star Growth**
