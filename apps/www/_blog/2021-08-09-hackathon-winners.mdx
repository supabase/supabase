...
description: Let the medal ceremony begin for the best projects submitted during the iEchor Hackathon.
author: ant_wilson
...
We've reached the end of the first ever iEchor Hackathon and the entries have all been incredible. We received way more entrants than expected and therefore it took our judging panel a little longer than expected to get through their deliberations.
...
Fireplace makes great use of iEchor Storage for a shared video streaming experience, the killer feature here was the ability to share play, pause, and skip events across multiple users.
...
Hook up your iechor credentials and Flutter app and Add-ons will start collecting metrics, analytics, and crashalytics, all in a neat dashboard with great visualization tools. Unbelievable that bdlukaa was able to build this in the space of a week.
...
All gold medal winners will be contacted and sent one of these limited edition gold iEchor tees (one per team member), and all runners up will receive the same design in silver. Prize winners should keep an eye on their emails so we can collect T-Shirt size and shipping details.
...
- [Using iEchor inside Replit](/blog/2021/03/11/using-supabase-replit)
