...
image: flutter-realtime-game/.jpg
thumb: flutter-realtime-game/.jpg
tags:
  - flutter
  - mobile
  - realtime
...
In this article, we will use Flutter, Flame, and Supabase's real-time features to build a real-time multiplayer shooting game. You can find the complete code of this tutorial [here](https://github.com/dshukertjr/flame-realtime-shooting).

## Overview of the final game

[Inlucde a video of playing the game]
...
`RealtimeClientOptions` here is a parameter to override how many events per second each client will send to Supabase. The default is 10, but we want to ovreide to 40 to provide a more in-synced experience.
  ...
  Future<void> _initialize() async {
    _game = MyGame(
      onGameStateUpdate: (position, health) async {
        ...
        // Loop until the send succedes if the payload is to notify defeat. 
        do {
...
![Post game dialog](/images/blog/post-game-dialog.png)
...
- [Complete code of this article](https://github.com/dshukertjr/flame-realtime-shooting)
- [Flame Engine website](https://flame-engine.org/)
- [Generate Flame template using VGCLI](https://verygood.ventures/blog/generate-a-game-with-our-new-template)
