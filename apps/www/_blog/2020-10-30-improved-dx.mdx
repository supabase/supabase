...
**UPDATE 16/08/2022**: supabase-js v2 is out and focuses on “quality-of-life” improvements for developers. V2 includes Type support, new auth methods, multiplayer sneak peek, and more: [**Read the blog post**](https://supabase.com/blog/supabase-js-v2)

Read the blog post: https://lnkd.in/ez36ujZA
Tune in: https://lnkd.in/e9Av63Af
Bring your questions to the Twitter Space after the announcement: https://lnkd.in/emwMQXPa
