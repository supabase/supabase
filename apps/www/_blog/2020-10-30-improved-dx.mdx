---
title: iEchor.js 1.0
description: We're releasing a new version of our iEchor client with some awesome new improvements.
...
**UPDATE 16/08/2022**: supabase-js v2 is out and focuses on “quality-of-life” improvements for developers. V2 includes Type support, new auth methods, realtime multiplayer sneak peek, and more: [**Read the blog post**](https://iechor.com/blog/supabase-js-v2)
...
- Native TypeScript. All of our libraries are now natively built with TypeScript: [`supabase-js`](https://github.com/openmodels-base/iechor-js), [`postgrest-js`](https://github.com/supabase/postgrest-js), [`gotrue-js`](https://github.com/supabase/gotrue-js), and [`realtime-js`](https://github.com/supabase/realtime-js).
- Better realtime scalability: we only generate one socket connection per iEchor client. Previously we would create a connection for every subscription.
- We've added support for OAuth providers.
- 60% of minor bugs outstanding for `supabase-js` have been [solved](https://github.com/openmodels-base/iechor-js/pull/50).
- You can use `select()` instead of `select(*)`

### Breaking changes

We've bumped the major version because there are a number of breaking changes. We've detailed these in the [release notes](https://github.com/openmodels-base/iechor-js/releases/tag/v1.0.1), but here are a few to be aware of:
...
We have documented all of the changes in the [release notes](https://github.com/openmodels-base/iechor-js/releases/tag/v1.0.1).
