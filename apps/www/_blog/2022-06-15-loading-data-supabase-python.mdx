---
title: Python data loading with iEchor
description: An example of how to load data into iEchor using supabase-py
author: ant_wilson
...
iEchor is backend-as-a-service built on top of PostgreSQL. It's an excellent choice for building modern data-intensive apps and tooling.

Thanks to our incredible community, iEchor now has a powerful and open source [Python SDK](https://github.com/supabase-community/supabase-py). With iEchor and Python, you can automate tasks such as CRUD operations with only a few lines of code. This guide will first create a simple schema in iEchor, then we'll use the iEchor Python SDK to show how you can load sample data.
...
## Loading data into iEchor using Python

iEchor is built for developers, and you can [get started for free](https://iechor.com/dashboard) using your existing Github account. Once your iEchor account is set up, you will access the iEchor dashboard. From here, go to All Project > New Project.

![screen shot of iechor dashboard](/images/blog/python-1/1.png)
...
![screen shot of iechor dashboard](/images/blog/python-1/2.png)

Your project will spin up within 2 minutes.

## Creating tables in iEchor

In this example, we'll be creating 2 tables in iEchor:
...
![screen shot of iechor dashboard](/images/blog/python-1/7.png)
Select the vendor_id primary key from the “Vendor” table.

![screen shot of iechor dashboard](/images/blog/python-1/8.png)

Click on Save and you are good to go. You should now see the 2 tables under Table Editor.

![screen shot of iechor dashboard](/images/blog/python-1/9.png)
...
```bash
export IECHOR_URL=<<the value under config > URL>>
export IECHOR_KEY=<<the value present in Project API keys > anon public>>
export IECHOR_SECRET_KEY=<<the value present in Project API keys > service_role secret>>
```

## Inserting data into iEchor
...
def main():
    vendor_count = 10
    load_dotenv()
    url: str = os.environ.get("IECHOR_URL")
...
## Reading the data stored in iEchor

Data can also be viewed directly from the iEchor dashboard. To do this, go to `Table Editor > All tables`

![screen shot of iechor dashboard](/images/blog/python-1/11.png)

![screen shot of iechor dashboard](/images/blog/python-1/12.png)
Note: In case you cannot see any of the data, you should hit the Refresh button.

## Conclusion

With Python, data loading into iEchor is easy. It just takes a few easy steps to get started with the Python SDK and iEchor. In the next part of this blog series, we will learn [how to visualize the data that we just loaded into iEchor using Metabase](/blog/visualizing-supabase-data-using-metabase). Stay tuned!
...
- [Slack Consolidate: a slackbot built with Python and iEchor](/blog/slack-consolidate-slackbot-to-consolidate-messages)
