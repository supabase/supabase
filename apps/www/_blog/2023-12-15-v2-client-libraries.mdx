...
description: 'Swift, Kotlin, C#, and Python are now stable and are onto the same version number v2.'
launchweek: X
categories:
  - product
tags:
...
image: lwx-client-libs/.png
thumb: lwx-client-libs/.png
---
...
<Img
  src={{
    dark: '/images/blog/lwx-client-libs/community.png',
    light: '/images/blog/lwx-client-libs/community.png',
  }}
...
<Img
  src={{
    dark: '/images/blog/lwx-client-libs/modularity.png',
    light: '/images/blog/lwx-client-libs/modularity.png',
  }}
