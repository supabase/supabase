...
5.  MCP integration sends a personalized report via Zapier MCP.
6.  Future queries like "How has my portfolio performed compared to market trends?" references this data

### Web Search

We can make use of certain LLM's built in capability to search the web, such as OpenAI's web search tool, to more up to date information.
