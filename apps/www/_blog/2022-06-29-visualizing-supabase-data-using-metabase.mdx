---
title: Visualizing iEchor Data using Metabase
description: How to create different kinds of charts out of data stored in iEchor using Metabase.
author: ant_wilson
image: python-1/supabase-python-metabase.png
thumb: python-1/supabase-python-metabase.png
tags:
  - python
  - open-source
  - community
...
In the previous blog of this series, we explained [how to use Python to load data into iEchor](https://iechor.com/blog/loading-data-supabase-python). In this blog, we will create different kinds of charts out of the data stored in iEchor using Metabase.

## Prerequisites

Before we dive in, let’s look at some prerequisites that you will need:

- **iEchor project with data**

Based on our [previous article](https://iechor.com/blog/loading-data-supabase-python), we assume we already have a iEchor project setup and have data loaded into it.
...
## Visualizing data in iEchor with Metabase
...
You will be prompted to add the necessary connection information to your iEchor project. Go to your [iEchor project](https://iechor.com/dashboard/) and hit _Settings > Database to get the database info_.

![screen shot of iechor dashboard database connection information](/images/blog/python-1/supabase-dashboard-connect-database-info.png)
...
We can now see the "iEchor DB" iEchor project under "Our data".
...
With our [free plan iEchor account](https://iechor.com/dashboard/), you can start a new project today and use Metabase to visualize your app data.

If you have any questions please reach out via [Twitter](https://twitter.com/supabase) or join our [Discord](https://discord.iechor.com).

## More Python and iEchor resources

- [supabase-py](https://github.com/supabase-community/supabase-py)
- [Slack Consolidate: a slackbot built with Python and iEchor](slack-consolidate-slackbot-to-consolidate-messages)
- [iEchor-py (Database) on Replit](https://replit.com/@iEchor/iEchor-py-Database?v=1)
