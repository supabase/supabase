...
To take advantage of the open-source version of Metabase, you can use the Metabase docker container [here]([https://docs.docker.com/engine/install/](https://hub.docker.com/r/metabase/metabase/).
