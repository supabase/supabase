...
description: 'We are rolling out access to early-access subscribers.'
launchweek: X
categories:
  - product
tags:
...
We are operating on a first-signed-up, first-served basis. For now, we are onboarding organizations on paid plans.

<Img src="/images/blog/lwx-supabase-branching/branching-ui.png" wide={true} />
...
<Img
  alt="Tweet showing Guillermo Rauch mentioning Supabase as one of the companies compatible with the Next.js App Router"
  src={'/images/blog/lwx-supabase-branching/vercel-env-var-settings.png'}
  wide={true}
/>
...
ℹ️ If you need to test with production workloads today, check out [Snaplet](https://www.snaplet.dev/) and [Postgres.ai](http://Postgres.ai). Both are great partners of Supabase.
