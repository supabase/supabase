...
Navigate to `Database` in your Supabase Dashboard. Select the `Pipelines` tab, click `Add destination`, choose a Pipelines destination, and click `Enable Pipelines`.
