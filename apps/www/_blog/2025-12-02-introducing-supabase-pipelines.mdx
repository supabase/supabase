...
Our goal with Supabase Pipelines is to let you connect your existing data systems to Supabase. We're actively expanding the list of supported destinations. The first supported destination is Google BigQuery.
...
When you replicate to BigQuery, Supabase Pipelines handles the ongoing change delivery so your analytical system stays up to date.
