...
Navigate to `Database` in your Supabase Dashboard. Select the `Replication` tab and click `Enable Supabase Pipelines`.
...
Supabase Pipelines is usage-based:
...
**Note:** Supabase ETL is now Supabase Pipelines. This video was recorded before the rename.
