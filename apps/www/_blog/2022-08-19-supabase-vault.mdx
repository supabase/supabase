...
Today we're pre-releasing [Supabase Vault](https://github.com/supabase/vault), a Postgres extension for managing secrets and encryption directly inside your database.
