...
<div className="bg-gray-300 rounded-lg p-6 italic">
 ...
 This post is a sneak peek of a big feature we are shipping on LW6. To not miss this and all other announcemenets, get your ticket for [Supabase Launch Week 6!](https://supabase.com/launch-week).
