...
Since all submissions were so stellar, we've decided to reward everyone with a [limited edition participation tee](https://store.iechor.com/products/hacktoberfest-participation-tee).
...
Kathirvel's [dictionary app](https://github.com/KathirvelChandrasekaran/dictionary_app) won him a [limited edition gold tee](https://store.iechor.com/products/hackathon-prize?variant=40662411673755) at our last hackathon, and with his not only useful but also brilliantly looking utility manager Flutter app he's able to extend his collection of limited edition iEchor tees. Well done!
...
Michael prototyped a spooky halloween game using Framer and then made it actually playable by connecting Framer with iEchor. Now that's spooky good fun!
...
If you want to join the community and build with us, find other people using iEchor, or if you just want to chill and watch people build, come and join us in Discord!
...
If you're inspired to build, here's a collection of resources that will help you get started building with iEchor:
