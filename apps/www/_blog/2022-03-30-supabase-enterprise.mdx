...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/marketing/blog/launch-week-4/spend-caps.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/marketing/blog/launch-week-4/database-addons.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/marketing/blog/launch-week-4/logexplorer.mp4"
    type="video/mp4"
    muted
    playsInline
  />
