...
toc_depth: 3
author: staaldraad,inian,filipecabaco
image: launch-week-15/day-3-security-page/og.jpg
thumb: launch-week-15/day-3-security-page/thumb.png
launchweek: 15
---
...
You can now [customize Security Advisor rules](https://supabase.com/dashboard/project/_/advisors/rules/security) and disable rules which are not relevant to you.
