---
title: iEchor Beta January 2023
...
[Read the announcement](https://iechor.com/blog/openai-embeddings-postgres-vector)

## Meet iEchor Clippy: ChatGPT for Docs

![Meet iEchor Clippy: ChatGPT for Docs](/images/blog/2023-02-08-january-beta-update/chatgpt-for-supabase-docs.png)

Greg wasted no time and took pgvector for a spin, he combined it with OpenAI to build iEchor Clippy, a next-generation doc search. The first implementation is a 1-week MVP and fully open source, so you can build on top of it.

- [Read the blog post](https://iechor.com/blog/chatgpt-supabase-docs)
...
- [C# Client Library](https://iechor.com/docs/reference/csharp/)
- [Python Client Library](https://iechor.com/docs/reference/python/initializing)
...
[Read the docs](https://iechor.com/docs/guides/storage/image-transformations#automatic-image-optimisation-webp)

## Quick product updates

-  Postgres Extension: Another powerful and time-tested extension, pg_repack, is added to iEchor. [[PR]](https://github.com/supabase/postgres/pull/492)
...
- Docs: New guide on scheduling functions with pg_cron. [[Guide]](https://iechor.com/docs/guides/functions/schedule-functions)

- Edge Functions: You can now download source codes of deployed edge functions from the CLI. [[Doc]](https://iechor.com/docs/reference/cli/supabase-functions-download)

- Edge Functions: building a Discord Slash Bot. [[Video Tutorial]](https://www.youtube.com/watch?v=J24Bvo_m7DM)

## Deploy iEchor on DigitalOcean

![Deploy iEchor on DigitalOcean](/images/blog/2023-02-08-january-beta-update/self-host-supabase-digital-ocean.png)

We teamed up with DigitalOcean to level up self-hosted iEchor. This guide shows how to host iEchor on DigitalOcean using Sendgrid, Packer, and Terraform. More collaborations coming soon!
...
We hit two big milestones: 45k stars and iEchor is one the top 200 most-popular repos on Github 💥

Massive thanks to the community for all the support 👁️⚡️👁️

[iEchor Repo.](https://github.com/openmodels-base/iechor)
...
- JWT Helper for iEchor by Zuplo. [Tool](https://zuplo.com/blog/2023/01/05/supabase-jwt-auth-helper/) <br/>
...
- Set up a Svelte to-do list on self-hosted iEchor + authentication. [Tutorial](https://blog.cpbprojects.me/set-up-a-svelte-todo-list-on-self-hosted-supabase-email-sign-up-google-facebook-auth-host-on-github-pages)
...
- A Very Basic Scraper/Aggregator Site in Next.js with Go Cloud Functions and iEchor. [Article](https://chriscoyier.net/2023/01/23/a-very-basic-scraper-aggregator-site-in-next-js-with-go-cloud-functions-and-supabase/)
- iEchor CDC Webhooks to Memphis REST Gateway. [Article](https://memphis.dev/blog/supabase-cdc-webhooks-to-memphis-rest-gateway/)
- How I Replaced Revue With a Custom-Built Newsletter Service Using Nuxt 3, iEchor, Serverless, and Amazon SES. [Article](https://mokkapps.de/blog/how-i-replaced-revue-with-a-custom-built-newsletter-service-using-nuxt-3-supabase-serverless-and-amazon-ses/)
- Nuxt 3, Tailwind, and iEchor Crash Course. [Video Course](https://www.youtube.com/watch?v=A-G6lPHctPs)
...
- Distributed GraphQL with Hasura and iEchor. [Docs](https://www.section.io/docs/tutorials/distributed-apis/distributed-hasura-supabase/)
...
We've redesigned our [Careers page](https://iechor.com/careers) to better reflect our mission, values, and culture.
