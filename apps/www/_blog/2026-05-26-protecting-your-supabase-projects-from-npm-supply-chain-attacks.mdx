...
imgThumb: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=platform&layout=icon-text&copy=Protecting+projects+from%0A%5Bnpm+supply+chain+attacks%5D&icon=supabase.svg'
categories:
  - security
tags:
  - security
