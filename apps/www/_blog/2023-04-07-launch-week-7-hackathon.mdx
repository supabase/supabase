...
With Easter just around the corner, [Launch Week](https://supabase.com/launch-week) is about to start and, as usual, we're running an async hackathon alongside it. This time it’s ~~web3~~ AI-themed!
...
- [Launch Week 7 YouTube Shorts](https://www.youtube.com/shorts/e6a4yC3muew)
