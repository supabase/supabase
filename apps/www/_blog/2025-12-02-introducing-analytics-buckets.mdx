...
## Streaming data with Supabase Pipelines

Analytics Buckets work hand in hand with [Supabase Pipelines](/blog/introducing-supabase-pipelines). Supabase Pipelines captures changes from your Postgres database and streams them to Analytics Buckets in near real time.
...
2. Stream all data to Analytics Buckets using Supabase Pipelines
...
4. Set up Supabase Pipelines to stream data from Postgres automatically
