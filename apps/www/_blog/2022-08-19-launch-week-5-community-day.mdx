...
If you’re an avid Launch Week participant, you might have been surprised, because we used to kick off launch week with community day on Mondays. And we used to close out Launch Week with a bunch more things on Friday as well as the kickoff for our virtual Hackathon.

This time, we’re switching things around a bit:

- [Monday to Thursday](https://supabase.com/launch-week) are the big ticket feature launches.
...
We now have a shiny new l[aunch week page](http://supabase.com/launch-week), your one-stop shop for all things Launch Week, where you can find each day’s feature as well as highlights from the past Launch Weeks.

We’ve also taken a page out of [Vercel’s Virtual Events Starter Kit](https://vercel.com/templates/next.js/virtual-event-starter-kit), and generated over 3000 virtual tickets. Thank you all for participating, we love [seeing your tickets on Twitter](https://twitter.com/hashtag/SupaLaunchWeek?src=hashtag_click&f=live)! To make this work, we’ve adapted the Virtual Events Starter Kit and [added in a Supabase Database provider](https://github.com/vercel/virtual-event-starter-kit/pull/88) as an alternative to the Redis database option.

We’ve also added a Golden Ticket mechanic, distributing some special edition launch week swag to some lucky winners. If you’re interested in how we’ve built this, check out the video above with a brief explanation.
...
### [Placeholder] Postgrest v10: Native Types

## New courses & Tutorials

### New free Egghead course: Cache Supabase data at the Edge with Cloudflare Workers and KV Storage
...
### Realtime Trello Board with Angular by Simon Grimm (22:06)
...
- Subscribe to [Simon's YouTube](https://www.youtube.com/simongrimmdev_) where the course will be released soon!
- Find the code on GitHub: [https://github.com/saimon24/supabase-trello-angular](https://github.com/saimon24/supabase-trello-angular)

## New Integration, Expert Partners, and Developer Stories

### CodeSandbox Projects Beta (25:53)
...
### [Zapp.run](http://Zapp.run) by Invertase (36:31)
...
Well, actually a couple more things! As it is now tradition, we have too many things for one week, so at the end of the week we compile everything that didn’t get its own spotlight day, into a nice little box of treats.
