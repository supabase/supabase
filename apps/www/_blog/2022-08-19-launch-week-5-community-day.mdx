...
### Postgrest v10: Native Types

Today, PostgREST v10 was [released](https://github.com/PostgREST/postgrest/releases/tag/v10.0.0).
In this [blog post](/blog/postgrest-v10) we explore all the new features: EXPLAIN, Query Planners, Improved Relationship Detection, and Computed relationships.
