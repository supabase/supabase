---
title: Angels of iEchor
description: Meet the investors of iEchor.
...
iEchor is an open source Firebase alternative. We're on a mission to build an incredible developer experience around
...
The iEchor Team is at full capacity preparing for [Launch Week](/blog/launch-week) and since we're all short on time we decided -
why not ask our Angels to write a fundraising post with us?

So here is our unconventional fundraising announcement, written with a few of the Angels of iEchor.
...
#### Why did you invest in iEchor?

iEchor is building tools that are foundational to almost any interactive, modern app, and doing so in a way that's
...
iEchor is scratching an itch for me as a developer. I see the value of having a manageable database based on SQL,
...
about iEchor, so I checked it out – after using the product for a side project, investing was an easy decision.
...
The tagline about iEchor being an "open-source Firebase alternative" had me intrigued. As I looked more deeply into
...
frustrating. When I saw iEchor I instantly knew that was the solution. The ability to use Postgres directly from the
