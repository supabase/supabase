...
date: '2023-04-14'
to_depth: 3
author: alaister,joshenlim,saltcod
...
<ul>
  <li>[**⌘K Menu with AI**](#k-menu-with-ai): ChatGPT, right in the Studio</li>
  <li>[**GraphiQL**](#item-one): Query your database with GraphQL</li>
  <li>[**Cascade deletes**](#item-one): Our #1 most requested feature from the community</li>
  <li>[**Query Performance**](#item-one): Investiate slow running queries</li>
  <li>[**Foreign key Selector**](#item-one): Lookup a referencing row in another table</li>
  <li>[**Postgres Roles**](#item-one): Manage your Postgres roles and privileges</li>
  <li>[**Database Webhooks**](#item-one): Update webhooks and select Edge Functions</li>
  <li>[**Network restrictions**](#item-one): Block access from specified IP ranges</li>
  <li>[**Table/View definitions**](#item-one): View SQL definitions for tables and views</li>
  <li>[**API Autodocs**](#item-one): Auto-generated docs, right in the Table Editor</li>
  <li>[**Support for many tables**](#item-one): Editor support for thousands of tables</li>
  <li>[**JSON editing**](#item-one): Improved JSON editing</li>
  <li>[**Nullable columns**](#item-one): Allow text/bool cells to be null or empty</li>
</ul>
...
<ImageFadeStack
  autoplay
  showNavigation
  altText="Studio cmdk menu"
  delay={3000}
  images={[
    '/images/blog/lw7-studio/cmdk-1.png',
    '/images/blog/lw7-studio/cmdk-2.png',
    '/images/blog/lw7-studio/cmdk-3.png',
    '/images/blog/lw7-studio/cmdk-4.png',
    '/images/blog/lw7-studio/cmdk-5.png',
  ]}
/>

One of our guiding principles at Supabase is to to make SQL more accessible to developers. We don't want to just abstract it away with a custom implementation. By embracing SQL, developers learn important, transferrable skills while they build on top of Supabase.
...
AI has already changed a lot about the way we work as developers. We can use ChatGPT to write code for us as fast as we cant prompt it. We wanted to bring this power into the Studio with integrations that will help you work even faster than before.
...
We'll be actively working on our ⌘K menu in the coming months to make it faster and even more useful for you. We're going to focus next on better support for writing RLS policies. Stay tuned!
...
![Logs UI](/images/blog/lw7-studio/cascade-deletes.png)
...
<ImageFadeStack
  ...
  delay={4000}
  images={[
    '/images/blog/lw7-studio/foreign-table-lookup-1.png',
    '/images/blog/lw7-studio/foreign-table-lookup-2.png',
    '/images/blog/lw7-studio/foreign-table-lookup-3.png',
    '/images/blog/lw7-studio/foreign-table-lookup-4.png',
    '/images/blog/lw7-studio/foreign-table-lookup-5.png',
    '/images/blog/lw7-studio/foreign-table-lookup-6.png',
    '/images/blog/lw7-studio/foreign-table-lookup-7.png',
  ]}
/>
...
A new add-on for you to configure restrictions on the IP ranges that are allowed to connect to your Postgres database. With network restrictions, you're able to control exactly who has access to your data. Read more in the Docs.
