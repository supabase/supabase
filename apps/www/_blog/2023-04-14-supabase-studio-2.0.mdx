...
thumb: launch-week-7/day-5-supabase-studio-2.0/day-5-supabase-studio-2.0-og.jpg
---
...
<ul>
  <li>[**Supabase AI**](supabase-ai-command-menu): ChatGPT, right in the Studio</li>
  ...
  <li>[**Query Performance**](#item-one): investigate slow running queries</li>
  <li>[**Foreign key Selector**](#item-one): look up a row in reference table</li>
  <li>[**Postgres Roles**](#item-one): manage your Postgres roles and privileges</li>
  <li>[**Database Webhooks**](#item-one): database triggers for Edge Functions</li>
  ...
  <li>[**API Autodocs**](#item-one): view auto-generated docs right from the Table Editor</li>
  <li>[**Support for many tables**](#item-one): Table Editor now supports 1000s of tables</li>
...
We'll be actively working on our ⌘K menu in the coming months to make it faster and even more useful for you. We're going to focus next on better support for writing RLS policies. Stay tuned, and make sure to explore how we're integrating AI [behind the scenes](https://supabase.com/blog/tags/AI)!
