...
description: Learn about the great things we shipped last month. Spoiler alert: AI related.
author: ant_wilson
...
- [Use AI to generate a PostgreSQL database that can play Tony Hawk's Pro Skater](https://www.youtube.com/watch?v=ffdUZbYov9g)
...
- [How to create a chatbot with OpenAI's API: a conceptual cheat sheet](https://dev.to/farez/how-to-create-a-chatbot-with-openais-api-a-conceptual-cheat-sheet-2o5p)
- [How to Implement Role-Based Access with Supabase](https://dev.to/akkilah/how-to-implement-role-based-access-with-supabase-3a2)
- [Rodrigo Mansueli, Developer Support Enginere here at Supabase, started a blog that is starting to become go-to resource for leveling up with Supabase and Postgres](https://blog.mansueli.com/)
