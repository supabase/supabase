...
At Supabase, we believe that a combination of Postgres and pgvector serves as a better alternative to single-purpose databases like Weaviate or Pinecone for AI tasks. This isn't the first time a Postgres-based solution has successfully rivaled specialized databases designed for specific data types. Timescale for time-series data and Greenplum for analytics are just a few examples.

Specialized vector databases claim better performance, as they are tailored specifically for this type of workload. However, we decided to put this to the test and run a direct comparison between pgvector and Pinecone.

## What is Pinecone

Pinecone is a fully managed cloud Vector Database that is only suitable for storing and searching vector data. It offers straightforward start-up and scalability. However, it employs a proprietary ANN index and lacks support for exact nearest neighbors search or fine-tuning. The only setting that allows you to adjust the balance between query accuracy and speed is the choice of pod type when creating an index.
...
- **horizontal scaling** increases the number of pods or creates replicas to boost QPS. This works linearly for Pinecone: doubling the number of replica pods doubles your QPS.
...
<div>
  <img
    ...
    src="/images/blog/2023-10-10-pgvector-vs-pinecone/s1x1--light.png"
  />
  <img
    alt="visual of an example skip list (dark)"
    className="hidden dark:block"
    src="/images/blog/2023-10-10-pgvector-vs-pinecone/s1x1--dark.png"
  />
</div>
...
<div>
  <img
    alt="visual of an example skip list (light)"
    className="dark:hidden"
    src="/images/blog/2023-10-10-pgvector-vs-pinecone/ivfflat--light.png"
  />
  <img
    alt="visual of an example skip list (dark)"
    className="hidden dark:block"
    src="/images/blog/2023-10-10-pgvector-vs-pinecone/ivfflat--dark.png"
  />
</div>
...
<div>
  <img
    alt="visual of an example skip list (light)"
    className="dark:hidden"
    src="/images/blog/2023-10-10-pgvector-vs-pinecone/p1x2--light.png"
  />
  <img
    alt="visual of an example skip list (dark)"
    className="hidden dark:block"
    src="/images/blog/2023-10-10-pgvector-vs-pinecone/p1x2--dark.png"
  />
</div>
...
<div>
  <img
    alt="visual of an example skip list (light)"
    className="dark:hidden"
    src="/images/blog/2023-10-10-pgvector-vs-pinecone/p2x2--light.png"
  />
  <img
    alt="visual of an example skip list (dark)"
    className="hidden dark:block"
    src="/images/blog/2023-10-10-pgvector-vs-pinecone/p2x2--dark.png"
  />
</div>
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Is PGVector really that bad ?<br /><br />Almost 1M vectors on our <a href="https://twitter.com/supabase?ref_src=twsrc%5Etfw">@supabase</a> database and it is 🔥 for <a href="https://twitter.com/quivr_brain?ref_src=twsrc%5Etfw">@quivr_brain</a><br /><br />A few stats:<br />- 13117 users and 400 daily <br />- 9GB of Vectors<br />- 46% Memory Usage (4Gb DB)<br />- Less than 0.5s to retrieve content in similarity search with embedding using… <a href="https://t.co/ezQpot0CvA">pic.twitter.com/ezQpot0CvA</a></p>&mdash; Stan Girard (@_StanGirard) <a href="https://twitter.com/_StanGirard/status/1691135519948787719?ref_src=twsrc%5Etfw">August 14, 2023</a></blockquote><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
- Implementing additional databases would increase operational complexity and the learning curve.
