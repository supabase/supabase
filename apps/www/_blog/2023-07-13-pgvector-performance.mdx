...
description: There are a few pgvector benchmarks floating around the internet, most recently a pgvector vs Qdrant comparison. We wanted to reproduce (or improve!) the results.
tags:
  - AI
  - performance
  - postgres
...
image: 2023-07-13-pgvector-performance/chatgpt-plugins-support-postgres.jpeg
thumb: 2023-07-13-pgvector-performance/chatgpt-plugins-support-postgres.jpeg
---
...
There is an obvious bias here: we're a Postgres company. It is NOT our goal to prove that pgvector is better than Qdrant for running vector workloads - it's not. Qdrant is a specialized Vector engine, and specialized systems always outperform generalized systems. From everything we hear about Qdrant, it's fantastic (even compared to other specialized Vector databases).
...
<div>
  <img
    ...
    src="2023-07-13-pgvector-performance/vecs-bench--light.png"
  />
  <img
    alt="multi database"
    className="hidden dark:block"
    src="2023-07-13-pgvector-performance/vecs-bench--dark.png"
  />
</div>
...
<div>
  <img
    alt="multi database"
    className="dark:hidden"
    src="2023-07-13-pgvector-performance/nirantk--light.png"
  />
  <img
    alt="multi database"
    className="hidden dark:block"
    src="2023-07-13-pgvector-performance/nirantk--dark.png"
  />
</div>
...
With probes set to 10, pgvector was faster and more accurate:
...
<div>
  <img
    alt="multi database"
    className="dark:hidden"
    src="2023-07-13-pgvector-performance/pgvector-optimized--light.png"
  />
  <img
    alt="multi database"
    className="hidden dark:block"
    src="2023-07-13-pgvector-performance/pgvector-optimized--dark.png"
  />
</div>

### PROBES = 40

With probes set to 40, pgvector was not just substantially faster but also boasted almost the same precision as Qdrant:
...
<div>
  <img
    alt="multi database"
    className="dark:hidden"
    src="2023-07-13-pgvector-performance/pgvector-qdrant--light.png"
  />
  <img
    alt="multi database"
    className="hidden dark:block"
    src="2023-07-13-pgvector-performance/pgvector-qdrant--dark.png"
  />
</div>
...
Again, it is NOT our goal to prove that pgvector is better than Qdrant for running vector workloads. The Qdrant benchmark uses “default” configuration and is in not indicative of its capabilities after modifying the configuration.

</Admonition>

Although more compute is required to match Qdrant's precision and RPS levels concurrently, this is still a satisfying outcome. It means that it's not a _necessity_ to use another vector database - if you want to lower your operational complexity, just increase your Postgres size.
...
<div>
  <img
    alt="multi database"
    className="dark:hidden"
    src="2023-07-13-pgvector-performance/size-to-rps--light.png"
  />
  <img
    alt="multi database"
    className="hidden dark:block"
    src="2023-07-13-pgvector-performance/size-to-rps--dark.png"
  />
</div>
...
We ran a test to measure the impact of list size: we uploaded 90,000 vectors from Wikipedia dataset and then queried 10,000 vectors from the same dataset. The documentation recommends to use `lists` constant of `number of vectors / 1000`. In this case, it would be 90.

But as our experiment shows, we can improve select queries speed if we make more lists (i.e. with more lists in the index we need to get less index data to get the same precision). E.g. for a precision of 95%, we need to take

- 3% of index data for 270 lists,
- 6% - for 90 lists,
- and 13% - for 30 lists.
...
<div>
  <img
    alt="multi database"
    className="dark:hidden"
    src="2023-07-13-pgvector-performance/lists-count--light.png"
  />
  <img
    alt="multi database"
    className="hidden dark:block"
    src="2023-07-13-pgvector-performance/lists-count--dark.png"
  />
</div>
...
<div>
  <img
    alt="multi database"
    className="dark:hidden"
    src="2023-07-13-pgvector-performance/lists-for-1m--light.png"
  />
  <img
    alt="multi database"
    className="hidden dark:block"
    src="2023-07-13-pgvector-performance/lists-for-1m--dark.png"
  />
</div>
...
<div>
  <img
    alt="multi database"
    className="dark:hidden"
    src="2023-07-13-pgvector-performance/random-data--light.png"
  />
  <img
    alt="multi database"
    className="hidden dark:block"
    src="2023-07-13-pgvector-performance/random-data--dark.png"
  />
</div>
...
pgvector is still early in development. As with any open source tool, it needs time and resources to make it better. Supabase plans to continue Andrew with his development of pgvector as much as we can.
