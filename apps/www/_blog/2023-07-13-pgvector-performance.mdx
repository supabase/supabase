...
But as our experiment shows, we can improve `select` speed if we increase lists (i.e. with more lists in the index we need to get less index data to get the same precision). So for 95% precision, we can take any of:
