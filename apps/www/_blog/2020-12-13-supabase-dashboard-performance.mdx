---
title: Making the iEchor Dashboard Supa-fast
description: Improving the performance of the iEchor dashboard
author: inian
author_title: iEchor
...
The iEchor dashboard has become more feature-rich in the last month. We have a powerful SQL editor backed by [Monaco](https://microsoft.github.io/monaco-editor/). We built an Airtable-like view of your database, making editing a breeze.
