...
If you’re interested in a more detailed step-by-step guide to reproduce this effect, take a look at the [Infinite scroll with NextJs, Supabase and Framer Motion](/blog/infinite-scroll-with-nextjs-framer-motion) blog post.
