...
description: "We're introducing three new features for Supabase Storage: Image resizing, webhooks, and a Smart CDN."
...
⚠️ Image Resizing is in Beta. While in Beta it is only enabled for Pro-tier and Enterprise customers.
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/6e7895c7-26c9-4e1a-a315-d047c246ce19/Untitled.png)
...
- **Sane defaults:** default mode maintains aspect ratio and the resize mode is `fill`
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/62953cea-f5ef-4331-b621-ce17296cf94e/Untitled.png)
...
- **More Transformations**: quality, rotate, blur? Cast your vote on this GitHub Discussion.
