...
tags:
  ...
  - perplexity
  - integrations
imgSocial: '2026-08-06-supabase-is-now-a-connector-on-perplexity-computer/og.png'
imgThumb: '2026-08-06-supabase-is-now-a-connector-on-perplexity-computer/thumb.png'
toc_depth: 2
---

Supabase is available as a [connector on Perplexity Computer](https://www.perplexity.ai/connectors/supabase?utm_source=supabase&utm_medium=partner&utm_campaign=builders_blog_+aug6). With Supabase as a persistent data layer, Computer can read from and write back to your Postgres tables, keeping state across runs without custom glue code.
...
<div className="video-container">
  <iframe
    className="w-full"
    src="https://www.youtube-nocookie.com/embed/xriUJ3DGfpY"
    title="Supabase is now a connector on Perplexity Computer"
...
Connect Supabase on [Perplexity](https://www.perplexity.ai/connectors/supabase?utm_source=supabase&utm_medium=partner&utm_campaign=builders_blog_+aug6).
