...
image: hardening-supabase/hardening-og.png
thumb: hardening-supabase/hardening-thumb.png
categories:
  - product
tags:
  - security
...
<div>
  <Img
    alt="multi database"
    src={{
      light: '/images/blog/hardening-supabase/traditional-vs-db-centric-architecture--light.png',
      dark: '/images/blog/hardening-supabase/traditional-vs-db-centric-architecture--dark.png',
    }}
  />
</div>
...
If you find any misconfigured projects, we will work with those customers to ensure that they know about the issue and can solve it. If you are a security professional, we welcome your help to secure the Supabase community.
