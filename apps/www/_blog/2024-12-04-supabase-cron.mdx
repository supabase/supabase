...
Today we're releasing Supabase Cron, a new Postgres Module that makes scheduling recurring Jobs simple and intuitive inside your database.
...
Supabase Cron is built on the powerful [`pg_cron`](https://github.com/citusdata/pg_cron) extension by the team at [Citus Data](https://github.com/citusdata). It's Supabase's policy to [support existing tools](https://supabase.com/docs/guides/getting-started/architecture#support-existing-tools) wherever possible, and the Citus team have generously licensed their extension with the OSI-comptible [PostgreSQL license](https://github.com/citusdata/pg_cron?tab=PostgreSQL-1-ov-file). We're very thankful to all the contributors and we look forward to working with the community.
