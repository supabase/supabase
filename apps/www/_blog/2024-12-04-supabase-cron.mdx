---
title: 'Supabase Cron'
description: Schedule and automate tasks using Postgres
...
Today we're releasing Supabase Cron, a new module that makes scheduling and managing database tasks simple and intuitive. It's designed to work seamlessly with the entire Supabase platform. Create Jobs to call Database Functions, Edge Functions, and even remote webhooks.

### What's a Cron?

[**Cron**](https://en.wikipedia.org/wiki/Cron) is a tool for scheduling tasks at specified intervals. These periodic tasks are called “Cron Jobs”. Common use-cases include:
...
Supabase Cron stores the scheduling logic within Postgres and integrates with the rest of the Supabase primitives - the Dashboard, Edge Functions, and AI Assistant.

## How Do You Use Supabase Cron?
You can create Jobs with SQL or the Dashboard.



<Admonition>

For this post we'll focus on the Dashboard. You can refer to the [documentation](https://supabase.com/docs/guides/database/cron) for SQL.
 ...
 Within the Dashboard you can define schedules using standard cron syntax, natural language, or the special `pg_cron` seconds-level syntax.
...
<Img
  alt="Job types"
  src="/images/blog/launch-week-13/day-3-supabase-cron/job-types.jpg"
/>
...
<Img
  alt="View cron logs"
  src="/images/blog/launch-week-13/day-3-supabase-cron/logs.jpg"
/>
...
1. Visit the new [Integrations page](https://supabase.com/dashboard/project/_/integrations) in your project.
2. Enable the **Cron** Module.
...
<Img
  ...
  src="/images/blog/launch-week-13/day-3-supabase-cron/create-job.jpg"
/>
