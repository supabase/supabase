...
description: 'We are launching support for database Read Replicas'
launchweek: x
categories:
  - product
tags:
...
src={{
  dark: "/images/blog/lwx-read-replicas/read-replicas-02.png",
  light: "/images/blog/lwx-read-replicas/read-replicas-02.png"
}}

In the SQL editor, you can choose if you want to run the query on the primary or one of the read replicas.

src={{
  dark: "/images/blog/lwx-read-replicas/read-replicas.png",
  light: "/images/blog/lwx-read-replicas/read-replicas.png"
}}
