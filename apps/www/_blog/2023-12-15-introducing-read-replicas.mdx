...
Today, we are launching support for database Read Replicas. You can use Read Replicas to:
...
<aside>
ℹ️ Our read replicas will inherit the compute size of its primary. They will eventually scale independently.
...
![Group.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/165a3c21-8e38-4d4b-831a-f9bb88a3262b/b4a2f445-3767-4fa1-95f2-3c386c478952/Group.png)

In the SQL editor, you can choose if you want to run the query on the primary or one of the read replicas.

![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/165a3c21-8e38-4d4b-831a-f9bb88a3262b/49a5f807-59fc-4398-8be7-46e4c652bff4/Untitled.png)
...
- old diagrams
    ...
    ![Original diagram](https://prod-files-secure.s3.us-west-2.amazonaws.com/165a3c21-8e38-4d4b-831a-f9bb88a3262b/41130f27-c9a3-4667-b81c-709e299c3a9e/Untitled.png)
    
    Original diagram
    
    ![Suggested changes to the diagram](https://prod-files-secure.s3.us-west-2.amazonaws.com/165a3c21-8e38-4d4b-831a-f9bb88a3262b/45be49e8-1f63-43ad-aa14-fdd8732982b9/Untitled.png)
    
    Suggested changes to the diagram
    

![streaming-replication-dark.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/165a3c21-8e38-4d4b-831a-f9bb88a3262b/f500ebed-404e-49cc-b0a5-83d48479bf02/streaming-replication-dark.png)
...
~~We are rolling out self-serve Read Replica support to all paid plans over the next month. If you want to be prioritized on the rollout, [let us know](https://forms.supabase.com/read-replica)!~~ 
