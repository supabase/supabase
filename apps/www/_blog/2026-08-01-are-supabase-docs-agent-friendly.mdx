...
{/* TODO before merge: replace with the real demo video once it's hosted (see PR description) */}
![Demo video placeholder](/images/blog/are-supabase-docs-agent-friendly/demo-placeholder.png)
