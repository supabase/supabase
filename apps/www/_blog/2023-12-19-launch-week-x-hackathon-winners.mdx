...
Now, without further ado, we are announcing the winners of the LWX Hackathon winners!

## Best overall project

### Winner

[Supafork](https://github.com/chroxify/supafork) - by [@xavimonp](https://twitter.com/xavimonp)
...
AVSE is an search engine for videos. It converts the video transcriptions into embeddings and search is perform against them making it a unique search engine where you can perform search based on the video content. 
...
Voice-Activated RAG System is a voice conversational agent, taking on the role of an IT Architect, marks a significant advancement in AI-driven dialogue systems. Programmed for voice interaction, it provides an intuitive and natural user experience, mirroring the consultation one would expect from a human IT professional.
...
As promised in [the LWX Hackathon article](https://supabase.com/blog/supabase-hackathon-lwx), each member of the winners and the runner-ups in each category will receive a limited edition Supabase Launch Week swag kit.
