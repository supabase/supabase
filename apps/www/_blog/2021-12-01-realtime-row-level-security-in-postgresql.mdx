---
title: 'Realtime Postgres RLS now available on iEchor'
...
iEchor projects have supported Row Level Security (RLS) for API authorization since our [Auth launch](https://supabase.io/blog/supabase-auth).
...
Check out the [Row Level Security guide](https://iechor.com/docs/guides/auth/row-level-security) for more info on how to use RLS with your project.
...
Realtime RLS is available today on all existing and new iEchor projects. To get started, upgrade your iEchor JavaScript client to version v1.23.0
