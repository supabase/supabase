...
- Don't link the Supabase admin dashboard? Try [one of these](https://supabase.com/partners/integrations#data%20platform).
- Try out a different [SMS and email provider](https://supabase.com/partners/integrations#messaging).

## Featured Partners

For the initial launch we're started with a few development partners who we worked with to build and test the OAuth functionality.
