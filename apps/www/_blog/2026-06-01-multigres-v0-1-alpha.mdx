---
title: 'Multigres v0.1 Alpha: an operating system for PostgreSQL'
description: "Today we're releasing Multigres v0.1 alpha to the open source community, bringing Vitess-grade horizontal scaling, high availability, and operational simplicity to PostgreSQL."
author: sugu_sougoumarane
imgSocial: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=platform&layout=icon-text&copy=Multigres+v0.1+Alpha%0Aan+%5Boperating+system%5D+for+PostgreSQL&icon=1780123285988-Multigres+Logo.png'
imgThumb: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=ruler&layout=icon-only&copy=Multigres+v0.1+Alpha%0Aan+%5Boperating+system%5D+for+PostgreSQL&icon=1780123285988-Multigres+Logo.png'
categories:
  - product
  - postgres
tags:
...
Today we're releasing Multigres v0.1 alpha to the open source community, the first public milestone of our mission to bring Vitess-grade horizontal scaling, high availability, and operational simplicity to PostgreSQL. It's early, it's alpha, and we're excited to get it into your hands.
...
- **Built on top of PostgreSQL replication**: The protocol uses unmodified PostgreSQL replication, and yet satisfies all the strict consistency requirements of a consensus-based system.
