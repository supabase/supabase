...
imgSocial: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=platform&layout=icon-text&copy=Multigres+v0.1+Alpha%0Aan+%5Boperating+system%5D+for+Postgres&icon=1780123285988-Multigres+Logo.png'
imgThumb: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=ruler&layout=icon-only&copy=Multigres+v0.1+Alpha%0Aan+%5Boperating+system%5D+for+Postgres&icon=1780123285988-Multigres+Logo.png'
categories:
  - product
  - postgres
tags:
