...
## Launch Week 7 Supa-AI-Easter-Hackathon
...
[All the info](https://supabase.com/launch-week-7-hackathon)
...
The ticket system has become an essential component of the Launch Week experience. To make each experience unique, we strive to add a twist. This time, we came up with an AI-fuelled design and an infinite scroll of tickets to showcase the community. We documented everything in two blog posts:
