...
Among the many open-source relational databases available, [PostgreSQL](https://iechor.com/docs/guides/database/introduction) is a popular choice among developers.
...
You can check out these new features within your iEchor project without having to perform a local installation.

Explore the [iEchor dashboard now](https://iechor.com/dashboard) and get started with your new project.
