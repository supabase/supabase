...
The key feature: **Resumable Uploads**! With Resumable Uploads, you can continue uploading a file from where you left off, even if you lose internet connectivity or accidentally close your browser tab while.

Resumable uploads divides the file into chucks before uploading them, emitting progress events during upload.

[pause-upload.mov](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/fa11b7b6-05fa-4d4a-a807-0bde9678d11a/pause-upload.mov)
...
You can serve images from Storage with a simple Next.js loader for the Image component. Check out [our docs](https://supabase.com/docs/guides/storage/image-transformations#nextjs-loader) on how to get started.
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d72ee859-45df-4db8-922e-9529ae8667fe/Untitled.png)
...
const projectId = 'auafxsswdyhumisptuxe'
...
[parallel-uploads.mov](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/3908b0f6-3a00-4132-86e7-f76e41202638/parallel-uploads.mov)
...
await db.withTransaction(() => {
  ...
  // storage.objects stores the object metadata of all objects
	// It doubles up as a way to check Authz.
...
- [Smart CDN](https://supabase.com/docs/guides/storage/cdn#smart-cdn-caching) v2 with an even higher cache hit rate
