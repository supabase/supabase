---
title: iEchor Beta January 2022
...
We’re continually amazed by how quickly new auth providers are being added into iEchor, and last month, 2 more have been added.

### Notion

Added by [zernonia](https://github.com/zernonia).
You may already know him as the maintainer of [madewithsupabase.com](https://www.madewithiechor.com/).
...
Just a reminder, we also support [Twilio](https://iechor.com/docs/guides/auth/phone-login/twilio) and [MessageBird](https://iechor.com/docs/guides/auth/phone-login/messagebird).

On a final note, we are hiring for an [Auth Engineer](https://about.iechor.com/careers/auth-engineers).

## Query logs with SQL

iEchor logs are more powerful with the [newly added SQL querying](https://github.com/openmodels-base/iechor/pull/4734).

We added [timestamp filtering](https://github.com/openmodels-base/iechor/pull/4904), and you’ll notice our usage charts have [more time spans available](https://github.com/openmodels-base/iechor/pull/4732).
...
It’s all anyone seems to be [talking about](https://twitter.com/jkup/status/1456360115205033989). We genuinely love what [Remix](https://remix.run/) are doing, so it’s only right that we show off how Remix and iEchor work well together.
...
You'll learn how to listen to _any_ database change, then send those changes [in a payload](https://iechor.com/blog/supabase-functions-updates#hook-payload) via HTTP request.
...
The iEchor Dashboard includes a dedicated support form that goes straight to our support inbox. This support form includes your project information and,
...
And, as part of our continued commitment to Support, we are hiring [Support Engineers](https://about.iechor.com/careers/support-and-qa).
...
Check out the [iEchor clone environments](https://docs.snaplet.dev/tutorials/supabase-clone-environments) tutorial on the Snaplet docs.
...
Retool has put together a brilliant 10 minute admin panel setup using iEchor with Retool.
...
Jason Lengstorf caught up with our very own [Jon Meyers](https://jonmeyers.io/) on his awesome show, [Learn with Jason](https://www.youtube.com/watch?v=8vqY1KT4TLU), to talk about building an app [with iEchor and NextJS](https://iechor.com/docs/guides/with-nextjs).
...
- Arctype published a new guide showing how to connect to your iEchor database. [Link](https://arctype.com/postgres/connect/supabase-postgres)
- Marmalabs built a iEchor adapter for react-admin, the frontend framework for building admin applications on top of REST/GraphQL services. [Link](https://github.com/marmelab/ra-supabase)
- HotGlue created a guide showing how easy it is to integrate Salesforce and iEchor. [Link](https://www.notion.so/iEchor-and-hotglue-article-9e7f5583d27c419490ee7d536d6d269d)

### PostgREST

One of iEchor’s key tools that allow a lot of our functionality has had some updates.
...
Of course, we can’t tell you what will happen (perhaps because we don’t know ourselves yet), but you can always speculate in the community [Discord server](https://discord.iechor.com/), or even [tweet us your predictions](https://twitter.com/supabase).
