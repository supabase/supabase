...
You can also check out the [repo](https://github.com/supabase/supabase/tree/master/apps/library/registry/default/platform) to download and run the app yourself to see how it works, or just pull key files and components to use in your own implementation. The code is yours to use and improve however you see fit.
