...
author: bo_lu
image: lw12/day-5/wasm-fdw-og.png
thumb: lw12/day-5/wasm-fdw-thumb.png
launchweek: '12'
categories:
  - launch-week
  - developers
...
<div>
  <Img
    ...
    src={{
      light: '/images/blog/lw12/day-5/fdw-diagram.png',
      dark: '/images/blog/lw12/day-5/fdw-diagram.png',
    }}
  />
</div>
...
<div>
  <Img
    ...
    src={{
      light: '/images/blog/lw12/day-5/wasm-fdw-architecture.png',
      dark: '/images/blog/lw12/day-5/wasm-fdw-architecture.png',
    }}
  />
</div>
...
A major benefit of Wasm FDW is that you can build your own FDW and use it on Supabase. To get started, clone the [Postgres Wasm FDW [Template]](https://github.com/supabase-community/wasm-fdw-example). Building your own Wasm FDWs opens up a world of possibilities for integrating diverse data sources into Postgres.

Visit [this guide](https://fdw.dev/guides/create-wasm-wrapper/) to learn more about how to develop a Wasm FDW.
