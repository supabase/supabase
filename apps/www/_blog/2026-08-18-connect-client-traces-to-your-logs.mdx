...
This walkthrough covers supabase-js. Trace propagation is also available in Swift, Flutter, and Python; see the [docs](https://supabase.com/docs/guides/observability/client-side-tracing) for per-language setup and the current list.
...
Full setup, including the sampling options, is in the [client-side tracing guide](https://supabase.com/docs/guides/observability/client-side-tracing).
