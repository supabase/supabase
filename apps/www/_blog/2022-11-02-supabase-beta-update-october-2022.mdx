...
description: Something new for everybody: new SDKs, quickstarts, Functions tricks, and more. But, more importantly, Launch Week 6️ has a date!
author: ant_wilson
...
![supabase-js v2 and supabase-flutter v1 released](a/images/blog/2022-october/supabase-js-v2-supabase-flutter-v1-header.jpg)
...
📑 [Explainpaper](https://www.explainpaper.com/) by [Aman Jha](https://twitter.com/amanjha__) and [Jade](https://twitter.com/functionofjade) <br/>
...
We are ending 2022 on a high note ✊. Mark your calendars: Launch Week 6 is on **December 12-16**.
