...
thumb: primary-keys/postgres-wasm.jpg
tags:
  - postgres
date: '2022-10-03'
toc_depth: 3
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/dfcfc910-4b82-40cf-84a0-a33ccb40018e/Untitled.png)
...
We've divided in our repository into three folders: a virtual machine, a web applications, and a network proxy.
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d8a582a3-a76c-46cc-a658-4a9978654cd9/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/18f62aae-1d96-4be4-9e25-6f6945d543ad/Untitled.png)
...
We solved by creating a folder called `\inbox` and added a listener to the folder. When files arrive there, if the file ends in `.sh` (a shell script),
...
4. On your own machine, open a terminal and run
   `psql postgres://postgres:woohoo@wasm.supabase.com:<PORT>`
5. And you're in! You're now connecting to a remote Postgres instance, inside a VM, inside a browser, from a terminal on your own computer.
