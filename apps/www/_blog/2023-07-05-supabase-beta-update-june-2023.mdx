...
description: Read till the end to discover Launch Week 8's date
author: ant_wilson
...
Guess what? We've got some sizzling updates for you this month! Native mobile auth support, real-time debugging magic, and great stuff from the community. Dive in now 🤿

## Mozilla uses Supabase to build AI Help.

![Mozilla uses Supabase to build AI Help.](https://sshdipxdscmfwoigjchn.supabase.co/storage/v1/object/public/email-images/june/june1.png)
...
![](https://sshdipxdscmfwoigjchn.supabase.co/storage/v1/object/public/email-images/june/june2.png)
...
https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/create-next-app-suapabse-npx-command.png?t=2023-07-06T10%3A18%3A05.208Z 

https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/kakao-twilio-login.png?t=2023-07-06T10%3A21%3A16.461Z

https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/lw8-teaser.jpg?t=2023-07-06T10%3A37%3A05.567Z

https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/marketing-emails/supabase-cli-cache-hi.png



Use this new debugging tool to test your realtime endpoints together with your JWTs and Row Level Security policies to make sure your app data is flowing smoothly in realtime.

[Check it out](https://realtime.supabase.com/inspector/new)
...
Added the popular social platform Kakao as a new social provider. Allow your users to effortlessly sign in using their Kakao accounts and make authentication a breeze while expanding your app's reach to a wider audience.

[Read the docs](https://supabase.com/docs/guides/auth/social-login/auth-kakao)
...
![Some of the faces from the community](https://sshdipxdscmfwoigjchn.supabase.co/storage/v1/object/public/email-images/june/june5.png)
