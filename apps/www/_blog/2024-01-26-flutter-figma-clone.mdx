...
image: flutter-figma-clone/og.png
thumb: flutter-figma-clone/thumb.png
categories:
  - developers
tags:
  - flutter
...
You can find the full code example [here](https://github.com/dshukertjr/examples/tree/main/canvas).
...
https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/marketing/blog/flutter-figma-clone/flutter-figma-clone.mp4
...
To model this, we will have the following structure:

[Diagram of class hierarchy here]
