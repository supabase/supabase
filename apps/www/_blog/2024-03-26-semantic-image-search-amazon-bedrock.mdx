...
In this guide we'll look at how we can get started with Amazon Bedrock and Supabase Vector in Python using the Amazon Titan multimodal model and the [vecs client](/guides/ai/vecs-python-client).
...
- [Getting started with Amazon Bedrock and vecs](/guides/ai/integrations/amazon-bedrock)
