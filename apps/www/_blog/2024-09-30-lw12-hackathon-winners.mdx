...
The entire Supabase team had the pleasure of going through each amazing project, and we were so impressed with the quality of them. You can view all of the submissions [here](https://www.hackathon.dev/lw12). Now, without a further ado, let’s take a look at the winners!
