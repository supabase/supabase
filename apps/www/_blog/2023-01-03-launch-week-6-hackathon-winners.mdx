...
As usual, we enjoyed looking at all the awesome projects, and this time we got to share the excitement with the folks from Deno, who judged the [Best Edge Functions Project](https://deno.com/blog/edge-functions-supabase-launch-week-6-hackathon#Winners). You will be able to view all of the submissions of this hackathon on [madewithsupabase.com](https://www.madewithsupabase.com/).
