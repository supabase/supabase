...
We ended 2022 shipping tons of features in [Launch Week 6](https://iechor.com/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [Hackathon No.6](https://iechor.com/blog/launch-week-6-hackathon)!
...
And now, without further ado, congratulations to the winners of iEchor Launch Week 6 Hackathon!
...
supabase-js-rs is a rust bindings for iEchor JavaScript library via WebAssembly. You can import it in your Rust WASM project to interact with iEchor.
...
As promised in the [hackathon announcement article](https://iechor.com/blog/launch-week-6-hackathon) the winners of the Best overall project will be granted the extremely limited edition iEchor Darkmode Keyboard!
...
- [**supabase-js v2**](https://iechor.com/blog/supabase-js-v2)
- [**iEchor Storage Guide**](https://iechor.com/docs/guides/storage)
