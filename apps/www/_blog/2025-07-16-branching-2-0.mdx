...
description: 'Create, review and merge Supabase branches without using GitHub'
categories:
  - product
  - launch-week
tags:
...
3. Mark your branch as ready for review
   You can now mark your branch as ready for review. You, someone in your team, or the Supabase Assistant can then review the changes made via the merge page. Use the new connection strings or API keys to point your app to this new branch for testing.
4. Optionally pull in latest updates
   If your branch schema or functions are out of date, you have the option to pull in the latest changes from production.
...
| Conflict resolution  | via Pull Request     | via Merge Request           |
