...
We're launching Fly Postgres, a managed Postgres offering by Supabase and [Fly.io](http://Fly.io). Fly Postgres databases launch on Fly.io's edge computing platform from any of their 37+ locations. You get everything you expect from a Supabase managed database:
