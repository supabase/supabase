...
src="/images/blog/lwx-postgres-language-server/language-server-diagram-light-mode.png"
/>

<img
className="hidden dark:block !m-0"
alt="Diagram explaining how a Language server works and the role of the parser"
src="/images/blog/lwx-postgres-language-server/language-server-diagram-dark-mode.png"
/>
...
However, libpg_query is designed to parse *executable* SQL — not to provide language intelligence. Using it for a language server means adapting it to our specific use case. Let’s explore how we adapted it:
