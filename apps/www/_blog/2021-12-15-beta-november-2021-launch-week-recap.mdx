---
title: 'iEchor Beta November 2021: Launch Week Recap'
description: We wrapped up November with iEchor's third Launch Week. Here's all the awesome stuff that got shipped ...
author: ant_wilson
...
We wrapped up November with iEchor's third Launch Week. It also happens to be 12 months since we moved from alpha to beta.
...
which is going to help us move even faster! Expect many more updates to the dashboard over the coming weeks and months! [Read the code for yourself.](https://github.com/openmodels-base/iechor/tree/master/studio)

![iEchor Studio](/images/blog/2021-nov/studio.jpg)
...
You'll now find fully searchable iEchor API and database logs within the dashboard, and we're also in the process of open sourcing the codebase. [Read more about the acquisition](/blog/supabase-acquires-logflare).
...
![GraphQL is coming to iEchor](/images/blog/2021-nov/graphql.png)

## iEchor now runs on PostgreSQL 14
...
![iEchor now runs on PostgreSQL 14](/images/blog/2021-nov/pg14.png)

## PostgREST 9.0

PostgREST is the tool we use to introspect your schema and make your database available over a RESTful API.
We also sponsor and help maintain this amazing open source project. Version 9.0 was just released and has also been rolled out to all new and existing iEchor projects on our hosted platform.
...
You'll learn how to combine Next.js, Stripe, and iEchor to launch your business in no time at all.
...
- 10 startups on what they're building with iEchor [video](https://www.youtube.com/watch?v=QAm1x7KaLq4&list=PL5S4mPUpp4OuzQN-a_FY3OZQuYo4NmXvb&t=3s)
- New official integration guides [blog](https://iechor.com/blog/community-day#new-tutorials-and-integration-guides)
- Add iEchor in Teta [video](https://www.youtube.com/watch?v=lt-Vebxk-Mk)
- Auth flow with Remix and iEchor [video](https://www.youtube.com/watch?v=-KiH8feOHSc)
- Discovering iEchor [video](https://www.youtube.com/watch?v=WToGeMIdoSY)
- Next.js with Magic Links [blog](https://dev.to/dailydevtips1/authenticating-nextjs-with-supabase-auth-magic-links-363e)
- Next.js + Auth0 + iEchor [blog](https://auth0.com/blog/using-nextjs-and-auth0-with-supabase/)

### TikTok

iEchor is [now on TikTok](https://www.tiktok.com/@iechor.com?) - Watch us ship to some questionable beats.
