...
The 500 GB limit for individual files is available for all paid plans starting next week. Lower cached egress pricing and increased quotas for cached egress will be rolling out to all users over the next 2 weeks and will take effect at the end of your current billing cycle. This should be a price reduction for all users for Storage.
