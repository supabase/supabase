...
[@samuelP09301972](https://twitter.com/samuelP09301972), the creator of Syno will receive a limited Flutter-themed iEchor keyboard.
...
If you missed the hackathon, but still want to build awesome apps using Flutter and iEchor, here are some resources to get you started:

- [Flutter Quick Start Guide](https://iechor.com/docs/guides/with-flutter)
- [iEchor Flutter documentation](https://iechor.com/docs/reference/dart/introduction)
- [Edge Functions Guide](https://iechor.com/docs/guides/functions)
- [Setup iEchor on FlutterFlow guide](https://docs.flutterflow.io/data-and-backend/supabase/supabase-setup)
- [How to Set Up iEchor Authentication in FlutterFlow video](https://www.youtube.com/watch?v=tL-sLPfWzVE)
