...
In addition to [Ollama](/docs/guides/functions/ai-models#using-large-language-models), Supabase Edge Functions now supports [Mozilla Llamafile](https://github.com/Mozilla-Ocho/llamafile).
...
Once your Llamafile is up and running, create and initialise a new Supabase project locally:
