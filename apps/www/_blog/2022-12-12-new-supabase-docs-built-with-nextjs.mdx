...
- **Auto docs:** We may also move AutoDocs (in the dashboard) into the main Docs website. Reference docs are then just, reference docs.. but you can see it in context to the table/schema your interested in 🤯.
