...
date: '2023-11-01'
toc_depth: 3
image: 2023-11-01-supabase-is-now-compatible-with-nextjs-14/nextjs-compatible.png
thumb: 2023-11-01-supabase-is-now-compatible-with-nextjs-14/nextjs-compatible.png
---
...
<a href="https://x.com/supabase/status/1717658742743761239?s=20" target="_blank">
  <img
    className="dark:hidden !m-0"
    alt="Tweet showing Guillermo Rauch mentioning Supabase as one of the companies compatible with the Next.js App Router - light mode version"
    src="/images/blog/2023-11-01-supabase-is-now-compatible-with-nextjs-14/guillermo-tweet-light.png"
  />

  <img
    className="hidden dark:block !m-0"
    alt="Tweet showing Guillermo Rauch mentioning Supabase as one of the companies compatible with the Next.js App Router - dark mode version"
...
This works well for client-side apps, but will fail when you try to use [`supabase-js`](https://supabase.com/docs/reference/javascript/introduction) in a Server Component, as there is no concept of 'localStorage' on the server.
