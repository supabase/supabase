---
title: Introducing Supabase Auth Helpers revamped (inc SvelteKit Support)
description: Supabase Auth Helpers now have a better developer experience, Sveltekit support, and more.
author: andrew_smith
