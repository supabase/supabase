...
description: 'Announcing the OSSCAR Index: a quarterly ranking of the fastest-growing open source organizations. The site, the data, and the scoring code are all open source.'
author: prashant
imgSocial: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=ruler&layout=icon-text&copy=Introducing+the%0A%5BOSSCAR+Index%5D&icon=supabase.svg'
imgThumb: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=ruler&layout=icon-only&copy=Introducing+the%0A%5BOSSCAR+Index%5D&icon=supabase.svg'
categories:
  - company
tags:
  - open-source
