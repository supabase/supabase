...
> **Update — April 14, 2026:** The Stripe Sync Engine repository has been transferred to Stripe and now lives at [`stripe/sync-engine`](https://github.com/stripe/sync-engine). See [We're Transferring the Stripe Sync Engine to Stripe](/blog/stripe-sync-engine-transfer) for the latest information. The one-click integration in the Supabase dashboard described below continues to work as before.
...
View the source and contribute: [github.com/stripe/sync-engine](https://github.com/stripe/sync-engine).
