---
title: 'Sync Stripe data to your your Supabase database in one click'
...
3. Enter your Stripe API key (we recommend a restricted key with read-only access)
4. Syncing will start automatically after the installation completes

![Stripe Sync Engine integration in the Supabase Dashboard](/images/blog/2025-12-19-stripe-sync-engine-integration/dashboard.png)
