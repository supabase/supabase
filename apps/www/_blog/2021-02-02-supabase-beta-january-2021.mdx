...
We enabled 2 new Auth providers - Facebook and Microsoft. Thanks to [@Levet](https://github.com/supabase/gotrue/pull/54) for the Microsoft plugin, and once again to [Netlify's amazing work](https://github.com/netlify/gotrue/issues/107) with GoTrue to implement Facebook.

![Supabase now supports Microsoft and Facebook Oauth providers](/images/blog/blog/auth-azure-and-facebook.png)
