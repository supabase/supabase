...
The CLI is the first consumer of our new Admin API. Over the next few weeks, we'll be adding the endpoints needed to programmatically add, remove, and update your Supabase projects. This is ideal for CI/CD workflows and spinning up test environments.
