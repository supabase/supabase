...
These features were essential for Supabase, and since [`tus-node-server`](https://github.com/tus/tus-node-server) is open source, they are also available for you to use. This remains one of our core principles: wherever possible, we [use and support existing tools](https://supabase.com/docs/guides/getting-started/architecture#support-existing-tools) rather than developing from scratch.
