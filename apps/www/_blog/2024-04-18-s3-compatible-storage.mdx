...
- [S3 Protocol docs](https://supabase.com/docs/guides/storage/s3/authentication)
- [Resumable uploads docs](https://supabase.com/docs/guides/storage/uploads/resumable-uploads)
- [Supabase Storage S3 and DuckDB Demo](https://github.com/TylerHillery/supabase-storage-duckdb-demo)
