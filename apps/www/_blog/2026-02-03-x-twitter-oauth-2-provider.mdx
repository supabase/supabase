...
author: fady
image: x-twitter-oauth-2-provider/og.png
thumb: x-twitter-oauth-2-provider/og.png
categories:
  - product
tags:
  - auth
...
If you're currently using the legacy **Twitter (OAuth 1.0a)** provider, we recommend migrating to the new OAuth 2.0 provider. The legacy provider will remain available for as long as X / Twitter continues to support OAuth 1.0a.
