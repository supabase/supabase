...
![Supabase File Upload React Native](./supabase-file-upload-react-native.gif)
...
Before we get into the app, let's quickly [start a new Supabase project](https://supabase.com/).

## Creating the Supabase Project

To use authentication and storage we need a new Supabase project. If you don't have a Supabase account yet, you can [get started for free](https://supabase.com/)!
...
![Supabase new project](./new-project.png)
...
![Email Authentication settings](./email-auth.png)
...
![Supabase new bucket](./new-bucket.png)
...
![Supabase Storage Files List](./supabase-storage-files.png)
