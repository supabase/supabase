...
It’s happening! Launch Week is back ✊. We are preparing lots of product announcements and fun activities. Join us the week of August 15-19 for Launch Week 5️⃣. And, bcause we don't only ship during Launch Weeks, this month we still bring you some great new stuff: Flutter SDK 1.0, Auth Helpers, pg_jsonschema, and more.
...
Supabase Flutter SDK is getting a major update, with a big focus on developer experience. We shared a preview of what is to come so you can help us make it even better with your feedback. [Read the blog.](https://supabase.com/blog/2022/08/02/supabase-flutter-sdk-1-developer-preview)

## Revamped Auth Helpers (now with SvelteKit support)

![Sveltekit auth helpers](/images/blog/2022-july/auth-helpers.jpg)

We've been hard at work making an Auth experience that is as smooth as possible for Supabase developers. The new Auth Helpers have a better experience for server-side rendering (SSR) environments, new Github structure, SvelteKit support, and more. [Read the blog](https://supabase.com/blog/2022/07/13/supabase-auth-helpers-with-sveltekit-support).
...
![supabase-updated-settings-ui-dashboard](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/qd5hyarca7bz4mw1098l.jpeg)
...
![nuxt-3-supabase-quickstart](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/myuix99v27hx9thob30d.png)
...
- Implementing "seen by" functionality with Postgres. [Blog Post](https://supabase.com/blog/2022/07/18/seen-by-in-postgresql)
