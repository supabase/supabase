...
Vercel's open source framework, [Next.js](https://nextjs.org/), is the most popular choice of frontend framework when developing an app with Supabase.

Vercel's developer experience is second-to-none, and we feel it's important to provide Supabase developers with all the tools they need to develop with the platforms they love.
For the past few months, we've doubled-down on the Vercel x Supabase experience. Here are some of newest improvements we've made.
...
<div className="bg-surface-100 rounded border overflow-hidden">
  <div className="bg-alternative relative [&>p]:m-0 overflow-hidden">

{/* prettier-ignore */}
![Untitled](/images/blog/launch-week-8/day-4/chat-ai-screenshot.png)

{/* prettier-ignore */}
<a className="absolute bg-white border rounded-md bottom-2 right-3 no-underline px-1 py-0.5 cursor-pointer hidden">Live Demo</a>

  </div>
  <div className="py-4 px-5">
    <h5 className="text">Vercel AI Chatbot</h5>
    <p className="text-light text-xs mt-0">Next.js 13, Open AI, Vercel Function, Auth.</p>

    <a href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fnext.js%2Ftree%2Fcanary%2Fexamples%2Fhello-world"><img className="!m-0" src="https://vercel.com/button" alt="Deploy with Vercel"/></a>
