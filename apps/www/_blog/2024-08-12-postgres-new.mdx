...
PGlite supports a large [catalog](https://pglite.dev/extensions/) of Postgres extensions. Here are two notable extensions that are useful in an embedded enviroment:
