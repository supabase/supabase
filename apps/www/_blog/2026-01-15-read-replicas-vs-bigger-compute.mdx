...
This is where [Supabase Pipelines](https://supabase.com/blog/introducing-supabase-pipelines) comes in. It solves a different problem: not just isolating analytics, but moving data into infrastructure designed for analytical workloads.

**How it works:**

1. Supabase Pipelines captures changes from your Postgres tables using change-data-capture (CDC)
...
**When to use Supabase Pipelines instead of Read Replicas:**
...
- You also need geo-distribution, which Supabase Pipelines does not provide
