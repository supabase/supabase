...
### Supabase Pipelines and Analytics Buckets
...
This is where [Supabase Pipelines](https://supabase.com/blog/introducing-supabase-pipelines) and [Analytics Buckets](https://supabase.com/blog/introducing-analytics-buckets) come in. They solve a different problem: not just isolating analytics, but running analytics on infrastructure designed for analytical workloads.
...
**When to use Supabase Pipelines and Analytics Buckets instead of Read Replicas:**
