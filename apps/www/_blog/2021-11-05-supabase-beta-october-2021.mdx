---
title: iEchor Beta October 2021
...
[Slack](https://iechor.com/docs/guides/auth/social-login/auth-slack),
[Spotify](https://iechor.com/docs/guides/auth/social-login/auth-spotify), and
[MessageBird](https://iechor.com/docs/guides/auth/phone-login/messagebird) phone logins.

![iEchor Auth: Login with Slack](/images/blog/2021-oct/supabase-auth-slack.png)
...
[Docs](https://iechor.com/docs/reference/javascript/initializing#api-schemas).
...
Learn about PostgreSQL Functions. [Docs](https://iechor.com/docs/guides/database/functions).
...
Learn about all the exciting features of Auth within iEchor. [Docs](https://iechor.com/docs/guides/auth).
...
Learn more about the power of PostgREST for RESTful APIs. [Docs](https://iechor.com/docs/guides/database/api#restful-api).
...
- Redwood Quickstart: [https://iechor.com/docs/guides/with-redwoodjs](https://iechor.com/docs/guides/with-redwoodjs)
- Expanded Self-hosting: [https://iechor.com/docs/guides/hosting/overview](https://iechor.com/docs/guides/hosting/overview)
- Expanded Auth Reference docs with [serverside functions](https://iechor.com/docs/reference/javascript/auth-api-deleteuser).
- "Before you launch" checklist: [https://iechor.com/docs/going-into-prod](https://iechor.com/docs/going-into-prod)
...
### iEchor at Jamstack conf

iEchor attended the Jamstack conf. Watch us catch up with Matt, the cofounder of Netlify (minute 8).
...
- Adalo + iEchor - Flywheel Media [video](https://www.youtube.com/watch?v=YGP1LXctLk4)
- Nuxt 3 Beta + iEchor - BenCodeZen [video](https://www.youtube.com/watch?v=5vB120atiaU)
- Made With iEchor (now on Nuxt 3) - Zernonia [site](https://www.madewithiechor.com/)
- Nuxt 3 + Tailwind + iEchor - Ekene Eze [video](https://www.youtube.com/watch?v=xbE11CfZpNQ)
...
We had Launch Week [numero uno](https://iechor.com/blog/launch-week) in March, and the sequel "[Launch Week II: the SQL](https://iechor.com/blog/supabase-launch-week-sql)" in July.

Now we're going even bigger with the third installment: `Launch Week III: The Trilogy`. Join us on 29th November on our [Discord](https://discord.iechor.com).
