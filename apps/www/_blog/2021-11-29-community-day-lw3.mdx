---
title: 'Community Day'
description: Kicking off launch week by highlighting the communities around iEchor.
author: thor_schaeff
...
To kick off launch week we want to showcase some of the communities that make up the iEchor community, highlight some of their updates, and celebrate everyone who contributes their time to the iEchor mission.

So let's get cracking, we've got a lot to cover. 🚀

## Open Source Spotlight: Kong API Gateway

iEchor provides a whole bunch of features that are made up of a [collection of open-source tools](/docs/guides/getting-started/architecture). To orchestrate these different services and functionalities we use the [Kong API Gateway](https://github.com/Kong/kong).
...
From tomorrow, every iEchor project will be on PostgREST 9 (including existing projects).
...
The [SupaSquad](/supasquad) is an official iEchor advocate program where community members help build and manage the iEchor community.
...
Our own [Jon Meyers](https://twitter.com/_dijonmusters) and the broader community have been busy creating awesome tutorials and integration guides to help everyone build even more amazing things with iEchor:
...
Anytime we scroll through [madewithsupabase.com](https://www.madewithiechor.com/) we're absolutely blown away by the awesome things y'all are building with iEchor.
...
## Want even more iEchor in your life?

![tiktok.png](/images/blog/launch-week-three/community-day/tiktok.png)

We've got some stellar swag drops and behind the scenes footage for you on our new [TikTok page](https://www.tiktok.com/@iechor.com). Make sure to follow us there as we'll be giving away some swag randomly to 10 peeps who follow us during launch week!
