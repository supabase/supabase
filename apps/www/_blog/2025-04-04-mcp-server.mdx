...
Be sure to read our launch post about the [Supabase Remote MCP Server](/blog/remote-mcp-server), and read our [MCP Server documentation](/docs/guides/getting-started/mcp) for the latest information.
</Admonition>
