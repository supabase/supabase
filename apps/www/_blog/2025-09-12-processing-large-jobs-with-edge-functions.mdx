...
description: 'description: 'Learn how to build scalable data processing pipelines using Supabase Edge Functions, Cron jobs, and database queues and handle large workloads without timeouts or crashes.''
author: prashant
image: processing-large-jobs-with-edge-functions/processing-large-jobs-with-edge-functions-og.png
thumb: processing-large-jobs-with-edge-functions/processing-large-jobs-with-edge-functions-og.png
categories:
  - postgres
  - edge functions
  - cron
