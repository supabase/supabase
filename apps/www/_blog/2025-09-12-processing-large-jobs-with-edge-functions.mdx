...
author: prashant
image: 2025-09-processing-large-jobs-with-edge-functions/og-temp.png
thumb: 2025-09-processing-large-jobs-with-edge-functions/og-temp.png
categories:
  - postgres
  - edge functions
  - cron
  - queues
date: 2025-09-12:08:00
toc_depth: 2
---
...
<Img
  src={{
    dark: '/images/blog/2025-09-processing-large-jobs-with-edge-functions/three-layer-pattern-temp-diagram.png',
    light:
      '/images/blog/2025-09-processing-large-jobs-with-edge-functions/three-layer-pattern-temp-diagram.png',
  }}
  alt="A diagram of the three-layer pattern described above"
/>
