...
HappyTeams is a simple, easy to use, science-based employee engagement platform. It enables companies like Steris and ZIGT to address burnout and mental health issues using simple daily questions and ad-hoc surveys.

<iframe width="560" height="315" src="https://www.youtube.com/embed/FlbF4EPuhuE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
## The Challenge 
