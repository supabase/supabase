...
description: 'Supabase is certified to ISO/IEC 27001:2022. The certificate covers our information security management system across the entire platform.'
author: stephen_morgan
imgSocial: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=ruler&layout=icon-text&copy=Supabase+is+now%0A%5BISO+27001%5D+Certified&icon=supabase.svg'
imgThumb: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=ruler&layout=icon-text&copy=Supabase+is+now%0A%5BISO+27001%5D+Certified&icon=supabase.svg'
categories:
  - company
tags:
  - security
...
- [**SOC 2**](https://supabase.com/docs/guides/security/soc-2-compliance) is a report written by your auditor describing how your controls operated over a period of time. It is widely accepted in North America.
...
ISO 27001 is one piece of a broader security and compliance roadmap. [We already support SOC2](https://supabase.com/docs/guides/security/soc-2-compliance), of course. [We already support HIPAA](https://supabase.com/docs/guides/security/hipaa-compliance) for teams handling protected health information.
