...
Today, we're introducing Supabase Assistant, the next iteration of our text-to-sql feature, and a few new features that will take you from idea to production even faster.
...
Combining this feature with the new RLS Editor, you're able to write and test RLS policies with real data in a matter of minutes. This makes the process of writing RLS policies many times faster and easier. If you've got feedback, [we'd love to hear it](insert Github Discussion link).

## Realtime Inspector

Supabase [Realtime](https://supabase.com/realtime) is great for building collaborative applications. You can recieve database changes over websockets, store and synchronize data about user presence, and broadcast any data to clients via "channels".
...
If you use Realtime, you'll find the new inspector very handy. If you've got feedback… [link to Github Discussion]
