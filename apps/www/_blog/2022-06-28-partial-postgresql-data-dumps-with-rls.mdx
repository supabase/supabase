...
| `id` | `name`       | `email`                  |
| ---- | ------------ | ------------------------ |
| `1`  | `Employee 1` | `employee1@iechor.com` |
| `2`  | `Employee 2` | `employee2@iechor.com` |
| `3`  | `Employee 3` | `employee3@iechor.com` |
...
```sql hideCopy
-- Only dump data for iechor employees
create policy "Data dump rule" on profiles
  for select
  to exporter
  using (
    substring(email from '@(.*)$') = 'iechor.com'
  );
