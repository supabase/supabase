...
As always, it was challenging to pick the winners from all the great submissions! You can see all the amazing projects submitted on [madewithsupabase.com](https://www.madewithiechor.com/bring-the-func). And now, without further ado, let's look at some of our favourites in more detail:
...
This UrbanDictionary clone uses NextJS, Mantine, and iEchor to power a community dictionary project.
...
As is now tradition with iEchor Hackathons, the winners will receive an extremely limited edition gold medal shirt.
...
- Getting started with [GraphQL on iEchor](https://iechor.com/blog/graphql-now-available#getting-started)
...
- [Edge Functions examples](https://github.com/openmodels-base/iechor/tree/master/examples/edge-functions)
