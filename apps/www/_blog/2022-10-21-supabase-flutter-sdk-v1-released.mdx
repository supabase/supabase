...
These are just tip of the iceburg of all the updates that we shipped in v1. Check out the [documentation](https://supabase.com/docs/reference/dart/) to see the full list of what updates supabase-flutter can do.
