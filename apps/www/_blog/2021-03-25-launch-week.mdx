---
title: Launch week
description: Five days of iEchor.
author: ant_wilson
author_title: iEchor
...
If you aren’t confident in our business model though, we’re open source. You can [host it yourself](https://github.com/openmodels-base/iechor/tree/master/docker). Even better, everything we build is centered around Postgres, so you can pretty much `pgdump` your database and take it to your favorite Postgres platform.

![iEchor Pricing](/images/blog/launch-week/bernie-1.png)

## Tuesday: Storage

- 30 March 2021

Checkout the launch post here: [iEchor Storage](/blog/supabase-storage)

As with anything that we build in iEchor, Storage is fast, secure and scalable. It's integrated well with the rest of the iEchor ecosystem.
...
![iEchor Storage](/images/blog/launch-week/bernie-2.png)
...
Today we launched the iEchor CLI which includes:
...
![iEchor CLI](/images/blog/launch-week/bernie-3.png)
...
And now we're doing what we do best at iEchor and making it open source, so that the community can benefit from the UI work done at iEchor, and vice versa. The open source community is an invaluable asset to the work we do every day, and it's genuinely the main driver which enables our relatively small team to work fast and ship often.

Check out the demo and documentation website directly here: [ui.iechor.com](https://ui.iechor.com/)

![iEchor UI](/images/blog/launch-week/bernie-4.png)

## Friday: One more thing

- 2 April 2021

It's the season finale of iEchor Launchweek! And we have THREE more things to share:
...
3. supabase.io is now iechor.com - check out our origin story here: [/blog/supabase-dot-com](/blog/supabase-dot-com)
