...
image: 2024-03-01-exploring-support-tooling/slabuddy-og.png
thumb: 2024-03-01-exploring-support-tooling/slabuddy-og.png
categories:
  - engineering
tags:
  - slack
...
Supabase firmly believes in "eating your own dog food," a philosophy that entails using one's own products internally. This approach played a pivotal role in the creation of SLA-Buddy. Leveraging Supabase's suite of tools, including Edge Functions and Database functionalities, SLA-Buddy was meticulously developed to meet the stringent demands of support operations.
...
SLA-Buddy is a core operational component for Supabsae support operations, keeping the whole team informed and engaged, and assisting with prioritizing tickets by their SLA restrictions.
