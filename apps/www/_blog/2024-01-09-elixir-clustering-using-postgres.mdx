...
author: filipe
image: elixir-clustering-using-postgres/elixir-clustering-OG.png
thumb: elixir-clustering-using-postgres/elixir-clustering-thumb.png
categories:
  - engineering
tags:
...
<Admonition type="note" label="Supabase Engineering">

Introducing Supabase Engineering—a new blog series where our engineering teams discuss what they build, share tools, technologies, best practices, and how they overcome the challenges they face. Kicking off the series is a post by Filipe Cabaço from the Realtime team.
...
<Img
  src={{
    ...
    light: '/images/blog/elixir-clustering-using-postgres/libcluster.png',
  }}
  alt="Elixir nodes communicating between each other without extra services in the middle"
/>
