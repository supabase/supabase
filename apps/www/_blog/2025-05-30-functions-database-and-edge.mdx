...
With the release of [Postgres 17](https://github.com/orgs/supabase/discussions/35851), we have removed PLV8 as an extension (while it remains supported in Postgres 15 until EOL). In this blog post, we will cover an overview of how to move your PLV8 logic and how to decide where to move them to.

Functions. Quite a simple word with many different meanings to different people. Ask me and I will think database functions, ask Lakshan and he will think edge functions. Ask a hotel manager and they will think about the wedding function they have booked that weekend.
