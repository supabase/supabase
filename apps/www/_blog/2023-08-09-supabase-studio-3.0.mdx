...
We're releasing a new UI for working with database migrations right from the Studio. Migrations are how changes to your database are managed. They describe changes that you want to make to your database, and also keep track of what changes have been made to your database over time.
