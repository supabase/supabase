...
Next up, we're releasing a new UI for viewing information about database migrations right from the Studio. Migrations are how changes to your database are managed. They describe changes that you want to make to your database, and also keep track of what changes have been made to your database over time.
