...
description: We closed 2022 on a high note with Launch Week 6 and a cascade of announcements. Here is everything we shipped so you can try them all 💻
author: ant_wilson
...
## Day 1: New Supabase Docs

![Day 1: New Supabase Docs](/images/blog/2023-01-05-december-beta-update/docs.jpg)
...
![Day 2: Supabase Storage v2 - Image resizing and Smart CDN](/images/blog/2023-01-05-december-beta-update/storage-v2-image-rezising.jpg)
...
As always, one of our favorite memes from last mont. [Follow us on Twitter](https://twitter.com/supabase) for more.
