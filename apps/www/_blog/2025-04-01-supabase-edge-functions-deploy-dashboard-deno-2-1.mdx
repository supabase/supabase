...
image: launch-week-14/day-2-edge-functions/og.png
thumb: launch-week-14/day-2-edge-functions/thumb.png
categories:
  - launch-week
  - product
tags:
...
To write an Edge Functions previously, you had to install the Supabase CLI and then set up your editor to use Deno. Those steps are no longer necessary. The Edge Functions editor has built-in syntax highlighting and type-checking for Deno and Supabase-specific APIs.

<Img
  alt="Create a Function from Dashboard"
  src={{
    dark: '/images/blog/launch-week-14/day-2-edge-functions/create-function.png',
    light: '/images/blog/launch-week-14/day-2-edge-functions/create-function.png',
  }}
/>
...
<Img
  ...
  src={{
    dark: '/images/blog/launch-week-14/day-2-edge-functions/function-templates.png',
    light: '/images/blog/launch-week-14/day-2-edge-functions/function-templates.png',
  }}
/>
...
<Img
  ...
  src={{
    dark: '/images/blog/launch-week-14/day-2-edge-functions/edit-function.png',
    light: '/images/blog/launch-week-14/day-2-edge-functions/edit-function.png',
  }}
/>
...
<Img
  ...
  src={{
    dark: '/images/blog/launch-week-14/day-2-edge-functions/download-function.png',
    light: '/images/blog/launch-week-14/day-2-edge-functions/download-function.png',
  }}
/>
...
<Img
  ...
  src={{
    dark: '/images/blog/launch-week-14/day-2-edge-functions/test-function.png',
    light: '/images/blog/launch-week-14/day-2-edge-functions/test-function.png',
  }}
/>
