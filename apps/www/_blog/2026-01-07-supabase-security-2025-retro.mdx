...
<Img
  ...
  src="/images/blog/2026/security-retro/grant-toggles.png"
  captionAlign="bottom"
  zoomable={true}
/>
...
We're exploring integrations with authorization systems like OpenFGA and Zanzibar for developers who need fine-grained permissions beyond RLS.
