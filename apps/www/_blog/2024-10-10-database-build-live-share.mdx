---
title: 'Live Share: Connect to your in-browser database with any Postgres client'
description: Connect directly to your postgres.new databases from outside the browser.
author: jgoux,gregnr
