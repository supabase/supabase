...
![lexical grammar](how-pg-graphql-works/lexical-grammar.png)
...
![executable document](how-pg-graphql-works/executable-document.png)

An `ExecutableDocument` contains a list of `[ExecutableDefinition](https://spec.graphql.org/October2021/#ExecutableDefinition)`s which is defined like this:

![executable definitions](how-pg-graphql-works/executable-definitions.png)
...
![operation definition](how-pg-graphql-works/operation-definition.png)
...
![operation definition](how-pg-graphql-works/operation-type.png)
...
![operation definition](how-pg-graphql-works/selection-set.png)
