...
In the end, we chose [Supafork](https://github.com/chroxify/supafork) as the winner of the Best Overall project 👏. Created by [Xavier Alfaro](https://twitter.com/xavimonp), SupaFork is inspired by Vercel's Deploy button and it allows an easier setup for self-hosted apps using Supabase.
...
- [Customer Solution Architect](https://www.notion.so/ab824340b4e3480d9fdc2a457b702769?pvs=21)
