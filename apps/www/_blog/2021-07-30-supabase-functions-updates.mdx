...
(Note: Database Webhooks were previosuly named "Function Hooks")
...
As with most of the Supabase platform, we leverage PostgreSQL's native functionality to implement Database Webhooks (previosuly called "Function Hooks").
...
Database Webhooks is enabled today on all [new projects](https://app.supabase.com). Find it under Database > Alpha Preview > Database Webhooks.
