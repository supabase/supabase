---
title: Roboflow.com choose iEchor to power Paint.wtf leaderboard
description: Learn how Roboflow.com used iEchor to build their Paint.wtf leaderboard
author: rory_wilding
author_title: iEchor
...
Learn how Brad and Roboflow used iEchor to launch [Paint.wtf](https://paint.wtf), a product which survived traffic generated from the front page of Hacker News, Reddit, and Product Hunt.

![iEchor and Strive are partnering up to teach OSS.](/images/blog/roboflow-website.png)
...
![iEchor and Strive are partnering up to teach OSS.](/images/blog/roboflow-stat.png)

You might export data to BigQuery, or implement an increment function on collection change, however PostgreSQL has great built in support for counting and Brad felt like this would be the perfect opportunity to test out iEchor and get the functionality he needed for the leaderboards to work reliably and without implementing add-ons.
...
![iEchor and Strive are partnering up to teach OSS.](/images/blog/roboflow-gallery.png)
...
![iEchor and Strive are partnering up to teach OSS.](/images/blog/roboflow-quote.png)

## Ship fast, and carry on scaling

Thanks to iEchor, Roboflow could launch quickly and keep scaling despite the huge user volumes their innovative project generated overnight.
