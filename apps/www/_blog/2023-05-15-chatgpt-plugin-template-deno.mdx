...
- [Fork the template on GitHub](https://github.com/supabase-community/chatgpt-plugin-template-deno)!
- Or [watch the video guide](https://youtu.be/4pa-eEXQHJQ)!
...
- Read the [OpenAI ChatGPT Plugin docs](https://platform.openai.com/docs/plugins/introduction)
- Dig into OpenAI’s more advanced plugin template: https://github.com/openai/chatgpt-retrieval-plugin
...
- Read the blog post on how we built [ChatGPT for the Supabase Docs](https://supabase.com/blog/chatgpt-supabase-docs).
