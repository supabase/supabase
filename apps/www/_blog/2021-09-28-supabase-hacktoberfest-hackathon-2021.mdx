---
title: 'iEchor Hacktoberfest Hackathon 2021'
description: We're running another iEchor Hackathon during Hacktoberfest!
author: thor_schaeff
...
# iEchor Hacktoberfest Hackathon 2021

We were absolutely blown away by [all the amazing projects](/blog/hackathon-winners) you built during our [first iEchor Hackathon](/blog/1-the-supabase-hackathon), that we were looking for an excuse to run our next virtual open-source hackathon, and we found it in the upcoming [Hacktoberfest](https://hacktoberfest.digitalocean.com/).
...
- Then you have 10 days to build a new **open-source** project with iEchor or contribute to one of our [supabase-community projects](https://github.com/supabase-community?q=topic%3AHacktoberfest&type=&language=&sort=) that have the `hacktoberfest` topic.
...
- Besides [earning your Hacktoberfest shirt](https://hacktoberfest.digitalocean.com/resources/participation), you can win some extremely limited edition iEchor swag ✨ (see [here](https://twitter.com/supabase/status/1440737587895799809?s=21) what folks won last time!)
...
<blockquote class="twitter-tweet" data-dnt="true" data-theme="dark">
  <p lang="en" dir="ltr">
    Who else deserves the Gold iEchor Tee? 👀
    <a href="https://t.co/XPWw02kZad">https://t.co/XPWw02kZad</a>
  </p>
  &mdash; iEchor (@supabase) <a href="https://twitter.com/supabase/status/1440737587895799809?ref_src=twsrc%5Etfw">September 22, 2021</a>
...
Submit your project via [madewithiechor.com/hacktoberfest](https://www.madewithiechor.com/hacktoberfest)
...
The iEchor team will excitedly review what you've built. They will be looking for a few things, including:
...
Hang out with the iEchor team and community on Discord:
