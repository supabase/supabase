...
author: gregnr
imgSocial: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=platform&layout=icon-text&copy=Supabase+docs+over+SSH&icon=icon-docs.svg&icon2=icon-CLI.svg'
