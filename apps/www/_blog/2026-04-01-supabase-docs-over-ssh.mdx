...
author: gregnr
imgSocial: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=announcement&layout=horizontal&copy=Supabase+docs+over+SSH&icon=supabase.svg'
imgThumb: 'https://zhfonblqamxferhoguzj.supabase.co/functions/v1/generate-og?template=ruler&layout=icon-only&copy=Supabase+docs+over+SSH&icon=supabase.svg'
categories:
  - product
tags:
  - docs
