...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/marketing/blog/launch-week-storage-2/nyan-cat.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/marketing/blog/launch-week-storage-2/directory-uploads.mp4"
    type="video/mp4"
    muted
    playsInline
  />
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source
    src="https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/videos/marketing/blog/launch-week-storage-2/large-buckets.mp4"
    type="video/mp4"
    muted
    playsInline
  />
