...
const MONO_FONT_URL = `${STORAGE_URL}/assets/font/SourceCodePro-Regular.ttf?t=2023-07-18T13%3A03%3A29.474Z`
  ...
  try {
    ...
    const BACKGROUND = {
      regular: {
        ...
        // LOGO: `${STORAGE_URL}/assets/supabase_lw11_ga_logo_dark.png`,
      },
      platinum: {
        OG: `${STORAGE_URL}/assets/lw11_og_bg_temp.png`,
        BG: `${STORAGE_URL}/assets/lw11_ticket_platinum.png`,
        LOGO: `${STORAGE_URL}/assets/lw11_ga_logo_black.svg`,
        // LOGO: `${STORAGE_URL}/assets/supabase_lw11_ga_logo_light.png`,
      },
      secret: {
        OG: `${STORAGE_URL}/assets/lw11_og_bg_temp.png`,
