...
![connect-your-database](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/snaplet/documentation/connect-your-database.png)
...
![supabase-connection-db-info](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/snaplet/documentation/supabase-connection-db-info.png)
...
![checking-database-credentials](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/snaplet/documentation/checking-database-credentials.png)

### 2.2. Transform your data

![transform-your-data](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/snaplet/documentation/transform-your-data.png)
...
![create-your-first-snapshot](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/snaplet/documentation/create-your-first-snapshot.png)
