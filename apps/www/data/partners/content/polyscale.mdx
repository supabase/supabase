[PolyScale](https://www.polyscale.ai/) is an intelligent, serverless database caching engine which allows low-latency reads from Supabase globally, no coding required.
...
![supabase-host](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/polyscale/documentation/supabase-host.png)
...
![create-cache-supabase](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/polyscale/documentation/create-cache-supabase-400.png)
