...
![Create Supabase JWT template from Clerk dashboard](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/clerk/documentation/01_supabase-template.png)
...
![JWT template claims](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/clerk/documentation/02_jwt-claims.png)
...
![Sign with Supabase secret](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/clerk/documentation/03_jwt-secret.png)

Click to reveal the JWT secret, copy it, and then paste it in the Signing key field in the Clerk JWT template.

![Paste signing key](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/clerk/04_signing-key.png)
...
![Clerk Frontend API](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/clerk/documentation/05_clerk-frontend-api.png)
...
![Supabase keys](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/clerk/documentation/06_supabase-keys.png)
...
![Set requesting_user_id() as default value](https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public/images/integrations/clerk/documentation/07_requesting-user-id.png)
