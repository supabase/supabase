...
const data: () => {
  ...
  return {
    ...
    heroSection: {
      id: 'hero',
      title: 'Supabase powers every major AI builder. Your prototypes deserve enterprise infrastructure.',
      h1: (
        <>
    ...
    quote: {
      ...
      logo: (
      <svg className='w-24' fill="currentColor" xmlns="http://www.w3.org/2000/svg" id="Logo" viewBox="0 0 277.397 144">
