...
const data: () => {
  ...
  return {
    ...
    heroSection: {
      id: 'hero',
      title: 'Supabase for Enterprise AI Development',
      h1: (
        <>
      ...
      ctas: [
        {
          ...
          onClick: () =>
            sendTelemetryEvent({
              action: 'start_building_button_clicked',
    ...
    quote: {
      ...
      logo: '/images/customers/logos/exp-realty.png',
      link: '/customers/exp-realty',
      avatar: '/images/customers/avatars/seth-exp-realty.jpg',
    },
    secondaryQuote: {
      text: 'Supabase powers prototyping for fast-moving teams such as GitHub Next.',
      author: 'Idan Gazit',
      role: 'Senior Director of Research',
      logo: '/images/customers/logos/github.png',
    },
    aiBuilderEcosystem: {
