...
“**Program Addendum**” means the applicable addenda to this MPPA as provided at [https://supabase.com/ /legal/partner-resources/program-addenda](file:///legal/partner-resources/program-addenda) or, such other addendum to this MPPA as otherwise agreed to in writing by Supabase and Partner, which contains terms and conditions that govern Partner's participation in a Program.
