...
import {
  ...
  WorkflowCode,
  WorkflowMonitor,
} from '~/components/Modules/Workflows/WorkflowDiagram'

export default () => ({
  metaTitle: 'Supabase Workflows | Durable Multi-Step Workflows Powered by pgflow',
  metaDescription:
    'Build durable, multi-step workflows with automatic retries, parallelization, and Postgres as the execution engine using pgflow.',
  metaImage: '/images/modules/workflows/og.png',
  url: 'https://supabase.com/dashboard/project/_/integrations/workflows',
  docsUrl: '/docs/guides/workflows',
  heroSection: {
    title: 'Supabase Workflows',
    h1: <>Build Durable Workflows with Postgres</>,
    subheader: (
      <>
        Supabase Workflows is powered by pgflow, a Postgres-native workflow engine. Define
        multi-step workflows with automatic retries, parallelization, and durable execution—all
        managed through SQL.
      </>
    ),
    ...
    cta: {
      ...
      link: 'https://supabase.com/dashboard/project/_/integrations/workflows',
    },
    secondaryCta: {
      label: 'Explore documentation',
      link: '/docs/guides/workflows',
    },
    ...
    highlights: [
      {
        ...
        paragraph: 'Workflows run entirely within Postgres—no external orchestrators required.',
        svg: (
          <svg
            width="25"
            height="25"
      ...
      },
      {
        ...
        paragraph: 'Failed steps are automatically retried with configurable backoff strategies.',
        svg: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
      ...
      },
      {
        ...
        paragraph: 'Run multiple workflow steps concurrently for maximum throughput.',
        svg: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
      ...
      {
        title: 'Durable State',
        paragraph: 'Workflow state persists in Postgres—survive crashes and restarts seamlessly.',
        svg: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
      ...
      },
      {
        ...
        paragraph: 'Built on pgflow, a fully open-source workflow engine.',
        svg: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
  ...
  videoSection: {
    video: <WorkflowDAG className="mx-auto" />,
  },
  section1: {
    id: 'define',
    label: 'Define',
    heading: <>Define Workflows in TypeScript</>,
    subheading:
      'Create type-safe workflows with a fluent API. Define steps, dependencies, and error handling with full IDE support.',
    cta: {
  ...
  section2: {
    id: 'architecture',
    label: 'Architecture',
    heading: <>Powered by Postgres + Edge Functions</>,
    subheading:
      'pgflow orchestrates workflows directly in Postgres while Edge Functions execute your step logic. No external infrastructure needed.',
    cta: {
      label: 'Learn how it works',
      url: '/docs/guides/workflows',
    },
    reverse: true,
    image: <WorkflowArchitecture />,
    className: 'md:!pt-0',
  },
  section3: {
    id: 'monitor',
    label: 'Monitor',
    heading: <>Monitor and Debug Executions</>,
    subheading:
      'Track workflow runs in real-time. Inspect step outputs, retry failed steps, and debug issues with full execution visibility.',
    cta: {
      label: 'Open Dashboard',
      url: 'https://supabase.com/dashboard/project/_/integrations/workflows',
    },
    image: <WorkflowMonitor />,
    className: 'md:!pt-0',
  },
})
