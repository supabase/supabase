      ...
      <DefaultLayout>
        ...
        >
          <div className="grid grid-cols-12 gap-8 xl:gap-16">
            <article className="col-span-12 max-w-6xl mx-auto flex flex-col gap-8">
              <div className="col-span-12 flex flex-col gap-8 lg:col-span-10 xl:col-span-8 md:max-w-2xl xl:max-w-4xl">
