...
import { addSlugToEvents, fetchEventsWithBlocks, getNotionDatabase } from '~/lib/notion'
...
export async function getStaticProps() {
  ...
  const eventsWithBlocks = eventsWithSlug?.length ? await fetchEventsWithBlocks(eventsWithSlug) : []
