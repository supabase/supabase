...
- Pro & Free users: Technical support is available exclusively through the Supabase help feature in the dashboard or this website: [https://app.supabase.com/support/new](https://app.supabase.com/support/new)
- Teams Tier: Same as Pro & Free plus access to the Teams form, including Success Engineers that will answer the ticket.
- Enterprise Tier: All the above + access to a shared slack channel for faster communication including Supabase Engineers.
...
You can find the Service Level Agreement levels including support response times. On the dedicated page for this topic:
