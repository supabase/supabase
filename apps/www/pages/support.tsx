  ...
  return (
    <>
      ...
      <DefaultLayout>
        ...
        <SectionContainer>
          <div className="text grid gap-5 md:grid-cols-3">
        ...
        <SectionContainer className="!pt-0">
          <div className="mx-auto max-w-5xl bg-alternative border rounded-xl p-6 lg:p-16">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 xl:gap-10 justify-between">
              ...
              <div className="col-span-full lg:col-start-6 lg:col-span-7 flex flex-col gap-4">
                <p className="text-light">
