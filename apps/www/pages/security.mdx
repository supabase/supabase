...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:gap-16 bg-surface-100 border rounded-lg gap-4 transition-colors p-10 mb-20">
...
SOC2 Type 2 and HIPAA are available to Enterprise and Team customers. Request to sign our BAA [on the dashboard](/dashboard/org/_/documents).
