...
import { IconActivity, IconLock, IconSmartphone } from 'ui'
...
<Section icon={<IconLock strokeWidth={1}/>}>

### Multi-factor Authentication

Multi-factor authentication (MFA) adds an additional layer of security to your user account, by requiring a second factor to verify your user identity.

Supabase allows users to enable MFA on their account and set it as a requirement for subsequent logins.
