...
In addition to protection at the Cloudflare level, we employ fail2ban on instances and [customizable rate limiting](/docs/guides/platform/going-into-prod#rate-limiting-resource-allocation--abuse-prevention) and abuse prevention safeguards. Users can set [spend caps](/docs/guides/platform/spend-cap) to prevent surprise bills.
