...
<h3 className="text-3xl">Documents Centre</h3>
...
You can build healthcare apps on our hosted platform once you enter into a Business Associate Agreement (BAA) with us and fulfil your HIPAA obligations under our [shared responsibilty model](/docs/guides/platform/shared-responsibility-model#managing-healthcare-data).
