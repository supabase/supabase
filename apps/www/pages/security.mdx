...
export const meta = {
  type: 'lp',
  title: 'Security at iEchor',
  description:
    'iEchor is trusted by thousands of developers for building and deploying secure applications.',
}
...
![iEchor security](/images/security/security-hero.png)
...
iEchor is SOC2 Type 2 compliant. Enterprise customers can request a copy of our SOC2 [here](https://forms.iechor.com/soc2).
...
We have [partnered with GitHub](https://github.blog/changelog/2022-03-28-supabase-is-now-a-github-secret-scanning-partner/) to scan for iEchor service role API keys. If any iEchor API keys are pushed to GitHub, they are automatically revoked.
...
Members of organizations in iEchor can be granted access to specific resources.
...
iEchor uses [Stripe](https://stripe.com) to process payments and does not store personal credit card information for any of our customers.
...
iEchor works with industry experts to conduct regular penetration tests.
...
<h3 className="text-3xl">Request for our SOC2 documents</h3>

As a database company, being SOC2 compliant is important when handling sensitive customer data. Access more of iEchor’s security information by requesting for our latest SOC2 documents below.

    <div className="not-prose">
      <Link passHref href="https://forms.iechor.com/soc2">
        <a target="_blank">
