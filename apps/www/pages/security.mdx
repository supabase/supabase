...
export const Section = ({ children, icon, img }) => (
  <div>
    {icon && (
      <div className="bordershadow-scale-500 not-prose dark:bg-scale-400 -mb-4 flex h-8 w-8 items-center justify-center rounded-md bg-white">
