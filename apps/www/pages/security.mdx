...
Supabase is ISO 27001:2022 certified. ISO 27001 is an internationally recognized standard for managing information security, covering the policies, processes, and controls that keep customer data secure.

Enterprise and Team customers can access our ISO 27001 certificate [on the dashboard](/dashboard/org/_/documents).

<div className="w-32">
  <img src="/images/security/iso-27001.svg" />
</div>
