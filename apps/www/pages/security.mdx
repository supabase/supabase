...
In addition to protection at the Cloudflare level, we employ fail2ban on instances and [customizable rate limiting and abuse prevention](/docs/guides/platform/going-into-prod#rate-limiting-resource-allocation--abuse-prevention) safeguards at the API level such as CAPTCHA for auth endpoints. Users can set [spend caps](/docs/guides/platform/spend-cap) to prevent surprise bills.
