...
Supabase is SOC2 Type 1 compliant. Enterprise customers can request a copy of our SOC2 [here](https://security.supabase.com).
...
We have [partnered with GitHub](https://github.blog/changelog/2022-03-28-supabase-is-now-a-github-secret-scanning-partner/) to scan for Supabase service role API keys. If Github detects any keys with full access to the database being pushed to GitHub, they are automatically revoked.
