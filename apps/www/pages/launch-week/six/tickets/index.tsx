    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          images: [
            {
              url: `https://supabase.com/images/launchweek/six/og-image.jpg`, // TODO
            },
          ],
        }}
      />
      <DefaultLayout>
        <SectionContainer className="flex flex-col gap-16">
          <div className="flex flex-col gap-3 items-center justify-center xl:justify-start">
            <img
              src="/images/launchweek/six/launchweek-logo--light.svg"
              className="flex w-40 dark:hidden lg:w-80"
            />
            <img
              src="/images/launchweek/six/launchweek-logo--dark.svg"
