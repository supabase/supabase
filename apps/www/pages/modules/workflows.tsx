...
import WorkflowsPageData from '~/data/products/modules/workflows'
...
function WorkflowsPage() {
  const pageData = WorkflowsPageData()
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: pageData.metaTitle,
          description: pageData.metaDescription,
          url: `https://supabase.com/modules/workflows`,
          images: [
            {
      ...
      <DefaultLayout className="!bg-alternative" stickyNavbar={false}>
        <ModulesNav activePage={PRODUCT_MODULES_NAMES.WORKFLOWS} docsUrl={pageData.docsUrl} />
