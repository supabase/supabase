...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const assumePlatinum = req.query.platinum as string
  ...
  try {
    ...
    const lineNumberStyle = {
      paddingLeft: 24,
      width: 46,
      color: STYLING_CONFIG[ticketType].CODE_LINE_NUMBER,
    }
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: '20px',
                fontSize: 18,
                background: STYLING_CONFIG[ticketType].TICKET_BACKGROUND_CODE,
                color: STYLING_CONFIG[ticketType].TICKET_FOREGROUND,
                border: `1px solid ${STYLING_CONFIG[ticketType].TICKET_BORDER}`,
            ...
            >
              <span tw="uppercase p-6" style={{ fontSize: 18, letterSpacing: 2 }}>
                ...
                <span
                  tw="pl-2"
                  style={{ color: STYLING_CONFIG[ticketType].TICKET_FOREGROUND_LIGHT }}
                >
                  Ticket
                </span>
              </span>
              ...
              >
                <div
                  ...
                  style={{ color: STYLING_CONFIG[ticketType].CODE_LINE_NUMBER }}
                >
                  <span>1</span>
                  <span>2</span>
                  <span>3</span>
                ...
                <div
                  tw="flex flex-col"
                  style={{
                    color: STYLING_CONFIG[ticketType].CODE_BASE,
                  }}
                >
                  <span>
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_EXPRESSION }}>await</span>{' '}
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_FUNCTION }} tw="ml-3">
                      supabase
                    </span>
                  </span>
                  <span tw="pl-4">
                    <span>.</span>
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_METHOD }}>from</span>
                    <span>&#40;</span>
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_STRING }}>'tickets'</span>
                    <span>&#41;</span>
                  </span>
                  <span tw="pl-4">
                    <span>.</span>
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_METHOD }}>select</span>
                    <span>&#40;</span>
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_STRING }}>'*'</span>
                    <span>&#41;</span>
                  </span>
                  <span tw="pl-4">
                    <span>.</span>
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_METHOD }}>eq</span>
                    <span>&#40;</span>
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_STRING }}>
                      'username'
                    </span>
                    <span tw="mr-3">,</span>
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_NUMBER }}>
                      {username}
                    </span>
                    <span>&#41;</span>
                  </span>
                  <span tw="pl-4">
                    <span>.</span>
                    <span style={{ color: STYLING_CONFIG[ticketType].CODE_METHOD }}>single</span>
                    <span>&#40;</span>
                    <span>&#41;</span>
                  </span>
                </div>
              ...
              <div
                style={{
                  ...
                  lineHeight: '130%',
                  background: STYLING_CONFIG[ticketType].TICKET_BACKGROUND,
                  borderTop: `1px solid ${STYLING_CONFIG[ticketType].TICKET_BORDER}`,
                }}
              ...
              >
                ...
                >
                  ...
                  <div tw="flex">
                    ...
                    <span>
                      <span tw="ml-6 mr-2" style={{ color: STYLING_CONFIG[ticketType].CODE_BASE }}>
                        data:
                      </span>
                      <span>&#123;</span>
                    </span>
                  ...
                  <div
                    tw="flex flex-col w-full"
                    style={{
                      background: STYLING_CONFIG[ticketType].CODE_HIGHLIGHT,
                      borderLeft: `1px solid ${STYLING_CONFIG[ticketType].CODE_BASE}`,
                    }}
                  >
                    <div tw="flex">
                      ...
                      <span>
                        <span
                          tw="ml-12 mr-2"
                          style={{ color: STYLING_CONFIG[ticketType].CODE_BASE }}
                        >
                          name
                        </span>
                        <span>:</span>
                        <span tw="ml-2" style={{ color: STYLING_CONFIG[ticketType].CODE_STRING }}>
                          "{name}"
                        </span>
                        <span>,</span>
                      </span>
                  ...
                  <div tw="flex">
                    ...
                    <span>
                      <span tw="ml-6" style={{ color: STYLING_CONFIG[ticketType].CODE_BASE }}>
                        error
                      </span>
                      <span>:</span>
                      <span tw="ml-2" style={{ color: STYLING_CONFIG[ticketType].CODE_NULL }}>
                        null
                      </span>
                    </span>
                  </div>
    ...
    const response = await fetch(
      `${STORAGE_URL}/og/${ticketType}/${username}.png?t=${NEW_TIMESTAMP}`
    )
