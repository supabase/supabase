            ...
            {pageData.featureBlocks.map((item, i) => {
              return (
                <div
                  ...
                  key={i}
                >
                  <div className="bg-brand-300 in-data-[theme*=dark]:bg-brand-500 text-brand-1200 group-hover:text-brand-800 [[data-theme*=dark]_&]:group-hover:text-brand-1000 flex h-12 w-12 items-center justify-center rounded-md border border-brand-default transition-all group-hover:scale-105">
