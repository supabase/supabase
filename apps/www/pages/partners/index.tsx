    ...
    <>
      ...
      <DefaultLayout className="bg-scale-300 dark:bg-scale-100">
        <div className="relative bg-scale-300 dark:bg-[#121212]">
          ...
          <SectionContainer>
            <p className="text-scale-1000 text-xs sm:text-sm lg:text-base text-center pt-3">
        ...
        <SectionContainer>
          ...
          <div className="grid mt-8 lg:mt-12 gap-8 rounded md:grid-cols-2 xl:grid-cols-4">
        ...
        <SectionContainer className="flex flex-col gap-8">
          <div className="flex flex-col lg:flex-row gap-8 xl:gap-10 justify-between">
            ...
            <div className="relative w-full lg:w-1/2 min-h-[300px] border bg-scale-300 flex items-center justify-center aspect-video">
              diagram: - Use Supabase API to control the projects
            </div>
          </div>
