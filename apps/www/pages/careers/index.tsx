        ...
        <div className="text-scale-1200">
          ...
          <SectionContainer>
            ...
            <div className="mt-16 md:ml-36 lg:flex lg:items-start lg:w-fit lg:mx-auto">
                ...
                return (
                  ...
                  >
                    <div className="lg:flex items-center">
                      <h3 className="bg-brand-600 border-[1px] border-brand-500 text-brand text-md text-center w-[44px] px-2 py-1.5 rounded-md">
                        {i + 1}
                      </h3>
              ...
              <h3 className="bg-brand-600 border-[1px] border-brand-500 text-brand text-xl w-[44px] min-h-[40px] px-2 py-1 rounded-md grid justify-items-center items-center">
                <IconCheck />
              </h3>
            </div>
          </SectionContainer>
