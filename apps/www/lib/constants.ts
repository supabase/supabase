...
export const TWEET_TEXT = 'Claim your ticket to join this @supabase Special Event'
export const TWEET_TEXT_GOLDEN = ``
export const TWEET_TEXT_PLATINUM = `Just got a platinum @supabase ticket. Claim yours!`
export const TWEET_TEXT_SECRET = `Found a secret @supabase ticket. Guess the word at supabase.com/launch-week to get yours:`
