...
export function SurveyChapter({
  ...
  return (
    <section
      id={`chapter-${number}`}
      className="flex flex-col bg-200 border-t last-of-type:border-b pt-24"
    >
      <div className="flex flex-col gap-12 container max-w-[60rem] mx-auto px-6 lg:px-0 pb-24">
        <header className="mx-auto flex flex-col gap-4 text-center text-balance pb-12 border-b border-muted">
