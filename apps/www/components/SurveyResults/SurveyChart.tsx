...
export function SurveyChart({
  ...
  return (
    <div
      ...
      style={{
        background: `radial-gradient(circle at center -150%, var(--brand-300), transparent 80%), radial-gradient(ellipse at center 230%, var(--background-surface-200), transparent 75%)`,
      }}
    >
