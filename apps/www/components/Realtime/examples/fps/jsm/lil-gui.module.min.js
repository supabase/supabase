...
class d extends t {
  ...
  updateDisplay() {
    ...
    return (
      this._inputFocused ||
        (this.$input.value = void 0 === this._decimals ? t : t.toFixed(this._decimals)),
      this
    )
  }
  _initInput() {
    ...
    this.$input.addEventListener('input', () => {
      ...
      this.$input.addEventListener('keydown', (i) => {
        'Enter' === i.code && this.$input.blur(),
          ...
          'ArrowDown' === i.code &&
            (i.preventDefault(), t(this._step * this._arrowKeyMultiplier(i) * -1))
      }),
    ...
    this.$slider.addEventListener('mousedown', (s) => {
      ...
      this.$slider.addEventListener(
        ...
        (t) => {
          t.touches.length > 1 ||
            (this._hasScrollBar
              ? ((s = t.touches[0].clientX), (n = t.touches[0].clientY), (l = !0))
              : r(t),
