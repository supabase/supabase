              ...
              <div className="relative z-10 lg:h-auto pt-[90px] lg:pt-[90px] lg:min-h-[300px] flex flex-col items-center justify-center sm:mx-auto md:w-3/4 lg:mx-0 lg:w-full gap-4 lg:gap-8">
                <div className="flex flex-col items-center">
                  <div className="z-40 w-full flex flex-col gap-4 items-center justify-center -mt-4 md:-mt-8 mb-8 lg:mb-8">
                    <Link
                      className="py-1 text-xs text-foreground-light hover:text-foreground transition-opacity flex items-center gap-2"
                      href="/events/ai-engineer-summit-2024"
                    >
                      <span className="font-mono uppercase text-brand pr-2 border-r border-muted">
                        Webinar
                      </span>
                      <span className="font-mono uppercase pr-2 border-r border-muted">21 AUG</span>
