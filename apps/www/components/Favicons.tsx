...
const Favicons = () => {
  ...
  return (
    <Head>
      ...
      {/* prettier-ignore */}
      <link rel="icon" type="image/png" href={`${basePath}/favicon/favicon-196x196.png`}/>
      {/* prettier-ignore */}
      <link rel="icon" type="image/png" href={`${basePath}/favicon/favicon-96x96.png`}/>
      {/* prettier-ignore */}
      ...
      {/* prettier-ignore */}
      <link rel="icon" type="image/png" href={`${basePath}/favicon/favicon-128.png`}/>
