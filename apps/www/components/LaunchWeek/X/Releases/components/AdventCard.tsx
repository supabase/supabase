...
const AdventCard = ({ day, index }: { day: AdventDay; index: number }) => {
  ...
  return (
    ...
    >
      <motion.div
        className="opacity-0 flex flex-col justify-between w-full aspect-square p-6 lg:p-8 rounded-xl bg-[#121516] transition-colors text-[#575E61] border hover:border-strong overflow-hidden"
        variants={variants}
      >
