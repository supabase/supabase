  ...
  return (
    <div className="w-full text-white flex flex-col lg:flex-row gap-8 lg:gap-16">
      ...
      <div className="lg:basis-2/3 relative grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        >
          <span className="relative z-10 stroke-text inline-block text-transparent bg-clip-text bg-linear-to-b from-foreground to-foreground-lighter text-7xl drop-shadow-lg">
            6
          </span>
