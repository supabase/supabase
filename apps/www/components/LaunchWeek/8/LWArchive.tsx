    ...
    <div className="w-full text-white flex flex-col lg:flex-row gap-8 lg:gap-16">
      ...
      <div className="lg:basis-2/3 relative grid grid-cols-1 xl:grid-cols-2 gap-4">
        <Link href="/launch-week/6">
          <a className="relative h-[160px] w-full rounded-md md:rounded-lg transition-transform bg-[#030A0C] flex items-center justify-center border border-[#111618] hover:border-brand-800 overflow-hidden">
        ...
        <Link href="/launch-week/7">
          <a className="relative h-[160px] w-full rounded-md md:rounded-lg transition-transform bg-[#030A0C] flex items-center justify-center border border-[#111718] hover:border-brand-1200 overflow-hidden">
            <span className="relative z-10 stroke-text inline-block text-transparent bg-clip-text bg-gradient-to-b from-scale-1200 to-scale-1000 text-7xl drop-shadow-lg">
              7
            </span>
