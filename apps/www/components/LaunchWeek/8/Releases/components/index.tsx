  ...
  uiOnly ? (
    ...
    <Link href={href}>
      <a
        ...
        rel="noopener"
        className={[
          'flex flex-auto justify-center sm:justify-between focus-base focus-rounded-full w-full text-center sm:text-left min-h-[43px] sm:w-auto items-center border border-[#232323] bg-gradient-to-r text-white from-[#46444460] to-[#19191980] hover:from-[#4e4e4e90] hover:to-[#19191990] hover:border-scale-800 backdrop-blur-xl rounded-full text-sm py-2 px-3 sm:pr-2',
          className,
        ].join(' ')}
      >
        {children}
