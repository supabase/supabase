      ...
      <SectionContainer>
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 xl:col-span-2 xl:mt-0">
            <nav role="navigation" className="grid grid-cols-2 gap-8 md:grid-cols-4">
                  ...
                  <div key={`footer_${segment.title}`}>
                    ...
                    <ul role="list" className="mt-4 space-y-2">
                      {segment.links.map((link, idx) => {
                        ...
                        return (
                          <li role="listitem" key={`${segment.title}_link_${idx}`}>
        ...
        <section className="border-scale-500 dark:border-scale-600 mt-32 flex justify-between border-t pt-8">
