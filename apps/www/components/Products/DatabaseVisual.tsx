...
const DatabaseVisual = () => {
  ...
  return (
    ...
    >
      <span className="absolute w-full md:w-auto h-full md:aspect-square flex items-end md:items-center justify-center md:justify-end right-0 left-0 md:left-auto top-24 md:top-24 md:top-0 md:bottom-0 my-auto">
        <Image
