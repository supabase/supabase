...
const FunctionsVisual = ({ isHovered }: { isHovered?: boolean }) => {
  ...
  return (
    <div className="absolute inset-0 z-0">
      <svg
        ...
        fill="none"
        className="absolute w-full h-auto inset-0 top-auto z-10 object-cover"
      >
        <g clip-path="url(#clip0_444_4697)">
        ...
        <defs>
          ...
          >
            ...
            <feGaussianBlur stdDeviation="1.44088" result="effect1_foregroundBlur_444_4697" />
          </filter>
          <filter
          ...
          >
            ...
            <stop offset="0.2" stop-color="#3ECF8E" />
            <stop offset="0.8" stop-color="#3ECF8E" stop-opacity="0.3" />
          ...
          >
            <stop offset="0" stop-color="#4B4B4B" stop-opacity="0" />
            <stop offset="0.1" stop-color="#3ECF8E" />
            <stop offset="0.9" stop-color="#3ECF8E" />
            <stop offset="1" stop-color="#4B4B4B" stop-opacity="0" />
          </motion.linearGradient>
          <clipPath id="clip0_444_4697">
            <rect width="289" height="430" fill="white" />
          </clipPath>
        </defs>
      </svg>
