    ...
    >
      ...
      >
        ...
        <defs>
          ...
          >
            <stop offset="0" stopColor="#4B4B4B" stopOpacity="0" />
            <stop offset="0.2" stopColor="#3ECF8E" />
            <stop offset="0.8" stopColor="#3ECF8E" stopOpacity="0.0" />
          ...
          >
            <stop offset="0" stopColor="#4B4B4B" stopOpacity="0" />
            <stop offset="0.1" stopColor="#3ECF8E" stopOpacity="0.0" />
            <stop offset="0.9" stopColor="#3ECF8E" />
            <stop offset="1" stopColor="#4B4B4B" stopOpacity="0" />
          </motion.linearGradient>
          <clipPath id="clip0_444_4697">
            <rect width="289" height="430" fill="none" />
          </clipPath>
        </defs>
      </svg>
