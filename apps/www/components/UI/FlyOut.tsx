        ...
        <>
          <div className="absolute inset-x-0 transform shadow-lg ">
            <div
              ...
              aria-hidden="true"
            >
              <div className="dark:bg-[#03030899] backdrop-blur-xl dark:border-scale-400 border-r bg-white sm:h-1/2 sm:w-full lg:h-full lg:w-1/2" />
              <div
                className={`${
                  singleBgColor ? 'dark:bg-[#030308] bg-white' : 'dark:bg-[#0A0B0F] bg-gray-50'
