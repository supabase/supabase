  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-40 transform" style={{ transform: 'translate3d(0,0,999px)' }}>
        <div
          className={[
            'absolute inset-0 h-full w-full opacity-100 bg-[#0A0B0F90] backdrop-blur-lg',
        ...
        >
          ...
          >
            <div
              className={[
                'dark:bg-[#0A0B0F] fixed -inset-y-0 z-50 h-screen w-screen transform overflow-y-scroll bg-white p-4 md:p-8',
                open && '!bg-[#0A0B0F]',
              ].join(' ')}
            >
              <div className="absolute items-center justify-between right-4 top-4">
                <div className="-mr-2">
                  <button
                    ...
                    type="button"
                    className="inline-flex items-center justify-center p-2 bg-white rounded-md text-scale-900 focus:ring-brand-900 dark:bg-[#0A0B0F] dark:hover:bg-[#0A0B0F] hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset"
                  >
