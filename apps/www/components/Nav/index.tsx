                        ...
                        >
                          <NavigationMenuTrigger
                            className={cn(
                              ...
                              'bg-transparent! hover:text-brand data-open:text-brand! focus-ring focus-visible:text-foreground px-2.5 h-full'
                            )}
                          >
                            {menuItem.title}
                          </NavigationMenuTrigger>
                        ...
                        <NavigationMenuItem className="text-sm font-medium" key={menuItem.title}>
                          <NavigationMenuLink asChild>
                            <MenuItem
                              ...
                              className="group-hover:bg-transparent text-foreground focus-visible:text-brand px-2.5 h-full"
                              hoverColor="brand"
                            />
                          </NavigationMenuLink>
                        </NavigationMenuItem>
