            ...
            {posts.map((post: any) => (
              <li key={post.title}>
                ...
                >
                  ...
                  <p className="text-sm line-clamp-1 text-foreground-lighter leading-relaxed !mb-0 group-hover:text-foreground-light group-focus-visible:text-foreground-light">
                    {post.description}
                  </p>
                </Link>
              </li>
