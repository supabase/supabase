        ...
        <div key={column.label} className="p-0 flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-4">
            {column.links.map(({ icon: Icon, ...link }: Props) => (
              <li key={link.text}>
                <Link href={link.url!}>
                  <a className="flex group items-center gap-2 text-foreground-light text-sm hover:text-foreground focus-visible:text-foreground focus-visible:ring-2 focus-visible:outline-none focus-visible:rounded focus-visible:ring-foreground-lighter">
            ...
            <li key={announcement.title}>
              <Link href={announcement.url}>
                <a className="group flex flex-col focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-foreground-lighter focus-visible:ring-offset-4 focus-visible:ring-offset-background-alternative focus-visible:rounded">
                  ...
                  <p className="text-sm line-clamp-2 text-foreground-lightround-lighter leading-relaxed !mb-0 group-hover:text-foreground-light group-focus-visible:text-foreground-light">
