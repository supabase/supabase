...
export function StateOfStartupsAuroraHeader() {
  ...
  return (
    <header
      className="relative w-full overflow-hidden min-h-[44svh] md:min-h-[50svh]"
    ...
    >
      ...
      <div className="relative z-10 max-w-240 mx-auto px-8 flex flex-col gap-4 justify-end pb-16 md:pb-18 min-h-[44svh] md:min-h-[50svh]">
