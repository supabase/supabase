      ...
      <div className="flex flex-col gap-6 lg:gap-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-end">
          ...
          <p className="text-foreground-lighter text-sm lg:text-base">
            Every Supabase project is a dedicated Postgres database. Use it on its own with any
            Postgres client or ORM. Auth, Storage, and Realtime are optional. 100% portable with no
            vendor lock-in.
          </p>
        </div>
