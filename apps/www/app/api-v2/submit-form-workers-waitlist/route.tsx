...
export async function POST(req: Request) {
  ...
  const { name, email, company, useCase, details, honeypot } = body
  ...
  try {
    ...
    await cio.createOrUpdateProfile(email, {
      ...
      workers_use_case: useCase || undefined,
      workers_use_case_details: details || undefined,
    })

    await cio.trackEvent(email, {
      userId: email,
      type: 'track',
      event: 'workers_waitlist_requested',
      properties: {
        name,
        company: company || undefined,
