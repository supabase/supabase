...
const page: GoPageInput = {
  ...
  metadata: {
    title: 'Win an iPhone Pro Max | Supabase at Startup Grind 2026',
    description:
      'Create a Supabase account and load data for a chance to win an iPhone Pro Max. Startup Grind 2026.',
  },
  hero: {
