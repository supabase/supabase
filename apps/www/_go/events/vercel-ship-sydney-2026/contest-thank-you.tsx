...
const page: GoPageInput = {
  template: 'thank-you',
  slug: 'vercel-ship-sydney-2026/contest/thank-you',
  metadata: {
    title: "You're entered | Supabase at Vercel Ship Sydney 2026",
    description: 'Thanks for entering the Supabase contest at Vercel Ship Sydney 2026. Good luck!',
  },
  hero: {
