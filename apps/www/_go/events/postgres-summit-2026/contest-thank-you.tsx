...
const page: GoPageInput = {
  template: 'thank-you',
  slug: 'postgres-summit-2026/contest/thank-you',
  metadata: {
    title: "You're entered | Supabase at Postgres Summit US 2026",
    description: 'Thanks for entering the Supabase contest at Postgres Summit US 2026. Good luck!',
  },
  hero: {
