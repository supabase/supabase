...
const page: GoPageInput = {
  template: 'lead-gen',
  slug: 'select-2026/hackathon',
  metadata: {
    title: 'Select Hackathon · Day of | Supabase',
    description:
  ...
  hero: {
    ...
    subtitle: 'Build in a day at YC · October 3, 2026',
    description: 'YC 560 + 580, San Francisco. Everything you need for the day, in one file.',
    ctas: [
      {
        label: 'Submit at hackathon.supabase.com',
