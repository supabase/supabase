...
The restoration can take several minutes. If you database has a lot of data, then the restore process will take a lonnger. You will receive an email once the restoration is complete.
