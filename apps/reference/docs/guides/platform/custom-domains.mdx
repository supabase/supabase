...
To get configure a custom domain, you must first:

- [Install](/docs/guides/cli) the Supabase CLI 1.10.1+
- [Login](/docs/guides/cli/local-development#log-in-to-the-supabase-cli) to your account usig the CLI
- Enable the Custom Domains add-on in the Billing page of the Dashboard.

## Configure a Custom Domain

In this example we will assume your Supabase project is `foobar` with a corresponding API URL `foobar.supabase.co`. We'll step you through setting up your own subdomain "api.example.com".
