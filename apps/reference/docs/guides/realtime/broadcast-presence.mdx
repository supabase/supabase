---
id: broadcast
title: Supabase Broadcast
description: Getting started with Realtime's broadcast feature
---

Supabase Broadcast allows a client to broadcast messages and multiple receivers to receive the broadcasted message. The broadcasted messages are ephemeral, they are not persisted to the database and are directly relayed by the Realtime server.
