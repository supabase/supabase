...
1. Clone the [firebase-to-supabase](https://github.com/supabase-community/firebase-to-supabase) repository:
    ...
    ```
1. In the `/firestore` directory, rename [supabase-service-sample.json](https://github.com/supabase-community/firebase-to-supabase/blob/main/firestore/supabase-service-sample.json) to `supabase-service.json`.
