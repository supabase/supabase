...
```
We want the user to get redirected to the app on login. Go to project [Authentication](https://app.supabase.com/project/_/auth/settings) settings. Under Redirect URLs, click "Add Domain" and add `http://localhost:3000`.
