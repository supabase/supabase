...
```bash
curl -X POST 'https://xxx.supabase.co/auth/v2/signup' \
...
```bash
curl -X POST 'https://xxx.supabase.co/auth/v2/verify' \
-H "apikey: SUPABASE_KEY" \
-H "Content-Type: application/json" \
-d '{
  "type": "sms",
...
```bash
curl -X POST 'https://xxx.supabase.co/auth/v2/token?grant_type=password' \
-H "apikey: SUPABASE_KEY" \
-H "Content-Type: application/json" \
-d '{
  "phone": "491512223334444",
...
```bash
curl -X POST 'https://xxx.supabase.co/auth/v2/otp' \
-H "apikey: SUPABASE_KEY" \
-H "Content-Type: application/json" \
-d '{
  "phone": "491512223334444"
