...
- Add `/auth/v2/callback` to the end of that to get your full `OAuth Redirect URI`.

Your redirect uri should look like the following: `https://<project-ref>.supabase.co/auth/v2/callback`
