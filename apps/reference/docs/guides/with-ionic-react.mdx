...
import QuickstartIntro from './_components/quickstart_intro.md'
import ProjectSetup from './_components/project_setup.mdx'
...
![Supabase Ionic React](/img/ionic-demos/ionic-react.png)
