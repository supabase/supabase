...
First, create a free account on the Keyri dashboard (<https://app.keyri.com>) and register a new service. On Add Your Application, set a name and input the domain on which your app will eventually be deployed. You can create multiple applications in Keyri to account for your development, staging, and production environments.
