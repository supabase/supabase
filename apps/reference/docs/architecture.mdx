...
Our goal is to provide an architecture which any large-scale company would design for themselves,
and then offer tooling around this architecture to make it simple-to-use for indie-developers and small teams.
...
Supabase supports existing tools and communities wherever possible. Supabase is more like a "community of communities" - each tool typically has it's own community
which we work with. We take a collabortative approach to open source: we employ maintainers, sponsor projects,
invest in businesses, and employ developers to build our own open source tools.
