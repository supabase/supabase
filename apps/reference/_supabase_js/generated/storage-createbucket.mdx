...
The visibility of the bucket. By default, buckets are not public. Public buckets don't require an authorization token to download objects, but still require an valid token for all other operations.
