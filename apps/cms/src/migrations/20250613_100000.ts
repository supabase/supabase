...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_customers_industry" AS ENUM('healthcare', 'fintech', 'ecommerce', 'education', 'gaming', 'media', 'real-estate', 'saas', 'social', 'analytics', 'ai', 'developer-tools');
  CREATE TYPE "public"."enum_customers_supabase_products" AS ENUM('database', 'auth', 'storage', 'realtime', 'functions', 'vector');
  CREATE TYPE "public"."enum_customers_company_size" AS ENUM('startup', 'enterprise', 'indie_dev');
  CREATE TYPE "public"."enum_customers_region" AS ENUM('Asia', 'Europe', 'North America', 'South America', 'Africa', 'Oceania');
  CREATE TYPE "public"."enum_customers_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__customers_v_version_industry" AS ENUM('healthcare', 'fintech', 'ecommerce', 'education', 'gaming', 'media', 'real-estate', 'saas', 'social', 'analytics', 'ai', 'developer-tools');
  CREATE TYPE "public"."enum__customers_v_version_supabase_products" AS ENUM('database', 'auth', 'storage', 'realtime', 'functions', 'vector');
  CREATE TYPE "public"."enum__customers_v_version_company_size" AS ENUM('startup', 'enterprise', 'indie_dev');
  CREATE TYPE "public"."enum__customers_v_version_region" AS ENUM('Asia', 'Europe', 'North America', 'South America', 'Africa', 'Oceania');
  CREATE TYPE "public"."enum__customers_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_events_type" AS ENUM('conference', 'hackathon', 'launch-week', 'meetup', 'office-hours', 'talk', 'webinar', 'workshop', 'other');
  ...
  CREATE TYPE "public"."enum_events_link_target" AS ENUM('_self', '_blank');
  CREATE TYPE "public"."enum_events_main_cta_target" AS ENUM('_self', '_blank');
  CREATE TYPE "public"."enum_events_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__events_v_version_type" AS ENUM('conference', 'hackathon', 'launch-week', 'meetup', 'office-hours', 'talk', 'webinar', 'workshop', 'other');
  CREATE TYPE "public"."enum__events_v_version_timezone" AS ENUM('Africa/Abidjan', 'Africa/Accra', 'Africa/Addis_Ababa', 'Africa/Algiers', 'Africa/Asmara', 'Africa/Bamako', 'Africa/Bangui', 'Africa/Banjul', 'Africa/Bissau', 'Africa/Blantyre', 'Africa/Brazzaville', 'Africa/Bujumbura', 'Africa/Cairo', 'Africa/Casablanca', 'Africa/Ceuta', 'Africa/Conakry', 'Africa/Dakar', 'Africa/Dar_es_Salaam', 'Africa/Djibouti', 'Africa/Douala', 'Africa/El_Aaiun', 'Africa/Freetown', 'Africa/Gaborone', 'Africa/Harare', 'Africa/Johannesburg', 'Africa/Juba', 'Africa/Kampala', 'Africa/Khartoum', 'Africa/Kigali', 'Africa/Kinshasa', 'Africa/Lagos', 'Africa/Libreville', 'Africa/Lome', 'Africa/Luanda', 'Africa/Lubumbashi', 'Africa/Lusaka', 'Africa/Malabo', 'Africa/Maputo', 'Africa/Maseru', 'Africa/Mbabane', 'Africa/Mogadishu', 'Africa/Monrovia', 'Africa/Nairobi', 'Africa/Ndjamena', 'Africa/Niamey', 'Africa/Nouakchott', 'Africa/Ouagadougou', 'Africa/Porto-Novo', 'Africa/Sao_Tome', 'Africa/Tripoli', 'Africa/Tunis', 'Africa/Windhoek', 'America/Adak', 'America/Anchorage', 'America/Anguilla', 'America/Antigua', 'America/Araguaina', 'America/Argentina/Buenos_Aires', 'America/Argentina/Catamarca', 'America/Argentina/Cordoba', 'America/Argentina/Jujuy', 'America/Argentina/La_Rioja', 'America/Argentina/Mendoza', 'America/Argentina/Rio_Gallegos', 'America/Argentina/Salta', 'America/Argentina/San_Juan', 'America/Argentina/San_Luis', 'America/Argentina/Tucuman', 'America/Argentina/Ushuaia', 'America/Aruba', 'America/Asuncion', 'America/Atikokan', 'America/Bahia', 'America/Bahia_Banderas', 'America/Barbados', 'America/Belem', 'America/Belize', 'America/Blanc-Sablon', 'America/Boa_Vista', 'America/Bogota', 'America/Boise', 'America/Cambridge_Bay', 'America/Campo_Grande', 'America/Cancun', 'America/Caracas', 'America/Cayenne', 'America/Cayman', 'America/Chicago', 'America/Chihuahua', 'America/Costa_Rica', 'America/Creston', 'America/Cuiaba', 'America/Curacao', 'America/Danmarkshavn', 'America/Dawson', 'America/Dawson_Creek', 'America/Denver', 'America/Detroit', 'America/Dominica', 'America/Edmonton', 'America/Eirunepe', 'America/El_Salvador', 'America/Fort_Nelson', 'America/Fortaleza', 'America/Glace_Bay', 'America/Godthab', 'America/Goose_Bay', 'America/Grand_Turk', 'America/Grenada', 'America/Guadeloupe', 'America/Guatemala', 'America/Guayaquil', 'America/Guyana', 'America/Halifax', 'America/Havana', 'America/Hermosillo', 'America/Indiana/Indianapolis', 'America/Indiana/Knox', 'America/Indiana/Marengo', 'America/Indiana/Petersburg', 'America/Indiana/Tell_City', 'America/Indiana/Vevay', 'America/Indiana/Vincennes', 'America/Indiana/Winamac', 'America/Inuvik', 'America/Iqaluit', 'America/Jamaica', 'America/Juneau', 'America/Kentucky/Louisville', 'America/Kentucky/Monticello', 'America/Kralendijk', 'America/La_Paz', 'America/Lima', 'America/Los_Angeles', 'America/Lower_Princes', 'America/Maceio', 'America/Managua', 'America/Manaus', 'America/Marigot', 'America/Martinique', 'America/Matamoros', 'America/Mazatlan', 'America/Menominee', 'America/Merida', 'America/Metlakatla', 'America/Mexico_City', 'America/Miquelon', 'America/Moncton', 'America/Monterrey', 'America/Montevideo', 'America/Montserrat', 'America/Nassau', 'America/New_York', 'America/Nipigon', 'America/Nome', 'America/Noronha', 'America/North_Dakota/Beulah', 'America/North_Dakota/Center', 'America/North_Dakota/New_Salem', 'America/Ojinaga', 'America/Panama', 'America/Pangnirtung', 'America/Paramaribo', 'America/Phoenix', 'America/Port-au-Prince', 'America/Port_of_Spain', 'America/Porto_Velho', 'America/Puerto_Rico', 'America/Punta_Arenas', 'America/Rainy_River', 'America/Rankin_Inlet', 'America/Recife', 'America/Regina', 'America/Resolute', 'America/Rio_Branco', 'America/Santarem', 'America/Santiago', 'America/Santo_Domingo', 'America/Sao_Paulo', 'America/Scoresbysund', 'America/Sitka', 'America/St_Barthelemy', 'America/St_Johns', 'America/St_Kitts', 'America/St_Lucia', 'America/St_Thomas', 'America/St_Vincent', 'America/Swift_Current', 'America/Tegucigalpa', 'America/Thule', 'America/Thunder_Bay', 'America/Tijuana', 'America/Toronto', 'America/Tortola', 'America/Vancouver', 'America/Whitehorse', 'America/Winnipeg', 'America/Yakutat', 'America/Yellowknife', 'Antarctica/Casey', 'Antarctica/Davis', 'Antarctica/DumontDUrville', 'Antarctica/Macquarie', 'Antarctica/Mawson', 'Antarctica/McMurdo', 'Antarctica/Palmer', 'Antarctica/Rothera', 'Antarctica/Syowa', 'Antarctica/Troll', 'Antarctica/Vostok', 'Arctic/Longyearbyen', 'Asia/Aden', 'Asia/Almaty', 'Asia/Amman', 'Asia/Anadyr', 'Asia/Aqtau', 'Asia/Aqtobe', 'Asia/Ashgabat', 'Asia/Atyrau', 'Asia/Baghdad', 'Asia/Bahrain', 'Asia/Baku', 'Asia/Bangkok', 'Asia/Barnaul', 'Asia/Beirut', 'Asia/Bishkek', 'Asia/Brunei', 'Asia/Chita', 'Asia/Choibalsan', 'Asia/Colombo', 'Asia/Damascus', 'Asia/Dhaka', 'Asia/Dili', 'Asia/Dubai', 'Asia/Dushanbe', 'Asia/Famagusta', 'Asia/Gaza', 'Asia/Hebron', 'Asia/Ho_Chi_Minh', 'Asia/Hong_Kong', 'Asia/Hovd', 'Asia/Irkutsk', 'Asia/Istanbul', 'Asia/Jakarta', 'Asia/Jayapura', 'Asia/Jerusalem', 'Asia/Kabul', 'Asia/Kamchatka', 'Asia/Karachi', 'Asia/Kathmandu', 'Asia/Khandyga', 'Asia/Kolkata', 'Asia/Krasnoyarsk', 'Asia/Kuala_Lumpur', 'Asia/Kuching', 'Asia/Kuwait', 'Asia/Macau', 'Asia/Magadan', 'Asia/Makassar', 'Asia/Manila', 'Asia/Muscat', 'Asia/Nicosia', 'Asia/Novokuznetsk', 'Asia/Novosibirsk', 'Asia/Omsk', 'Asia/Oral', 'Asia/Phnom_Penh', 'Asia/Pontianak', 'Asia/Pyongyang', 'Asia/Qatar', 'Asia/Qostanay', 'Asia/Qyzylorda', 'Asia/Riyadh', 'Asia/Sakhalin', 'Asia/Samarkand', 'Asia/Seoul', 'Asia/Shanghai', 'Asia/Singapore', 'Asia/Srednekolymsk', 'Asia/Taipei', 'Asia/Tashkent', 'Asia/Tbilisi', 'Asia/Tehran', 'Asia/Thimphu', 'Asia/Tokyo', 'Asia/Tomsk', 'Asia/Ulaanbaatar', 'Asia/Urumqi', 'Asia/Ust-Nera', 'Asia/Vientiane', 'Asia/Vladivostok', 'Asia/Yakutsk', 'Asia/Yangon', 'Asia/Yekaterinburg', 'Asia/Yerevan', 'Atlantic/Azores', 'Atlantic/Bermuda', 'Atlantic/Canary', 'Atlantic/Cape_Verde', 'Atlantic/Faroe', 'Atlantic/Madeira', 'Atlantic/Reykjavik', 'Atlantic/South_Georgia', 'Atlantic/St_Helena', 'Atlantic/Stanley', 'Australia/Adelaide', 'Australia/Brisbane', 'Australia/Broken_Hill', 'Australia/Currie', 'Australia/Darwin', 'Australia/Eucla', 'Australia/Hobart', 'Australia/Lindeman', 'Australia/Lord_Howe', 'Australia/Melbourne', 'Australia/Perth', 'Australia/Sydney', 'Europe/Amsterdam', 'Europe/Andorra', 'Europe/Astrakhan', 'Europe/Athens', 'Europe/Belgrade', 'Europe/Berlin', 'Europe/Bratislava', 'Europe/Brussels', 'Europe/Bucharest', 'Europe/Budapest', 'Europe/Busingen', 'Europe/Chisinau', 'Europe/Copenhagen', 'Europe/Dublin', 'Europe/Gibraltar', 'Europe/Guernsey', 'Europe/Helsinki', 'Europe/Isle_of_Man', 'Europe/Istanbul', 'Europe/Jersey', 'Europe/Kaliningrad', 'Europe/Kiev', 'Europe/Kirov', 'Europe/Lisbon', 'Europe/Ljubljana', 'Europe/London', 'Europe/Luxembourg', 'Europe/Madrid', 'Europe/Malta', 'Europe/Mariehamn', 'Europe/Minsk', 'Europe/Monaco', 'Europe/Moscow', 'Europe/Oslo', 'Europe/Paris', 'Europe/Podgorica', 'Europe/Prague', 'Europe/Riga', 'Europe/Rome', 'Europe/Samara', 'Europe/San_Marino', 'Europe/Sarajevo', 'Europe/Saratov', 'Europe/Simferopol', 'Europe/Skopje', 'Europe/Sofia', 'Europe/Stockholm', 'Europe/Tallinn', 'Europe/Tirane', 'Europe/Ulyanovsk', 'Europe/Uzhgorod', 'Europe/Vaduz', 'Europe/Vatican', 'Europe/Vienna', 'Europe/Vilnius', 'Europe/Volgograd', 'Europe/Warsaw', 'Europe/Zagreb', 'Europe/Zaporozhye', 'Europe/Zurich', 'Indian/Antananarivo', 'Indian/Chagos', 'Indian/Christmas', 'Indian/Cocos', 'Indian/Comoro', 'Indian/Kerguelen', 'Indian/Mahe', 'Indian/Maldives', 'Indian/Mauritius', 'Indian/Mayotte', 'Indian/Reunion', 'Pacific/Apia', 'Pacific/Auckland', 'Pacific/Bougainville', 'Pacific/Chatham', 'Pacific/Chuuk', 'Pacific/Easter', 'Pacific/Efate', 'Pacific/Enderbury', 'Pacific/Fakaofo', 'Pacific/Fiji', 'Pacific/Funafuti', 'Pacific/Galapagos', 'Pacific/Gambier', 'Pacific/Guadalcanal', 'Pacific/Guam', 'Pacific/Honolulu', 'Pacific/Kiritimati', 'Pacific/Kosrae', 'Pacific/Kwajalein', 'Pacific/Majuro', 'Pacific/Marquesas', 'Pacific/Midway', 'Pacific/Nauru', 'Pacific/Niue', 'Pacific/Norfolk', 'Pacific/Noumea', 'Pacific/Pago_Pago', 'Pacific/Palau', 'Pacific/Pitcairn', 'Pacific/Pohnpei', 'Pacific/Port_Moresby', 'Pacific/Rarotonga', 'Pacific/Saipan', 'Pacific/Tahiti', 'Pacific/Tarawa', 'Pacific/Tongatapu', 'Pacific/Wake', 'Pacific/Wallis', 'UTC');
  CREATE TYPE "public"."enum__events_v_version_link_target" AS ENUM('_self', '_blank');
  CREATE TYPE "public"."enum__events_v_version_main_cta_target" AS ENUM('_self', '_blank');
  CREATE TYPE "public"."enum__events_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_launchweek" AS ENUM('6', '7', '8', 'x', 'ga', '12', '13', '14', '15');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_launchweek" AS ENUM('6', '7', '8', 'x', 'ga', '12', '13', '14', '15');
  ...
  CREATE TABLE IF NOT EXISTS "customers_stats" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"stat" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "customers_misc" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "customers_industry" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_customers_industry",
  	"id" serial PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE IF NOT EXISTS "customers_supabase_products" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_customers_supabase_products",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "customers" (
  	...
  	"about" varchar,
  	"company_url" varchar,
  	"company_size" "enum_customers_company_size",
  ...
  CREATE TABLE IF NOT EXISTS "_customers_v_version_stats" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"stat" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_customers_v_version_misc" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_customers_v_version_industry" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum__customers_v_version_industry",
  	"id" serial PRIMARY KEY NOT NULL
  );
  
  CREATE TABLE IF NOT EXISTS "_customers_v_version_supabase_products" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum__customers_v_version_supabase_products",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "_customers_v" (
  	...
  	"version_company_size" "enum__customers_v_version_company_size",
  	"version_region" "enum__customers_v_version_region",
  ...
  CREATE TABLE IF NOT EXISTS "events" (
  	...
  	"link_href" varchar,
  	"link_target" "enum_events_link_target" DEFAULT '_blank',
  	"main_cta_href" varchar,
  	"main_cta_target" "enum_events_main_cta_target" DEFAULT '_blank',
  ...
  CREATE TABLE IF NOT EXISTS "_events_v_version_type" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum__events_v_version_type",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "_events_v" (
  	...
  	"version_timezone" "enum__events_v_version_timezone",
  	...
  	"version_link_target" "enum__events_v_version_link_target" DEFAULT '_blank',
  	"version_main_cta_href" varchar,
  	"version_main_cta_target" "enum__events_v_version_main_cta_target" DEFAULT '_blank',
  ...
  CREATE TABLE IF NOT EXISTS "posts" (
  	...
  	"thumb_id" integer,
  	"image_id" integer,
  	"launchweek" "enum_posts_launchweek",
  ...
  CREATE TABLE IF NOT EXISTS "_posts_v" (
  	...
  	"version_thumb_id" integer,
  	"version_image_id" integer,
  	"version_launchweek" "enum__posts_v_version_launchweek",
  ...
  DO $$ BEGIN
   ALTER TABLE "customers_stats" ADD CONSTRAINT "customers_stats_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."customers"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "customers_misc" ADD CONSTRAINT "customers_misc_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."customers"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "customers_industry" ADD CONSTRAINT "customers_industry_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."customers"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "customers_supabase_products" ADD CONSTRAINT "customers_supabase_products_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."customers"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "customers" ADD CONSTRAINT "customers_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "customers" ADD CONSTRAINT "customers_logo_inverse_id_media_id_fk" FOREIGN KEY ("logo_inverse_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_customers_v_version_stats" ADD CONSTRAINT "_customers_v_version_stats_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_customers_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_customers_v_version_misc" ADD CONSTRAINT "_customers_v_version_misc_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_customers_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_customers_v_version_industry" ADD CONSTRAINT "_customers_v_version_industry_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_customers_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_customers_v_version_supabase_products" ADD CONSTRAINT "_customers_v_version_supabase_products_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_customers_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_customers_v" ADD CONSTRAINT "_customers_v_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_customers_v" ADD CONSTRAINT "_customers_v_version_logo_id_media_id_fk" FOREIGN KEY ("version_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_customers_v" ADD CONSTRAINT "_customers_v_version_logo_inverse_id_media_id_fk" FOREIGN KEY ("version_logo_inverse_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "events" ADD CONSTRAINT "events_thumb_id_media_id_fk" FOREIGN KEY ("thumb_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "events" ADD CONSTRAINT "events_company_logo_id_media_id_fk" FOREIGN KEY ("company_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "events" ADD CONSTRAINT "events_company_logo_light_id_media_id_fk" FOREIGN KEY ("company_logo_light_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_events_v_version_type" ADD CONSTRAINT "_events_v_version_type_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_events_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_events_v" ADD CONSTRAINT "_events_v_version_thumb_id_media_id_fk" FOREIGN KEY ("version_thumb_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_events_v" ADD CONSTRAINT "_events_v_version_company_logo_id_media_id_fk" FOREIGN KEY ("version_company_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_events_v" ADD CONSTRAINT "_events_v_version_company_logo_light_id_media_id_fk" FOREIGN KEY ("version_company_logo_light_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "authors_author_image_url_idx" ON "authors" USING btree ("author_image_url_id");
  ...
  CREATE INDEX IF NOT EXISTS "customers_stats_order_idx" ON "customers_stats" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "customers_stats_parent_id_idx" ON "customers_stats" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "customers_misc_order_idx" ON "customers_misc" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "customers_misc_parent_id_idx" ON "customers_misc" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "customers_industry_order_idx" ON "customers_industry" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "customers_industry_parent_idx" ON "customers_industry" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "customers_supabase_products_order_idx" ON "customers_supabase_products" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "customers_supabase_products_parent_idx" ON "customers_supabase_products" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "customers_slug_idx" ON "customers" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "customers_meta_meta_image_idx" ON "customers" USING btree ("meta_image_id");
  CREATE INDEX IF NOT EXISTS "customers_logo_idx" ON "customers" USING btree ("logo_id");
  CREATE INDEX IF NOT EXISTS "customers_logo_inverse_idx" ON "customers" USING btree ("logo_inverse_id");
  ...
  CREATE INDEX IF NOT EXISTS "_customers_v_version_stats_order_idx" ON "_customers_v_version_stats" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_customers_v_version_stats_parent_id_idx" ON "_customers_v_version_stats" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_customers_v_version_misc_order_idx" ON "_customers_v_version_misc" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_customers_v_version_misc_parent_id_idx" ON "_customers_v_version_misc" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_customers_v_version_industry_order_idx" ON "_customers_v_version_industry" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "_customers_v_version_industry_parent_idx" ON "_customers_v_version_industry" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_customers_v_version_supabase_products_order_idx" ON "_customers_v_version_supabase_products" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "_customers_v_version_supabase_products_parent_idx" ON "_customers_v_version_supabase_products" USING btree ("parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_customers_v_version_meta_version_meta_image_idx" ON "_customers_v" USING btree ("version_meta_image_id");
  CREATE INDEX IF NOT EXISTS "_customers_v_version_version_logo_idx" ON "_customers_v" USING btree ("version_logo_id");
  CREATE INDEX IF NOT EXISTS "_customers_v_version_version_logo_inverse_idx" ON "_customers_v" USING btree ("version_logo_inverse_id");
  ...
  CREATE INDEX IF NOT EXISTS "events_thumb_idx" ON "events" USING btree ("thumb_id");
  CREATE INDEX IF NOT EXISTS "events_image_idx" ON "events" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "events_company_company_logo_idx" ON "events" USING btree ("company_logo_id");
  CREATE INDEX IF NOT EXISTS "events_company_company_logo_light_idx" ON "events" USING btree ("company_logo_light_id");
  ...
  CREATE INDEX IF NOT EXISTS "events_rels_authors_id_idx" ON "events_rels" USING btree ("authors_id");
  CREATE INDEX IF NOT EXISTS "_events_v_version_type_order_idx" ON "_events_v_version_type" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "_events_v_version_type_parent_idx" ON "_events_v_version_type" USING btree ("parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_events_v_version_version_thumb_idx" ON "_events_v" USING btree ("version_thumb_id");
  CREATE INDEX IF NOT EXISTS "_events_v_version_version_image_idx" ON "_events_v" USING btree ("version_image_id");
  CREATE INDEX IF NOT EXISTS "_events_v_version_company_version_company_logo_idx" ON "_events_v" USING btree ("version_company_logo_id");
  CREATE INDEX IF NOT EXISTS "_events_v_version_company_version_company_logo_light_idx" ON "_events_v" USING btree ("version_company_logo_light_id");
  ...
  CREATE INDEX IF NOT EXISTS "_events_v_rels_authors_id_idx" ON "_events_v_rels" USING btree ("authors_id");
  ...
  CREATE INDEX IF NOT EXISTS "posts_thumb_idx" ON "posts" USING btree ("thumb_id");
  ...
  CREATE INDEX IF NOT EXISTS "_posts_v_version_version_thumb_idx" ON "_posts_v" USING btree ("version_thumb_id");
  ...
  DROP SCHEMA "cms-payload";
  `)
}

export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   CREATE SCHEMA "cms-payload";
