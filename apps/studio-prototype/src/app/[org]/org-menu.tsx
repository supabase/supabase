...
import { Boxes, Building2, Check } from 'lucide-react'
import Link from 'next/link'
import { useRouter } from 'next/navigation'
import { useState } from 'react'
import { Button, CommandSeparator_Shadcn_, ScrollArea, ScrollBar, cn } from 'ui'
                      ...
                      onSelect={(currentValue) => {
                        ...
                        setConfig({
                          ...
                          selectedProject: db?.orgs?.find((o: Org) => o.key === currentValue)
                            ?.projects[0],
                          selectedEnv: db?.orgs?.find((o: Org) => o.key === currentValue)
                            ?.projects[0].branches[0] ?? {
                            name: 'main',
                            type: 'prod',
                            key: 'main',
                          },
