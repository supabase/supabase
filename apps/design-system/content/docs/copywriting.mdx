...
| Noun or adjective           | sign-in, sign-out, sign-up     | "sign-in page"            |
...
Keep `login`, `logout`, and `logOut` in code, routes, URL slugs, and CLI commands
when they match implementation names.
