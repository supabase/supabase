...
Use Collapsible for generic disclosure behaviour: rows, sections, menus, tool details, and custom layouts. Use [Expandable Alert](../fragments/expandable-alert) instead when the disclosure is an alert-styled callout that should keep standard alert padding, variants, trigger styling, and toggle treatment.
