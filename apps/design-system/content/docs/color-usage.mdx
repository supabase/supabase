...
| ------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Readable ink  | `--primary`, `text-primary`, `border-primary`                                      | The color must be _read_ or recognized at a small size: links, labels, statuses, radio borders/dots, step dots                                               |
| Bright chrome | `brand-default`, `--ring`, `bg-brand-default`, `border-brand-default`, `ring-ring` | The color should feel on-brand and obvious as chrome: focus rings, highlight rings, larger selected fills (choice cards, slider ranges), solid brand buttons |
