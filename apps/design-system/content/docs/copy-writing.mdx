...
| Bad | Good |
|-----|------|
| Primary action: "Submit"<br />Secondary action: "Go back" | Primary action: "Create table"<br />Secondary action: "Cancel" |

## Form labels and descriptions

### Labels describe the field, not the feature

<ComponentPreview name="copy-form-labels" />

| Bad | Good |
|-----|------|
| Label: "Name your table"<br />Description: "This field allows you to specify a name for your table using letters, numbers, and underscores" | Label: "Table name"<br />Description: "Letters, numbers, and underscores only" |
...
<ComponentPreview name="copy-error-messages" />
...
<ComponentPreview name="copy-success-messages" />
...
<ComponentPreview name="copy-tooltips" />
...
<ComponentPreview name="copy-empty-states" />
...
<ComponentPreview name="copy-loading-states" />
...
| Bad | Good |
|-----|------|
| Action: "Delete project" → Loading: "Processing..." | Action: "Delete project" → Loading: "Deleting project..." |
| Action: "Save changes" → Loading: "Please wait..." | Action: "Save changes" → Loading: "Saving changes..." |

## Confirmations and dialogs

### State consequences clearly

<ComponentPreview name="copy-confirmations" />
