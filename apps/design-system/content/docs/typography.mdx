...
(`ring-ring`), and other non-text brand utilities. Its light-mode value has at least 4.5:1
contrast against the light surfaces used by the apps, meeting WCAG AA for normal text. See
[Brand green: two jobs](../docs/color-usage#brand-green-two-jobs) for when to use each green.
