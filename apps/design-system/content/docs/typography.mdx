...
`text-brand-display` is an intentional exception for expressive text at 40px or larger. Its light-mode value has 2.40:1 contrast against white and does not meet the 3:1 WCAG AA threshold for large informative text. Do not use it for body copy, controls, or smaller text.
