...
Use `title` for the heading slot and `description` for short body copy. Use `children` instead of `description` when the body needs rich React or MDX content such as links, lists, or paragraphs.
