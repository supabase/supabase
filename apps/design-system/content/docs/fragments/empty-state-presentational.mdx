...
It’s okay to repeat buttons inside of EmptyStatePresentational that are also available outside of it. The alternative—conditionally loading button placement during empty state determination—often leads to confusing layout shift.
