...
## 30th Sep 2024 - Update multi-select

### improved Multi Select with collapsed selected items counter

- [Multi Select](/design-system/components/multi-select-2)

[PR](https://github.com/supabase/supabase/pull/[...])
