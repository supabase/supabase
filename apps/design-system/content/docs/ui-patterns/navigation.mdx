...
Keyboard-accessible skip link for apps with persistent header and sidebar chrome. Hidden until focused via Tab, then slides into view so users can jump past navigation to the main landmark.

[Skip to Content fragment](../fragments/skip-to-content) · [Accessibility guidance](../accessibility#jumping-ahead)
