...
A horizontal list of related views within a consistent context, allowing for clearer page-level organisation. Activating a NavMenu item should trigger a URL change.
