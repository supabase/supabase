...
- [Data Table](../components/data-table) builds on [Table](../components/table) and [TanStack Table](https://tanstack.com/table) to provide a feature-rich data browsing experience (sorting, filtering, pagination, etc.).
...
[Data Table](../components/data-table) is a pattern-component built on top of [Table](../components/table) and [TanStack Table](https://tanstack.com/table). It is designed to extend Table with column definitions and row models (via TanStack) and for more complex sorting, filtering, and row actions. is designed for immersive, data-heavy experiences. Use it when:
