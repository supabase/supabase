...
As a general rule: use a dialogs for short, focused tasks and use sheets for longer forms or more detailed views.
...
- **Accessibile:** Always provide clear labels and descriptions via semantic HTML and the correct ARIA attributes. Ensure keyboard navigation works correctly.
