...
Use [Alert Dialog](#alert-dialog) when a single paragraph is enough.

<ComponentPreview name="alert-dialog-demo" />

#### Selection

Use [Confirmation Modal](#confirmation-modal) when you need the user to make a selection or the contents are more than a single paragraph.
...
A `destructive` pattern here is too easy to skip over.
