...
| ----------------- | ------ | ----------- | ------------------ | ------------------------- |
| Sheet             | Shadcn | Extensive   | ✅ Active          | Used for side panels      |
| Dialog            | Shadcn | Moderate    | ✅ Active          | Base component for modals |
| AlertDialog       | Shadcn | 6 files     | ✅ Active          | Underutilized             |
| ConfirmationModal | Dialog | 95 files    | ⚠️ Needs migration | Should wrap AlertDialog   |
| TextConfirmModal  | Dialog | 19 files    | ⚠️ Needs migration | Should wrap AlertDialog   |
| Modal             | -      | Legacy      | ❌ Deprecated      | Use Dialog instead        |
...
3. **Document clear decision tree**:
   ...
   ├─ Need text input to confirm?
   │  └─ Use TextConfirmModal
   └─ Custom confirmation flow?
      └─ Use AlertDialog directly
...
1. ✅ **Migrate deprecated components**

   - ✅ All uses of `ConfirmDialog` have been migrated to `ConfirmationModal`
   - ✅ `ConfirmDialog` component has been removed
...
1. ✅ **Document current state** - This document now captures all components and their usage
2. ⚠️ **Migrate ConfirmationModal to AlertDialog** - High impact, improves UX for 95 files
3. ⚠️ **Migrate TextConfirmModal to AlertDialog** - High impact, improves UX for 19 files
4. 📋 **Create decision tree** - Help developers choose the right component
