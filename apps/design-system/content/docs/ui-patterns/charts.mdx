...
<ComponentPreview name="chart-composed-metrics" peekCode wide />

### Charts with Actions

<ComponentPreview name="chart-composed-actions" peekCode wide />

### Chart with Table

<ComponentPreview name="chart-composed-table" peekCode wide />
...
| `clearHighlight` | `() => void` | Function to clear highlight |
...
| `isDisabled` | `(ctx: { start: string; end: string; clear: () => void }) => boolean` | Function to determine if action is disabled |
