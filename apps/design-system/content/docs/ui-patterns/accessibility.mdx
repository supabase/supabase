...
[Button](../components/button) has all of the above built-in. Any bespoke interactive elements, such as the below button-like [TableRow](../components/table) require these props to be manually added:
