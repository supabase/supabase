...
export const getReportAttributesV2: (
  ...
  return [
    ...
    {
      id: 'disk-io-balance',
      label: 'Disk I/O balance',
      docsUrl: `${DOCS_URL}/guides/platform/compute-and-disk#choosing-the-right-compute-instance-for-consistent-disk-performance`,
      syncId: 'database-reports',
      format: '%',
      valuePrecision: 2,
      availableIn: ['free', 'pro', 'team', 'enterprise', 'platform'],
      ...
      attributes: [
        {
          ...
          format: '%',
          tooltip:
            'Percentage of disk I/O budget consumed. Values above 1% indicate the workload has exceeded baseline I/O throughput. At 100%, all available disk I/O budget has been used and the instance reverts to baseline performance',
        },
        {
          attribute: 'disk_io_balance_max',
          provider: 'reference-line',
          label: 'Max',
          value: 100,
          tooltip: 'Maximum disk I/O balance (100% consumed)',
          isMaxValue: true,
        },
      ],
    },
