...
export const getReportAttributes = (isFreePlan: boolean): ReportAttributes[] => [
  {
    id: 'ram-usage',
    label: 'Memory usage',
    availableIn: ['free'],
    ...
    attributes: [
      {
        ...
        provider: 'infra-monitoring',
        label: 'Disk IOps write',
        tooltip: 'Disk write operations per second',
      },
      {
        attribute: 'disk_iops_read',
        provider: 'infra-monitoring',
        label: 'Disk IOps read',
        tooltip: 'Disk read operations per second',
      },
    ],
  },
  {
    ...
    attributes: [
      {
        ...
        tooltip: 'Active connections from clients to the dedicated pooler',
      },
    ],
  },
]
