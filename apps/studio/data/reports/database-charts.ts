...
export const getReportAttributesV2: (
  ...
  return [
    ...
    },
    {
      ...
      label: 'Disk Usage %',
      docsUrl: `${DOCS_URL}/guides/telemetry/reports#disk-usage`,
      syncId: 'database-reports',
      format: '%',
      valuePrecision: 2,
      availableIn: ['free', 'pro', 'team', 'enterprise', 'platform'],
      ...
      attributes: [
        {
          ...
          label: 'Disk Usage',
          tooltip:
            'Percentage of disk space used. High values may indicate you need to resize your disk or clean up data',
          format: '%',
        },
        {
          ...
          provider: 'infra-monitoring',
          label: 'Total',
          tooltip: 'Total disk size (used for calculation)',
          hide: true,
        },
        {
          attribute: 'disk_usage_percent_max',
          provider: 'reference-line',
          label: 'Max',
          value: 100,
          tooltip: 'Maximum disk usage (100%)',
          isMaxValue: true,
        },
      ],
    },
