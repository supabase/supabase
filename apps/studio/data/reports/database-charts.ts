...
export const getReportAttributesV2: (
  entitlements: { hasDbAdvancedMetrics: boolean; hasDiskThroughputMetrics: boolean },
  project: Project,
  ...
  return [
    ...
    },
    {
      ...
      syncId: 'database-reports',
      entitlement: 'observability.disk_throughput_metrics',
      requiredPlan: 'Team',
      hide: false,
      showTooltip: true,
    ...
    },
    {
      ...
      syncId: 'database-reports',
      valuePrecision: 0,
      hide: entitlements.hasDbAdvancedMetrics,
      showTooltip: false,
      showLegend: false,
      showMaxValue: true,
      hideChartType: false,
    ...
    },
    {
      ...
      syncId: 'database-reports',
      valuePrecision: 0,
      entitlement: 'observability.db_advanced_metrics',
      requiredPlan: 'Pro',
      hide: !entitlements.hasDbAdvancedMetrics,
      showTooltip: true,
      showLegend: true,
    ...
    },
    {
      ...
      attributes: [
        ...
        entitlements.hasDbAdvancedMetrics &&
          (isSpendCapEnabled
            ? {
