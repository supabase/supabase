      ...
      attributes: [
        {
          ...
          label: 'Used',
          color: CHART_ROLE_COLORS.used.color,
          fill: CHART_ROLE_COLORS.used.fill,
          tooltip:
        ...
        },
        {
          ...
          provider: 'infra-monitoring',
          label: 'Cache + Buffers',
          color: CHART_ROLE_COLORS.overhead.color,
          fill: CHART_ROLE_COLORS.overhead.fill,
          tooltip:
        ...
        },
        {
          ...
          provider: 'infra-monitoring',
          label: 'Free',
          color: CHART_ROLE_COLORS.headroom.color,
          fill: CHART_ROLE_COLORS.headroom.fill,
          tooltip:
      ...
      attributes: [
        {
          ...
          label: 'System',
          format: '%',
          color: CHART_OVERHEAD_RAMP[0].color,
          fill: CHART_OVERHEAD_RAMP[0].fill,
          tooltip:
        ...
        },
        {
          ...
          label: 'IRQs',
          format: '%',
          color: CHART_OVERHEAD_RAMP[2].color,
          fill: CHART_OVERHEAD_RAMP[2].fill,
        ...
        },
        {
          ...
          label: 'Other',
          format: '%',
          color: CHART_OVERHEAD_RAMP[3].color,
          fill: CHART_OVERHEAD_RAMP[3].fill,
          tooltip:
      ...
      attributes: [
        {
          ...
          provider: 'infra-monitoring',
          label: 'Network in',
          color: CHART_ROLE_COLORS.in.color,
          fill: CHART_ROLE_COLORS.in.fill,
        ...
        },
        {
          ...
          provider: 'infra-monitoring',
          label: 'Network out',
          color: CHART_ROLE_COLORS.out.color,
          fill: CHART_ROLE_COLORS.out.fill,
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          ...
          provider: 'infra-monitoring',
          label: 'Other roles',
          color: CHART_OVERHEAD_RAMP[4].color,
          fill: CHART_OVERHEAD_RAMP[4].fill,
