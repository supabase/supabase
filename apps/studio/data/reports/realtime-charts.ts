export const getRealtimeReportAttributes = (isFreePlan: boolean) => [
  {
    ...
    attributes: [
      { attribute: 'presence', provider: 'mock', label: 'Presence', enabled: true },
      { attribute: 'postgres-changes', provider: 'mock', label: 'Postgres Changes', enabled: true },
      { attribute: 'broadcast', provider: 'mock', label: 'Broadcast', enabled: true },
    ],
  },
  {
    ...
    attributes: [
      {
        attribute: 'client_to_realtime_connections',
        provider: 'mock',
        label: 'Connections',
        enabled: true,
      },
