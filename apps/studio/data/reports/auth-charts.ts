export const getAuthReportAttributes = (isFreePlan: boolean) => [
  ...
  },
  {
    ...
    attributes: [
      ...
      { attribute: 'Phone', provider: 'mock', label: 'Phone', enabled: true },
      { attribute: 'SAML', provider: 'mock', label: 'SAML 2.0', enabled: true },
      ...
      { attribute: 'Facebook', provider: 'mock', label: 'Facebook', enabled: true },
      { attribute: 'Figma', provider: 'mock', label: 'Figma', enabled: false },
      { attribute: 'GitHub', provider: 'mock', label: 'GitHub', enabled: true },
      { attribute: 'GitLab', provider: 'mock', label: 'GitLab', enabled: true },
      ...
      { attribute: 'WorkOS', provider: 'mock', label: 'WorkOS', enabled: true },
