...
const IndexAdvisorResultSchema = z.object({
  ...
  startup_cost_before: z.number().nullable().transform((v) => v ?? 0),
  startup_cost_after: z.number().nullable().transform((v) => v ?? 0),
  total_cost_before: z.number().nullable().transform((v) => v ?? 0),
  total_cost_after: z.number().nullable().transform((v) => v ?? 0),
})
