...
export const useOrganizationTaxIdQuery = <TData = OrganizationTaxIdData>(
  ...
  const canReadSubscriptions = useAsyncCheckProjectPermissions(PermissionAction.BILLING_READ, 'stripe.tax_ids')
  return useQuery<OrganizationTaxIdData, OrganizationTaxIdError, TData>(
    ...
    {
      enabled: enabled && typeof slug !== 'undefined' && canReadSubscriptions.can,
      ...options,
    }
  )
}
