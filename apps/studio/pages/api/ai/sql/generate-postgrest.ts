import { ContextLengthError, EmptySqlError } from 'ai-commands'
import { generatePostgrestSql } from 'ai-commands/edge'
...
export async function handlePost(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    const result = await generatePostgrestSql(openai, prompt, entityDefinitions)
