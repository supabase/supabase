...
/**
 * Handles incoming POST requests to generate AI documentation responses.
 *
 * Configures the OpenAI client with `OPENAI_API_KEY` and normalized `OPENAI_BASE_URL` if set.
 *
 * @param request - Next.js edge API request containing conversation messages.
 * @returns Streaming response generated by the Clippy assistant.
 */
