                      ...
                      <Head>
                        ...
                        <style
                          dangerouslySetInnerHTML={{
                            __html: `:root{--font-custom:${inter.style.fontFamily};--font-sans:${inter.style.fontFamily};--font-mono:${sourceCodePro.style.fontFamily};--font-source-code-pro:${sourceCodePro.style.fontFamily};--font-manrope:${manrope.style.fontFamily};}`,
                          }}
                        />
