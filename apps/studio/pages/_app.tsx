                      ...
                      <Head>
                        ...
                        <style
                          dangerouslySetInnerHTML={{
                            __html: `:root{--font-inter:${inter.style.fontFamily};--font-sans:${inter.style.fontFamily};--font-source-code-pro:${sourceCodePro.style.fontFamily};--font-mono:${sourceCodePro.style.fontFamily};}`,
                          }}
                        />
