...
import { useEdgeFnIdToName } from 'data/reports/report.utils'
...
EdgeFunctionsReportV2.getLayout = (page) => (
  <DefaultLayout>
    <ReportsLayout title="Edge Functions (V2)">{page}</ReportsLayout>
  </DefaultLayout>
)
...
const EdgeFunctionsUsage = () => {
  ...
  return (
    <>
      <ReportHeader title="Edge Functions (V2)" showDatabaseSelector={false} />
      <ReportStickyNav
        content={
