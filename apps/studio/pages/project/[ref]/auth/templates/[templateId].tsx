...
import { getEmailTemplatesDocsPath } from '@/components/interfaces/Auth/EmailTemplates/EmailTemplates.constants'
import {
    ...
    <>
      <PageHeader size="default">
        ...
        <PageHeaderMeta>
          ...
          <PageHeaderAside>
            <DocsButton href={`${DOCS_URL}${getEmailTemplatesDocsPath(IS_PLATFORM)}`} />
          </PageHeaderAside>
        </PageHeaderMeta>
      </PageHeader>
