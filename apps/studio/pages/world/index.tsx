...
// ΓöÇΓöÇΓöÇ MATRIX RAIN COLUMN (orange) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
function MatrixColumn({ delay, speed, left, bright }: { delay: number; speed: number; left: string; bright?: boolean }) {
  const chars = 'πéóπé½πé╡πé┐πâèπâÅπâ₧πâñπâ⌐πâ»πé¼πé╢πâÇπâÉπâæ0123456789ABCDEFMARCEAU@#$%&'.split('')
...
// ΓöÇΓöÇΓöÇ TI-LEX CLOCK ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
function TiLexClock() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-1">
        <span className="text-xs" style={{ color: '#ff8c00' }}>≡ƒ¬╢</span>
        <span
...
const MENU_ITEMS = [
  { key: 'gpsMap' as const, href: '/world/gps-map', icon: '≡ƒù║∩╕Å', color: '#00ff88', label: '' },
  { key: 'agentAlex' as const, href: '/world/agent-alex', icon: '≡ƒò╢∩╕Å', color: '#ff0000', label: '' },
  { key: 'tilexal' as const, href: '/world/tilexal', icon: '≡ƒ¬╢', color: '#ff8c00', label: '' },
  { key: 'security' as const, href: '/world/security', icon: '≡ƒöÉ', color: '#00ffcc', label: '' },
  { key: 'dashboard' as const, href: '/world/world-map', icon: '≡ƒîì', color: '#4488ff', label: 'World Map FREE' },
  { key: 'settings' as const, href: '/world/settings', icon: 'ΓÜÖ∩╕Å', color: '#888888', label: '' },
]
