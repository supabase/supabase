...
const csp = [
  ...
  process.env.NEXT_PUBLIC_ENVIRONMENT === 'staging'
    ? [
        `default-src 'self' ${DEFAULT_SRC_URLS} ${SUPABASE_STAGING_PROJECTS_URL} ${SUPABASE_STAGING_PROJECTS_URL_WS} ${VERCEL_LIVE_URL} ${SUPABASE_DOCS_PROJECT_URL};`,
        ...
        `connect-src 'self' ${PUSHER_URL_WS};`,
      ]
    : [
