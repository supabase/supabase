...
describe('parseMigrationVersion', () => {
  ...
  it('should parse version as UTC so toISOString reflects the encoded time as UTC', () => {
    // Migration versions represent UTC timestamps (generated by the Supabase CLI in UTC).
    // Parsing as local time would cause the ISO string to be off by the user's UTC offset.
    const result = parseMigrationVersion('20231128095400')
