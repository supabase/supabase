...
// Nitro server, every API route's module gets evaluated when the single
// function handler loads, regardless of whether its URL is hit. Without a
// lazy wrapper, constructing the client at module scope with undefined
