...
export const API_URL = IS_PLATFORM ? process.env.NEXT_PUBLIC_API_URL : undefined
export const API_ADMIN_URL = IS_PLATFORM ? process.env.NEXT_PUBLIC_API_ADMIN_URL : '/api'
