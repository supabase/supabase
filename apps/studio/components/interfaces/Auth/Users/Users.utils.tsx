...
import { ColumnConfiguration, USER_CONTEXT_MENU_ID, USERS_TABLE_COLUMNS } from './Users.constants'
...
export const formatUserColumns = ({
  ...
  showContextMenu: (e: TriggerEvent, data: Partial<Pick<ContextMenuParams, 'id' | 'props'>>) => void
}) => {
          ...
          <div
            ...
            onContextMenu={(e) => {
              showContextMenu(e, {
                ...
                props: { user, column: { name: col.name, id: col.id } },
              })
            }}
          >
