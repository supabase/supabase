...
const PROVIDER_EMAIL = {
  ...
  type: 'object',
  title: 'Email',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/passwords`,
  properties: {
...
export const PROVIDER_PHONE = {
  ...
  type: 'object',
  title: 'Phone',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/phone-login`,
  properties: {
...
const EXTERNAL_PROVIDER_APPLE = {
  ...
  type: 'object',
  title: 'Apple',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-apple`,
  properties: {
    ...
    EXTERNAL_APPLE_SECRET: {
      ...
      description: `Secret key used in the OAuth flow. [Learn more](${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-apple#generate-a-client_secret)`,
      type: 'string',
      isSecret: true,
    },
  },
...
const EXTERNAL_PROVIDER_AZURE = {
  ...
  type: 'object',
  title: 'Azure',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-azure`,
  properties: {
    ...
    EXTERNAL_AZURE_SECRET: {
      // [TODO] Change docs
      title: 'Secret Value',
      description: `Enter the data from Value, not the Secret ID. [Learn more](${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-azure#obtain-a-secret-id)`,
      type: 'string',
      isSecret: true,
    },
    EXTERNAL_AZURE_URL: {
...
const EXTERNAL_PROVIDER_BITBUCKET = {
  ...
  type: 'object',
  title: 'Bitbucket',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-bitbucket`,
  properties: {
...
const EXTERNAL_PROVIDER_DISCORD = {
  ...
  type: 'object',
  title: 'Discord',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-discord?`,
  properties: {
...
const EXTERNAL_PROVIDER_FACEBOOK = {
  ...
  type: 'object',
  title: 'Facebook',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-facebook`,
  properties: {
...
const EXTERNAL_PROVIDER_FIGMA = {
  ...
  type: 'object',
  title: 'Figma',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-figma`,
  properties: {
...
const EXTERNAL_PROVIDER_GITHUB = {
  ...
  type: 'object',
  title: 'GitHub',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-github`,
  properties: {
...
const EXTERNAL_PROVIDER_GITLAB = {
  ...
  type: 'object',
  title: 'GitLab',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-gitlab`,
  properties: {
...
const EXTERNAL_PROVIDER_GOOGLE = {
  ...
  type: 'object',
  title: 'Google',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-google`,
  properties: {
...
[Learn more](${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-google#configure-your-services-id)`,
  },
}
...
const EXTERNAL_PROVIDER_KAKAO = {
  ...
  type: 'object',
  title: 'Kakao',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-kakao`,
  properties: {
...
const EXTERNAL_PROVIDER_KEYCLOAK = {
  ...
  type: 'object',
  title: 'KeyCloak',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-keycloak`,
  properties: {
...
const EXTERNAL_PROVIDER_LINKEDIN_OIDC = {
  ...
  key: 'linkedin_oidc',
  title: 'LinkedIn (OIDC)',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-linkedin`,
  properties: {
...
const EXTERNAL_PROVIDER_NOTION = {
  ...
  type: 'object',
  title: 'Notion',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-notion`,
  properties: {
...
const EXTERNAL_PROVIDER_TWITCH = {
  ...
  type: 'object',
  title: 'Twitch',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-twitch`,
  properties: {
...
const EXTERNAL_PROVIDER_TWITTER = {
  ...
  type: 'object',
  title: 'Twitter',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-twitter`,
  properties: {
...
const EXTERNAL_PROVIDER_SLACK = {
  ...
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-slack`,
  properties: {
...
const EXTERNAL_PROVIDER_SPOTIFY = {
  ...
  type: 'object',
  title: 'Spotify',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-spotify`,
  properties: {
...
const EXTERNAL_PROVIDER_WORKOS = {
  ...
  type: 'object',
  title: 'WorkOS',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-workos`,
  properties: {
...
const EXTERNAL_PROVIDER_ZOOM = {
  ...
  type: 'object',
  title: 'Zoom',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/social-login/auth-zoom`,
  properties: {
...
const PROVIDER_SAML = {
  ...
  type: 'object',
  title: 'SAML 2.0',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/enterprise-sso/auth-sso-saml`,
  properties: {
    SAML_ENABLED: {
      title: 'Enable SAML 2.0 Single Sign-on',
      description:
        `You will need to use the [Supabase CLI](${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/sso/auth-sso-saml#managing-saml-20-connections) to set up SAML after enabling it`,
      type: 'boolean',
    },
    SAML_EXTERNAL_URL: {
...
const PROVIDER_WEB3 = {
  ...
  type: 'object',
  title: 'Web3 Wallet',
  link: `${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/auth-web3`,
  properties: {
