...
import { FormControl } from '@ui/components/shadcn/ui/form'
import { CustomJWTModal } from './CustomJWTModal'
...
const JWTSettings = () => {
  ...
  return (
    <>
      <Form_Shadcn_ key={authConfig?.JWT_EXP} {...form}>
            ...
            <Panel.Content className="space-y-6 border-t border-panel-border-interior-light [[data-theme*=dark]_&]:border-panel-border-interior-dark">
              {isError ? (
                ...
                <>
                  ...
                  >
                    <Input
                      className="input-mono !cursor-default"
                      readOnly
                      disabled
                  ...
                  <FormField_Shadcn_
                    ...
                    render={({ field }) => (
                      <FormItemLayout
                        ...
                        description="How long access tokens are valid for before a refresh token has to be used. Recommendation: 3600 (1 hour)."
                      >
                        <FormControl>
                          <Input
                            id="JWT_EXP"
                      ...
                      <div className="flex flex-col gap-6 border rounded-md bg p-6">
                        <div className="flex flex-col gap-2">
                          ...
                          <ul className="text-sm text-foreground-light list-disc list-inside">
                            ...
                            <li>
                              Improve app's performance by using public keys to verify JWTs instead
                              of calling <code>getUser()</code>.
                            </li>
                          </ul>
                        </div>
