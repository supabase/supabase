...
const statusLabels: Record<SigningKey['status'], string> = {
  in_use: 'Current key',
  standby: 'Standby key',
...
const statusColors: Record<SigningKey['status'], string> = {
...
const algorithmLabels: Record<SigningKey['algorithm'], string> = {
