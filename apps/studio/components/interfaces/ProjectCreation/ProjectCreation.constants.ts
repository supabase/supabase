...
export const INSTANCE_SIZE_SPECS: Record<
  DesiredInstanceSize,
  { label: string; ram: string; cpu: string; price: string; cloud_providers: string[] }
> = {
  micro: {
    label: 'Micro',
    ram: '1 GB',
...
export const AVAILABLE_SIZES: DesiredInstanceSize[] = [
  'micro',
  'small',
  'medium',
  'large',
