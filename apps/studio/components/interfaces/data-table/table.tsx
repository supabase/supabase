...
const Table = React.forwardRef<HTMLTableElement, React.ComponentPropsWithRef<typeof ShadcnTable>>(
  ({ className, ...props }, ref) => (
    <ShadcnTable
      ref={ref}
      {...props}
...
const TableBody = React.forwardRef<
  HTMLTableSectionElement,
  React.ComponentPropsWithRef<typeof ShadcnTableBody>
>(({ className, ...props }, ref) => (
  <ShadcnTableBody
    ref={ref}
    {...props}
...
const TableFooter = React.forwardRef<
  HTMLTableSectionElement,
  React.ComponentPropsWithRef<typeof ShadcnTableFooter>
>(({ className, ...props }, ref) => (
...
const TableRow = React.forwardRef<
  HTMLTableRowElement,
  React.ComponentPropsWithRef<typeof ShadcnTableRow>
>(({ className, ...props }, ref) => (
  <ShadcnTableRow
    ref={ref}
    className={cn(
...
const TableHead = React.forwardRef<
  ...
  React.ComponentPropsWithRef<typeof ShadcnTableHead>
>(({ className, ...props }, ref) => (
  <ShadcnTableHead
    ref={ref}
    className={cn(
...
const TableCell = React.forwardRef<
  HTMLTableCellElement,
  React.ComponentPropsWithRef<typeof ShadcnTableCell>
>(({ className, ...props }, ref) => (
  <ShadcnTableCell
    ref={ref}
...
const TableCaption = React.forwardRef<
  ...
  React.ComponentPropsWithRef<typeof ShadcnTableCaption>
>(({ className, ...props }, ref) => (
