...
const CONFIG_FIELD_REGISTRY: Record<string, ConfigFieldDefinition> = {
  ...
  'auth.sms.twilio.message_service_sid': { settingHref: toAuthProvidersHref, label: 'Twilio message service SID' },
  'auth.sms.twilio.content_sid': { settingHref: toAuthProvidersHref, label: 'Twilio content SID' },
  'auth.sms.twilio_verify.account_sid': { settingHref: toAuthProvidersHref, label: 'Twilio Verify account SID' },
  'auth.sms.twilio_verify.message_service_sid': { settingHref: toAuthProvidersHref, label: 'Twilio Verify message service SID' },
  'auth.sms.messagebird.originator': { settingHref: toAuthProvidersHref, label: 'MessageBird originator' },
  ...
  'auth.external.apple.email_optional': { settingHref: toAuthProvidersHref, label: 'Apple email optional' },
  'auth.external.apple.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Apple skip nonce check' },
  ...
  'auth.external.azure.email_optional': { settingHref: toAuthProvidersHref, label: 'Azure email optional' },
  'auth.external.azure.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Azure skip nonce check' },
  ...
  'auth.external.bitbucket.client_id': { settingHref: toAuthProvidersHref, label: 'Bitbucket client ID' },
  'auth.external.bitbucket.email_optional': { settingHref: toAuthProvidersHref, label: 'Bitbucket email optional' },
  'auth.external.bitbucket.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Bitbucket skip nonce check' },
  'auth.external.discord.enabled': { settingHref: toAuthProvidersHref, label: 'Discord enabled' },
  'auth.external.discord.client_id': { settingHref: toAuthProvidersHref, label: 'Discord client ID' },
  'auth.external.discord.email_optional': { settingHref: toAuthProvidersHref, label: 'Discord email optional' },
  'auth.external.discord.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Discord skip nonce check' },
  'auth.external.facebook.enabled': { settingHref: toAuthProvidersHref, label: 'Facebook enabled' },
  'auth.external.facebook.client_id': { settingHref: toAuthProvidersHref, label: 'Facebook client ID' },
  'auth.external.facebook.email_optional': { settingHref: toAuthProvidersHref, label: 'Facebook email optional' },
  'auth.external.facebook.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Facebook skip nonce check' },
  ...
  'auth.external.figma.email_optional': { settingHref: toAuthProvidersHref, label: 'Figma email optional' },
  'auth.external.figma.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Figma skip nonce check' },
  ...
  'auth.external.github.email_optional': { settingHref: toAuthProvidersHref, label: 'GitHub email optional' },
  'auth.external.github.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'GitHub skip nonce check' },
  ...
  'auth.external.gitlab.email_optional': { settingHref: toAuthProvidersHref, label: 'GitLab email optional' },
  'auth.external.gitlab.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'GitLab skip nonce check' },
  ...
  'auth.external.kakao.email_optional': { settingHref: toAuthProvidersHref, label: 'Kakao email optional' },
  'auth.external.kakao.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Kakao skip nonce check' },
  'auth.external.keycloak.enabled': { settingHref: toAuthProvidersHref, label: 'Keycloak enabled' },
  'auth.external.keycloak.client_id': { settingHref: toAuthProvidersHref, label: 'Keycloak client ID' },
  'auth.external.keycloak.email_optional': { settingHref: toAuthProvidersHref, label: 'Keycloak email optional' },
  'auth.external.keycloak.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Keycloak skip nonce check' },
  ...
  'auth.external.linkedin_oidc.client_id': { settingHref: toAuthProvidersHref, label: 'LinkedIn (OIDC) client ID' },
  'auth.external.linkedin_oidc.email_optional': { settingHref: toAuthProvidersHref, label: 'LinkedIn (OIDC) email optional' },
  'auth.external.linkedin_oidc.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'LinkedIn (OIDC) skip nonce check' },
  ...
  'auth.external.notion.email_optional': { settingHref: toAuthProvidersHref, label: 'Notion email optional' },
  'auth.external.notion.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Notion skip nonce check' },
  ...
  'auth.external.slack.email_optional': { settingHref: toAuthProvidersHref, label: 'Slack email optional' },
  'auth.external.slack.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Slack skip nonce check' },
  'auth.external.slack_oidc.enabled': {
    settingHref: toAuthProvidersHref,
    label: 'Slack (OIDC) enabled',
  },
  'auth.external.slack_oidc.client_id': { settingHref: toAuthProvidersHref, label: 'Slack (OIDC) client ID' },
  'auth.external.slack_oidc.email_optional': { settingHref: toAuthProvidersHref, label: 'Slack (OIDC) email optional' },
  'auth.external.slack_oidc.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Slack (OIDC) skip nonce check' },
  'auth.external.spotify.enabled': { settingHref: toAuthProvidersHref, label: 'Spotify enabled' },
  'auth.external.spotify.client_id': { settingHref: toAuthProvidersHref, label: 'Spotify client ID' },
  'auth.external.spotify.email_optional': { settingHref: toAuthProvidersHref, label: 'Spotify email optional' },
  'auth.external.spotify.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Spotify skip nonce check' },
  ...
  'auth.external.twitch.email_optional': { settingHref: toAuthProvidersHref, label: 'Twitch email optional' },
  'auth.external.twitch.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Twitch skip nonce check' },
  'auth.external.twitter.enabled': { settingHref: toAuthProvidersHref, label: 'Twitter enabled' },
  'auth.external.twitter.client_id': { settingHref: toAuthProvidersHref, label: 'Twitter client ID' },
  'auth.external.twitter.email_optional': { settingHref: toAuthProvidersHref, label: 'Twitter email optional' },
  'auth.external.twitter.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Twitter skip nonce check' },
  ...
  'auth.external.x.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'X skip nonce check' },
  ...
  'auth.external.workos.email_optional': { settingHref: toAuthProvidersHref, label: 'WorkOS email optional' },
  'auth.external.workos.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'WorkOS skip nonce check' },
  ...
  'auth.external.zoom.email_optional': { settingHref: toAuthProvidersHref, label: 'Zoom email optional' },
  'auth.external.zoom.skip_nonce_check': { settingHref: toAuthProvidersHref, label: 'Zoom skip nonce check' },
  ...
  'auth.third_party.aws_cognito.enabled': { settingHref: toProjectHref, label: 'AWS Cognito enabled' },
