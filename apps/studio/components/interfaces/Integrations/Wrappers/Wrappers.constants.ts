...
export const WRAPPERS: WrapperMeta[] = [
  ...
  },
  {
    ...
    icon: `${BASE_PATH}/img/icons/duckdb-icon.svg`,
    description: "Query and transform your data anywhere using DuckDB's feature-rich SQL dialect.",
    extensionName: 'duckdbFdw',
    label: 'DuckDB',
    docsUrl: 'https://supabase.com/docs/guides/database/extensions/wrappers/duckdb',
    minimumExtensionVersion: '0.5.3',
    createComponent: CreateDuckDbWrapperSheet,
    server: {
      options: [
        {
          name: 'vault_key_id',
        ...
        {
          name: 'url_compatibility_mode',
          required: false,
          encrypted: false,
          secureEntry: false,
          defaultValue: 'true',
          label: 'URL Compatibility Mode',
        },
        {
          name: 'url_style',
          required: false,
  ...
  },
  {
    ...
    description: 'Connect to Iceberg-compatible data lakes.',
