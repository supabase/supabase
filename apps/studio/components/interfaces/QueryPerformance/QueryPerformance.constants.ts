...
export const QUERY_PERFORMANCE_REPORTS = {
  [QUERY_PERFORMANCE_REPORT_TYPES.MOST_TIME_CONSUMING]: [
    ...
    { id: 'calls', name: 'Calls', description: undefined, minWidth: 160 },
    { id: 'total_time', name: 'Total time', description: 'latency', minWidth: 160 },
    { id: 'prop_total_time', name: 'Time consumed', description: undefined, minWidth: 160 },
    { id: 'mean_time', name: 'Mean time', description: undefined, minWidth: 160 },
  ],
