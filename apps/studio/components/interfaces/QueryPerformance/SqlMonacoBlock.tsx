...
export const SqlMonacoBlock = ({ value, wrapperClassName }: SqlMonacoBlockProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-2 top-2 inline-flex rounded-lg bg-background opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
        <Button
          className="px-1.5"
