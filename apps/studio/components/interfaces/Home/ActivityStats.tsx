  ...
  return (
    <div className="@container">
      <div className="grid grid-cols-2 gap-4 @md:grid-cols-4">
        <div className="block">
          <p className="heading-meta">Status</p>
          <div className="flex items-center gap-2 mt-1">
            <ServiceStatus />
          </div>
        </div>
        <Link href={`/project/${ref}/branches`} className="block">
          <h4 className="heading-meta mb-1">Last branch</h4>
        ...
        <Link href={`/project/${ref}/database/migrations`} className="block">
          <p className="heading-meta mb-1">Last migration</p>
          <p className="text-foreground">
            {isLoadingMigrations
              ? 'Loading...'
              : latestMigration
        ...
        <Link href={`/project/${ref}/database/backups/scheduled`} className="block">
          <p className="heading-meta mb-1">Last backup</p>
          <p className="text-foreground">
            {isLoadingBackups
              ? 'Loading...'
