...
const SecuritySettings = () => {
  ...
  const canReadMfaConfig = useAsyncCheckProjectPermissions(PermissionAction.READ, 'organizations')
  const canUpdateMfaConfig = useAsyncCheckProjectPermissions(PermissionAction.UPDATE, 'organizations')
  ...
  } = useOrganizationMfaQuery({ slug }, { enabled: canReadMfaConfig.can })
