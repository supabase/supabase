...
const IntegrationSettings = () => {
  ...
  const canReadGithubConnection = useAsyncCheckProjectPermissions(
    PermissionAction.READ,
    'integrations.github_connections'
  )
  const canCreateGitHubConnection = useAsyncCheckProjectPermissions(
    PermissionAction.CREATE,
    'integrations.github_connections'
  )
  const canUpdateGitHubConnection = useAsyncCheckProjectPermissions(
