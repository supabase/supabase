...
export const OAuthAppRow = ({ app, onSelectEdit, onSelectDelete }: OAuthAppRowProps) => {
  const canUpdateOAuthApps = useAsyncCheckProjectPermissions(PermissionAction.UPDATE, 'approved_oauth_apps')
  const canDeleteOAuthApps = useAsyncCheckProjectPermissions(PermissionAction.DELETE, 'approved_oauth_apps')
