      ...
      <SectionContent
        section={{
          ...
          description: isUsageBillingEnabled
            ? `Your plan includes a limited amount of usage. If exceeded, you will be charged for the overages. It may take up to 1 hour for usage stats to update.`
            : `Your plan includes a limited amount of usage. If exceeded, you may experience restrictions, as you are currently not billed for overages. It may take up to 1 hour for usage stats to update.`,
          links: [
            {
