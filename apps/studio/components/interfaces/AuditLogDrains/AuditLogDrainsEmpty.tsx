...
export const AuditLogDrainsEmpty = () => {
  const items = [
    {
      step: 1,
      title: 'Pricing',
      description:
        'Audit Log Drains are available as an organization Add-On for all Pro, Team, and Enterprise users. Each Audit Log Drain costs $60 per month.',
      ...
      <div className="flex grow items-center justify-center p-12 @container">
        <div className="w-full max-w-4xl flex flex-col items-center gap-0">
          <div className="text-center mb-12">
            <AnimatedLogos />
            <h2 className="heading-section mb-1">Capture your audit logs, your way</h2>
            <p className="text-foreground-light mb-6">
              Upgrade to a Pro, Team or Enterprise Plan to send your organization audit logs to your
              preferred platform
            </p>
