...
export const DeleteDestination = ({
  ...
  return (
    <TextConfirmModal
      ...
      text={`This will delete the destination "${name}" and permanently stop its replication pipeline.`}
      alert={{ title: 'You cannot recover this destination or pipeline once deleted.' }}
