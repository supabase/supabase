...
export async function getGraphDataFromTables(
  ...
  // Precompute name â†’ { tableId, columnsByName } lookup so each relationship
...
// GöÇGöÇ Enum / Custom Type markdown GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
// GöÇGöÇ RLS Policy markdown GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
...
export const getPoliciesAsMarkdown = (schema: string, policies: PolicyForMarkdown[]): string => {
  ...
  for (const [table, tablePolicies] of byTable) {
    ...
    for (const p of tablePolicies) {
      ...
      const using = p.definition ? `\`${escapeForMarkdown(p.definition)}\`` : 'GÇö'
      const check = p.check ? `\`${escapeForMarkdown(p.check)}\`` : 'GÇö'
