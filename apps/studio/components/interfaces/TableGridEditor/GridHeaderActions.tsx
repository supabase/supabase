...
const GridHeaderActions = ({ table }: GridHeaderActionsProps) => {
  ...
  const [isTestMode] = useQueryState('isTestMode')
  const [impersonate] = useQueryState('impersonate')
      ...
      {showHeaderActions && (
        <div className="flex items-center gap-x-2 px-1">
          ...
          <RoleImpersonationPopover
            ...
            initialOpen={impersonate === 'true'}
            initialSelectedOption={impersonate === 'true' ? 'authenticated' : undefined}
          />
        </div>
      )}
      <ConfirmationModal
