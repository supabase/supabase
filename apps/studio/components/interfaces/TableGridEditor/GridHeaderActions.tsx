...
const GridHeaderActions = ({ table }: GridHeaderActionsProps) => {
  ...
  // [Alaister]: This is only here to disable features that are not yet supported
  // in embedded mode. This can be removed once we support them.
    ...
    <>
      {showHeaderActions && (
        <div className="flex items-center gap-x-2">
          ...
          {isTable && realtimeEnabled && !isEmbedded && (
            <Button
              type="default"
              icon={
                <MousePointer2
          ...
          {doesHaveAutoGeneratedAPIDocs && !isEmbedded && (
