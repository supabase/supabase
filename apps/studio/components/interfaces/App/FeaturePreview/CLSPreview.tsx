    ...
    <div className="flex flex-col gap-2">
      <div className="mb-4 flex flex-col gap-y-2">
        <Markdown
          ...
          content={`[Postgres Column-Level Privileges](${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/column-level-security) is a feature of Postgres that allows you to grant or revoke privileges on tables and columns based on user roles.`}
        />
        <Markdown
          className="text-foreground-light max-w-full"
          content={`This is an advanced feature and should be used with caution. Unless you have a very specific use case, we recommend just using [Row-Level Security](${process.env.NEXT_PUBLIC_DOCS_URL}/guides/auth/row-level-security).`}
        />
