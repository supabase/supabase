  ...
  return (
    <>
      ...
      <CardContent className="text-sm text-foreground-light">
        We recommend that you schedule a downtime window of 20 - 30 minutes for your application, as
        you will need to update any services that need to know about your custom domain (e.g client
        side code or OAuth providers)
        <Alert_Shadcn_ className="mt-4">
          ...
          <AlertDescription_Shadcn_>
            <p className="col-span-12 text-sm lg:col-span-7 leading-6">
              ...
              should resolve to{' '}
              {endpoint ? <code className="text-xs">{endpoint}</code> : "your project's API URL"}.
