...
const VercelSection = ({ isProjectScoped }: { isProjectScoped: boolean }) => {
  ...
  const canReadVercelConnection = useAsyncCheckProjectPermissions(
    PermissionAction.READ,
    'integrations.vercel_connections'
  )
  const canCreateVercelConnection = useAsyncCheckProjectPermissions(
    PermissionAction.CREATE,
    'integrations.vercel_connections'
  )
  const canUpdateVercelConnection = useAsyncCheckProjectPermissions(
