...
interface PublicSchemaNotEnabledAlertProps {
  context: 'settings' | 'docs' // postgrest settings or autodocs page
}

const PublicSchemaNotEnabledAlert = ({ context }: PublicSchemaNotEnabledAlertProps) => {
