      ...
      <section className="flex flex-col gap-4">
        ...
        {isDiskSizeUpdated && (
          <Admonition
            ...
            description={
              <>
                Supabase will right-size your project's disk size with the upgrade. Your project's
                current disk size is{' '}
        ...
        {hasLegacyAuthCustomRoles && (
          <Admonition
            ...
            description={
              <>
                <p>
                  New Postgres versions use <code className="text-code-inline">scram-sha-256</code>{' '}
                  authentication by default and do not support{' '}
                  <code className="text-code-inline">md5</code>, as it has been deprecated.
                </p>
