...
export const HelpPopover = () => {
  ...
  return (
    <Popover_Shadcn_ open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent_Shadcn_ className="w-[400px] space-y-5 p-0 py-4" align="end" side="bottom">
...
export const HelpContent = ({ onClose }: { onClose: () => void }) => {
            ...
            {IS_PLATFORM && (
              <>
                ...
                <ButtonGroupItem asChild size="tiny" icon={<Mail strokeWidth={1.5} size={14} />}>
                  <SupportLink queryParams={supportLinkQueryParams} onClick={onClose}>
                    Contact support
                  </SupportLink>
                </ButtonGroupItem>
              </>
