    ...
    >
      <PopoverTrigger_Shadcn_ asChild>
        <Button
          ...
          icon={
            hasCritical ? (
              <CriticalIcon className="!w-3.5 !h-3.5 transition-all -mr-1 group-hover:-mr-1 z-10" />
            ) : hasWarning ? (
              <WarningIcon className="!w-3.5 !h-3.5 transition-all -mr-1 group-hover:-mr-1 z-10" />
            ) : hasNewNotifications ? (
              <div
                className={clsx(
