...
/**
 * Menu-only component for the Integrations section. Used by the desktop sidebar and by the
 * mobile sheet submenu. Must not wrap ProjectLayout so that opening the integrations submenu
 * in the mobile sheet does not overwrite registerOpenMenu and break the menu button.
 */
export const IntegrationsProductMenu = () => {
