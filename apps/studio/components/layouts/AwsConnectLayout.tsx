...
export interface AwsConnectLayoutProps {}

const AwsConnectLayout = ({ children }: PropsWithChildren<AwsConnectLayoutProps>) => {
  const { resolvedTheme } = useTheme()
  return (
    <>
      <Head>
        <title>AWS Marketplace Onboarding | Supabase</title>
      </Head>
...
export default withAuth(AwsConnectLayout)
