...
export const SidebarContent = ({
  ...
  return (
    <>
      ...
      >
        {title && (
          <div className="absolute opacity-0 -left-96 -top-96 pointer-events-none md:left-auto md:top-auto md:relative md:opacity-100 md:pointer-events-auto block mb-2">
