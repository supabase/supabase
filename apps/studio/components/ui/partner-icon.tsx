...
export function PartnerIcon({
  ...
  // default is the selected organization
  let organizationSlug = useSelectedOrganization()?.slug

  if (_organizationSlug) {
    // if organization is passed, use that instead
    organizationSlug = _organizationSlug
  }

  console.log('organizationSlug', organizationSlug)

  // hardcoded to Vercel currently
