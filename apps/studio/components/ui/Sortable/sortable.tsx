...
interface SortableItemProps extends SlotProps {
  ...
  /**
   * Children of the SortableItem.
   * @type React.ReactNode
   */
  children?: React.ReactNode

  /**
   * Additional className for the SortableItem.
...
const SortableItem = React.forwardRef<HTMLDivElement, SortableItemProps>(
  ({ value, asTrigger, asChild, className, children, ...props }, ref) => {
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        ref={composeRefs(ref)}
        data-state={isDragging ? 'dragging' : undefined}
        className={cn('cursor-grab data-[state=dragging]:cursor-grabbing border-none', className)}
        {...attributes}
        {...listeners}
        {...props}
      />
