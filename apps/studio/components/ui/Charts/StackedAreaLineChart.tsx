...
import { Area, ComposedChart as RechartComposedChart, Tooltip, XAxis } from 'recharts'
...
export interface StackedAreaLineChartProps<D = Datum> extends CommonChartProps<D> {
  yAxisKey: string
  xAxisKey: string
  format?: string
...
export default StackedAreaLineChart
