...
export const ResourceExhaustionWarningBanner = () => {
  ...
  const isUsageOrInfraPage =
    router.pathname.endsWith('/usage') || router.pathname.endsWith('/settings/infrastructure')
  ...
  // infrastructure settings; free-plan links to billing instead, so we keep the banner visible for them.
