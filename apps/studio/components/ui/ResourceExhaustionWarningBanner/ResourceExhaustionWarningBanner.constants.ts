  ...
  disk_io_exhaustion: {
    bannerContent: {
      warning: {
        ...
        description:
          'Once exhausted, disk throughput will return to its baseline of {baseline}. The budget refills whenever disk usage runs below baseline. Upgrade your compute or use the AI Assistant to identify and optimize disk-intensive queries.',
      },
      critical: {
        title:
          'Your project has depleted its Disk IO Budget. Disk throughput is at its baseline of {baseline}',
        description:
          'Throughput stays at baseline until the budget refills. It refills whenever disk usage runs below baseline. Upgrade your compute to sustain higher throughput, or use the AI Assistant to identify and optimize disk-intensive queries.',
      },
    },
    cardContent: {
      warning: {
