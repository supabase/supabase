...
description: 'Supabase production checklist'
---
...
- If you find you require more resources, contact [support@supabase.io](mailto:support@supabase.io) to upgrade to PAYG for bigger servers
...
- upgrading to the Supabase Pro Tier will give you access to email support on [support@supabase.io](mailto:support@supabase.io)
