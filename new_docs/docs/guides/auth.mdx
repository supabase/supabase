...
<video width="99%" playsinline controls>
  <source src="/videos/auth-zoom2.mp4" type="video/mp4" playsInline />
</video>
...
<LinkCardsWrapper>
  <LinkCard class="lg:w-1/4" title="Apple" />
  <LinkCard class="lg:w-1/4" title="Azure" />
  <LinkCard class="lg:w-1/4" title="Bitbucket" />
  <LinkCard class="lg:w-1/4" title="Discord" />
  <LinkCard class="lg:w-1/4" title="Facebook" />
  <LinkCard class="lg:w-1/4" title="Github" />
  <LinkCard class="lg:w-1/4" title="GitLab" />
  <LinkCard class="lg:w-1/4" title="Google" />
  <LinkCard class="lg:w-1/4" title="MessageBird" />
  <LinkCard class="lg:w-1/4" title="Slack" />
  <LinkCard class="lg:w-1/4" title="Spotify" />
  <LinkCard class="lg:w-1/4" title="Twitter" />
  <LinkCard class="lg:w-1/4" title="Twitch" />
  <LinkCard class="lg:w-1/4" title="Twilio" />
</LinkCardsWrapper>
...
<video width="99%" playsinline controls>
  <source src="/videos/rls-zoom2.mp4" type="video/mp4" playsInline />
</video>
...
<video width="99%" playsinline controls>
  <source src="/videos/policies-zoom2.mp4" type="video/mp4" playsInline />
</video>
