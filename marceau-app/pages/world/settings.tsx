      ...
      >
        ...
        <div className="max-w-md p-6 space-y-6 ml-4">
          ...
          >
            ...
            {[
              { label: '≡ƒöö Notifications', value: notifications, set: setNotifications },
              { label: '≡ƒöè Sound', value: sound, set: setSound },
              { label: '≡ƒô║ Scanlines Effect', value: scanlines, set: setScanlines },
            ].map((opt) => (
