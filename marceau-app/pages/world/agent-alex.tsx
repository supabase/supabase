...
// ΓöÇΓöÇΓöÇ AGENT COMMANDS & RESPONSES ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
import {
  type MissionEntry,
  getToolOutput,
  shouldCreateMission,
...
// ΓöÇΓöÇΓöÇ BOOT SEQUENCE ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const BOOT_LINES = [
  ...
  '> Agent tools: ONLINE',
  '> ΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûê 100%',
  '> SYSTEM READY',
  '> ',
  '> Welcome, Agent Alex.',
]

// ΓöÇΓöÇΓöÇ TOOL ANIMATIONS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
function ToolCard({
  icon,
  name,
  onClick,
...
// ΓöÇΓöÇΓöÇ MAIN AGENT ALEX PAGE ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const AgentAlexPage = () => {
  ...
  return (
    <>
      ...
      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ BOOT SEQUENCE ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
      <AnimatePresence>
        {booting && (
          <motion.div
      ...
      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ MAIN INTERFACE ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
      <AnimatePresence>
        {!booting && (
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            {/* ΓöÇΓöÇΓöÇ LEFT: AGENT PROFILE + MISSIONS ΓöÇΓöÇΓöÇΓöÇ */}
            <div
            ...
            {/* ΓöÇΓöÇΓöÇ CENTER: TERMINAL + TOOLS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
              ...
              >
                <div className="flex items-center gap-4">
                  <span className="text-xs font-bold" style={{ color: '#00ff00' }}>
                    ΓùÅ {t(currentLang, 'systemOnline')}
                  </span>
              ...
              >
                ...
                <div className="mb-4 p-3 rounded-lg" style={{ background: 'rgba(255,100,0,0.05)', border: '1px solid #ff660022' }}>
                  <p style={{ color: '#ff8c00', textShadow: '0 0 5px #ff6600' }}>
                    ≡ƒò╢∩╕Å {t(currentLang, 'agentAlexGreeting')}
                  </p>
                </div>
