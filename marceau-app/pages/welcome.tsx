...
// ΓöÇΓöÇΓöÇ PHASES ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
// 0 ΓåÆ Fullscreen image + letter-by-letter "MARCEAU"
// 1 ΓåÆ Image zooms in, eyes glow red, 80s skull flash
// 2 ΓåÆ Matrix rain menu (Entrer / Inscription / Connecter)
// 3 ΓåÆ 3-sec hacker code burst
// 4 ΓåÆ ΓÜá∩╕Å "HAHA" 3D orange text
...
const HACKER_LINES = [
  ...
  '> ΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûêΓûê 100%',
...
// ΓöÇΓöÇΓöÇ MATRIX RAIN COLUMN ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
function MatrixColumn({ delay, speed, left }: { delay: number; speed: number; left: string }) {
  const chars = 'πéóπé½πé╡πé┐πâèπâÅπâ₧πâñπâ⌐πâ»0123456789ABCDEF'.split('')
...
// ΓöÇΓöÇΓöÇ MAIN PAGE ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const WelcomePage = () => {
  ...
  // Phase 1: Eyes red + skull flash ΓåÆ menu
  useEffect(() => {
    if (phase !== 1) return
  ...
  // Phase 4: HAHA ΓåÆ then navigate to world
  useEffect(() => {
    if (phase !== 4) return
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black overflow-hidden" style={{ fontFamily: "'Courier New', monospace" }}>
        {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ PHASE 0 & 1: FULLSCREEN IMAGE + TITLE ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
        <AnimatePresence>
          {(phase === 0 || phase === 1) && (
            <motion.div
        ...
        {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ PHASE 2: MATRIX RAIN + MENU ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
        <AnimatePresence>
          {phase === 2 && (
            <motion.div
        ...
        {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ PHASE 3: HACKER CODE ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
        <AnimatePresence>
          {phase === 3 && (
            <motion.div
        ...
        {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ PHASE 4: WARNING + HAHA ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
        <AnimatePresence>
          {phase === 4 && (
            <motion.div
