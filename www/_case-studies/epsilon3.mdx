...
stats:
  [
    { stat: '20,000', label: Number of employees },
    { stat: '10', label: Number of offices },
    { stat: '$1M', label: Annual revenue },
  ]
misc: [{ label: 'Founded', text: San Francisco }]
about: Vercel combines the best developer experience with an obsessive focus on end-user performance. Our platform enables frontend teams to do their best work.
---
