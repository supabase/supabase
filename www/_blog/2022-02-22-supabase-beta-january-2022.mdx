...
We haven’t released GraphQL onto the platform yet because we it's still under heavy development. You can expect availablity in the next few months.
...
Youll learn how to listen to _any_ database change, then send those changes [in a payload](https://supabase.com/blog/2021/07/30/supabase-functions-updates#hook-payload) via HTTP request.
