...
Database, Auth and Storage. We've included a two instance health metrics, CPU usage and Memory usage,
...
![Supabase architecture](/new/images/blog/launch-week-sql-day-4-reports-and-metrics/reports-infra.png)
...
![Supabase Prometheus](/new/images/blog/launch-week-sql-day-4-reports-and-metrics/prometheus.png)
