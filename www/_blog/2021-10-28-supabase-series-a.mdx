...
![Supabase has launched more than 50000 databases](/new/images/blog/series-a/total-databases.png)
...
![Supabase Discord](/new/images/blog/series-a/discord-supabase-community.png)
...
- **Auth:** when you want users to sign up.
...
![Supabase Dashboard](/new/images/blog/series-a/dashboard.png)
...
- **RESTful APIs:** query your database [tables](https://supabase.io/docs/reference/javascript/select) and [functions](https://supabase.io/docs/reference/javascript/rpc) over HTTP, using [PostgREST](https://postgrest.org).
