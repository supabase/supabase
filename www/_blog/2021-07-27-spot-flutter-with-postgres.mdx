...
image: epsilon3/og-spot-flutter-supabase.jpg
thumb: epsilon3/cover-spot-flutter-supabase.jpg
tags:
  - case-study
date: '2021-07-27'
toc_depth: 2
...
![Spot screenshots.](/new/images/blog/spot/spot-screenshots.jpg)

## Comparing Firebase to Supabase

Although Spot seems like simple, it has a lot of complicated components. Implementing social "Likes" requires `count` functionality, 
...
<Quote
  img="tyler-spot.jpg"
  caption="Tyler Shukert, creator of Spot."
>
  <p>
    As soon as I saw Supabase I knew it was the perfect technology to use alongside Flutter to build apps faster than ever. 
    For apps like Spot where we handle user submitted files, it is very easy to manage them securely.
  </p>
  <p>
...
You can download and install spot for [Android](https://apps.apple.com/us/app/spot-videos/id1564675926?utm_source=supabase&utm_campaign=static) 
and [iOS](https://play.google.com/store/apps/details?id=app.spotvideo&utm_source=supabase&utm_campaign=static) 
