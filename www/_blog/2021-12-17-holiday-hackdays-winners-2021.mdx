...
A chat app is a failry obvious use case for realtime syncing, but this project caught our eye because the chat is end-to-end encrypted!
...
Not only do we love a good rhyme, we also love christmas themed jokes, so Andy's Santa Banter checks all the boxes. Head over there now to submit your best jokes!
