...
[CleanShot 2022-03-30.mp4](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/32171070-808e-470d-97fb-f8bab49fa5c4/CleanShot_2022-03-30.mp4)
...
[logs-polish.mov](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/25f7bf80-9cc6-49d5-8850-f2b05d85292a/logs-polish.mov)
...
![new —> deploy —> invoke —> logs](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/5ffaea23-66c3-4113-b69b-fc77e795025e/functions-new-deploy-invoke-logs.gif)

new —> deploy —> invoke —> logs

![new -> deploy](/images/blog/launch-week-4/thursday-functions/new-deploy.gif)
new —> deploy

![invoke -> logs](/images/blog/launch-week-4/thursday-functions/invoke-logs.gif)
invoke —> logs
...
![functions-quickstart](/images/blog/launch-week-4/thursday-functions/functions-quickstart.png)

Can’t wait to get started? Develop, test, and deploy your first Supabase Edge Function in less than 7 minutes with our [Quickstart Video Tutorial](https://youtu.be/9TK6oTzibmk)!
