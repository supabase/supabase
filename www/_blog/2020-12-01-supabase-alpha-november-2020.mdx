...
![This image shows how to invite a new user directly from the dashboard.](/new/images/blog/invite-users.gif)

### User admin

You can also perform admin functions on existing users - send password reset emails, magic links, and delete users.

![This image shows how to delete a user directly from the dashboard.](/new/images/blog/delete-users.gif)
...
![This image shows our improved SQL Editor.](/new/images/blog/supabase-monaco-editor.png)

### Status page

We added a [Status Page](https://status.supabase.io/) which tracks the uptime and latency of the Supabase platform.

![This image shows our new status page.](/new/images/blog/status-page.png)
