...
At Supabase, we use dedicated roles for each of our customers' backend services. For instance, our [Storage API](https://supabase.io/storage) 
...
![This is an images of the lifecycle of a Postgres Hook.](/new/images/blog/postgres-hooks/hooks-postgres-alter-role.png)
...
By the way, if you like working on PostgreSQL tooling and extensions: we are hiring [PostgreSQL experts](https://supabase.io/docs/careers/postgres-experts)!
