...
GraphQL support is now in general availability on the Supabase platform via our [open source](https://github.com/supabase/pg_graphql/) PostgreSQL extension, [`pg_graphql](https://supabase.github.io/pg_graphql/) (beta)`.

![supameme.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/37484f92-884a-4690-8dbd-c878106faad4/supameme.png)
...
Each [free tier database](https://supabase.com/pricing) on the Supabase platform runs on a dedicated AWS t4g.micro instance with 2 vCPUs and 1 GB of memory. To squeeze the most out of that limited hardware we had to make a few significant optimizations:
...
<aside>
⚠️ GraphQL (Beta) is only available on self-hosted setups and Supabase projects created after 28th March 2022.

</aside>

To enable GraphQL in your Supabase instance, enable `pg_graphql` from the dashboard.

[api-enable-graphql.mp4](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d83930c3-53c0-4b7a-9f65-6ded53f072b7/api-enable-graphql.mp4)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/f07c93ed-3200-423c-bb49-d751c776c75f/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/531ecdd3-9039-414f-8097-6b9b41c95eb1/Untitled.png)
...
🎁  Get the the code on GitHub here: [github.com/supabase-community/supabase-graphql-example](https://github.com/supabase-community/supabase-graphql-example)
