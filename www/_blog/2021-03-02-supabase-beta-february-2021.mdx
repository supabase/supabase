...
![Our dashboard has sidebars](/new/images/blog/feb/sidebar-tables.png)
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source src="/new/images/blog/feb/autocomplete.mp4" type="video/mp4" muted playsInline />
</video>
...
![Redirect your users after sign up](/new/images/blog/feb/auth-redirect.png)
...
![Replication management](/new/images/blog/feb/manage-replication.png)
...
![Our dashboard has sidebars](/new/images/blog/feb/docs-resources.png)

### New Region

Launch your database in South Africa.

![Launch your database in South Africa](/new/images/blog/feb/new-region-south-africa.png)
...
![Supabase with Stencil](/new/images/blog/feb/supabase-stencil.png)
...
![This image shows the Supabase GitHub star growth.](/new/images/blog/feb/github-stars-feb-2021.png)
...
![Supabase Storage coming soon](/new/images/blog/feb/supabase-storage.png)
