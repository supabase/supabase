...
Try out connection pooling now with a new project in the [dashboard.](http://app.supabase.com) For now, we do not have any plans to port this over to older projects.
