...
- [ ]  TODO - add logo wall [https://supabase.com/blog/2021/10/28/supabase-series-a#developers](https://supabase.com/blog/2021/10/28/supabase-series-a#developers)
...
To simplify pricing, we've merged the “Pro” and “Pay as you go” tiers and introduced monthly spend caps to avoid nasty billing surprises. These changes to keep Supabase pricing [predictable, transparent, and developer friendly](https://supabase.com/blog/2021/03/29/pricing). 

When you upgrade to the Pro Tier, spend caps are turned on by default, limiting your per-project costs to $25 per month. We're also retaining our soft limits while we manage the transition to granular spend-caps, so your service will continue to run even if your usage exceeds $25 (we'll contact you directly when you go over the limit). Right now there is a global project spend-cap, and in the future you'll have full control with configurable spend-caps on a “per-feature” basis.

### Database Add-ons

- [ ]  Todo - Video
- Next week we're releasing self-serve database upgrades.
- What do you do when your project hits production and your user-base is sky-rocketing?
- Many developers have been asking for the control to scale their projects on-demand, especially for high-growth projects.
- Supabase is one of the most popular devtools amongst YC companies, who usually see exponential growth over a 3 month period.
...
- Today we're releasing a brand new [Log Explorer](https://supabase.com/docs/guides/platform/logs).
- Query your logs using SQL. Plenty of templates included.
- Available for free tier (7 days) and Pro-tier (30 days). Enterprise tier can query back as far as 90 days.
- This is just one of the exciting features we've release through our [Logflare acquisition](https://supabase.com/blog/2021/12/02/supabase-acquires-logflare).
...
For example, Supabase is popular with Web3 projects, and traffic to Web3 projects can be very unpredictable - especially when you partner with Snoop Dogg. 
When [sound.xyz](http://sound.xyz) [dropped an NFT with Snoop](https://www.sound.xyz/snoopdogg/death-row-mix-vol-1) recently, we customized their pooler to handle significant load. 
...
![pgbouncer_client_conns_supabase_livebook_sound_snoop.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/6df840cb-a612-4e4f-83a6-6a79118bdc05/pgbouncer_client_conns_supabase_livebook_sound_snoop.png)
...
With the release of our new Enterprise Tier, we're announcing a tonne of new features to the platform for Enterprise customers.
...
![Screenshot 2022-03-24 at 10.43.53.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/e7502bf6-4137-48f6-b72f-cb44c996287f/Screenshot_2022-03-24_at_10.43.53.png)
...
- [ ]  TODO - image of the new Pricing page
...
Get started today with all of our Enterprise Features on [app.supabase.io](https://app.supabase.io), or [contact the Supabase Enterprise team](https://supabase.com/contact/enterprise) 
