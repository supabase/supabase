...
To simplify pricing, we've merged the “Pro” and “Pay as you go” tiers and introduced monthly spend caps to avoid nasty billing surprises. These changes to keep Supabase pricing [predictable, transparent, and developer friendly](/blog/2021/03/29/pricing).
...
Log history is available to every Supabase project, with 7 days of log history available on the Free Tier and 30 days for the Pro-tier. Enterprise customer can query as far back as 90 days.
This is just one of the exciting features we've release through our [Logflare acquisition](/blog/2021/12/02/supabase-acquires-logflare).
