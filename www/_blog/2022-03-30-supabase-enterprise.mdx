...
These changes to keep Supabase pricing [predictable, transparent, and developer friendly](/blog/2021/03/29/pricing).
...
Today we're progressively releasing self-serve Database Add-Ons.
What do you do when your project hits production and your user-base is sky-rocketing? 
Supabase is one of the most popular devtools amongst YC companies, who see exponential growth over a 3 month period.
Many developers have been asking for the control to scale their projects on-demand, and our Database Add-ons release gives everyone the control to do that themse.

Database Add-ons are available today for a small set of customers, and will be generally available by the end of next week (Fridy 8th April).
