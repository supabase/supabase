...
image: may-2021/release-may-2021.jpg
thumb: may-2021/release-may-2021.jpg
tags:
  - release-notes
date: '2021-05-05'
---
...
Did you know: if you ship an app to the App Store with any third-party logins, you're require to enable Apple logins as well? Now you can with Supabase Auth.  

![Apple OAuth is now ava in Supabase](/new/images/blog/may-2021/supabase-apple-login.png)

## Twitter logins are now available

You can also use Twitter as an OAuth provider with Supabase Auth. Twitter has a very archaic OAuth impletementation, so this one too awhile.

![Twitter OAuth is now enabled in Supabase](/new/images/blog/may-2021/supabase-twitter-login.png)

## New storage policy editor

We shipped a new Policy Editor for managing Row Level Security on your Storage. We provide some simple templates to simplify the process for new developers. 
...
![This is an image of the new Supabase Grid](/new/images/blog/may-2021/table-grid.png)

## Japan (Tokyo) 🇯🇵 is now available as a region

There are a huge number of Supabase developers in Japan and China, and at their request we've launched a Tokyo as a region.

![Tokyo is now availabel as a region](/new/images/blog/may-2021/japan-region.png)
...
![Download data as a CSV](/new/images/blog/may-2021/return-data-as-csv.png)

## New Go Libraries

The community started developing the Go Libararies. [postgrest-go](https://github.com/supabase/postgrest-go) is completed, [@Yusuf_Papurcu](https://twitter.com/Yusuf_Papurcu) and [@muratmirgun](https://twitter.com/muratmirgun) are working on the remaining libraries.

![Supabase Go Libraries](/new/images/blog/may-2021/supabase-go-support.png)

## New Swift Libraries

The community started developing the Swift Libararies too. [@satishbabariya](https://twitter.com/satishbabariya) is making huge progress on 
...
![Supabase Swift Libraries](/new/images/blog/may-2021/supabase-swift-support.png)
...
- `@p_phiri` became made his first OSS contribution, and documented it on YouTube. [Twitter](https://twitter.com/p_phiri/status/1397815806990372865?s=20).
...
- Part 2 of "Going Full Stack with Flutter and Supabase". [Twitter](https://twitter.com/yallurium/status/1396850742724632582?s=20).
...
- Everyone who has produced Supabase content is now receiving their [swag](https://twitter.com/coderinblack/status/1397042488586559490?s=20). Send a link to your blog, app, or video on swag@supabase.io along with your address and we'll make sure you're included in the next drop.

**Supabase Github Star Growth** 

![14000 stars on GitHub.](/new/images/blog/may-2021/supabase-stars-may-2021.png)
