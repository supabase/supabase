...
the team tried organizing them into folders but this quickly became unscalable. With clear interest from users encouraged them to build a full website. They used Firebase for the backend and launched on 
