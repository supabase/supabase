...
![This poll on twitter shows that 78.5% of our developer base use Dark Mode for the IDE](/new/images/blog/april-2021/twitter-darkmode.png)

Light Mode is important however: accessibility. Dark Mode is difficult to use for developers with astigmatisms, or even just working in brightly-lit environments.

So today we're shipping Light Mode. 

<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source src="/new/images/blog/april-2021/light-mode.mp4" type="video/mp4" muted playsInline />
</video>
...
![Map of the world](/new/images/blog/april-2021/map.png)

## OpenAPI spec for Storage

We released [Storage Api docs](https://supabase.github.io/storage-api) built using OpenAPI (swagger). 

![Storage API documentation](/new/images/blog/april-2021/storage-openapi.png)

## Stripe Sync Engine (Experimental)

We have [open-sourced a server](https://github.com/supabase/stripe-sync-engine) which keeps any Postgres database in sync with a Stripe account. This is experimental only. We're evaluating other tools such as [Singer](https://www.singer.io/tap/stripe/postgresql/), which provide a more general solution (but are less "realtime"), and we're opening it up here to gather feedback.

![Stripe sync engine](/new/images/blog/april-2021/stripe-sync-engine.jpg)
...
<video width="99%" autoPlay="autoplay" muted playsInline controls={true}>
  <source src="/new/images/blog/april-2021/threaded-small.mp4" type="video/mp4" muted playsInline />
</video>
...
![SupaScript to lookup users in the past 1 week](/new/images/blog/april-2021/supascript.png)
...
![Stars from github](/new/images/blog/april-2021/stars-all.png)
...
![screenshot of our hiring page](/new/images/blog/april-2021/hiring.png)
