...
Head over to the [Self Hosting Docs](https://supabase.io/docs/guides/self-hosting) for a more complete walk through, it also includes several [one-click deploys](https://supabase.io/docs/guides/self-hosting#one-click-deploys), so you can easily deploy into your own cloud hosting provider.
