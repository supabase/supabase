...
![This image shows a SQL Editor with tabs. Originally our SQL editor was very basic, but we're moving towards something very powerful.](/new/images/blog/sql-editor.png)
...
![This image shows some of the keyboard shortcuts we introduced on the table editor.](/new/images/blog/keyboard-shortcuts.png)
...
![This image shows a template where developers can edit the magic links email which is sent to their users on sign up.](/new/images/blog/magic-links.png)
