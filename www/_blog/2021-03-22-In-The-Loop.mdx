...
With Supabase, Kevin can focus on his idea's core rather than worrying about his tech stack. With Postgres under the hood, he can add functionality that will delight his users without worrying about his data model. You can sign up to stay in the loop [here](https://intheloop.dev/).
