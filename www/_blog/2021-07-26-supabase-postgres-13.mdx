...
<small>*Disclaimer for self-hosting: This is not available for x86 instances. All instances on the Supabase platform have this enabled by default.*</small>
...
![PostgreSQL 13.3 performance](/new/images/blog/pg13/postgres-13-performance)
...
## PostgreSQL bundles [Coming Soon]
...
Instead of a single option, you we will soon offer four unique configurations of Supabase Postgres. Each bundle offers functionality for 
