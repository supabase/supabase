...
<div className ="avatar-card -mt-4">
<img className="inline-block h-20 w-20 rounded-md m-0 p-0 mr-4" src="/new/images/blog/avatars/mike-krieger-supabase.png" alt="Mike Krieger Supabase" />
<img class="inline-block max-h-20 p-4" src="https://tailwindui.com/img/logos/tuple-logo-gray-400.svg" alt="Workcation" />
<br />
<a href="https://twitter.com/mikeyk">@mikeyk</a> 
<br />
Cofounder & CTO of Instagram. 
</div>
...
<img className="inline-block h-20 w-20 rounded-md" src="/new/images/blog/avatars/cassidy-williams-supabase.png" alt="Cassidy Williams Supabase" />
...
<img className="inline-block h-20 w-20 rounded-md" src="/new/images/blog/avatars/thor-supabase.png" alt="Thorsten Schaeff Supabase" />
...
<img className="inline-block h-20 w-20 rounded-md" src="/new/images/blog/avatars/brian-douglas-supabase.png" alt="Brian Douglas Supabase" />
...
<img className="inline-block h-20 w-20 rounded-md" src="/new/images/blog/avatars/justin-gauge-supabase.png" alt="Justin Gage Supabase" />
...
## Zach Waterfield (WorkOS)

<img className="inline-block h-20 w-20 rounded-md" src="/new/images/blog/avatars/zach-waterfield-supabase.png" alt="Zach Waterfield Supabase" />

Most recently an engineer and team lead at WorkOS, Network Leader at Village Global, Founder of Kopa (W19). [@zlwaterfield](https://twitter.com/zlwaterfield)
...
What was the first program you wrote and what was it written with? When was the first time you used a computer and what 
did you do with it?
...
<img className="inline-block h-20 w-20 rounded-md" src="/new/images/blog/avatars/swyx-supabase.png" alt="Shawn Wang Supabase" />
...
round lead by Coatue, Mozilla, and YC. 
