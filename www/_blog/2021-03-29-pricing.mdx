...
Check back throughout the week to see what else we're launching [here](https://supabase.io/blog/2021/03/25/launch-week).

Sign up for the Supabase Beta [here](https://app.supabase.io).

And check out the full pricing details [here](https://supabase.io/pricing). And we'd love to hear your opnions on our Pricing! You can let us know via support@supabase.io.
