...
Thanks to everyone who joined in, and made this hackathon awesome. We're already looking forward to the next one. But for now, lets dish out some medals.
...
[![Work From](/new/images/blog/hackathon-winners/projects/workday.png)](https://github.com/joshcawthorne/work-from)
...
[![Fireplace](/new/images/blog/hackathon-winners/projects/fireplace.png)](https://github.com/0xDebabrata/fireplace)
...
[![Dictionary](/new/images/blog/hackathon-winners/projects/dictionary.png)](https://github.com/KathirvelChandrasekaran/dictionary_app)
...
[![tyler chat](/new/images/blog/hackathon-winners/projects/tyler.png)](https://github.com/dshukertjr/avatar-village)
...
[![Feature dot so](/new/images/blog/hackathon-winners/projects/featureso.png)](https://github.com/richiemcilroy/feature)

### Runner Up

[Flutter Add-ons](https://github.com/bdlukaa/supabase_addons) - by [@bdlukaa](https://twitter.com/bdlukaa)

Hook up your supabase credentials and Flutter app and Add-ons will start collecting metric, analytics, and crashalytics, all in a neat dashboard with great visualization tools. Unbelieve that bdlukaa was able to build this in the space of a week.

[![Add Ons](/new/images/blog/hackathon-winners/projects/addons.png)](https://github.com/bdlukaa/supabase_addons)
...
[![Peach recipes](/new/images/blog/hackathon-winners/projects/peach1.png)](https://github.com/Ngineer101/peckish-peach)

### Runner Up

[Tamagotreal](https://github.com/mgilangjanuar/tamagotreal) - by [@mgilangjanuar](https://twitter.com/mgilangjanuar)

Instagram for Pets! The best bit is all the interactions inside the app are from the perspective of your pet. We were loving the tamogochi throwback!

[![tamogochi real insta](/new/images/blog/hackathon-winners/projects/tamog.png)](https://github.com/mgilangjanuar/tamagotreal)
...
![meme runner up 2](/new/images/blog/hackathon-winners/misc/meme3.jpg) - by [@wycowley](https://github.com/wycowley), by [@SonavAgarwal](https://github.com/SonavAgarwal) 

## The Prizes

All gold medal winners will be contacted and sent one of these limited edition gold supabase tees (one per each team member), and all runners up will receive the same design in silver. Prize winners should keep an eye on their emails so we can collect T-Shirt size and shipping details.

![Gold Tshirt](/new/images/blog/hackathon/tshirt.png)
