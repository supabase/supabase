...
1. [Upvote Supabase UI](https://www.producthunt.com/posts/supabase-ui) (if you haven't already). 2. Register
   for the [Golden Kitty Awards Ceremony 2021](https://app.experiencewelcome.com/events/rPurvb/stages/epflG6)
2. Join us [on Discord](https://discord.supabase.com/) in the "hangout" channel. 4. Have fun and win
   Product Hunt & SupaSWAG \o/
