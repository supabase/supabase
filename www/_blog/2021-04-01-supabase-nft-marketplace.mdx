...
Despite the undeniable value of such a platform, this announcement is of course, an April Fool. We are not launching a Supabase NFT platform; but we are [Launching a TON of other stuff this week](https://supabase.io/new/blog/2021/03/25/launch-week).
