...
image: ../../web/static/img/supabase-auth-cover.png
tags:
  - supabase
date: '08-05-2020'
---
...
<video width="99%" autoPlay="autoplay" loop muted playsInline controls="true">
  <source src="../../web/static/videos/auth-zoom2.mp4" type="video/mp4" loop muted playsInline />
</video>
...
<video width="99%" autoPlay="autoplay" loop muted playsInline controls="true">
  <source src="../../web/static/videos/rls-zoom2.mp4" type="video/mp4" loop muted playsInline />
</video>
...
<video width="99%" autoPlay="autoplay" loop muted playsInline controls="true">
  <source src="../../web/static/videos/policies-zoom2.mp4" type="video/mp4" loop muted playsInline />
</video>
