    ...
    <div className="py-16 bg-gray-50 dark:bg-dark-400 overflow-hidden lg:py-16">
      ...
      <SectionHeader className="text-center mx-auto" title={'Supafast easy-to-use APIs'} title_alt={' that do the hard work for you'} subtitle={'MADE FOR DEVELOPERS'} paragraph={'We inspect your database and provide APIs instantly so you can stop building repetitive CRUD endpoints and focus on your product.'} />
        ...
        <div className="relative grid grid-cols-12 gap-1 sm:gap-8 lg:items-center">
          ...
          <div className="mt-2 col-span-12 sm:col-span-10 sm:col-start-2">

            <CodeExamples />

            <div className="grid grid-cols-12 gap-2">
              <dl className="mt-12 grid-cols-12 grid col-start-1 col-span-12 sm:gap-4 md:col-span-12 lg:gap-8 lg:space-y-0 lg:col-start-2 lg:col-span-10 xl:col-start-3 xl:col-span-8">
                <div className="col-span-12 mb-6 sm:mb-0 sm:col-span-6 sm:border-r-2 sm:border-gray-200 sm:pr-4 md:pr-6 dark:border-dark-200">
