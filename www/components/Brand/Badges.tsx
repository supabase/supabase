...
import { Button, IconDownload, Tabs, Typography } from '@supabase/ui'
      ...
      <div className="col-span-12 lg:col-span-5 xl:col-span-5 pb-8">
        ...
        {props.documentation_link && (
          <Link href={props.documentation_link} as={props.documentation_link}>
            <a>
              <Button size="small" className="mt-4" type="default" iconRight={<IconDownload />}>
                Download Full Badge Kit
              </Button>
            </a>
          </Link>
        )}
