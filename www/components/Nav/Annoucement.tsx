    ...
    <div className="bg-brand-700">
      <div className="flex items-center justify-center py-2 mx-auto space-x-2 text-sm lg:container lg:px-16 xl:px-20 md:text-base">
        ...
        <a
          href={a.link.url}
          target="_blank"
          className="inline-flex items-center px-2 py-1 space-x-1 text-xs transition-colors rounded-lg text-brand-800 bg-white border border-transparent dark:hover:border-white dark:hover:bg-brand-700"
        >
