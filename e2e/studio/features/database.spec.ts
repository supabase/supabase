...
test.describe('Database', () => {
  test.describe('Schema Visualizer', () => {
    test('actions works as expected', async ({ page, ref }, testInfo) => {
      ...
      await runCheckpointScan(page, testInfo, 'Database - Export Options Menu', MENU_SELECTOR)
    ...
    test('table actions work as expected', async ({ page, ref }, testInfo) => {
      ...
      await runCheckpointScan(page, testInfo, 'Database - Edit Table Dialog')
      ...
      await runCheckpointScan(page, testInfo, 'Database - Table Actions Menu', MENU_SELECTOR)
    ...
    test('columns actions work as expected', async ({ page, ref }, testInfo) => {
      ...
      await runCheckpointScan(page, testInfo, 'Database - Edit Column Dialog')
      await page.getByLabel('Description').fill('Bazinga')
      await page.getByRole('button', { name: 'Save' }).click()
      await expect(
  ...
  test.describe('Tables', () => {
    ...
    test('CRUD operations and copy works as expected', async ({ page, ref }, testInfo) => {
      ...
      await expect(page.getByRole('dialog')).toBeVisible()
      await runCheckpointScan(page, testInfo, 'Database - Create Table Dialog')
      ...
      await runCheckpointScan(page, testInfo, 'Database - Edit Table Dialog (Tables List)')
      ...
      await expect(page.getByRole('dialog')).toBeVisible()
      await runCheckpointScan(page, testInfo, 'Database - Duplicate Table Dialog')
      ...
      await expect(page.getByRole('dialog')).toBeVisible()
      await runCheckpointScan(page, testInfo, 'Database - Delete Table Confirmation')
  ...
  test.describe('Tables columns', () => {
    test('can view, create, update, delete, and filter table columns', async ({
      ...
      await expect(page.getByRole('dialog')).toBeVisible()
      await runCheckpointScan(page, testInfo, 'Database - New Column Dialog')
      ...
      await expect(page.getByRole('dialog')).toBeVisible()
      await runCheckpointScan(page, testInfo, 'Database - Edit Column Dialog (Columns List)')
      ...
      await runCheckpointScan(page, testInfo, 'Database - Delete Column Confirmation')
  ...
  test.describe('Triggers', () => {
    ...
    test('CRUD operations works as expected', async ({ page, ref }, testInfo) => {
      ...
      await runCheckpointScan(page, testInfo, 'Database - Create Trigger Dialog')
      ...
      await runCheckpointScan(page, testInfo, 'Database - Edit Trigger Dialog')
      ...
      await runCheckpointScan(page, testInfo, 'Database - Delete Trigger Confirmation')
  ...
  test.describe('Database Indexes', () => {
    test('actions works as expected', async ({ page, ref }, testInfo) => {
      ...
      await runCheckpointScan(page, testInfo, 'Database - Index Definition Popover')
    })
    ...
    test('CRUD operations works as expected', async ({ page, ref }, testInfo) => {
      ...
      await runCheckpointScan(page, testInfo, 'Database - Create Index Dialog')
      ...
      await runCheckpointScan(page, testInfo, 'Database - Delete Index Confirmation')
  ...
  test.describe('Roles', () => {
    ...
    test('CRUD operations works as expected', async ({ page, ref }, testInfo) => {
      ...
      await runCheckpointScan(page, testInfo, 'Database - Add Role Dialog')
      ...
      await page.getByRole('button', { name: `${databaseRoleName} actions` }).click()
      await page.getByRole('menuitem', { name: 'Delete' }).click()
      await runCheckpointScan(page, testInfo, 'Database - Delete Role Confirmation')
...
test.describe('Database Extensions', () => {
  ...
  test('can enable an extension', async ({ page, ref }, testInfo) => {
    ...
    await runCheckpointScan(page, testInfo, 'Database - Enable Extension Dialog')
  ...
  test('can disable an extension', async ({ page, ref }, testInfo) => {
    ...
    await runCheckpointScan(page, testInfo, 'Database - Disable Extension Confirmation')
  ...
  test('can enable an extension in a different existing schema', async ({
    ...
    // Scanned before the select opens: its listbox portals out of the dialog and
    // aria-hides what is behind it, so the open state has nothing left to scan.
    await runCheckpointScan(page, testInfo, 'Database - Extension Schema Selector')
...
test.describe('Database Enumerated Types', () => {
  ...
  test('CRUD operations works as expected', async ({ page, ref }, testInfo) => {
    ...
    await runCheckpointScan(page, testInfo, 'Database - Create Enum Type Dialog')
    ...
    await runCheckpointScan(page, testInfo, 'Database - Update Enum Type Dialog')
    await page.getByRole('button', { name: 'Add value' }).click()
    ...
    await page.getByRole('menuitem', { name: 'Delete type' }).click()
    await runCheckpointScan(page, testInfo, 'Database - Delete Enum Type Confirmation')
    await page.getByRole('heading', { name: 'Confirm to delete enumerated' }).click()
    await page.getByRole('button', { name: 'Confirm delete' }).click()
    await expect(page.getByText(`Successfully deleted type "${databaseEnumName}"`)).toBeVisible({
      timeout: 50000,
...
test.describe('Database Functions', () => {
  ...
  test('CRUD operations works as expected', async ({ page, ref }, testInfo) => {
    ...
    await runCheckpointScan(page, testInfo, 'Database - Create Function Dialog')
    ...
    await runCheckpointScan(page, testInfo, 'Database - Edit Function Dialog')
    ...
    await runCheckpointScan(page, testInfo, 'Database - Delete Function Confirmation')
