...
<kbd><img src="https://raw.githubusercontent.com/supabase/supabase/d5f7f413ab356dc1a92075cb3cee4e40a957d5b1/web/static/watch-repo.gif" alt="Watch this repo"/></kbd></kbd>
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr> <tr>
    <th>Мова</th>
    <th>Клієнт</th>
    <th colspan="5">Функціональні клієнти (в комплекті з клієнтом Supabase)</th></th>
    ...
    <th><a href="https://github.com/supabase/storage-api" target="_blank" rel="noopener noreferrer">Сховище</a></th>
    <th>Функції</th>
  </tr> <!
  <!-- ШАБЛОН ДЛЯ НОВОГО РЯДКА -->
  <!-- ПОЧАТКОВИЙ РЯДОК
  </tr> <tr> <td>мова</td> </tr> <tr> <!
    <td>lang</td>
  ...
  КІНЕЦЬ РЯДКА -->>>>> <TH COLSPAN="7
  <th colspan="7">⚡️ Офіційний ⚡️</th>
  </tr> <td>Яваскрипт (тип)
    <td>JavaScript (TypeScript)</td></td>
  ...
  <tr>
    ...
    <td><a href="https://github.com/supabase-community/functions-go" target="_blank" rel="noopener noreferrer">функції-go</a></td>
  ...
  <tr> <td>Python</td> </tr> <tr> <td>Python
    <td>Python</td>
...
<!--- Видаліть цей список, якщо ви перекладаєте на іншу мову, важко підтримувати оновлення в декількох файлах-->
<!--- Залиште лише посилання на список файлів перекладу-->
...
- [Список перекладів](/i18n/languages.md) <!--- Зберегти тільки це -->
