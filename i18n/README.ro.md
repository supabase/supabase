...
<kbd><img src="https://raw.githubusercontent.com/supabase/supabase/d5f7f413ab356dc1a92075cb3cee4e40a957d5b1/web/static/watch-repo.gif" alt="Urmăriți acest repo"/></kbd>
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Language</th>
    <th>Client</th>
    <th colspan="5">Feature-Clients (inclus în clientul Supabase)</th>
  </tr>
  <tr>
    <th></th>
    <th>Supabase</th>
  ...
  <tr>
    ...
    <td><a href="https://github.com/supabase-community/functions-swift" target="_blank" rel="noopener noreferrer">funcții-swift</a></td>
  </tr>
  <tr>
...
<!--- Îndepărtați această listă dacă traduceți în altă limbă, este greu de ținut la zi în mai multe fișiere-->
<!--- Păstrați doar linkul către lista de fișiere de traducere-->
...
- [List of translations](/i18n/languages.md) <!--- Păstrați doar acest lucru -->
