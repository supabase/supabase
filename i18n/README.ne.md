...
- [GoTrue](https://github.com/supabase/gotrue) प्रयोगकर्ताहरू प्रबन्ध गर्न र JWT टोकनहरू जारी गर्नका लागि एक JWT आधारित एपीआई हो।
...
- **`supabase-{lang}`**: लाइब्रेरी संयोजन र संवर्धन थप गर्दछ।
  ...
  - `gotrue-{lang}`: ग्राहक पुस्तकालय [GoTrue](https://github.com/supabase/gotrue) को साथ काम गर्न
