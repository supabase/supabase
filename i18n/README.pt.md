...
- [Problemas do GitHub](https://github.com/supabase/supabase/issues). Indicado para: bugs e errors que tu encontrares ao usar o Supabase.
...
Estamos atualmente em Beta Público. Assista aos lançamentos deste repositório para set notificado sobre as principais atualizações.
...
Supabase é uma [plataforma hospedada](https://supabase.com/dashboard). Podes-te inscrever e começar a usar o Supabase sem instalar nada. Ainda estamos a criar a experiência de desenvolvimento local - esse é nosso foco actual, juntamente com a estabilidade da plataforma.
...
| Repositório           | Official                                                                                | Comunidade                                                                                                                                                                                                                 |
| --------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
