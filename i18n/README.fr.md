...
<table style="table-layout:fixed ; white-space : nowrap ;">
  <tr>
    <th>Langue</th>
    <th>Client</th>
    <th colspan="5">Clients de fonctionnalités (intégrés dans le client Supabase)</th>
  </tr>
  <tr>
    <th></th>
    <th>Supabase</th>
  ...
  <tr>
    ...
    <td><a href="https://github.com/supabase/storage-js" target="_blank" rel="noopener noreferrer">storage-js</a></td><a href="https://github.com/supabase/storage-js" target="_blank" rel="noopener noreferrer">storage-js</a></td>
    ...
    <td><a href="https://github.com/supabase/functions-dart" target="_blank" rel="noopener noreferrer">fonctions-dart</a></td>
  </tr>
  <th colspan="7">💚 Communauté 💚</th>
  <tr>
    <td>C#</td>
...
<!--- Supprimez cette liste si vous traduisez dans une autre langue, il est difficile d'assurer la mise à jour dans plusieurs fichiers-->
<!--- Ne gardez que le lien vers la liste des fichiers de traduction-->
...
- [Liste des traductions](/i18n/languages.md) <!--- Ne garder que ceci -->
