...
- [GoTrue](https://github.com/supabase/gotrue) વપરાશકર્તાઓને સંચાલિત કરવા અને JWT ટોકન્સ ઇશ્યૂ કરવા માટે એક JWT આધારિત API છે.
...
- **`supabase-{lang}`**: લાઇબ્રેરીઝને જોડે છે અને સમૃધ્ધિ ઉમેરે છે.
  ...
  - `gotrue-{lang}`: [GoTrue](https://github.com/supabase/gotrue) સાથે કામ કરવા માટે ક્લાયન્ટ લાઇબ્રેરી.
