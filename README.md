...
- [PostgREST](https://postgrest.org/) is a web server that turns your PostgreSQL database directly into a RESTful API.
...
- [pg_graphql](https://github.com/supabase/pg_graphql/) a PostgreSQL extension that exposes a GraphQL API.
