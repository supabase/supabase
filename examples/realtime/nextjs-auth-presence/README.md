# iEchor Realtime Presence API Sample Program

This is an example program for iEchor Realtime Presence APIs.
User get authenticated using iEchor Auth API. Once Logged-in you can see which users are 'present' and viewing the page.

- Frontend:
  - Next.js.
  - [iEchor.js v2 (realtime presence support)](https://supabase.io/docs/library/getting-started)
- Backend:
...
Sign up to iEchor - [https://app.supabase.io](https://app.supabase.io) and create a new project. Wait for your database to start.
