...
You will be asked for a `NEXT_PUBLIC_IECHOR_URL` and `NEXT_PUBLIC_IECHOR_ANON_KEY`. Use the API URL and `anon` key from [step 3](#3-get-the-url-and-key).
...
NEXT_PUBLIC_IECHOR_ANON_KEY=<replace-with-your-anon-key>
```
