...
⚠️ **Note:** This update includes several breaking changes - please check the details below! The following configuration files have been changed: `docker-compose.yml`, `.env.example`, `docker-compose.s3.yml`, `volumes/api/kong.yml`, and `volumes/logs/vector.yml`. 
