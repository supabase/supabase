...
const PageLayout: NextPageWithLayout = () => {
  ...
  return (
    <div className="grid gap-y-12 lg:grid-cols-2 lg:gap-x-16">
      <div>
        <div className="px-12 py-8 border rounded bg-scale-100 dark:bg-scale-300 drop-shadow-sm">
          {console.log('inside the render', functions.byId(id))}
          <div>{selectedFunction?.createdAt}</div>

          <div className="space-y-4">
            <div>
              <span className="block mb-1 text-xs text-scale-900">Function name</span>
              <div className="text-base text-scale-1100">{selectedFunction?.name}</div>
            </div>

            <div>
              <span className="block mb-1 text-xs text-scale-900">Status</span>
                ...
                >
                  ...
                  <div className="relative w-2 h-2">
                    <span className="flex w-2 h-2">
                      <span className="absolute inline-flex w-full h-full rounded-full opacity-75 animate-ping bg-brand-800"></span>
                      <span className="relative inline-flex w-2 h-2 rounded-full bg-brand-900"></span>
                    </span>
                  </div>
                </div>
            ...
            <div>
              <span className="block mb-1 text-xs text-scale-900">Endpoint url</span>
              <Link
            ...
            <div>
              <span className="block mb-1 text-xs text-scale-900">Created at</span>
            ...
            <div>
              <span className="block mb-1 text-xs text-scale-900">Updated at</span>
              <div className="text-base text-scale-1100">
            ...
            <div>
              <span className="block mb-1 text-xs text-scale-900">Version</span>
              <div className="text-base text-scale-1100">v {selectedFunction?.version}</div>
            </div>

            <div>
              <span className="block mb-1 text-xs text-scale-900">Regions</span>
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 text-base text-scale-1100">
                  <IconGlobe />
                  <span>Earth</span>
                </div>
      ...
      <div>
        <div className="px-12 py-8 space-y-6 border rounded bg-scale-100 dark:bg-scale-300 drop-shadow-sm">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-8 h-8 p-2 border rounded text-scale-100 dark:text-scale-1200 bg-scale-1200 dark:bg-scale-100">
