        ...
        <Head>
          <script
            dangerouslySetInnerHTML={{
              __html: `window._getReturnToPath = ${getReturnToPath.toString()};if (localStorage.getItem('${STORAGE_KEY}') && !(new URLSearchParams(location.search).has('next'))) {location.replace('${BASE_PATH}' + window._getReturnToPath())}`,
            }}
          />
        </Head>
      )}
