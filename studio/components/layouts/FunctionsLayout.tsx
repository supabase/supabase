            ...
            >
              <div className="flex items-center gap-3">
                <div className="flex items-center space-x-4">
                  <h1 className="text-2xl text">Edge Functions</h1>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center space-x-4">
                    <Link href={`/project/${ref}/functions`}>
                      <h1 className="cursor-pointer text-2xl text transition-colors hover:text-scale-1100">
                        Edge Functions
                      </h1>
                    </Link>
                    {name && (
                      <div className="mt-1.5 flex items-center space-x-4">
                        ...
                        <h5 className="text-lg text">{name}</h5>
                      </div>
                    )}
                  </div>
