...
const ResourceContent = ({
  ...
  return (
    <>
      <h2 className="doc-section__table-name text mt-0 flex items-center px-6 gap-2">
      ...
      {methods.includes('GET') && (
        <>
          <h3 className="text mt-4 px-6">Read rows</h3>
          <div className="doc-section">
            <article className="text ">
              <p>
      ...
      {methods.includes('POST') && (
        <>
          <h3 className="text mt-4 px-6">Insert rows</h3>
          <div className="doc-section">
            <article className="text ">
              <p>
      ...
      {methods.includes('PATCH') && (
        <>
          <h3 className="text mt-4 px-6">Update rows</h3>
          <div className="doc-section">
            <article className="text ">
              <p>
      ...
      {methods.includes('DELETE') && (
        <>
          <h3 className="text mt-4 px-6">Delete rows</h3>
          <div className="doc-section">
            <article className="text ">
              <p>
      ...
      {(methods.includes('DELETE') || methods.includes('POST') || methods.includes('PATCH')) && (
        <>
          <h3 className="text mt-4 px-6">Subscribe to changes</h3>
          <div className="doc-section">
            <article className="text ">
              <p>
