                    ...
                    <Tooltip.Content side="bottom">
                      ...
                      >
                        <p className="text-xs text-scale-1200">
                          ...
                          table if row-level security is enabled.
                        </p>
                        <p className="text-xs text-scale-1200">
                          Only rows for which the expression evaluates to true will be allowed. An
                          error will be thrown if the expression evaluates to false or null for any
                          of the records inserted or any of the records that result from the update.
                        </p>
                        <p className="text-xs text-scale-1200">
                          Note that this expression is evaluated against the proposed new contents
                          of the row, not the original contents.
                        </p>
                      </div>
                    </Tooltip.Content>
                  </Tooltip.Portal>
