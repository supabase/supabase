const GetStartedHero = () => {
  return (
    <div className="w-full h-full relative pointer-events-none">
      <div
        className={[
          'w-[290px] lg:w-[400px] h-[180px] bg-alternative border border-border',
      ...
      <div
        className={[
          'w-[260px] lg:w-[320px] h-[160px] lg:h-[220px] bg-surface-100 border border-border',
          'absolute right-0 top-[50px] lg:-top-[40px] rounded-t overflow-y-hidden',
        ].join(' ')}
      >
        <div className="h-[24px] flex items-center border-b border-border">
          <div className="w-[10%] h-full flex items-center border-r border-border px-2">
            <div className="w-3 h-3 rounded border border-control" />
          </div>
          <div className="w-[20%] h-full flex items-center border-r border-border px-2">
            <p className="text-xs">id</p>
          </div>
          <div className="w-[40%] h-full flex items-center border-r border-border px-2">
        ...
        <div className="h-[30px] flex items-center bg-background border-b border-border">
          <div className="w-[10%] h-full flex items-center border-r border-border px-2">
            <div className="w-3 h-3 rounded border border-control" />
          </div>
          <div className="w-[20%] h-full flex items-center border-r border-border px-2">
