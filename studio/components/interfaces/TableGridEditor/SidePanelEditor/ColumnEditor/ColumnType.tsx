...
const ColumnType = ({
  ...
  const inferIcon = (type: string) => {
    switch (type) {
      case 'number':
        return <IconHash size={16} className="text" strokeWidth={1.5} />
      case 'time':
        return <IconCalendar size={16} className="text" strokeWidth={1.5} />
      case 'text':
        return <IconType size={16} className="text" strokeWidth={1.5} />
      case 'json':
        return (
          <div className="text" style={{ padding: '0px 1px' }}>
            {'{ }'}
          </div>
        )
      case 'bool':
        return <IconToggleRight size={16} className="text" strokeWidth={1.5} />
      default:
        return <div />
    }
  }
