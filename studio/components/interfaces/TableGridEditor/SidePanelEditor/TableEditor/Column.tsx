            ...
            <Tooltip.Content side="bottom">
              ...
              >
                {column.foreignKey === undefined ? (
                  <span className="text-xs text">Edit foreign key relation</span>
                ) : (
                  <div>
          ...
          <>
            <Popover
              ...
              header={
                <div className="flex items-center justify-center">
                  <h5 className="text-sm text">Extra options</h5>
                </div>
              }
              overlay={[
            ...
            >
              <div className="group flex items-center -space-x-1">
                ...
                <div className="text-scale-1100 transition-colors group-hover:text">
