...
import { TEXT_TYPES, JSON_TYPES, DATETIME_TYPES, TIME_TYPES } from '../SidePanelEditor.constants'
...
const InputField: FC<Props> = ({
  ...
  if (includes(DATETIME_TYPES, field.format) || includes(TIME_TYPES, field.format)) {
    return (
      <DateTimeInput
        name={field.name}
        format={field.format}
