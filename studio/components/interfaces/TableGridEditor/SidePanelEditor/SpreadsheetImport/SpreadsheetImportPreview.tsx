        ...
        <SidePanel.Content>
          <div className="py-1 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              {!isTypeCompatible && <Badge color="red">Data type incompatible</Badge>}
                      ...
                      <p className="text-sm">
                        ...
                        {incompatibeTypeColumns.map((c) => (
                          <div className="flex items-start space-x-2">
                            ...
                            <p className="text-sm">
                              "{c.name}": expected type of <span className="font-bold">{c.expectedFormat}</span> but
                              found <span className="font-bold">{c.format}</span>
                            </p>
                          </div>
                        ))}
                      </p>
