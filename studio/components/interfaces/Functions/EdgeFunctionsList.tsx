...
import { IconUpload, IconCheck, IconClipboard, IconClock } from 'ui'
import { useRouter } from 'next/router'

interface Props {}

const EdgeFunctionsList: FC<Props> = () => {
  const router = useRouter()
  const { ref } = useParams()
  const { ui, functions: functionsStore } = useStore()
  const functions: Function[] = functionsStore.list() ?? []
