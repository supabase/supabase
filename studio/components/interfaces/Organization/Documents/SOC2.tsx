          ...
          <div className="sticky space-y-6 top-12">
            ...
            <div className="space-y-2">
              <p className="text-sm text-foreground-light m-0">
                For organizations on Teams plan or above, you have access to our most recent SOC2
                Type 2 report.
              </p>
            </div>
          </div>
              ...
              <div className="py-4 text-sm text-foreground-light pl-30">
                <ol className="list-decimal list-inside">
                  ...
                  <li>
                    ...
                    contained in the agreement between Supabase, Inc ("Supabase", "we", "our" or
                    "us") and the Supabase customer that has authorised you to access our platform
                    to obtain this information (our "Customer").
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <ol className="list-[lower-roman] list-inside pl-4">
                      ...
                      <li>
                        confirm that you have been authorised by the Customer to access this
                  ...
                  <li>
                    This Confidentiality Notice does not substitute or supersede any agreement
                    between us and the Customer, or any internal rules or policies that the Customer
                    requires you to comply with in your access to and use of confidential
                    information. However, your failure to comply with this Confidentiality Notice
                    may be used to determine whether the Customer has complied with its
                    confidentiality obligations to us.
                  </li>
                </ol>
              </div>
            </Modal.Content>
