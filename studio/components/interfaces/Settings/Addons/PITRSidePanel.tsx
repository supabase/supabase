                    ...
                    <div className="w-full group">
                      ...
                      <div className="px-4 py-2">
                        ...
                        <div className="flex items-center space-x-1 mt-2">
                          <p className="text text-sm">${option.price.toLocaleString()}</p>
            ...
            <>
              ...
              (selectedPitr?.price ?? 0) < (subscriptionPitr?.variant.price ?? 0) ? (
                ...
                <p className="text-sm text-scale-1100">
                  ...
                  <span className="text">${selectedPitr?.price.toLocaleString()}</span> will be
                  added to your monthly invoice. You're immediately charged for the remaining days
                  of your billing cycle. The addon is prepaid per month and in case of a downgrade,
                  you get credits for the remaining time.
                </p>
              )}
            </>
          )}
