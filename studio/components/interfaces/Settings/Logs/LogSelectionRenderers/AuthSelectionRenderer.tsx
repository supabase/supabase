  ...
  return (
    <div className={`${LOGS_TAILWIND_CLASSES.log_selection_x_padding} space-y-6`}>
      <div className="flex flex-col gap-3">
        ...
        <div className="text-xs text-wrap font-mono text whitespace-pre-wrap overflow-x-auto">
      ...
      <div className="flex flex-col gap-3">
        ...
        <pre
          className=" className={`text text-sm col-span-8 overflow-x-auto text-xs font-mono`}"
