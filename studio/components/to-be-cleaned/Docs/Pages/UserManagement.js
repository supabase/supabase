      ...
      <div className="doc-section ">
        <article className="text ">
          ...
          <p>
            ...
            <a href="https://supabase.com/docs/guides/auth#providers" target="_blank" rel="noreferrer">
          ...
          <p>
            ...
            <a href="https://console.developers.google.com/apis/credentials" target="_blank" rel="noreferrer">
              Google
            </a>
            ,{` `}
